...
- Results must flow through the durable layer (commits + `.tick/` + RESULT.md), never terminal scraping (alternate-screen output is unrecoverable via `agent read`).
