...
func (e *ProtocolMismatchError) Error() string {
	return fmt.Sprintf(
		"herdclient: herdr protocol mismatch at %s: server reports protocol %d (herdr %s), this client requires at least protocol %d — refusing to continue",
...
func (e *UnexpectedResultError) Error() string {
	return fmt.Sprintf("herdclient: %s returned result type %q, expected %q", e.Method, e.Got, e.Want)
}
