import{i as $,n as c,a as $t,b as h,r as y,E as ve,A as w,e as x,u as Ao,t as Lt}from"./ticks-logo-DYgrblNn.js";var la=$`
  :host {
    --track-width: 2px;
...
`;const Ji=new Set,ye=new Map;let ce,ho="ltr",po="en";const fs=typeof MutationObserver<"u"&&typeof document<"u"&&typeof document.documentElement<"u";if(fs){const t=new MutationObserver(bs);ho=document.documentElement.dir||"ltr",po=document.documentElement.lang||navigator.language,t.observe(document.documentElement,{attributes:!0,attributeFilter:["dir","lang"]})}function ms(...t){t.map(e=>{const i=e.$code.toLowerCase();ye.has(i)?ye.set(i,Object.assign(Object.assign({},ye.get(i)),e)):ye.set(i,e),ce||(ce=e)}),bs()}function bs(){fs&&(ho=document.documentElement.dir||"ltr",po=document.documentElement.lang||navigator.language),[...Ji.keys()].map(t=>{typeof t.requestUpdate=="function"&&t.requestUpdate()})}let ca=class{constructor(e){this.host=e,this.host.addController(this)}hostConnected(){Ji.add(this.host)}hostDisconnected(){Ji.delete(this.host)}dir(){return`${this.host.dir||ho}`.toLowerCase()}lang(){return`${this.host.lang||po}`.toLowerCase()}getTranslationData(e){var i,o;const s=new Intl.Locale(e.replace(/_/g,"-")),a=s==null?void 0:s.language.toLowerCase(),r=(o=(i=s==null?void 0:s.region)===null||i===void 0?void 0:i.toLowerCase())!==null&&o!==void 0?o:"",l=ye.get(`${a}-${r}`),d=ye.get(a);return{locale:s,language:a,region:r,primary:l,secondary:d}}exists(e,i){var o;const{primary:s,secondary:a}=this.getTranslationData((o=i.lang)!==null&&o!==void 0?o:this.lang());return i=Object.assign({includeFallback:!1},i),!!(s&&s[e]||a&&a[e]||i.includeFallback&&ce&&ce[e])}term(e,...i){const{primary:o,secondary:s}=this.getTranslationData(this.lang());let a;if(o&&o[e])a=o[e];else if(s&&s[e])a=s[e];else if(ce&&ce[e])a=ce[e];else return console.error(`No translation found for: ${String(e)}`),String(e);return typeof a=="function"?a(...i):a}date(e,i){return e=new Date(e),new Intl.DateTimeFormat(this.lang(),i).format(e)}number(e,i){return e=Number(e),isNaN(e)?"":new Intl.NumberFormat(this.lang(),i).format(e)}relativeTime(e,i,o){return new Intl.RelativeTimeFormat(this.lang(),o).format(e,i)}};var gs={$code:"en",$name:"English",$dir:"ltr",carousel:"Carousel",clearEntry:"Clear entry",close:"Close",copied:"Copied",copy:"Copy",currentValue:"Current value",error:"Error",goToSlide:(t,e)=>`Go to slide ${t} of ${e}`,hidePassword:"Hide password",loading:"Loading",nextSlide:"Next slide",numOptionsSelected:t=>t===0?"No options selected":t===1?"1 option selected":`${t} options selected`,previousSlide:"Previous slide",progress:"Progress",remove:"Remove",resize:"Resize",scrollToEnd:"Scroll to end",scrollToStart:"Scroll to start",selectAColorFromTheScreen:"Select a color from the screen",showPassword:"Show password",slideNum:t=>`Slide ${t}`,toggleColorFormat:"Toggle color format"};ms(gs);var da=gs,it=class extends ca{};ms(da);var F=$`
  :host {
...
`,qt=class{constructor(t,...e){this.slotNames=[],this.handleSlotChange=i=>{const o=i.target;(this.slotNames.includes("[default]")&&!o.name||o.name&&this.slotNames.includes(o.name))&&this.host.requestUpdate()},(this.host=t).addController(this),this.slotNames=e}hasDefaultSlot(){return[...this.host.childNodes].some(t=>{if(t.nodeType===t.TEXT_NODE&&t.textContent.trim()!=="")return!0;if(t.nodeType===t.ELEMENT_NODE){const e=t;if(e.tagName.toLowerCase()==="sl-visually-hidden")return!1;if(!e.hasAttribute("slot"))return!0}return!1})}hasNamedSlot(t){return this.host.querySelector(`:scope > [slot="${t}"]`)!==null}test(t){return t==="[default]"?this.hasDefaultSlot():this.hasNamedSlot(t)}hostConnected(){this.host.shadowRoot.addEventListener("slotchange",this.handleSlotChange)}hostDisconnected(){this.host.shadowRoot.removeEventListener("slotchange",this.handleSlotChange)}};function _a(t){if(!t)return"";const e=t.assignedNodes({flatten:!0});let i="";return[...e].forEach(o=>{o.nodeType===Node.TEXT_NODE&&(i+=o.textContent)}),i}var Zi="";function to(t){Zi=t}function Ca(t=""){if(!Zi){const e=[...document.getElementsByTagName("script")],i=e.find(o=>o.hasAttribute("data-shoelace"));if(i)to(i.getAttribute("data-shoelace"));else{const o=e.find(a=>/shoelace(\.min)?\.js($|\?)/.test(a.src)||/shoelace-autoloader(\.min)?\.js($|\?)/.test(a.src));let s="";o&&(s=o.getAttribute("src")),to(s.split("/").slice(0,-1).join("/"))}}return Zi.replace(/\/$/,"")+(t?`/${t.replace(/^\//,"")}`:"")}var $a={name:"default",resolver:t=>Ca(`assets/icons/${t}.svg`)},Ta=$a,Mo={caret:`
  ...
  `},Sa={name:"system",resolver:t=>t in Mo?`data:image/svg+xml,${encodeURIComponent(Mo[t])}`:""},Ea=Sa,Da=[Ta,Ea],eo=[];function Aa(t){eo.push(t)}function Oa(t){eo=eo.filter(e=>e!==t)}function Po(t){return Da.find(e=>e.name===t)}var za=$`
  :host {
    display: inline-block;
    width: 1em;
    height: 1em;
...
`;function T(t,e){const i=Ut({waitUntilFirstUpdate:!1},e);return(o,s)=>{const{update:a}=o,r=Array.isArray(t)?t:[t];o.update=function(l){r.forEach(d=>{const u=d;if(l.has(u)){const p=l.get(u),f=this[u];p!==f&&(!i.waitUntilFirstUpdate||this.hasUpdated)&&this[s](p,f)}}),a.call(this,l)}}}/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ma=(t,e)=>(t==null?void 0:t._$litType$)!==void 0,ws=t=>t.strings===void 0,Pa={},La=(t,e=Pa)=>t._$AH=e;var Me=Symbol(),ei=Symbol(),Wi,Ui=new Map,G=class extends M{constructor(){super(...arguments),this.initialRender=!1,this.svg=null,this.label="",this.library="default"}async resolveIcon(t,e){var i;let o;if(e!=null&&e.spriteSheet)return this.svg=h`<svg part="svg">
        <use part="use" href="${t}"></use>
      </svg>`,this.svg;try{if(o=await fetch(t,{mode:"cors"}),!o.ok)return o.status===410?Me:ei}catch{return ei}try{const s=document.createElement("div");s.innerHTML=await o.text();const a=s.firstElementChild;if(((i=a==null?void 0:a.tagName)==null?void 0:i.toLowerCase())!=="svg")return Me;Wi||(Wi=new DOMParser);const l=Wi.parseFromString(a.outerHTML,"text/html").body.querySelector("svg");return l?(l.part.add("svg"),document.adoptNode(l)):Me}catch{return Me}}connectedCallback(){super.connectedCallback(),Aa(this)}firstUpdated(){this.initialRender=!0,this.setIcon()}disconnectedCallback(){super.disconnectedCallback(),Oa(this)}getIconSource(){const t=Po(this.library);return this.name&&t?{url:t.resolver(this.name),fromLibrary:!0}:{url:this.src,fromLibrary:!1}}handleLabelChange(){typeof this.label=="string"&&this.label.length>0?(this.setAttribute("role","img"),this.setAttribute("aria-label",this.label),this.removeAttribute("aria-hidden")):(this.removeAttribute("role"),this.removeAttribute("aria-label"),this.setAttribute("aria-hidden","true"))}async setIcon(){var t;const{url:e,fromLibrary:i}=this.getIconSource(),o=i?Po(this.library):void 0;if(!e){this.svg=null;return}let s=Ui.get(e);if(s||(s=this.resolveIcon(e,o),Ui.set(e,s)),!this.initialRender)return;const a=await s;if(a===ei&&Ui.delete(e),e===this.getIconSource().url){if(Ma(a)){if(this.svg=a,o){await this.updateComplete;const r=this.shadowRoot.querySelector("[part='svg']");typeof o.mutator=="function"&&r&&o.mutator(r)}return}switch(a){case ei:case Me:this.svg=null,this.emit("sl-error");break;default:this.svg=a.cloneNode(!0),(t=o==null?void 0:o.mutator)==null||t.call(o,this.svg),this.emit("sl-load")}}}render(){return this.svg}};G.styles=[F,za];n([y()],G.prototype,"svg",2);n([c({reflect:!0})],G.prototype,"name",2);n([c()],G.prototype,"src",2);n([c()],G.prototype,"label",2);n([c({reflect:!0})],G.prototype,"library",2);n([T("label")],G.prototype,"handleLabelChange",1);n([T(["name","src","library"])],G.prototype,"setIcon",1);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const z=Ti(class extends Si{constructor(t){var e;if(super(t),t.type!==Ht.ATTRIBUTE||t.name!=="class"||((e=t.strings)==null?void 0:e.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(t){return" "+Object.keys(t).filter(e=>t[e]).join(" ")+" "}update(t,[e]){var o,s;if(this.st===void 0){this.st=new Set,t.strings!==void 0&&(this.nt=new Set(t.strings.join(" ").split(/\s/).filter(a=>a!=="")));for(const a in e)e[a]&&!((o=this.nt)!=null&&o.has(a))&&this.st.add(a);return this.render(e)}const i=t.element.classList;for(const a of this.st)a in e||(i.remove(a),this.st.delete(a));for(const a in e){const r=!!e[a];r===this.st.has(a)||(s=this.nt)!=null&&s.has(a)||(r?(i.add(a),this.st.add(a)):(i.remove(a),this.st.delete(a)))}return ve}});/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ks=Symbol.for(""),Ia=t=>{if((t==null?void 0:t.r)===ks)return t==null?void 0:t._$litStatic$},hi=(t,...e)=>({_$litStatic$:e.reduce((i,o,s)=>i+(a=>{if(a._$litStatic$!==void 0)return a._$litStatic$;throw Error(`Value passed to 'literal' function must be a 'literal' result: ${a}. Use 'unsafeStatic' to pass non-literal values, but
            take care to ensure page security.`)})(o)+t[s+1],t[0]),r:ks}),Lo=new Map,Ra=t=>(e,...i)=>{const o=i.length;let s,a;const r=[],l=[];let d,u=0,p=!1;for(;u<o;){for(d=e[u];u<o&&(a=i[u],(s=Ia(a))!==void 0);)d+=s+e[++u],p=!0;u!==o&&l.push(a),r.push(d),u++}if(u===o&&r.push(e[o]),p){const f=r.join("$$lit$$");(e=Lo.get(f))===void 0&&(r.raw=r,Lo.set(f,e=r)),i=l}return t(e,...i)},li=Ra(h);/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const k=t=>t??w;var P=class extends M{constructor(){super(...arguments),this.formControlController=new qe(this,{assumeInteractionOn:["click"]}),this.hasSlotController=new qt(this,"[default]","prefix","suffix"),this.localize=new it(this),this.hasFocus=!1,this.invalid=!1,this.title="",this.variant="default",this.size="medium",this.caret=!1,this.disabled=!1,this.loading=!1,this.outline=!1,this.pill=!1,this.circle=!1,this.type="button",this.name="",this.value="",this.href="",this.rel="noreferrer noopener"}get validity(){return this.isButton()?this.button.validity:mo}get validationMessage(){return this.isButton()?this.button.validationMessage:""}firstUpdated(){this.isButton()&&this.formControlController.updateValidity()}handleBlur(){this.hasFocus=!1,this.emit("sl-blur")}handleFocus(){this.hasFocus=!0,this.emit("sl-focus")}handleClick(){this.type==="submit"&&this.formControlController.submit(this),this.type==="reset"&&this.formControlController.reset(this)}handleInvalid(t){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(t)}isButton(){return!this.href}isLink(){return!!this.href}handleDisabledChange(){this.isButton()&&this.formControlController.setValidity(this.disabled)}click(){this.button.click()}focus(t){this.button.focus(t)}blur(){this.button.blur()}checkValidity(){return this.isButton()?this.button.checkValidity():!0}getForm(){return this.formControlController.getForm()}reportValidity(){return this.isButton()?this.button.reportValidity():!0}setCustomValidity(t){this.isButton()&&(this.button.setCustomValidity(t),this.formControlController.updateValidity())}render(){const t=this.isLink(),e=t?hi`a`:hi`button`;return li`
      <${e}
        part="base"
...
`,bo=(t="value")=>(e,i)=>{const o=e.constructor,s=o.prototype.attributeChangedCallback;o.prototype.attributeChangedCallback=function(a,r,l){var d;const u=o.getPropertyOptions(t),p=typeof u.attribute=="string"?u.attribute:t;if(a===p){const f=u.converter||Ao,m=(typeof f=="function"?f:(d=f==null?void 0:f.fromAttribute)!=null?d:Ao.fromAttribute)(l,u.type);this[t]!==m&&(this[i]=m)}s.call(this,a,r,l)}},Ei=$`
...
`,V=class extends M{constructor(){super(...arguments),this.hasFocus=!1,this.label="",this.disabled=!1}handleBlur(){this.hasFocus=!1,this.emit("sl-blur")}handleFocus(){this.hasFocus=!0,this.emit("sl-focus")}handleClick(t){this.disabled&&(t.preventDefault(),t.stopPropagation())}click(){this.button.click()}focus(t){this.button.focus(t)}blur(){this.button.blur()}render(){const t=!!this.href,e=t?hi`a`:hi`button`;return li`
    ...
    `}};V.styles=[F,Ba];V.dependencies={"sl-icon":G};n([x(".icon-button")],V.prototype,"button",2);n([y()],V.prototype,"hasFocus",2);n([c()],V.prototype,"name",2);n([c()],V.prototype,"library",2);n([c()],V.prototype,"src",2);n([c()],V.prototype,"href",2);n([c()],V.prototype,"target",2);n([c()],V.prototype,"download",2);n([c()],V.prototype,"label",2);n([c({type:Boolean,reflect:!0})],V.prototype,"disabled",2);var fe=class extends M{constructor(){super(...arguments),this.localize=new it(this),this.variant="neutral",this.size="medium",this.pill=!1,this.removable=!1}handleRemoveClick(){this.emit("sl-remove")}render(){return h`
      <span
        part="base"
    ...
    `}};fe.styles=[F,Na];fe.dependencies={"sl-icon-button":V};n([c({reflect:!0})],fe.prototype,"variant",2);n([c({reflect:!0})],fe.prototype,"size",2);n([c({type:Boolean,reflect:!0})],fe.prototype,"pill",2);n([c({type:Boolean})],fe.prototype,"removable",2);var Ha=$`
  :host {
    display: block;
  }
...
`;function ja(t,e){return{top:Math.round(t.getBoundingClientRect().top-e.getBoundingClientRect().top),left:Math.round(t.getBoundingClientRect().left-e.getBoundingClientRect().left)}}var io=new Set;function Va(){const t=document.documentElement.clientWidth;return Math.abs(window.innerWidth-t)}function Wa(){const t=Number(getComputedStyle(document.body).paddingRight.replace(/px/,""));return isNaN(t)||!t?0:t}function Re(t){if(io.add(t),!document.documentElement.classList.contains("sl-scroll-lock")){const e=Va()+Wa();let i=getComputedStyle(document.documentElement).scrollbarGutter;(!i||i==="auto")&&(i="stable"),e<2&&(i=""),document.documentElement.style.setProperty("--sl-scroll-lock-gutter",i),document.documentElement.classList.add("sl-scroll-lock"),document.documentElement.style.setProperty("--sl-scroll-lock-size",`${e}px`)}}function Fe(t){io.delete(t),io.size===0&&(document.documentElement.classList.remove("sl-scroll-lock"),document.documentElement.style.removeProperty("--sl-scroll-lock-size"))}function oo(t,e,i="vertical",o="smooth"){const s=ja(t,e),a=s.top+e.scrollTop,r=s.left+e.scrollLeft,l=e.scrollLeft,d=e.scrollLeft+e.offsetWidth,u=e.scrollTop,p=e.scrollTop+e.offsetHeight;(i==="horizontal"||i==="both")&&(r<l?e.scrollTo({left:r,behavior:o}):r+t.clientWidth>d&&e.scrollTo({left:r-e.offsetWidth+t.clientWidth,behavior:o})),(i==="vertical"||i==="both")&&(a<u?e.scrollTo({top:a,behavior:o}):a+t.clientHeight>p&&e.scrollTo({top:a-e.offsetHeight+t.clientHeight,behavior:o}))}var Ua=$`
  :host {
...
`;const Jt=Math.min,ct=Math.max,fi=Math.round,ii=Math.floor,Ot=t=>({x:t,y:t}),qa={left:"right",right:"left",bottom:"top",top:"bottom"},Ya={start:"end",end:"start"};function so(t,e,i){return ct(t,Jt(e,i))}function Ce(t,e){return typeof t=="function"?t(e):t}function Zt(t){return t.split("-")[0]}function $e(t){return t.split("-")[1]}function xs(t){return t==="x"?"y":"x"}function go(t){return t==="y"?"height":"width"}const Ka=new Set(["top","bottom"]);function jt(t){return Ka.has(Zt(t))?"y":"x"}function vo(t){return xs(jt(t))}function Ga(t,e,i){i===void 0&&(i=!1);const o=$e(t),s=vo(t),a=go(s);let r=s==="x"?o===(i?"end":"start")?"right":"left":o==="start"?"bottom":"top";return e.reference[a]>e.floating[a]&&(r=mi(r)),[r,mi(r)]}function Xa(t){const e=mi(t);return[ao(t),e,ao(e)]}function ao(t){return t.replace(/start|end/g,e=>Ya[e])}const Io=["left","right"],Ro=["right","left"],Qa=["top","bottom"],Ja=["bottom","top"];function Za(t,e,i){switch(t){case"top":case"bottom":return i?e?Ro:Io:e?Io:Ro;case"left":case"right":return e?Qa:Ja;default:return[]}}function tr(t,e,i,o){const s=$e(t);let a=Za(Zt(t),i==="start",o);return s&&(a=a.map(r=>r+"-"+s),e&&(a=a.concat(a.map(ao)))),a}function mi(t){return t.replace(/left|right|bottom|top/g,e=>qa[e])}function er(t){return{top:0,right:0,bottom:0,left:0,...t}}function _s(t){return typeof t!="number"?er(t):{top:t,right:t,bottom:t,left:t}}function bi(t){const{x:e,y:i,width:o,height:s}=t;return{width:o,height:s,top:i,left:e,right:e+o,bottom:i+s,x:e,y:i}}function Fo(t,e,i){let{reference:o,floating:s}=t;const a=jt(e),r=vo(e),l=go(r),d=Zt(e),u=a==="y",p=o.x+o.width/2-s.width/2,f=o.y+o.height/2-s.height/2,g=o[l]/2-s[l]/2;let m;switch(d){case"top":m={x:p,y:o.y-s.height};break;case"bottom":m={x:p,y:o.y+o.height};break;case"right":m={x:o.x+o.width,y:f};break;case"left":m={x:o.x-s.width,y:f};break;default:m={x:o.x,y:o.y}}switch($e(e)){case"start":m[r]-=g*(i&&u?-1:1);break;case"end":m[r]+=g*(i&&u?-1:1);break}return m}const ir=async(t,e,i)=>{const{placement:o="bottom",strategy:s="absolute",middleware:a=[],platform:r}=i,l=a.filter(Boolean),d=await(r.isRTL==null?void 0:r.isRTL(e));let u=await r.getElementRects({reference:t,floating:e,strategy:s}),{x:p,y:f}=Fo(u,o,d),g=o,m={},b=0;for(let v=0;v<l.length;v++){const{name:C,fn:S}=l[v],{x:A,y:I,data:W,reset:N}=await S({x:p,y:f,initialPlacement:o,placement:g,strategy:s,middlewareData:m,rects:u,platform:r,elements:{reference:t,floating:e}});p=A??p,f=I??f,m={...m,[C]:{...m[C],...W}},N&&b<=50&&(b++,typeof N=="object"&&(N.placement&&(g=N.placement),N.rects&&(u=N.rects===!0?await r.getElementRects({reference:t,floating:e,strategy:s}):N.rects),{x:p,y:f}=Fo(u,g,d)),v=-1)}return{x:p,y:f,placement:g,strategy:s,middlewareData:m}};async function yo(t,e){var i;e===void 0&&(e={});const{x:o,y:s,platform:a,rects:r,elements:l,strategy:d}=t,{boundary:u="clippingAncestors",rootBoundary:p="viewport",elementContext:f="floating",altBoundary:g=!1,padding:m=0}=Ce(e,t),b=_s(m),C=l[g?f==="floating"?"reference":"floating":f],S=bi(await a.getClippingRect({element:(i=await(a.isElement==null?void 0:a.isElement(C)))==null||i?C:C.contextElement||await(a.getDocumentElement==null?void 0:a.getDocumentElement(l.floating)),boundary:u,rootBoundary:p,strategy:d})),A=f==="floating"?{x:o,y:s,width:r.floating.width,height:r.floating.height}:r.reference,I=await(a.getOffsetParent==null?void 0:a.getOffsetParent(l.floating)),W=await(a.isElement==null?void 0:a.isElement(I))?await(a.getScale==null?void 0:a.getScale(I))||{x:1,y:1}:{x:1,y:1},N=bi(a.convertOffsetParentRelativeRectToViewportRelativeRect?await a.convertOffsetParentRelativeRectToViewportRelativeRect({elements:l,rect:A,offsetParent:I,strategy:d}):A);return{top:(S.top-N.top+b.top)/W.y,bottom:(N.bottom-S.bottom+b.bottom)/W.y,left:(S.left-N.left+b.left)/W.x,right:(N.right-S.right+b.right)/W.x}}const or=t=>({name:"arrow",options:t,async fn(e){const{x:i,y:o,placement:s,rects:a,platform:r,elements:l,middlewareData:d}=e,{element:u,padding:p=0}=Ce(t,e)||{};if(u==null)return{};const f=_s(p),g={x:i,y:o},m=vo(s),b=go(m),v=await r.getDimensions(u),C=m==="y",S=C?"top":"left",A=C?"bottom":"right",I=C?"clientHeight":"clientWidth",W=a.reference[b]+a.reference[m]-g[m]-a.floating[b],N=g[m]-a.reference[m],yt=await(r.getOffsetParent==null?void 0:r.getOffsetParent(u));let Z=yt?yt[I]:0;(!Z||!await(r.isElement==null?void 0:r.isElement(yt)))&&(Z=l.floating[I]||a.floating[b]);const Nt=W/2-N/2,Et=Z/2-v[b]/2-1,bt=Jt(f[S],Et),Yt=Jt(f[A],Et),Dt=bt,Kt=Z-v[b]-Yt,st=Z/2-v[b]/2+Nt,ae=so(Dt,st,Kt),Bt=!d.arrow&&$e(s)!=null&&st!==ae&&a.reference[b]/2-(st<Dt?bt:Yt)-v[b]/2<0,wt=Bt?st<Dt?st-Dt:st-Kt:0;return{[m]:g[m]+wt,data:{[m]:ae,centerOffset:st-ae-wt,...Bt&&{alignmentOffset:wt}},reset:Bt}}}),sr=function(t){return t===void 0&&(t={}),{name:"flip",options:t,async fn(e){var i,o;const{placement:s,middlewareData:a,rects:r,initialPlacement:l,platform:d,elements:u}=e,{mainAxis:p=!0,crossAxis:f=!0,fallbackPlacements:g,fallbackStrategy:m="bestFit",fallbackAxisSideDirection:b="none",flipAlignment:v=!0,...C}=Ce(t,e);if((i=a.arrow)!=null&&i.alignmentOffset)return{};const S=Zt(s),A=jt(l),I=Zt(l)===l,W=await(d.isRTL==null?void 0:d.isRTL(u.floating)),N=g||(I||!v?[mi(l)]:Xa(l)),yt=b!=="none";!g&&yt&&N.push(...tr(l,v,b,W));const Z=[l,...N],Nt=await yo(e,C),Et=[];let bt=((o=a.flip)==null?void 0:o.overflows)||[];if(p&&Et.push(Nt[S]),f){const st=Ga(s,r,W);Et.push(Nt[st[0]],Nt[st[1]])}if(bt=[...bt,{placement:s,overflows:Et}],!Et.every(st=>st<=0)){var Yt,Dt;const st=(((Yt=a.flip)==null?void 0:Yt.index)||0)+1,ae=Z[st];if(ae&&(!(f==="alignment"?A!==jt(ae):!1)||bt.every(kt=>jt(kt.placement)===A?kt.overflows[0]>0:!0)))return{data:{index:st,overflows:bt},reset:{placement:ae}};let Bt=(Dt=bt.filter(wt=>wt.overflows[0]<=0).sort((wt,kt)=>wt.overflows[1]-kt.overflows[1])[0])==null?void 0:Dt.placement;if(!Bt)switch(m){case"bestFit":{var Kt;const wt=(Kt=bt.filter(kt=>{if(yt){const Gt=jt(kt.placement);return Gt===A||Gt==="y"}return!0}).map(kt=>[kt.placement,kt.overflows.filter(Gt=>Gt>0).reduce((Gt,na)=>Gt+na,0)]).sort((kt,Gt)=>kt[1]-Gt[1])[0])==null?void 0:Kt[0];wt&&(Bt=wt);break}case"initialPlacement":Bt=l;break}if(s!==Bt)return{reset:{placement:Bt}}}return{}}}},ar=new Set(["left","top"]);async function rr(t,e){const{placement:i,platform:o,elements:s}=t,a=await(o.isRTL==null?void 0:o.isRTL(s.floating)),r=Zt(i),l=$e(i),d=jt(i)==="y",u=ar.has(r)?-1:1,p=a&&d?-1:1,f=Ce(e,t);let{mainAxis:g,crossAxis:m,alignmentAxis:b}=typeof f=="number"?{mainAxis:f,crossAxis:0,alignmentAxis:null}:{mainAxis:f.mainAxis||0,crossAxis:f.crossAxis||0,alignmentAxis:f.alignmentAxis};return l&&typeof b=="number"&&(m=l==="end"?b*-1:b),d?{x:m*p,y:g*u}:{x:g*u,y:m*p}}const nr=function(t){return t===void 0&&(t=0),{name:"offset",options:t,async fn(e){var i,o;const{x:s,y:a,placement:r,middlewareData:l}=e,d=await rr(e,t);return r===((i=l.offset)==null?void 0:i.placement)&&(o=l.arrow)!=null&&o.alignmentOffset?{}:{x:s+d.x,y:a+d.y,data:{...d,placement:r}}}}},lr=function(t){return t===void 0&&(t={}),{name:"shift",options:t,async fn(e){const{x:i,y:o,placement:s}=e,{mainAxis:a=!0,crossAxis:r=!1,limiter:l={fn:C=>{let{x:S,y:A}=C;return{x:S,y:A}}},...d}=Ce(t,e),u={x:i,y:o},p=await yo(e,d),f=jt(Zt(s)),g=xs(f);let m=u[g],b=u[f];if(a){const C=g==="y"?"top":"left",S=g==="y"?"bottom":"right",A=m+p[C],I=m-p[S];m=so(A,m,I)}if(r){const C=f==="y"?"top":"left",S=f==="y"?"bottom":"right",A=b+p[C],I=b-p[S];b=so(A,b,I)}const v=l.fn({...e,[g]:m,[f]:b});return{...v,data:{x:v.x-i,y:v.y-o,enabled:{[g]:a,[f]:r}}}}}},cr=function(t){return t===void 0&&(t={}),{name:"size",options:t,async fn(e){var i,o;const{placement:s,rects:a,platform:r,elements:l}=e,{apply:d=()=>{},...u}=Ce(t,e),p=await yo(e,u),f=Zt(s),g=$e(s),m=jt(s)==="y",{width:b,height:v}=a.floating;let C,S;f==="top"||f==="bottom"?(C=f,S=g===(await(r.isRTL==null?void 0:r.isRTL(l.floating))?"start":"end")?"left":"right"):(S=f,C=g==="end"?"top":"bottom");const A=v-p.top-p.bottom,I=b-p.left-p.right,W=Jt(v-p[C],A),N=Jt(b-p[S],I),yt=!e.middlewareData.shift;let Z=W,Nt=N;if((i=e.middlewareData.shift)!=null&&i.enabled.x&&(Nt=I),(o=e.middlewareData.shift)!=null&&o.enabled.y&&(Z=A),yt&&!g){const bt=ct(p.left,0),Yt=ct(p.right,0),Dt=ct(p.top,0),Kt=ct(p.bottom,0);m?Nt=b-2*(bt!==0||Yt!==0?bt+Yt:ct(p.left,p.right)):Z=v-2*(Dt!==0||Kt!==0?Dt+Kt:ct(p.top,p.bottom))}await d({...e,availableWidth:Nt,availableHeight:Z});const Et=await r.getDimensions(l.floating);return b!==Et.width||v!==Et.height?{reset:{rects:!0}}:{}}}};function Di(){return typeof window<"u"}function Te(t){return Cs(t)?(t.nodeName||"").toLowerCase():"#document"}function dt(t){var e;return(t==null||(e=t.ownerDocument)==null?void 0:e.defaultView)||window}function It(t){var e;return(e=(Cs(t)?t.ownerDocument:t.document)||window.document)==null?void 0:e.documentElement}function Cs(t){return Di()?t instanceof Node||t instanceof dt(t).Node:!1}function _t(t){return Di()?t instanceof Element||t instanceof dt(t).Element:!1}function zt(t){return Di()?t instanceof HTMLElement||t instanceof dt(t).HTMLElement:!1}function No(t){return!Di()||typeof ShadowRoot>"u"?!1:t instanceof ShadowRoot||t instanceof dt(t).ShadowRoot}const dr=new Set(["inline","contents"]);function Ye(t){const{overflow:e,overflowX:i,overflowY:o,display:s}=Ct(t);return/auto|scroll|overlay|hidden|clip/.test(e+o+i)&&!dr.has(s)}const ur=new Set(["table","td","th"]);function hr(t){return ur.has(Te(t))}const pr=[":popover-open",":modal"];function Ai(t){return pr.some(e=>{try{return t.matches(e)}catch{return!1}})}const fr=["transform","translate","scale","rotate","perspective"],mr=["transform","translate","scale","rotate","perspective","filter"],br=["paint","layout","strict","content"];function Oi(t){const e=wo(),i=_t(t)?Ct(t):t;return fr.some(o=>i[o]?i[o]!=="none":!1)||(i.containerType?i.containerType!=="normal":!1)||!e&&(i.backdropFilter?i.backdropFilter!=="none":!1)||!e&&(i.filter?i.filter!=="none":!1)||mr.some(o=>(i.willChange||"").includes(o))||br.some(o=>(i.contain||"").includes(o))}function gr(t){let e=te(t);for(;zt(e)&&!ke(e);){if(Oi(e))return e;if(Ai(e))return null;e=te(e)}return null}function wo(){return typeof CSS>"u"||!CSS.supports?!1:CSS.supports("-webkit-backdrop-filter","none")}const vr=new Set(["html","body","#document"]);function ke(t){return vr.has(Te(t))}function Ct(t){return dt(t).getComputedStyle(t)}function zi(t){return _t(t)?{scrollLeft:t.scrollLeft,scrollTop:t.scrollTop}:{scrollLeft:t.scrollX,scrollTop:t.scrollY}}function te(t){if(Te(t)==="html")return t;const e=t.assignedSlot||t.parentNode||No(t)&&t.host||It(t);return No(e)?e.host:e}function $s(t){const e=te(t);return ke(e)?t.ownerDocument?t.ownerDocument.body:t.body:zt(e)&&Ye(e)?e:$s(e)}function Be(t,e,i){var o;e===void 0&&(e=[]),i===void 0&&(i=!0);const s=$s(t),a=s===((o=t.ownerDocument)==null?void 0:o.body),r=dt(s);if(a){const l=ro(r);return e.concat(r,r.visualViewport||[],Ye(s)?s:[],l&&i?Be(l):[])}return e.concat(s,Be(s,[],i))}function ro(t){return t.parent&&Object.getPrototypeOf(t.parent)?t.frameElement:null}function Ts(t){const e=Ct(t);let i=parseFloat(e.width)||0,o=parseFloat(e.height)||0;const s=zt(t),a=s?t.offsetWidth:i,r=s?t.offsetHeight:o,l=fi(i)!==a||fi(o)!==r;return l&&(i=a,o=r),{width:i,height:o,$:l}}function ko(t){return _t(t)?t:t.contextElement}function we(t){const e=ko(t);if(!zt(e))return Ot(1);const i=e.getBoundingClientRect(),{width:o,height:s,$:a}=Ts(e);let r=(a?fi(i.width):i.width)/o,l=(a?fi(i.height):i.height)/s;return(!r||!Number.isFinite(r))&&(r=1),(!l||!Number.isFinite(l))&&(l=1),{x:r,y:l}}const yr=Ot(0);function Ss(t){const e=dt(t);return!wo()||!e.visualViewport?yr:{x:e.visualViewport.offsetLeft,y:e.visualViewport.offsetTop}}function wr(t,e,i){return e===void 0&&(e=!1),!i||e&&i!==dt(t)?!1:e}function ue(t,e,i,o){e===void 0&&(e=!1),i===void 0&&(i=!1);const s=t.getBoundingClientRect(),a=ko(t);let r=Ot(1);e&&(o?_t(o)&&(r=we(o)):r=we(t));const l=wr(a,i,o)?Ss(a):Ot(0);let d=(s.left+l.x)/r.x,u=(s.top+l.y)/r.y,p=s.width/r.x,f=s.height/r.y;if(a){const g=dt(a),m=o&&_t(o)?dt(o):o;let b=g,v=ro(b);for(;v&&o&&m!==b;){const C=we(v),S=v.getBoundingClientRect(),A=Ct(v),I=S.left+(v.clientLeft+parseFloat(A.paddingLeft))*C.x,W=S.top+(v.clientTop+parseFloat(A.paddingTop))*C.y;d*=C.x,u*=C.y,p*=C.x,f*=C.y,d+=I,u+=W,b=dt(v),v=ro(b)}}return bi({width:p,height:f,x:d,y:u})}function Mi(t,e){const i=zi(t).scrollLeft;return e?e.left+i:ue(It(t)).left+i}function Es(t,e){const i=t.getBoundingClientRect(),o=i.left+e.scrollLeft-Mi(t,i),s=i.top+e.scrollTop;return{x:o,y:s}}function kr(t){let{elements:e,rect:i,offsetParent:o,strategy:s}=t;const a=s==="fixed",r=It(o),l=e?Ai(e.floating):!1;if(o===r||l&&a)return i;let d={scrollLeft:0,scrollTop:0},u=Ot(1);const p=Ot(0),f=zt(o);if((f||!f&&!a)&&((Te(o)!=="body"||Ye(r))&&(d=zi(o)),zt(o))){const m=ue(o);u=we(o),p.x=m.x+o.clientLeft,p.y=m.y+o.clientTop}const g=r&&!f&&!a?Es(r,d):Ot(0);return{width:i.width*u.x,height:i.height*u.y,x:i.x*u.x-d.scrollLeft*u.x+p.x+g.x,y:i.y*u.y-d.scrollTop*u.y+p.y+g.y}}function xr(t){return Array.from(t.getClientRects())}function _r(t){const e=It(t),i=zi(t),o=t.ownerDocument.body,s=ct(e.scrollWidth,e.clientWidth,o.scrollWidth,o.clientWidth),a=ct(e.scrollHeight,e.clientHeight,o.scrollHeight,o.clientHeight);let r=-i.scrollLeft+Mi(t);const l=-i.scrollTop;return Ct(o).direction==="rtl"&&(r+=ct(e.clientWidth,o.clientWidth)-s),{width:s,height:a,x:r,y:l}}const Bo=25;function Cr(t,e){const i=dt(t),o=It(t),s=i.visualViewport;let a=o.clientWidth,r=o.clientHeight,l=0,d=0;if(s){a=s.width,r=s.height;const p=wo();(!p||p&&e==="fixed")&&(l=s.offsetLeft,d=s.offsetTop)}const u=Mi(o);if(u<=0){const p=o.ownerDocument,f=p.body,g=getComputedStyle(f),m=p.compatMode==="CSS1Compat"&&parseFloat(g.marginLeft)+parseFloat(g.marginRight)||0,b=Math.abs(o.clientWidth-f.clientWidth-m);b<=Bo&&(a-=b)}else u<=Bo&&(a+=u);return{width:a,height:r,x:l,y:d}}const $r=new Set(["absolute","fixed"]);function Tr(t,e){const i=ue(t,!0,e==="fixed"),o=i.top+t.clientTop,s=i.left+t.clientLeft,a=zt(t)?we(t):Ot(1),r=t.clientWidth*a.x,l=t.clientHeight*a.y,d=s*a.x,u=o*a.y;return{width:r,height:l,x:d,y:u}}function Ho(t,e,i){let o;if(e==="viewport")o=Cr(t,i);else if(e==="document")o=_r(It(t));else if(_t(e))o=Tr(e,i);else{const s=Ss(t);o={x:e.x-s.x,y:e.y-s.y,width:e.width,height:e.height}}return bi(o)}function Ds(t,e){const i=te(t);return i===e||!_t(i)||ke(i)?!1:Ct(i).position==="fixed"||Ds(i,e)}function Sr(t,e){const i=e.get(t);if(i)return i;let o=Be(t,[],!1).filter(l=>_t(l)&&Te(l)!=="body"),s=null;const a=Ct(t).position==="fixed";let r=a?te(t):t;for(;_t(r)&&!ke(r);){const l=Ct(r),d=Oi(r);!d&&l.position==="fixed"&&(s=null),(a?!d&&!s:!d&&l.position==="static"&&!!s&&$r.has(s.position)||Ye(r)&&!d&&Ds(t,r))?o=o.filter(p=>p!==r):s=l,r=te(r)}return e.set(t,o),o}function Er(t){let{element:e,boundary:i,rootBoundary:o,strategy:s}=t;const r=[...i==="clippingAncestors"?Ai(e)?[]:Sr(e,this._c):[].concat(i),o],l=r[0],d=r.reduce((u,p)=>{const f=Ho(e,p,s);return u.top=ct(f.top,u.top),u.right=Jt(f.right,u.right),u.bottom=Jt(f.bottom,u.bottom),u.left=ct(f.left,u.left),u},Ho(e,l,s));return{width:d.right-d.left,height:d.bottom-d.top,x:d.left,y:d.top}}function Dr(t){const{width:e,height:i}=Ts(t);return{width:e,height:i}}function Ar(t,e,i){const o=zt(e),s=It(e),a=i==="fixed",r=ue(t,!0,a,e);let l={scrollLeft:0,scrollTop:0};const d=Ot(0);function u(){d.x=Mi(s)}if(o||!o&&!a)if((Te(e)!=="body"||Ye(s))&&(l=zi(e)),o){const m=ue(e,!0,a,e);d.x=m.x+e.clientLeft,d.y=m.y+e.clientTop}else s&&u();a&&!o&&s&&u();const p=s&&!o&&!a?Es(s,l):Ot(0),f=r.left+l.scrollLeft-d.x-p.x,g=r.top+l.scrollTop-d.y-p.y;return{x:f,y:g,width:r.width,height:r.height}}function qi(t){return Ct(t).position==="static"}function jo(t,e){if(!zt(t)||Ct(t).position==="fixed")return null;if(e)return e(t);let i=t.offsetParent;return It(t)===i&&(i=i.ownerDocument.body),i}function As(t,e){const i=dt(t);if(Ai(t))return i;if(!zt(t)){let s=te(t);for(;s&&!ke(s);){if(_t(s)&&!qi(s))return s;s=te(s)}return i}let o=jo(t,e);for(;o&&hr(o)&&qi(o);)o=jo(o,e);return o&&ke(o)&&qi(o)&&!Oi(o)?i:o||gr(t)||i}const Or=async function(t){const e=this.getOffsetParent||As,i=this.getDimensions,o=await i(t.floating);return{reference:Ar(t.reference,await e(t.floating),t.strategy),floating:{x:0,y:0,width:o.width,height:o.height}}};function zr(t){return Ct(t).direction==="rtl"}const ci={convertOffsetParentRelativeRectToViewportRelativeRect:kr,getDocumentElement:It,getClippingRect:Er,getOffsetParent:As,getElementRects:Or,getClientRects:xr,getDimensions:Dr,getScale:we,isElement:_t,isRTL:zr};function Os(t,e){return t.x===e.x&&t.y===e.y&&t.width===e.width&&t.height===e.height}function Mr(t,e){let i=null,o;const s=It(t);function a(){var l;clearTimeout(o),(l=i)==null||l.disconnect(),i=null}function r(l,d){l===void 0&&(l=!1),d===void 0&&(d=1),a();const u=t.getBoundingClientRect(),{left:p,top:f,width:g,height:m}=u;if(l||e(),!g||!m)return;const b=ii(f),v=ii(s.clientWidth-(p+g)),C=ii(s.clientHeight-(f+m)),S=ii(p),I={rootMargin:-b+"px "+-v+"px "+-C+"px "+-S+"px",threshold:ct(0,Jt(1,d))||1};let W=!0;function N(yt){const Z=yt[0].intersectionRatio;if(Z!==d){if(!W)return r();Z?r(!1,Z):o=setTimeout(()=>{r(!1,1e-7)},1e3)}Z===1&&!Os(u,t.getBoundingClientRect())&&r(),W=!1}try{i=new IntersectionObserver(N,{...I,root:s.ownerDocument})}catch{i=new IntersectionObserver(N,I)}i.observe(t)}return r(!0),a}function Pr(t,e,i,o){o===void 0&&(o={});const{ancestorScroll:s=!0,ancestorResize:a=!0,elementResize:r=typeof ResizeObserver=="function",layoutShift:l=typeof IntersectionObserver=="function",animationFrame:d=!1}=o,u=ko(t),p=s||a?[...u?Be(u):[],...Be(e)]:[];p.forEach(S=>{s&&S.addEventListener("scroll",i,{passive:!0}),a&&S.addEventListener("resize",i)});const f=u&&l?Mr(u,i):null;let g=-1,m=null;r&&(m=new ResizeObserver(S=>{let[A]=S;A&&A.target===u&&m&&(m.unobserve(e),cancelAnimationFrame(g),g=requestAnimationFrame(()=>{var I;(I=m)==null||I.observe(e)})),i()}),u&&!d&&m.observe(u),m.observe(e));let b,v=d?ue(t):null;d&&C();function C(){const S=ue(t);v&&!Os(v,S)&&i(),v=S,b=requestAnimationFrame(C)}return i(),()=>{var S;p.forEach(A=>{s&&A.removeEventListener("scroll",i),a&&A.removeEventListener("resize",i)}),f==null||f(),(S=m)==null||S.disconnect(),m=null,d&&cancelAnimationFrame(b)}}const Lr=nr,Ir=lr,Rr=sr,Vo=cr,Fr=or,Nr=(t,e,i)=>{const o=new Map,s={platform:ci,...i},a={...s.platform,_c:o};return ir(t,e,{...s,platform:a})};function Br(t){return Hr(t)}function Yi(t){return t.assignedSlot?t.assignedSlot:t.parentNode instanceof ShadowRoot?t.parentNode.host:t.parentNode}function Hr(t){for(let e=t;e;e=Yi(e))if(e instanceof Element&&getComputedStyle(e).display==="none")return null;for(let e=Yi(t);e;e=Yi(e)){if(!(e instanceof Element))continue;const i=getComputedStyle(e);if(i.display!=="contents"&&(i.position!=="static"||Oi(i)||e.tagName==="BODY"))return e}return null}function jr(t){return t!==null&&typeof t=="object"&&"getBoundingClientRect"in t&&("contextElement"in t?t.contextElement instanceof Element:!0)}var L=class extends M{constructor(){super(...arguments),this.localize=new it(this),this.active=!1,this.placement="top",this.strategy="absolute",this.distance=0,this.skidding=0,this.arrow=!1,this.arrowPlacement="anchor",this.arrowPadding=10,this.flip=!1,this.flipFallbackPlacements="",this.flipFallbackStrategy="best-fit",this.flipPadding=0,this.shift=!1,this.shiftPadding=0,this.autoSizePadding=0,this.hoverBridge=!1,this.updateHoverBridge=()=>{if(this.hoverBridge&&this.anchorEl){const t=this.anchorEl.getBoundingClientRect(),e=this.popup.getBoundingClientRect(),i=this.placement.includes("top")||this.placement.includes("bottom");let o=0,s=0,a=0,r=0,l=0,d=0,u=0,p=0;i?t.top<e.top?(o=t.left,s=t.bottom,a=t.right,r=t.bottom,l=e.left,d=e.top,u=e.right,p=e.top):(o=e.left,s=e.bottom,a=e.right,r=e.bottom,l=t.left,d=t.top,u=t.right,p=t.top):t.left<e.left?(o=t.right,s=t.top,a=e.left,r=e.top,l=t.right,d=t.bottom,u=e.left,p=e.bottom):(o=e.right,s=e.top,a=t.left,r=t.top,l=e.right,d=e.bottom,u=t.left,p=t.bottom),this.style.setProperty("--hover-bridge-top-left-x",`${o}px`),this.style.setProperty("--hover-bridge-top-left-y",`${s}px`),this.style.setProperty("--hover-bridge-top-right-x",`${a}px`),this.style.setProperty("--hover-bridge-top-right-y",`${r}px`),this.style.setProperty("--hover-bridge-bottom-left-x",`${l}px`),this.style.setProperty("--hover-bridge-bottom-left-y",`${d}px`),this.style.setProperty("--hover-bridge-bottom-right-x",`${u}px`),this.style.setProperty("--hover-bridge-bottom-right-y",`${p}px`)}}}async connectedCallback(){super.connectedCallback(),await this.updateComplete,this.start()}disconnectedCallback(){super.disconnectedCallback(),this.stop()}async updated(t){super.updated(t),t.has("active")&&(this.active?this.start():this.stop()),t.has("anchor")&&this.handleAnchorChange(),this.active&&(await this.updateComplete,this.reposition())}async handleAnchorChange(){if(await this.stop(),this.anchor&&typeof this.anchor=="string"){const t=this.getRootNode();this.anchorEl=t.getElementById(this.anchor)}else this.anchor instanceof Element||jr(this.anchor)?this.anchorEl=this.anchor:this.anchorEl=this.querySelector('[slot="anchor"]');this.anchorEl instanceof HTMLSlotElement&&(this.anchorEl=this.anchorEl.assignedElements({flatten:!0})[0]),this.anchorEl&&this.active&&this.start()}start(){!this.anchorEl||!this.active||(this.cleanup=Pr(this.anchorEl,this.popup,()=>{this.reposition()}))}async stop(){return new Promise(t=>{this.cleanup?(this.cleanup(),this.cleanup=void 0,this.removeAttribute("data-current-placement"),this.style.removeProperty("--auto-size-available-width"),this.style.removeProperty("--auto-size-available-height"),requestAnimationFrame(()=>t())):t()})}reposition(){if(!this.active||!this.anchorEl)return;const t=[Lr({mainAxis:this.distance,crossAxis:this.skidding})];this.sync?t.push(Vo({apply:({rects:i})=>{const o=this.sync==="width"||this.sync==="both",s=this.sync==="height"||this.sync==="both";this.popup.style.width=o?`${i.reference.width}px`:"",this.popup.style.height=s?`${i.reference.height}px`:""}})):(this.popup.style.width="",this.popup.style.height=""),this.flip&&t.push(Rr({boundary:this.flipBoundary,fallbackPlacements:this.flipFallbackPlacements,fallbackStrategy:this.flipFallbackStrategy==="best-fit"?"bestFit":"initialPlacement",padding:this.flipPadding})),this.shift&&t.push(Ir({boundary:this.shiftBoundary,padding:this.shiftPadding})),this.autoSize?t.push(Vo({boundary:this.autoSizeBoundary,padding:this.autoSizePadding,apply:({availableWidth:i,availableHeight:o})=>{this.autoSize==="vertical"||this.autoSize==="both"?this.style.setProperty("--auto-size-available-height",`${o}px`):this.style.removeProperty("--auto-size-available-height"),this.autoSize==="horizontal"||this.autoSize==="both"?this.style.setProperty("--auto-size-available-width",`${i}px`):this.style.removeProperty("--auto-size-available-width")}})):(this.style.removeProperty("--auto-size-available-width"),this.style.removeProperty("--auto-size-available-height")),this.arrow&&t.push(Fr({element:this.arrowEl,padding:this.arrowPadding}));const e=this.strategy==="absolute"?i=>ci.getOffsetParent(i,Br):ci.getOffsetParent;Nr(this.anchorEl,this.popup,{placement:this.placement,middleware:t,strategy:this.strategy,platform:Ue(Ut({},ci),{getOffsetParent:e})}).then(({x:i,y:o,middlewareData:s,placement:a})=>{const r=this.localize.dir()==="rtl",l={top:"bottom",right:"left",bottom:"top",left:"right"}[a.split("-")[0]];if(this.setAttribute("data-current-placement",a),Object.assign(this.popup.style,{left:`${i}px`,top:`${o}px`}),this.arrow){const d=s.arrow.x,u=s.arrow.y;let p="",f="",g="",m="";if(this.arrowPlacement==="start"){const b=typeof d=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"";p=typeof u=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"",f=r?b:"",m=r?"":b}else if(this.arrowPlacement==="end"){const b=typeof d=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"";f=r?"":b,m=r?b:"",g=typeof u=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:""}else this.arrowPlacement==="center"?(m=typeof d=="number"?"calc(50% - var(--arrow-size-diagonal))":"",p=typeof u=="number"?"calc(50% - var(--arrow-size-diagonal))":""):(m=typeof d=="number"?`${d}px`:"",p=typeof u=="number"?`${u}px`:"");Object.assign(this.arrowEl.style,{top:p,right:f,bottom:g,left:m,[l]:"calc(var(--arrow-size-diagonal) * -1)"})}}),requestAnimationFrame(()=>this.updateHoverBridge()),this.emit("sl-reposition")}render(){return h`
...
`,vt=class extends M{constructor(){super(...arguments),this.localize=new it(this),this.isInitialized=!1,this.current=!1,this.selected=!1,this.hasHover=!1,this.value="",this.disabled=!1}connectedCallback(){super.connectedCallback(),this.setAttribute("role","option"),this.setAttribute("aria-selected","false")}handleDefaultSlotChange(){this.isInitialized?customElements.whenDefined("sl-select").then(()=>{const t=this.closest("sl-select");t&&t.handleDefaultSlotChange()}):this.isInitialized=!0}handleMouseEnter(){this.hasHover=!0}handleMouseLeave(){this.hasHover=!1}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false")}handleSelectedChange(){this.setAttribute("aria-selected",this.selected?"true":"false")}handleValueChange(){typeof this.value!="string"&&(this.value=String(this.value)),this.value.includes(" ")&&(console.error("Option values cannot include a space. All spaces have been replaced with underscores.",this),this.value=this.value.replace(/ /g,"_"))}getTextLabel(){const t=this.childNodes;let e="";return[...t].forEach(i=>{i.nodeType===Node.ELEMENT_NODE&&(i.hasAttribute("slot")||(e+=i.textContent)),i.nodeType===Node.TEXT_NODE&&(e+=i.textContent)}),e.trim()}render(){return h`
      <div
        part="base"
    ...
    `}};vt.styles=[F,Yr];vt.dependencies={"sl-icon":G};n([x(".option__label")],vt.prototype,"defaultSlot",2);n([y()],vt.prototype,"current",2);n([y()],vt.prototype,"selected",2);n([y()],vt.prototype,"hasHover",2);n([c({reflect:!0})],vt.prototype,"value",2);n([c({type:Boolean,reflect:!0})],vt.prototype,"disabled",2);n([T("disabled")],vt.prototype,"handleDisabledChange",1);n([T("selected")],vt.prototype,"handleSelectedChange",1);n([T("value")],vt.prototype,"handleValueChange",1);vt.define("sl-option");var Kr=$`
  :host {
    --size: 25rem;
...
`;function*xo(t=document.activeElement){t!=null&&(yield t,"shadowRoot"in t&&t.shadowRoot&&t.shadowRoot.mode!=="closed"&&(yield*wa(xo(t.shadowRoot.activeElement))))}function Ms(){return[...xo()].pop()}var Yo=new WeakMap;function Ps(t){let e=Yo.get(t);return e||(e=window.getComputedStyle(t,null),Yo.set(t,e)),e}function Gr(t){if(typeof t.checkVisibility=="function")return t.checkVisibility({checkOpacity:!1,checkVisibilityCSS:!0});const e=Ps(t);return e.visibility!=="hidden"&&e.display!=="none"}function Xr(t){const e=Ps(t),{overflowY:i,overflowX:o}=e;return i==="scroll"||o==="scroll"?!0:i!=="auto"||o!=="auto"?!1:t.scrollHeight>t.clientHeight&&i==="auto"||t.scrollWidth>t.clientWidth&&o==="auto"}function Qr(t){const e=t.tagName.toLowerCase(),i=Number(t.getAttribute("tabindex"));if(t.hasAttribute("tabindex")&&(isNaN(i)||i<=-1)||t.hasAttribute("disabled")||t.closest("[inert]"))return!1;if(e==="input"&&t.getAttribute("type")==="radio"){const a=t.getRootNode(),r=`input[type='radio'][name="${t.getAttribute("name")}"]`,l=a.querySelector(`${r}:checked`);return l?l===t:a.querySelector(r)===t}return Gr(t)?(e==="audio"||e==="video")&&t.hasAttribute("controls")||t.hasAttribute("tabindex")||t.hasAttribute("contenteditable")&&t.getAttribute("contenteditable")!=="false"||["button","input","select","textarea","a","audio","video","summary","iframe"].includes(e)?!0:Xr(t):!1}function Jr(t){var e,i;const o=lo(t),s=(e=o[0])!=null?e:null,a=(i=o[o.length-1])!=null?i:null;return{start:s,end:a}}function Zr(t,e){var i;return((i=t.getRootNode({composed:!0}))==null?void 0:i.host)!==e}function lo(t){const e=new WeakMap,i=[];function o(s){if(s instanceof Element){if(s.hasAttribute("inert")||s.closest("[inert]")||e.has(s))return;e.set(s,!0),!i.includes(s)&&Qr(s)&&i.push(s),s instanceof HTMLSlotElement&&Zr(s,t)&&s.assignedElements({flatten:!0}).forEach(a=>{o(a)}),s.shadowRoot!==null&&s.shadowRoot.mode==="open"&&o(s.shadowRoot)}for(const a of s.children)o(a)}return o(t),i.sort((s,a)=>{const r=Number(s.getAttribute("tabindex"))||0;return(Number(a.getAttribute("tabindex"))||0)-r})}var Pe=[],Ls=class{constructor(t){this.tabDirection="forward",this.handleFocusIn=()=>{this.isActive()&&this.checkFocus()},this.handleKeyDown=e=>{var i;if(e.key!=="Tab"||this.isExternalActivated||!this.isActive())return;const o=Ms();if(this.previousFocus=o,this.previousFocus&&this.possiblyHasTabbableChildren(this.previousFocus))return;e.shiftKey?this.tabDirection="backward":this.tabDirection="forward";const s=lo(this.element);let a=s.findIndex(l=>l===o);this.previousFocus=this.currentFocus;const r=this.tabDirection==="forward"?1:-1;for(;;){a+r>=s.length?a=0:a+r<0?a=s.length-1:a+=r,this.previousFocus=this.currentFocus;const l=s[a];if(this.tabDirection==="backward"&&this.previousFocus&&this.possiblyHasTabbableChildren(this.previousFocus)||l&&this.possiblyHasTabbableChildren(l))return;e.preventDefault(),this.currentFocus=l,(i=this.currentFocus)==null||i.focus({preventScroll:!1});const d=[...xo()];if(d.includes(this.currentFocus)||!d.includes(this.previousFocus))break}setTimeout(()=>this.checkFocus())},this.handleKeyUp=()=>{this.tabDirection="forward"},this.element=t,this.elementsWithTabbableControls=["iframe"]}activate(){Pe.push(this.element),document.addEventListener("focusin",this.handleFocusIn),document.addEventListener("keydown",this.handleKeyDown),document.addEventListener("keyup",this.handleKeyUp)}deactivate(){Pe=Pe.filter(t=>t!==this.element),this.currentFocus=null,document.removeEventListener("focusin",this.handleFocusIn),document.removeEventListener("keydown",this.handleKeyDown),document.removeEventListener("keyup",this.handleKeyUp)}isActive(){return Pe[Pe.length-1]===this.element}activateExternal(){this.isExternalActivated=!0}deactivateExternal(){this.isExternalActivated=!1}checkFocus(){if(this.isActive()&&!this.isExternalActivated){const t=lo(this.element);if(!this.element.matches(":focus-within")){const e=t[0],i=t[t.length-1],o=this.tabDirection==="forward"?e:i;typeof(o==null?void 0:o.focus)=="function"&&(this.currentFocus=o,o.focus({preventScroll:!1}))}}}possiblyHasTabbableChildren(t){return this.elementsWithTabbableControls.includes(t.tagName.toLowerCase())||t.hasAttribute("controls")}},_o=t=>{var e;const{activeElement:i}=document;i&&t.contains(i)&&((e=document.activeElement)==null||e.blur())};function Ko(t){return t.charAt(0).toUpperCase()+t.slice(1)}var ut=class extends M{constructor(){super(...arguments),this.hasSlotController=new qt(this,"footer"),this.localize=new it(this),this.modal=new Ls(this),this.open=!1,this.label="",this.placement="end",this.contained=!1,this.noHeader=!1,this.handleDocumentKeyDown=t=>{this.contained||t.key==="Escape"&&this.modal.isActive()&&this.open&&(t.stopImmediatePropagation(),this.requestClose("keyboard"))}}firstUpdated(){this.drawer.hidden=!this.open,this.open&&(this.addOpenListeners(),this.contained||(this.modal.activate(),Re(this)))}disconnectedCallback(){super.disconnectedCallback(),Fe(this),this.removeOpenListeners()}requestClose(t){if(this.emit("sl-request-close",{cancelable:!0,detail:{source:t}}).defaultPrevented){const i=B(this,"drawer.denyClose",{dir:this.localize.dir()});H(this.panel,i.keyframes,i.options);return}this.hide()}addOpenListeners(){var t;"CloseWatcher"in window?((t=this.closeWatcher)==null||t.destroy(),this.contained||(this.closeWatcher=new CloseWatcher,this.closeWatcher.onclose=()=>this.requestClose("keyboard"))):document.addEventListener("keydown",this.handleDocumentKeyDown)}removeOpenListeners(){var t;document.removeEventListener("keydown",this.handleDocumentKeyDown),(t=this.closeWatcher)==null||t.destroy()}async handleOpenChange(){if(this.open){this.emit("sl-show"),this.addOpenListeners(),this.originalTrigger=document.activeElement,this.contained||(this.modal.activate(),Re(this));const t=this.querySelector("[autofocus]");t&&t.removeAttribute("autofocus"),await Promise.all([U(this.drawer),U(this.overlay)]),this.drawer.hidden=!1,requestAnimationFrame(()=>{this.emit("sl-initial-focus",{cancelable:!0}).defaultPrevented||(t?t.focus({preventScroll:!0}):this.panel.focus({preventScroll:!0})),t&&t.setAttribute("autofocus","")});const e=B(this,`drawer.show${Ko(this.placement)}`,{dir:this.localize.dir()}),i=B(this,"drawer.overlay.show",{dir:this.localize.dir()});await Promise.all([H(this.panel,e.keyframes,e.options),H(this.overlay,i.keyframes,i.options)]),this.emit("sl-after-show")}else{_o(this),this.emit("sl-hide"),this.removeOpenListeners(),this.contained||(this.modal.deactivate(),Fe(this)),await Promise.all([U(this.drawer),U(this.overlay)]);const t=B(this,`drawer.hide${Ko(this.placement)}`,{dir:this.localize.dir()}),e=B(this,"drawer.overlay.hide",{dir:this.localize.dir()});await Promise.all([H(this.overlay,e.keyframes,e.options).then(()=>{this.overlay.hidden=!0}),H(this.panel,t.keyframes,t.options).then(()=>{this.panel.hidden=!0})]),this.drawer.hidden=!0,this.overlay.hidden=!1,this.panel.hidden=!1;const i=this.originalTrigger;typeof(i==null?void 0:i.focus)=="function"&&setTimeout(()=>i.focus()),this.emit("sl-after-hide")}}handleNoModalChange(){this.open&&!this.contained&&(this.modal.activate(),Re(this)),this.open&&this.contained&&(this.modal.deactivate(),Fe(this))}async show(){if(!this.open)return this.open=!0,nt(this,"sl-after-show")}async hide(){if(this.open)return this.open=!1,nt(this,"sl-after-hide")}render(){return h`
      <div
        part="base"
    ...
    `}};ut.styles=[F,Kr];ut.dependencies={"sl-icon-button":V};n([x(".drawer")],ut.prototype,"drawer",2);n([x(".drawer__panel")],ut.prototype,"panel",2);n([x(".drawer__overlay")],ut.prototype,"overlay",2);n([c({type:Boolean,reflect:!0})],ut.prototype,"open",2);n([c({reflect:!0})],ut.prototype,"label",2);n([c({reflect:!0})],ut.prototype,"placement",2);n([c({type:Boolean,reflect:!0})],ut.prototype,"contained",2);n([c({attribute:"no-header",type:Boolean,reflect:!0})],ut.prototype,"noHeader",2);n([T("open",{waitUntilFirstUpdate:!0})],ut.prototype,"handleOpenChange",1);n([T("contained",{waitUntilFirstUpdate:!0})],ut.prototype,"handleNoModalChange",1);R("drawer.showTop",{keyframes:[{opacity:0,translate:"0 -100%"},{opacity:1,translate:"0 0"}],options:{duration:250,easing:"ease"}});R("drawer.hideTop",{keyframes:[{opacity:1,translate:"0 0"},{opacity:0,translate:"0 -100%"}],options:{duration:250,easing:"ease"}});R("drawer.showEnd",{keyframes:[{opacity:0,translate:"100%"},{opacity:1,translate:"0"}],rtlKeyframes:[{opacity:0,translate:"-100%"},{opacity:1,translate:"0"}],options:{duration:250,easing:"ease"}});R("drawer.hideEnd",{keyframes:[{opacity:1,translate:"0"},{opacity:0,translate:"100%"}],rtlKeyframes:[{opacity:1,translate:"0"},{opacity:0,translate:"-100%"}],options:{duration:250,easing:"ease"}});R("drawer.showBottom",{keyframes:[{opacity:0,translate:"0 100%"},{opacity:1,translate:"0 0"}],options:{duration:250,easing:"ease"}});R("drawer.hideBottom",{keyframes:[{opacity:1,translate:"0 0"},{opacity:0,translate:"0 100%"}],options:{duration:250,easing:"ease"}});R("drawer.showStart",{keyframes:[{opacity:0,translate:"-100%"},{opacity:1,translate:"0"}],rtlKeyframes:[{opacity:0,translate:"100%"},{opacity:1,translate:"0"}],options:{duration:250,easing:"ease"}});R("drawer.hideStart",{keyframes:[{opacity:1,translate:"0"},{opacity:0,translate:"-100%"}],rtlKeyframes:[{opacity:1,translate:"0"},{opacity:0,translate:"100%"}],options:{duration:250,easing:"ease"}});R("drawer.denyClose",{keyframes:[{scale:1},{scale:1.01},{scale:1}],options:{duration:250}});R("drawer.overlay.show",{keyframes:[{opacity:0},{opacity:1}],options:{duration:250}});R("drawer.overlay.hide",{keyframes:[{opacity:1},{opacity:0}],options:{duration:250}});ut.define("sl-drawer");var tn=$`
  :host {
    --width: 31rem;
    --header-spacing: var(--sl-spacing-large);
    --body-spacing: var(--sl-spacing-large);
...
`,Rt=class extends M{constructor(){super(...arguments),this.hasSlotController=new qt(this,"footer"),this.localize=new it(this),this.modal=new Ls(this),this.open=!1,this.label="",this.noHeader=!1,this.handleDocumentKeyDown=t=>{t.key==="Escape"&&this.modal.isActive()&&this.open&&(t.stopPropagation(),this.requestClose("keyboard"))}}firstUpdated(){this.dialog.hidden=!this.open,this.open&&(this.addOpenListeners(),this.modal.activate(),Re(this))}disconnectedCallback(){super.disconnectedCallback(),this.modal.deactivate(),Fe(this),this.removeOpenListeners()}requestClose(t){if(this.emit("sl-request-close",{cancelable:!0,detail:{source:t}}).defaultPrevented){const i=B(this,"dialog.denyClose",{dir:this.localize.dir()});H(this.panel,i.keyframes,i.options);return}this.hide()}addOpenListeners(){var t;"CloseWatcher"in window?((t=this.closeWatcher)==null||t.destroy(),this.closeWatcher=new CloseWatcher,this.closeWatcher.onclose=()=>this.requestClose("keyboard")):document.addEventListener("keydown",this.handleDocumentKeyDown)}removeOpenListeners(){var t;(t=this.closeWatcher)==null||t.destroy(),document.removeEventListener("keydown",this.handleDocumentKeyDown)}async handleOpenChange(){if(this.open){this.emit("sl-show"),this.addOpenListeners(),this.originalTrigger=document.activeElement,this.modal.activate(),Re(this);const t=this.querySelector("[autofocus]");t&&t.removeAttribute("autofocus"),await Promise.all([U(this.dialog),U(this.overlay)]),this.dialog.hidden=!1,requestAnimationFrame(()=>{this.emit("sl-initial-focus",{cancelable:!0}).defaultPrevented||(t?t.focus({preventScroll:!0}):this.panel.focus({preventScroll:!0})),t&&t.setAttribute("autofocus","")});const e=B(this,"dialog.show",{dir:this.localize.dir()}),i=B(this,"dialog.overlay.show",{dir:this.localize.dir()});await Promise.all([H(this.panel,e.keyframes,e.options),H(this.overlay,i.keyframes,i.options)]),this.emit("sl-after-show")}else{_o(this),this.emit("sl-hide"),this.removeOpenListeners(),this.modal.deactivate(),await Promise.all([U(this.dialog),U(this.overlay)]);const t=B(this,"dialog.hide",{dir:this.localize.dir()}),e=B(this,"dialog.overlay.hide",{dir:this.localize.dir()});await Promise.all([H(this.overlay,e.keyframes,e.options).then(()=>{this.overlay.hidden=!0}),H(this.panel,t.keyframes,t.options).then(()=>{this.panel.hidden=!0})]),this.dialog.hidden=!0,this.overlay.hidden=!1,this.panel.hidden=!1,Fe(this);const i=this.originalTrigger;typeof(i==null?void 0:i.focus)=="function"&&setTimeout(()=>i.focus()),this.emit("sl-after-hide")}}async show(){if(!this.open)return this.open=!0,nt(this,"sl-after-show")}async hide(){if(this.open)return this.open=!1,nt(this,"sl-after-hide")}render(){return h`
      <div
        part="base"
    ...
    `}};Rt.styles=[F,tn];Rt.dependencies={"sl-icon-button":V};n([x(".dialog")],Rt.prototype,"dialog",2);n([x(".dialog__panel")],Rt.prototype,"panel",2);n([x(".dialog__overlay")],Rt.prototype,"overlay",2);n([c({type:Boolean,reflect:!0})],Rt.prototype,"open",2);n([c({reflect:!0})],Rt.prototype,"label",2);n([c({attribute:"no-header",type:Boolean,reflect:!0})],Rt.prototype,"noHeader",2);n([T("open",{waitUntilFirstUpdate:!0})],Rt.prototype,"handleOpenChange",1);R("dialog.show",{keyframes:[{opacity:0,scale:.8},{opacity:1,scale:1}],options:{duration:250,easing:"ease"}});R("dialog.hide",{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.8}],options:{duration:250,easing:"ease"}});R("dialog.denyClose",{keyframes:[{scale:1},{scale:1.02},{scale:1}],options:{duration:250}});R("dialog.overlay.show",{keyframes:[{opacity:0},{opacity:1}],options:{duration:250}});R("dialog.overlay.hide",{keyframes:[{opacity:1},{opacity:0}],options:{duration:250}});Rt.define("sl-dialog");var en=$`
  :host {
    display: inline-flex;
  }
...
`,Ke=class extends M{constructor(){super(...arguments),this.variant="primary",this.pill=!1,this.pulse=!1}render(){return h`
      <span
        part="base"
    ...
    `}};Ke.styles=[F,en];n([c({reflect:!0})],Ke.prototype,"variant",2);n([c({type:Boolean,reflect:!0})],Ke.prototype,"pill",2);n([c({type:Boolean,reflect:!0})],Ke.prototype,"pulse",2);Ke.define("sl-badge");var on=$`
  :host {
    display: contents;
...
`,ht=class re extends M{constructor(){super(...arguments),this.hasSlotController=new qt(this,"icon","suffix"),this.localize=new it(this),this.open=!1,this.closable=!1,this.variant="primary",this.duration=1/0,this.remainingTime=this.duration}static get toastStack(){return this.currentToastStack||(this.currentToastStack=Object.assign(document.createElement("div"),{className:"sl-toast-stack"})),this.currentToastStack}firstUpdated(){this.base.hidden=!this.open}restartAutoHide(){this.handleCountdownChange(),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval),this.open&&this.duration<1/0&&(this.autoHideTimeout=window.setTimeout(()=>this.hide(),this.duration),this.remainingTime=this.duration,this.remainingTimeInterval=window.setInterval(()=>{this.remainingTime-=100},100))}pauseAutoHide(){var e;(e=this.countdownAnimation)==null||e.pause(),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval)}resumeAutoHide(){var e;this.duration<1/0&&(this.autoHideTimeout=window.setTimeout(()=>this.hide(),this.remainingTime),this.remainingTimeInterval=window.setInterval(()=>{this.remainingTime-=100},100),(e=this.countdownAnimation)==null||e.play())}handleCountdownChange(){if(this.open&&this.duration<1/0&&this.countdown){const{countdownElement:e}=this,i="100%",o="0";this.countdownAnimation=e.animate([{width:i},{width:o}],{duration:this.duration,easing:"linear"})}}handleCloseClick(){this.hide()}async handleOpenChange(){if(this.open){this.emit("sl-show"),this.duration<1/0&&this.restartAutoHide(),await U(this.base),this.base.hidden=!1;const{keyframes:e,options:i}=B(this,"alert.show",{dir:this.localize.dir()});await H(this.base,e,i),this.emit("sl-after-show")}else{_o(this),this.emit("sl-hide"),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval),await U(this.base);const{keyframes:e,options:i}=B(this,"alert.hide",{dir:this.localize.dir()});await H(this.base,e,i),this.base.hidden=!0,this.emit("sl-after-hide")}}handleDurationChange(){this.restartAutoHide()}async show(){if(!this.open)return this.open=!0,nt(this,"sl-after-show")}async hide(){if(this.open)return this.open=!1,nt(this,"sl-after-hide")}async toast(){return new Promise(e=>{this.handleCountdownChange(),re.toastStack.parentElement===null&&document.body.append(re.toastStack),re.toastStack.appendChild(this),requestAnimationFrame(()=>{this.clientWidth,this.show()}),this.addEventListener("sl-after-hide",()=>{re.toastStack.removeChild(this),e(),re.toastStack.querySelector("sl-alert")===null&&re.toastStack.remove()},{once:!0})})}render(){return h`
      <div
        part="base"
    ...
    `}};ht.styles=[F,on];ht.dependencies={"sl-icon-button":V};n([x('[part~="base"]')],ht.prototype,"base",2);n([x(".alert__countdown-elapsed")],ht.prototype,"countdownElement",2);n([c({type:Boolean,reflect:!0})],ht.prototype,"open",2);n([c({type:Boolean,reflect:!0})],ht.prototype,"closable",2);n([c({reflect:!0})],ht.prototype,"variant",2);n([c({type:Number})],ht.prototype,"duration",2);n([c({type:String,reflect:!0})],ht.prototype,"countdown",2);n([y()],ht.prototype,"remainingTime",2);n([T("open",{waitUntilFirstUpdate:!0})],ht.prototype,"handleOpenChange",1);n([T("duration")],ht.prototype,"handleDurationChange",1);var sn=ht;R("alert.show",{keyframes:[{opacity:0,scale:.8},{opacity:1,scale:1}],options:{duration:250,easing:"ease"}});R("alert.hide",{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.8}],options:{duration:250,easing:"ease"}});sn.define("sl-alert");var an=$`
  :host {
    display: block;
  }
...
`,ot=class extends M{constructor(){super(...arguments),this.localize=new it(this),this.open=!1,this.placement="bottom-start",this.disabled=!1,this.stayOpenOnSelect=!1,this.distance=0,this.skidding=0,this.hoist=!1,this.sync=void 0,this.handleKeyDown=t=>{this.open&&t.key==="Escape"&&(t.stopPropagation(),this.hide(),this.focusOnTrigger())},this.handleDocumentKeyDown=t=>{var e;if(t.key==="Escape"&&this.open&&!this.closeWatcher){t.stopPropagation(),this.focusOnTrigger(),this.hide();return}if(t.key==="Tab"){if(this.open&&((e=document.activeElement)==null?void 0:e.tagName.toLowerCase())==="sl-menu-item"){t.preventDefault(),this.hide(),this.focusOnTrigger();return}const i=(o,s)=>{if(!o)return null;const a=o.closest(s);if(a)return a;const r=o.getRootNode();return r instanceof ShadowRoot?i(r.host,s):null};setTimeout(()=>{var o;const s=((o=this.containingElement)==null?void 0:o.getRootNode())instanceof ShadowRoot?Ms():document.activeElement;(!this.containingElement||i(s,this.containingElement.tagName.toLowerCase())!==this.containingElement)&&this.hide()})}},this.handleDocumentMouseDown=t=>{const e=t.composedPath();this.containingElement&&!e.includes(this.containingElement)&&this.hide()},this.handlePanelSelect=t=>{const e=t.target;!this.stayOpenOnSelect&&e.tagName.toLowerCase()==="sl-menu"&&(this.hide(),this.focusOnTrigger())}}connectedCallback(){super.connectedCallback(),this.containingElement||(this.containingElement=this)}firstUpdated(){this.panel.hidden=!this.open,this.open&&(this.addOpenListeners(),this.popup.active=!0)}disconnectedCallback(){super.disconnectedCallback(),this.removeOpenListeners(),this.hide()}focusOnTrigger(){const t=this.trigger.assignedElements({flatten:!0})[0];typeof(t==null?void 0:t.focus)=="function"&&t.focus()}getMenu(){return this.panel.assignedElements({flatten:!0}).find(t=>t.tagName.toLowerCase()==="sl-menu")}handleTriggerClick(){this.open?this.hide():(this.show(),this.focusOnTrigger())}async handleTriggerKeyDown(t){if([" ","Enter"].includes(t.key)){t.preventDefault(),this.handleTriggerClick();return}const e=this.getMenu();if(e){const i=e.getAllItems(),o=i[0],s=i[i.length-1];["ArrowDown","ArrowUp","Home","End"].includes(t.key)&&(t.preventDefault(),this.open||(this.show(),await this.updateComplete),i.length>0&&this.updateComplete.then(()=>{(t.key==="ArrowDown"||t.key==="Home")&&(e.setCurrentItem(o),o.focus()),(t.key==="ArrowUp"||t.key==="End")&&(e.setCurrentItem(s),s.focus())}))}}handleTriggerKeyUp(t){t.key===" "&&t.preventDefault()}handleTriggerSlotChange(){this.updateAccessibleTrigger()}updateAccessibleTrigger(){const e=this.trigger.assignedElements({flatten:!0}).find(o=>Jr(o).start);let i;if(e){switch(e.tagName.toLowerCase()){case"sl-button":case"sl-icon-button":i=e.button;break;default:i=e}i.setAttribute("aria-haspopup","true"),i.setAttribute("aria-expanded",this.open?"true":"false")}}async show(){if(!this.open)return this.open=!0,nt(this,"sl-after-show")}async hide(){if(this.open)return this.open=!1,nt(this,"sl-after-hide")}reposition(){this.popup.reposition()}addOpenListeners(){var t;this.panel.addEventListener("sl-select",this.handlePanelSelect),"CloseWatcher"in window?((t=this.closeWatcher)==null||t.destroy(),this.closeWatcher=new CloseWatcher,this.closeWatcher.onclose=()=>{this.hide(),this.focusOnTrigger()}):this.panel.addEventListener("keydown",this.handleKeyDown),document.addEventListener("keydown",this.handleDocumentKeyDown),document.addEventListener("mousedown",this.handleDocumentMouseDown)}removeOpenListeners(){var t;this.panel&&(this.panel.removeEventListener("sl-select",this.handlePanelSelect),this.panel.removeEventListener("keydown",this.handleKeyDown)),document.removeEventListener("keydown",this.handleDocumentKeyDown),document.removeEventListener("mousedown",this.handleDocumentMouseDown),(t=this.closeWatcher)==null||t.destroy()}async handleOpenChange(){if(this.disabled){this.open=!1;return}if(this.updateAccessibleTrigger(),this.open){this.emit("sl-show"),this.addOpenListeners(),await U(this),this.panel.hidden=!1,this.popup.active=!0;const{keyframes:t,options:e}=B(this,"dropdown.show",{dir:this.localize.dir()});await H(this.popup.popup,t,e),this.emit("sl-after-show")}else{this.emit("sl-hide"),this.removeOpenListeners(),await U(this);const{keyframes:t,options:e}=B(this,"dropdown.hide",{dir:this.localize.dir()});await H(this.popup.popup,t,e),this.panel.hidden=!0,this.popup.active=!1,this.emit("sl-after-hide")}}render(){return h`
      <sl-popup
        part="base"
    ...
    `}};ot.styles=[F,rn];ot.dependencies={"sl-popup":L};n([x(".dropdown")],ot.prototype,"popup",2);n([x(".dropdown__trigger")],ot.prototype,"trigger",2);n([x(".dropdown__panel")],ot.prototype,"panel",2);n([c({type:Boolean,reflect:!0})],ot.prototype,"open",2);n([c({reflect:!0})],ot.prototype,"placement",2);n([c({type:Boolean,reflect:!0})],ot.prototype,"disabled",2);n([c({attribute:"stay-open-on-select",type:Boolean,reflect:!0})],ot.prototype,"stayOpenOnSelect",2);n([c({attribute:!1})],ot.prototype,"containingElement",2);n([c({type:Number})],ot.prototype,"distance",2);n([c({type:Number})],ot.prototype,"skidding",2);n([c({type:Boolean})],ot.prototype,"hoist",2);n([c({reflect:!0})],ot.prototype,"sync",2);n([T("open",{waitUntilFirstUpdate:!0})],ot.prototype,"handleOpenChange",1);R("dropdown.show",{keyframes:[{opacity:0,scale:.9},{opacity:1,scale:1}],options:{duration:100,easing:"ease"}});R("dropdown.hide",{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.9}],options:{duration:100,easing:"ease"}});ot.define("sl-dropdown");var nn=$`
  :host {
    display: block;
    position: relative;
    background: var(--sl-panel-background-color);
...
`,Co=class extends M{connectedCallback(){super.connectedCallback(),this.setAttribute("role","menu")}handleClick(t){const e=["menuitem","menuitemcheckbox"],i=t.composedPath(),o=i.find(l=>{var d;return e.includes(((d=l==null?void 0:l.getAttribute)==null?void 0:d.call(l,"role"))||"")});if(!o||i.find(l=>{var d;return((d=l==null?void 0:l.getAttribute)==null?void 0:d.call(l,"role"))==="menu"})!==this)return;const r=o;r.type==="checkbox"&&(r.checked=!r.checked),this.emit("sl-select",{detail:{item:r}})}handleKeyDown(t){if(t.key==="Enter"||t.key===" "){const e=this.getCurrentItem();t.preventDefault(),t.stopPropagation(),e==null||e.click()}else if(["ArrowDown","ArrowUp","Home","End"].includes(t.key)){const e=this.getAllItems(),i=this.getCurrentItem();let o=i?e.indexOf(i):0;e.length>0&&(t.preventDefault(),t.stopPropagation(),t.key==="ArrowDown"?o++:t.key==="ArrowUp"?o--:t.key==="Home"?o=0:t.key==="End"&&(o=e.length-1),o<0&&(o=e.length-1),o>e.length-1&&(o=0),this.setCurrentItem(e[o]),e[o].focus())}}handleMouseDown(t){const e=t.target;this.isMenuItem(e)&&this.setCurrentItem(e)}handleSlotChange(){const t=this.getAllItems();t.length>0&&this.setCurrentItem(t[0])}isMenuItem(t){var e;return t.tagName.toLowerCase()==="sl-menu-item"||["menuitem","menuitemcheckbox","menuitemradio"].includes((e=t.getAttribute("role"))!=null?e:"")}getAllItems(){return[...this.defaultSlot.assignedElements({flatten:!0})].filter(t=>!(t.inert||!this.isMenuItem(t)))}getCurrentItem(){return this.getAllItems().find(t=>t.getAttribute("tabindex")==="0")}setCurrentItem(t){this.getAllItems().forEach(i=>{i.setAttribute("tabindex",i===t?"0":"-1")})}render(){return h`
      <slot
 ...
 */const pn=()=>new fn;class fn{}const Ki=new WeakMap,mn=Ti(class extends hn{render(t){return w}update(t,[e]){var o;const i=e!==this.G;return i&&this.G!==void 0&&this.rt(void 0),(i||this.lt!==this.ct)&&(this.G=e,this.ht=(o=t.options)==null?void 0:o.host,this.rt(this.ct=t.element)),w}rt(t){if(this.isConnected||(t=void 0),typeof this.G=="function"){const e=this.ht??globalThis;let i=Ki.get(e);i===void 0&&(i=new WeakMap,Ki.set(e,i)),i.get(this.G)!==void 0&&this.G.call(this.ht,void 0),i.set(this.G,t),t!==void 0&&this.G.call(this.ht,t)}else this.G.value=t}get lt(){var t,e;return typeof this.G=="function"?(t=Ki.get(this.ht??globalThis))==null?void 0:t.get(this.G):(e=this.G)==null?void 0:e.value}disconnected(){this.lt===this.ct&&this.rt(void 0)}reconnected(){this.rt(this.ct)}});var bn=class{constructor(t,e){this.popupRef=pn(),this.enableSubmenuTimer=-1,this.isConnected=!1,this.isPopupConnected=!1,this.skidding=0,this.submenuOpenDelay=100,this.handleMouseMove=i=>{this.host.style.setProperty("--safe-triangle-cursor-x",`${i.clientX}px`),this.host.style.setProperty("--safe-triangle-cursor-y",`${i.clientY}px`)},this.handleMouseOver=()=>{this.hasSlotController.test("submenu")&&this.enableSubmenu()},this.handleKeyDown=i=>{switch(i.key){case"Escape":case"Tab":this.disableSubmenu();break;case"ArrowLeft":i.target!==this.host&&(i.preventDefault(),i.stopPropagation(),this.host.focus(),this.disableSubmenu());break;case"ArrowRight":case"Enter":case" ":this.handleSubmenuEntry(i);break}},this.handleClick=i=>{var o;i.target===this.host?(i.preventDefault(),i.stopPropagation()):i.target instanceof Element&&(i.target.tagName==="sl-menu-item"||(o=i.target.role)!=null&&o.startsWith("menuitem"))&&this.disableSubmenu()},this.handleFocusOut=i=>{i.relatedTarget&&i.relatedTarget instanceof Element&&this.host.contains(i.relatedTarget)||this.disableSubmenu()},this.handlePopupMouseover=i=>{i.stopPropagation()},this.handlePopupReposition=()=>{const i=this.host.renderRoot.querySelector("slot[name='submenu']"),o=i==null?void 0:i.assignedElements({flatten:!0}).filter(u=>u.localName==="sl-menu")[0],s=getComputedStyle(this.host).direction==="rtl";if(!o)return;const{left:a,top:r,width:l,height:d}=o.getBoundingClientRect();this.host.style.setProperty("--safe-triangle-submenu-start-x",`${s?a+l:a}px`),this.host.style.setProperty("--safe-triangle-submenu-start-y",`${r}px`),this.host.style.setProperty("--safe-triangle-submenu-end-x",`${s?a+l:a}px`),this.host.style.setProperty("--safe-triangle-submenu-end-y",`${r+d}px`)},(this.host=t).addController(this),this.hasSlotController=e}hostConnected(){this.hasSlotController.test("submenu")&&!this.host.disabled&&this.addListeners()}hostDisconnected(){this.removeListeners()}hostUpdated(){this.hasSlotController.test("submenu")&&!this.host.disabled?(this.addListeners(),this.updateSkidding()):this.removeListeners()}addListeners(){this.isConnected||(this.host.addEventListener("mousemove",this.handleMouseMove),this.host.addEventListener("mouseover",this.handleMouseOver),this.host.addEventListener("keydown",this.handleKeyDown),this.host.addEventListener("click",this.handleClick),this.host.addEventListener("focusout",this.handleFocusOut),this.isConnected=!0),this.isPopupConnected||this.popupRef.value&&(this.popupRef.value.addEventListener("mouseover",this.handlePopupMouseover),this.popupRef.value.addEventListener("sl-reposition",this.handlePopupReposition),this.isPopupConnected=!0)}removeListeners(){this.isConnected&&(this.host.removeEventListener("mousemove",this.handleMouseMove),this.host.removeEventListener("mouseover",this.handleMouseOver),this.host.removeEventListener("keydown",this.handleKeyDown),this.host.removeEventListener("click",this.handleClick),this.host.removeEventListener("focusout",this.handleFocusOut),this.isConnected=!1),this.isPopupConnected&&this.popupRef.value&&(this.popupRef.value.removeEventListener("mouseover",this.handlePopupMouseover),this.popupRef.value.removeEventListener("sl-reposition",this.handlePopupReposition),this.isPopupConnected=!1)}handleSubmenuEntry(t){const e=this.host.renderRoot.querySelector("slot[name='submenu']");if(!e){console.error("Cannot activate a submenu if no corresponding menuitem can be found.",this);return}let i=null;for(const o of e.assignedElements())if(i=o.querySelectorAll("sl-menu-item, [role^='menuitem']"),i.length!==0)break;if(!(!i||i.length===0)){i[0].setAttribute("tabindex","0");for(let o=1;o!==i.length;++o)i[o].setAttribute("tabindex","-1");this.popupRef.value&&(t.preventDefault(),t.stopPropagation(),this.popupRef.value.active?i[0]instanceof HTMLElement&&i[0].focus():(this.enableSubmenu(!1),this.host.updateComplete.then(()=>{i[0]instanceof HTMLElement&&i[0].focus()}),this.host.requestUpdate()))}}setSubmenuState(t){this.popupRef.value&&this.popupRef.value.active!==t&&(this.popupRef.value.active=t,this.host.requestUpdate())}enableSubmenu(t=!0){t?(window.clearTimeout(this.enableSubmenuTimer),this.enableSubmenuTimer=window.setTimeout(()=>{this.setSubmenuState(!0)},this.submenuOpenDelay)):this.setSubmenuState(!0)}disableSubmenu(){window.clearTimeout(this.enableSubmenuTimer),this.setSubmenuState(!1)}updateSkidding(){var t;if(!((t=this.host.parentElement)!=null&&t.computedStyleMap))return;const e=this.host.parentElement.computedStyleMap(),o=["padding-top","border-top-width","margin-top"].reduce((s,a)=>{var r;const l=(r=e.get(a))!=null?r:new CSSUnitValue(0,"px"),u=(l instanceof CSSUnitValue?l:new CSSUnitValue(0,"px")).to("px");return s-u.value},0);this.skidding=o}isExpanded(){return this.popupRef.value?this.popupRef.value.active:!1}renderSubmenu(){const t=getComputedStyle(this.host).direction==="rtl";return this.isConnected?h`
    ...
    `}};pt.styles=[F,ln];pt.dependencies={"sl-icon":G,"sl-popup":L,"sl-spinner":$i};n([x("slot:not([name])")],pt.prototype,"defaultSlot",2);n([x(".menu-item")],pt.prototype,"menuItem",2);n([c()],pt.prototype,"type",2);n([c({type:Boolean,reflect:!0})],pt.prototype,"checked",2);n([c()],pt.prototype,"value",2);n([c({type:Boolean,reflect:!0})],pt.prototype,"loading",2);n([c({type:Boolean,reflect:!0})],pt.prototype,"disabled",2);n([T("checked")],pt.prototype,"handleCheckedChange",1);n([T("disabled")],pt.prototype,"handleDisabledChange",1);n([T("type")],pt.prototype,"handleTypeChange",1);pt.define("sl-menu-item");G.define("sl-icon");var gn=$`
  :host {
...
`,X=class extends M{constructor(){super(),this.localize=new it(this),this.content="",this.placement="top",this.disabled=!1,this.distance=8,this.open=!1,this.skidding=0,this.trigger="hover focus",this.hoist=!1,this.handleBlur=()=>{this.hasTrigger("focus")&&this.hide()},this.handleClick=()=>{this.hasTrigger("click")&&(this.open?this.hide():this.show())},this.handleFocus=()=>{this.hasTrigger("focus")&&this.show()},this.handleDocumentKeyDown=t=>{t.key==="Escape"&&(t.stopPropagation(),this.hide())},this.handleMouseOver=()=>{if(this.hasTrigger("hover")){const t=Uo(getComputedStyle(this).getPropertyValue("--show-delay"));clearTimeout(this.hoverTimeout),this.hoverTimeout=window.setTimeout(()=>this.show(),t)}},this.handleMouseOut=()=>{if(this.hasTrigger("hover")){const t=Uo(getComputedStyle(this).getPropertyValue("--hide-delay"));clearTimeout(this.hoverTimeout),this.hoverTimeout=window.setTimeout(()=>this.hide(),t)}},this.addEventListener("blur",this.handleBlur,!0),this.addEventListener("focus",this.handleFocus,!0),this.addEventListener("click",this.handleClick),this.addEventListener("mouseover",this.handleMouseOver),this.addEventListener("mouseout",this.handleMouseOut)}disconnectedCallback(){var t;super.disconnectedCallback(),(t=this.closeWatcher)==null||t.destroy(),document.removeEventListener("keydown",this.handleDocumentKeyDown)}firstUpdated(){this.body.hidden=!this.open,this.open&&(this.popup.active=!0,this.popup.reposition())}hasTrigger(t){return this.trigger.split(" ").includes(t)}async handleOpenChange(){var t,e;if(this.open){if(this.disabled)return;this.emit("sl-show"),"CloseWatcher"in window?((t=this.closeWatcher)==null||t.destroy(),this.closeWatcher=new CloseWatcher,this.closeWatcher.onclose=()=>{this.hide()}):document.addEventListener("keydown",this.handleDocumentKeyDown),await U(this.body),this.body.hidden=!1,this.popup.active=!0;const{keyframes:i,options:o}=B(this,"tooltip.show",{dir:this.localize.dir()});await H(this.popup.popup,i,o),this.popup.reposition(),this.emit("sl-after-show")}else{this.emit("sl-hide"),(e=this.closeWatcher)==null||e.destroy(),document.removeEventListener("keydown",this.handleDocumentKeyDown),await U(this.body);const{keyframes:i,options:o}=B(this,"tooltip.hide",{dir:this.localize.dir()});await H(this.popup.popup,i,o),this.popup.active=!1,this.body.hidden=!0,this.emit("sl-after-hide")}}async handleOptionsChange(){this.hasUpdated&&(await this.updateComplete,this.popup.reposition())}handleDisabledChange(){this.disabled&&this.open&&this.hide()}async show(){if(!this.open)return this.open=!0,nt(this,"sl-after-show")}async hide(){if(this.open)return this.open=!1,nt(this,"sl-after-hide")}render(){return h`
      <sl-popup
        part="base"
        exportparts="
          popup:base__popup,
...
`,Cn=0,Tt=class extends M{constructor(){super(...arguments),this.localize=new it(this),this.attrId=++Cn,this.componentId=`sl-tab-${this.attrId}`,this.panel="",this.active=!1,this.closable=!1,this.disabled=!1,this.tabIndex=0}connectedCallback(){super.connectedCallback(),this.setAttribute("role","tab")}handleCloseClick(t){t.stopPropagation(),this.emit("sl-close")}handleActiveChange(){this.setAttribute("aria-selected",this.active?"true":"false")}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false"),this.disabled&&!this.active?this.tabIndex=-1:this.tabIndex=0}render(){return this.id=this.id.length>0?this.id:this.componentId,h`
      <div
        part="base"
    ...
    `}};Tt.styles=[F,_n];Tt.dependencies={"sl-icon-button":V};n([x(".tab")],Tt.prototype,"tab",2);n([c({reflect:!0})],Tt.prototype,"panel",2);n([c({type:Boolean,reflect:!0})],Tt.prototype,"active",2);n([c({type:Boolean,reflect:!0})],Tt.prototype,"closable",2);n([c({type:Boolean,reflect:!0})],Tt.prototype,"disabled",2);n([c({type:Number,reflect:!0})],Tt.prototype,"tabIndex",2);n([T("active")],Tt.prototype,"handleActiveChange",1);n([T("disabled")],Tt.prototype,"handleDisabledChange",1);Tt.define("sl-tab");var $n=$`
  :host {
    --padding: 0;
...
`,Tn=0,Ge=class extends M{constructor(){super(...arguments),this.attrId=++Tn,this.componentId=`sl-tab-panel-${this.attrId}`,this.name="",this.active=!1}connectedCallback(){super.connectedCallback(),this.id=this.id.length>0?this.id:this.componentId,this.setAttribute("role","tabpanel")}handleActiveChange(){this.setAttribute("aria-hidden",this.active?"false":"true")}render(){return h`
      <slot
        part="base"
        class=${z({"tab-panel":!0,"tab-panel--active":this.active})}
      ></slot>
    `}};Ge.styles=[F,$n];n([c({reflect:!0})],Ge.prototype,"name",2);n([c({type:Boolean,reflect:!0})],Ge.prototype,"active",2);n([T("active")],Ge.prototype,"handleActiveChange",1);Ge.define("sl-tab-panel");$i.define("sl-spinner");V.define("sl-icon-button");var Sn=$`
  :host {
    display: block;
  }
...
`,St=class extends M{constructor(){super(...arguments),this.localize=new it(this),this.open=!1,this.disabled=!1}firstUpdated(){this.body.style.height=this.open?"auto":"0",this.open&&(this.details.open=!0),this.detailsObserver=new MutationObserver(t=>{for(const e of t)e.type==="attributes"&&e.attributeName==="open"&&(this.details.open?this.show():this.hide())}),this.detailsObserver.observe(this.details,{attributes:!0})}disconnectedCallback(){var t;super.disconnectedCallback(),(t=this.detailsObserver)==null||t.disconnect()}handleSummaryClick(t){t.preventDefault(),this.disabled||(this.open?this.hide():this.show(),this.header.focus())}handleSummaryKeyDown(t){(t.key==="Enter"||t.key===" ")&&(t.preventDefault(),this.open?this.hide():this.show()),(t.key==="ArrowUp"||t.key==="ArrowLeft")&&(t.preventDefault(),this.hide()),(t.key==="ArrowDown"||t.key==="ArrowRight")&&(t.preventDefault(),this.show())}async handleOpenChange(){if(this.open){if(this.details.open=!0,this.emit("sl-show",{cancelable:!0}).defaultPrevented){this.open=!1,this.details.open=!1;return}await U(this.body);const{keyframes:e,options:i}=B(this,"details.show",{dir:this.localize.dir()});await H(this.body,qo(e,this.body.scrollHeight),i),this.body.style.height="auto",this.emit("sl-after-show")}else{if(this.emit("sl-hide",{cancelable:!0}).defaultPrevented){this.details.open=!0,this.open=!0;return}await U(this.body);const{keyframes:e,options:i}=B(this,"details.hide",{dir:this.localize.dir()});await H(this.body,qo(e,this.body.scrollHeight),i),this.body.style.height="auto",this.details.open=!1,this.emit("sl-after-hide")}}async show(){if(!(this.open||this.disabled))return this.open=!0,nt(this,"sl-after-show")}async hide(){if(!(!this.open||this.disabled))return this.open=!1,nt(this,"sl-after-hide")}render(){const t=this.localize.dir()==="rtl";return h`
      <details
        part="base"
    ...
    `}};St.styles=[F,Sn];St.dependencies={"sl-icon":G};n([x(".details")],St.prototype,"details",2);n([x(".details__header")],St.prototype,"header",2);n([x(".details__body")],St.prototype,"body",2);n([x(".details__expand-icon-slot")],St.prototype,"expandIconSlot",2);n([c({type:Boolean,reflect:!0})],St.prototype,"open",2);n([c()],St.prototype,"summary",2);n([c({type:Boolean,reflect:!0})],St.prototype,"disabled",2);n([T("open",{waitUntilFirstUpdate:!0})],St.prototype,"handleOpenChange",1);R("details.show",{keyframes:[{height:"0",opacity:"0"},{height:"auto",opacity:"1"}],options:{duration:250,easing:"linear"}});R("details.hide",{keyframes:[{height:"auto",opacity:"1"},{height:"0",opacity:"0"}],options:{duration:250,easing:"linear"}});St.define("sl-details");const En="modulepreload",Dn=function(t,e){return new URL(t,e).href},Xo={},Qo=function(e,i,o){let s=Promise.resolve();if(i&&i.length>0){const r=document.getElementsByTagName("link"),l=document.querySelector("meta[property=csp-nonce]"),d=(l==null?void 0:l.nonce)||(l==null?void 0:l.getAttribute("nonce"));s=Promise.allSettled(i.map(u=>{if(u=Dn(u,o),u in Xo)return;Xo[u]=!0;const p=u.endsWith(".css"),f=p?'[rel="stylesheet"]':"";if(!!o)for(let b=r.length-1;b>=0;b--){const v=r[b];if(v.href===u&&(!p||v.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${u}"]${f}`))return;const m=document.createElement("link");if(m.rel=p?"stylesheet":En,p||(m.as="script"),m.crossOrigin="",m.href=u,d&&m.setAttribute("nonce",d),document.head.appendChild(m),p)return new Promise((b,v)=>{m.addEventListener("load",b),m.addEventListener("error",()=>v(new Error(`Unable to preload CSS for ${u}`)))})}))}function a(r){const l=new Event("vite:preloadError",{cancelable:!0});if(l.payload=r,window.dispatchEvent(l),!l.defaultPrevented)throw r}return s.then(r=>{for(const l of r||[])l.status==="rejected"&&a(l.reason);return e().catch(a)})};/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let An=class extends Event{constructor(e,i,o,s){super("context-request",{bubbles:!0,composed:!0}),this.context=e,this.contextTarget=i,this.callback=o,this.subscribe=s??!1}};/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 *//**
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class On{get value(){return this.o}set value(e){this.setValue(e)}setValue(e,i=!1){const o=i||!Object.is(e,this.o);this.o=e,o&&this.updateObservers()}constructor(e){this.subscriptions=new Map,this.updateObservers=()=>{for(const[i,{disposer:o}]of this.subscriptions)i(this.o,o)},e!==void 0&&(this.value=e)}addCallback(e,i,o){if(!o)return void e(this.value);this.subscriptions.has(e)||this.subscriptions.set(e,{disposer:()=>{this.subscriptions.delete(e)},consumerHost:i});const{disposer:s}=this.subscriptions.get(e);e(this.value,s)}clearCallbacks(){this.subscriptions.clear()}}/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let zn=class extends Event{constructor(e,i){super("context-provider",{bubbles:!0,composed:!0}),this.context=e,this.contextTarget=i}};class Jo extends On{constructor(e,i,o){var s,a;super(i.context!==void 0?i.initialValue:o),this.onContextRequest=r=>{if(r.context!==this.context)return;const l=r.contextTarget??r.composedPath()[0];l!==this.host&&(r.stopPropagation(),this.addCallback(r.callback,l,r.subscribe))},this.onProviderRequest=r=>{if(r.context!==this.context||(r.contextTarget??r.composedPath()[0])===this.host)return;const l=new Set;for(const[d,{consumerHost:u}]of this.subscriptions)l.has(d)||(l.add(d),u.dispatchEvent(new An(this.context,u,d,!0)));r.stopPropagation()},this.host=e,i.context!==void 0?this.context=i.context:this.context=i,this.attachListeners(),(a=(s=this.host).addController)==null||a.call(s,this)}attachListeners(){this.host.addEventListener("context-request",this.onContextRequest),this.host.addEventListener("context-provider",this.onProviderRequest)}hostConnected(){this.host.dispatchEvent(new zn(this.context,this.host))}}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function Mn({context:t}){return(e,i)=>{const o=new WeakMap;if(typeof i=="object")return{get(){return e.get.call(this)},set(s){return o.get(this).setValue(s),e.set.call(this,s)},init(s){return o.set(this,new Jo(this,{context:t,initialValue:s})),s}};{e.constructor.addInitializer(r=>{o.set(r,new Jo(r,{context:t}))});const s=Object.getOwnPropertyDescriptor(e,i);let a;if(s===void 0){const r=new WeakMap;a={get(){return r.get(this)},set(l){o.get(this).setValue(l),r.set(this,l)},configurable:!0,enumerable:!0}}else{const r=s.set;a={...s,set(l){o.get(this).setValue(l),r==null||r.call(this,l)}}}return void Object.defineProperty(e,i,a)}}}var K={},Ii={};Object.defineProperty(Ii,"__esModule",{value:!0});Ii.StoreController=void 0;class Pn{constructor(e,i){this.host=e,this.atom=i,e.addController(this)}hostConnected(){this.unsubscribe=this.atom.subscribe(()=>{this.host.requestUpdate()})}hostDisconnected(){var e;(e=this.unsubscribe)===null||e===void 0||e.call(this)}get value(){return this.atom.get()}}Ii.StoreController=Pn;var Se={};Object.defineProperty(Se,"__esModule",{value:!0});Se.MultiStoreController=void 0;class Ln{constructor(e,i){this.host=e,this.atoms=i,e.addController(this)}hostConnected(){this.unsubscribes=this.atoms.map(e=>e.subscribe(()=>this.host.requestUpdate()))}hostDisconnected(){var e;(e=this.unsubscribes)===null||e===void 0||e.forEach(i=>i())}get values(){return this.atoms.map(e=>e.get())}}Se.MultiStoreController=Ln;var Ri={};Object.defineProperty(Ri,"__esModule",{value:!0});Ri.useStores=void 0;const In=Se;function Rn(...t){return e=>class extends e{constructor(...i){super(...i),new In.MultiStoreController(this,t)}}}Ri.useStores=Rn;var Fi={};Object.defineProperty(Fi,"__esModule",{value:!0});Fi.withStores=void 0;const Fn=Se,Nn=(t,e)=>class extends t{constructor(...o){super(...o),new Fn.MultiStoreController(this,e)}};Fi.withStores=Nn;(function(t){Object.defineProperty(t,"__esModule",{value:!0}),t.withStores=t.useStores=t.MultiStoreController=t.StoreController=void 0;var e=Ii;Object.defineProperty(t,"StoreController",{enumerable:!0,get:function(){return e.StoreController}});var i=Se;Object.defineProperty(t,"MultiStoreController",{enumerable:!0,get:function(){return i.MultiStoreController}});var o=Ri;Object.defineProperty(t,"useStores",{enumerable:!0,get:function(){return o.useStores}});var s=Fi;Object.defineProperty(t,"withStores",{enumerable:!0,get:function(){return s.withStores}})})(K);const Bn=Symbol("board"),Hn={ticks:[],epics:[],selectedEpic:"",searchTerm:"",activeColumn:"blocked",isMobile:!1};let xt=[],Xt=0;const oi=4;let di=0;const rt=t=>{let e=[],i={get(){return i.lc||i.listen(()=>{})(),i.value},lc:0,listen(o){return i.lc=e.push(o),()=>{for(let a=Xt+oi;a<xt.length;)xt[a]===o?xt.splice(a,oi):a+=oi;let s=e.indexOf(o);~s&&(e.splice(s,1),--i.lc||i.off())}},notify(o,s){di++;let a=!xt.length;for(let r of e)xt.push(r,i.value,o,s);if(a){for(Xt=0;Xt<xt.length;Xt+=oi)xt[Xt](xt[Xt+1],xt[Xt+2],xt[Xt+3]);xt.length=0}},off(){},set(o){let s=i.value;s!==o&&(i.value=o,i.notify(s))},subscribe(o){let s=i.listen(o);return o(i.value),s},value:t};return i},jn=5,si=6,ai=10;let Vn=(t,e,i,o)=>(t.events=t.events||{},t.events[i+ai]||(t.events[i+ai]=o(s=>{t.events[i].reduceRight((a,r)=>(r(a),a),{shared:{},...s})})),t.events[i]=t.events[i]||[],t.events[i].push(e),()=>{let s=t.events[i],a=s.indexOf(e);s.splice(a,1),s.length||(delete t.events[i],t.events[i+ai](),delete t.events[i+ai])}),Wn=1e3,Un=(t,e)=>Vn(t,o=>{let s=e(o);s&&t.events[si].push(s)},jn,o=>{let s=t.listen;t.listen=(...r)=>(!t.lc&&!t.active&&(t.active=!0,o()),s(...r));let a=t.off;return t.events[si]=[],t.off=()=>{a(),setTimeout(()=>{if(t.active&&!t.lc){t.active=!1;for(let r of t.events[si])r();t.events[si]=[]}},Wn)},()=>{t.listen=s,t.off=a}}),qn=(t,e,i)=>{Array.isArray(t)||(t=[t]);let o,s,a=()=>{if(s===di)return;s=di;let u=t.map(p=>p.get());if(!o||u.some((p,f)=>p!==o[f])){o=u;let p=e(...u);p&&p.then&&p.t?p.then(f=>{o===u&&r.set(f)}):(r.set(p),s=di)}},r=rt(void 0),l=r.get;r.get=()=>(a(),l());let d=a;return Un(r,()=>{let u=t.map(p=>p.listen(d));return a(),()=>{for(let p of u)p()}}),r};const oe=(t,e)=>qn(t,e),Yn=(t={})=>{let e=rt(t);return e.setKey=function(i,o){let s=e.value;typeof o>"u"&&i in e.value?(e.value={...e.value},delete e.value[i],e.notify(s,i)):e.value[i]!==o&&(e.value={...e.value,[i]:o},e.notify(s,i))},e},Mt=rt(!1),He=rt(null),Xe=rt(!0),Kn=rt(!1),Gn=oe([Mt,Xe],(t,e)=>t&&!e);function Gi(t){He.set(t),Mt.set(!0)}function Xn(){Mt.set(!1),He.set(null),Xe.set(!0)}function Qn(t){Xe.set(t)}function Zo(t){Kn.set(t)}class Rs extends Error{constructor(e,i,o){super(e),this.status=i,this.body=o,this.name="ApiError"}}function je(t){if(!t)return[];const e=[],i=t.split(`
`);for(const o of i){const s=o.trim();if(!s)continue;const a={text:s};if(s.length>=18&&s[4]==="-"&&s[7]==="-"&&s[10]===" "&&s[13]===":"){const r=s.indexOf(" - ",16);if(r!==-1){a.timestamp=s.slice(0,16);let l=s.slice(r+3);if(l.startsWith("(from: ")){const d=l.indexOf(") ");d!==-1?(a.author=l.slice(7,d),a.text=l.slice(d+2)):a.text=l}else a.text=l}}e.push(a)}return e}async function Jn(t,e){const i=t.startsWith("/")?"./"+t.slice(1):t,o=await fetch(i,e);if(!o.ok){const s=await o.text();throw new Rs(`API request failed: ${o.status} ${o.statusText}`,o.status,s)}return o.json()}async function Zn(){return Jn("/api/roadmap")}const gt=Yn({}),vi=rt(null),Fs=rt(""),Qe=rt(!0),Ni=rt(null),tl=oe(gt,t=>Object.values(t)),el=oe(gt,t=>{const e=Date.now()-432e5;return Object.values(t).filter(i=>i.type!=="epic"?!1:i.status!=="closed"?!0:i.closed_at?new Date(i.closed_at).getTime()>e:!1).map(i=>({id:i.id,title:i.title}))}),Bi=oe([gt,vi],(t,e)=>e&&t[e]||null),il=oe(Bi,t=>t?je(t.notes):[]),ol=oe([gt,Bi],(t,e)=>{var i;return(i=e==null?void 0:e.blocked_by)!=null&&i.length?e.blocked_by.map(o=>{const s=t[o];return s?{id:s.id,title:s.title,status:s.status}:null}).filter(o=>o!==null):[]}),sl=oe([gt,Bi],(t,e)=>{if(!(e!=null&&e.parent))return"";const i=t[e.parent];return(i==null?void 0:i.title)||""});function al(t,e){return t.status==="closed"||!t.blocked_by||t.blocked_by.length===0?!1:t.blocked_by.some(i=>{const o=e[i];return o?o.status!=="closed":!1})}function yi(t,e={}){const i=al(t,e);let o;return t.status==="closed"?o="done":i?o="blocked":t.awaiting?o="human":t.status==="in_progress"?o="agent":o="ready",{...t,is_blocked:i,column:o}}function rl(t){const e={};for(const o of t)e[o.id]=o;const i={};for(const o of t)i[o.id]=yi(o,e);gt.set(i),Qe.set(!1),Ni.set(null)}function nl(t){const e={};for(const[o,s]of t)e[o]=s;const i={};for(const[o,s]of t)i[o]=yi(s,e);gt.set(i),Qe.set(!1),Ni.set(null)}function ge(t){var r;const e=gt.get(),i={};for(const[l,d]of Object.entries(e))i[l]=d;i[t.id]=t;const o=yi(t,i),s={...e};s[t.id]=o;const a=e[t.id];if((a==null?void 0:a.status)!==t.status)for(const[l,d]of Object.entries(e))l!==t.id&&(r=d.blocked_by)!=null&&r.includes(t.id)&&(s[l]=yi(d,i));gt.set(s)}function ll(t){const e=gt.get(),{[t]:i,...o}=e;gt.set(o),vi.get()===t&&vi.set(null)}function ne(t){vi.set(t)}function Ns(t){Fs.set(t)}function wi(t){Qe.set(t)}function Ve(t){Ni.set(t),Qe.set(!1)}function cl(t,e,i,o){if(t.status!=="closed"&&(t.awaiting||t.manual))return"gated";if(t.status==="closed")return"done";if(t.status==="open")for(const s of e){const a=i.get(s);if(a&&a.status!=="closed")return"queued"}return t.status==="in_progress"||o>0?"active":"ready"}function dl(t){const e=new Set,i=new Map;for(const f of t)f.type==="epic"&&(e.add(f.id),i.set(f.id,f));if(e.size===0)return{waves:null};const o=new Map,s=new Map;for(const f of t)f.parent&&e.has(f.parent)&&(o.set(f.parent,(o.get(f.parent)??0)+1),f.status==="closed"&&s.set(f.parent,(s.get(f.parent)??0)+1));const a=new Map;for(const[f,g]of i){const m=(g.blocked_by??[]).filter(b=>e.has(b));a.set(f,m)}const r=new Map,l=new Map;for(const f of i.keys())r.set(f,0);for(const[f,g]of a)for(const m of g){r.set(f,(r.get(f)??0)+1);const b=l.get(m)??[];b.push(f),l.set(m,b)}const d=[...i.keys()].sort(),u=new Set(d),p=[];for(;u.size>0;){const f=[];for(const m of d)u.has(m)&&r.get(m)===0&&f.push(m);if(f.length===0){const b=d.filter(v=>u.has(v)).map(v=>ts(i.get(v),a.get(v)??[],i,o.get(v)??0,s.get(v)??0));p.push(b);break}const g=f.map(m=>ts(i.get(m),a.get(m)??[],i,o.get(m)??0,s.get(m)??0));p.push(g);for(const m of f){u.delete(m);for(const b of l.get(m)??[])u.has(b)&&r.set(b,(r.get(b)??0)-1)}}return{waves:p}}function ts(t,e,i,o,s){const a=cl(t,e,i,o);return{id:t.id,title:t.title,status:a,awaiting_type:a==="gated"?t.awaiting??"work":void 0,blocked_by:e.length>0?[...e]:void 0,children_total:o,children_closed:s}}const Bs=rt(null),co=rt(!1),uo=rt(null);async function Hs(){co.set(!0),uo.set(null);try{let t;if(Mt.get()){const e=gt.get();t=dl(Object.values(e))}else t=await Zn();Bs.set(t)}catch(t){uo.set(t instanceof Error?t.message:String(t))}finally{co.set(!1)}}typeof window<"u"&&window.addEventListener("tick-update-for-roadmap",()=>{Hs().catch(()=>{})});class ul extends Error{constructor(e="Cannot write: local agent is offline"){super(e),this.name="ReadOnlyError"}}class de extends Error{constructor(e){super(e),this.name="ConnectionError"}}const hl="",es=1e3,pl=3e4;class fl{constructor(e=hl){this.tickHandlers=new Set,this.connectionHandlers=new Set,this.eventSource=null,this.reconnectDelay=es,this.reconnectTimeout=null,this.connected=!1,this.baseUrl=e}async connect(){return this.disconnectMainSSE(),new Promise((e,i)=>{try{this.eventSource=new EventSource(`${this.baseUrl}/api/events`),this.eventSource.addEventListener("connected",()=>{this.connected=!0,this.reconnectDelay=es,console.log("[LocalComms] Connected to SSE"),this.emitConnection({type:"connection:connected"}),e()}),this.eventSource.addEventListener("update",o=>{this.handleUpdateEvent(o)}),this.eventSource.onerror=()=>{var s;console.log("[LocalComms] SSE connection error");const o=this.connected;this.connected=!1,o&&this.emitConnection({type:"connection:disconnected"}),(s=this.eventSource)==null||s.close(),this.eventSource=null,this.scheduleReconnect(),o||i(new de("Failed to connect to SSE endpoint"))}}catch(o){i(new de(`Failed to create EventSource: ${o}`))}})}disconnect(){this.reconnectTimeout&&(clearTimeout(this.reconnectTimeout),this.reconnectTimeout=null),this.disconnectMainSSE(),this.connected&&(this.connected=!1,this.emitConnection({type:"connection:disconnected"}))}disconnectMainSSE(){this.eventSource&&(this.eventSource.close(),this.eventSource=null)}scheduleReconnect(){this.reconnectTimeout&&clearTimeout(this.reconnectTimeout),this.reconnectTimeout=setTimeout(()=>{console.log(`[LocalComms] Reconnecting after ${this.reconnectDelay}ms...`),this.connect().catch(e=>{console.error("[LocalComms] Reconnect failed:",e)})},this.reconnectDelay),this.reconnectDelay=Math.min(this.reconnectDelay*2,pl)}onTick(e){return this.tickHandlers.add(e),()=>this.tickHandlers.delete(e)}onConnection(e){return this.connectionHandlers.add(e),()=>this.connectionHandlers.delete(e)}async createTick(e){const i=await fetch(`${this.baseUrl}/api/ticks`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)});if(!i.ok)throw new Error(`Failed to create tick: ${i.statusText}`);return i.json()}async updateTick(e,i){const o=await fetch(`${this.baseUrl}/api/ticks/${e}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify(i)});if(!o.ok)throw new Error(`Failed to update tick: ${o.statusText}`);return o.json()}async deleteTick(e){const i=await fetch(`${this.baseUrl}/api/ticks/${e}`,{method:"DELETE"});if(!i.ok)throw new Error(`Failed to delete tick: ${i.statusText}`)}async addNote(e,i){const o=await fetch(`${this.baseUrl}/api/ticks/${e}/note`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({message:i})});if(!o.ok)throw new Error(`Failed to add note: ${o.statusText}`);return o.json()}async approveTick(e){const i=await fetch(`${this.baseUrl}/api/ticks/${e}/approve`,{method:"POST"});if(!i.ok)throw new Error(`Failed to approve tick: ${i.statusText}`);return i.json()}async rejectTick(e,i){const o=await fetch(`${this.baseUrl}/api/ticks/${e}/reject`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({reason:i})});if(!o.ok)throw new Error(`Failed to reject tick: ${o.statusText}`);return o.json()}async closeTick(e,i){const o=await fetch(`${this.baseUrl}/api/ticks/${e}/close`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({reason:i})});if(!o.ok)throw new Error(`Failed to close tick: ${o.statusText}`);return o.json()}async reopenTick(e){const i=await fetch(`${this.baseUrl}/api/ticks/${e}/reopen`,{method:"POST"});if(!i.ok)throw new Error(`Failed to reopen tick: ${i.statusText}`);return i.json()}async fetchTicks(){const e=await fetch(`${this.baseUrl}/api/ticks`);if(!e.ok)throw new Error(`Failed to fetch ticks: ${e.statusText}`);return(await e.json()).ticks.map(o=>({...o,is_blocked:o.isBlocked}))}async fetchInfo(){const e=await fetch(`${this.baseUrl}/api/info`);if(!e.ok)throw new Error(`Failed to fetch info: ${e.statusText}`);return e.json()}async fetchTick(e){const i=await fetch(`${this.baseUrl}/api/ticks/${e}`);if(!i.ok)throw new Error(`Failed to fetch tick: ${i.statusText}`);return i.json()}async fetchActivity(e){const i=e!==void 0?`${this.baseUrl}/api/activity?limit=${e}`:`${this.baseUrl}/api/activity`,o=await fetch(i);if(!o.ok)throw new Error(`Failed to fetch activity: ${o.statusText}`);return(await o.json()).activities}isConnected(){return this.connected}isReadOnly(){return!1}getConnectionInfo(){return{mode:"local",connected:this.connected,baseUrl:this.baseUrl||window.location.origin}}handleUpdateEvent(e){try{const i=JSON.parse(e.data);if(console.log("[LocalComms] Received update event:",i),i.type==="activity"){this.emitTick({type:"activity:updated"});return}const{type:o,tickId:s}=i;if(!s){console.warn("[LocalComms] Update event missing tickId:",i);return}o==="create"||o==="update"?this.fetchAndEmitTick(s):o==="delete"&&this.emitTick({type:"tick:deleted",tickId:s})}catch(i){console.error("[LocalComms] Failed to parse update event:",i)}}async fetchAndEmitTick(e){try{const i=await fetch(`${this.baseUrl}/api/ticks/${e}`);if(!i.ok)throw new Error(`HTTP ${i.status}`);const o=await i.json();this.emitTick({type:"tick:updated",tick:o})}catch(i){console.error(`[LocalComms] Failed to fetch tick ${e}:`,i),this.emitConnection({type:"connection:error",message:`Failed to fetch tick ${e}: ${i}`})}}emitTick(e){for(const i of this.tickHandlers)try{i(e)}catch(o){console.error("[LocalComms] Error in tick handler:",o)}}emitConnection(e){for(const i of this.connectionHandlers)try{i(e)}catch(o){console.error("[LocalComms] Error in connection handler:",o)}}}const ml=10,bl=1e3,gl=3e4;class vl{constructor(e){this.tickHandlers=new Set,this.connectionHandlers=new Set,this.ws=null,this.connected=!1,this.localAgentConnected=!1,this.reconnectAttempts=0,this.reconnectTimer=null,this.tickCache=new Map,this.projectId=e}async connect(){return this.closeWebSocket(),new Promise((e,i)=>{try{const o=window.location.protocol==="https:"?"wss:":"ws:",s=window.location.host,a=localStorage.getItem("token")||"",r=`${o}//${s}/api/projects/${encodeURIComponent(this.projectId)}/sync?type=cloud`;console.log("[CloudComms] Connecting to",r);const l=["ticks-v1",`token-${encodeURIComponent(a)}`];this.ws=new WebSocket(r,l);let d=!1;this.ws.onopen=()=>{console.log("[CloudComms] WebSocket connected"),this.connected=!0,this.reconnectAttempts=0,d||(d=!0,e()),this.emitConnection({type:"connection:connected"})},this.ws.onmessage=u=>{this.handleMessage(u)},this.ws.onclose=u=>{console.log("[CloudComms] WebSocket closed:",u.code,u.reason);const p=this.connected;this.connected=!1,this.ws=null,p&&this.emitConnection({type:"connection:disconnected"}),this.scheduleReconnect(),d||(d=!0,i(new de(`WebSocket closed: ${u.code} ${u.reason}`)))},this.ws.onerror=u=>{console.error("[CloudComms] WebSocket error:",u),d||(d=!0,i(new de("WebSocket connection error"))),this.emitConnection({type:"connection:error",message:"WebSocket connection error"})}}catch(o){i(new de(`Failed to create WebSocket: ${o}`))}})}disconnect(){this.reconnectTimer!==null&&(clearTimeout(this.reconnectTimer),this.reconnectTimer=null),this.closeWebSocket(),this.connected&&(this.connected=!1,this.emitConnection({type:"connection:disconnected"}))}closeWebSocket(){this.ws&&(this.ws.close(),this.ws=null)}scheduleReconnect(){if(this.reconnectAttempts>=ml){console.error("[CloudComms] Max reconnect attempts reached"),this.emitConnection({type:"connection:error",message:"Connection lost - max reconnect attempts reached"});return}const e=Math.min(bl*Math.pow(2,this.reconnectAttempts),gl);this.reconnectAttempts++,console.log(`[CloudComms] Reconnecting in ${e}ms (attempt ${this.reconnectAttempts})`),this.reconnectTimer=setTimeout(()=>{this.reconnectTimer=null,this.connect().catch(i=>{console.error("[CloudComms] Reconnect failed:",i)})},e)}onTick(e){return this.tickHandlers.add(e),()=>this.tickHandlers.delete(e)}onConnection(e){return this.connectionHandlers.add(e),()=>this.connectionHandlers.delete(e)}async createTick(e){this.checkWritable();const i={id:this.generateTickId(),title:e.title,description:e.description||"",type:e.type||"task",status:"open",priority:e.priority??2,parent:e.parent,labels:e.labels,blocked_by:e.blocked_by,awaiting:e.awaiting,owner:"",created_by:"",created_at:new Date().toISOString(),updated_at:new Date().toISOString()};return this.sendMessage({type:"tick_update",tick:i}),i}async updateTick(e,i){this.checkWritable();const o={id:e,title:i.title||"",description:i.description||"",status:i.status||"open",priority:i.priority??2,labels:i.labels,blocked_by:i.blocked_by,type:"task",owner:"",created_by:"",created_at:new Date().toISOString(),updated_at:new Date().toISOString()};return this.sendMessage({type:"tick_update",tick:o}),o}async deleteTick(e){this.checkWritable(),this.sendMessage({type:"tick_delete",id:e})}async addNote(e,i){return this.checkWritable(),this.tickOperation(e,"note",{message:i})}async approveTick(e){return this.checkWritable(),this.tickOperation(e,"approve")}async rejectTick(e,i){return this.checkWritable(),this.tickOperation(e,"reject",{reason:i})}async closeTick(e,i){return this.checkWritable(),this.tickOperation(e,"close",{reason:i})}async reopenTick(e){return this.checkWritable(),this.tickOperation(e,"reopen")}isConnected(){var e;return this.connected&&((e=this.ws)==null?void 0:e.readyState)===WebSocket.OPEN}isReadOnly(){return!this.localAgentConnected}getConnectionInfo(){return{mode:"cloud",connected:this.connected,localAgentConnected:this.localAgentConnected,projectId:this.projectId,baseUrl:window.location.origin}}async fetchTicks(){const e=[];for(const i of this.tickCache.values()){const o=(i.blocked_by||[]).some(a=>{const r=this.tickCache.get(a);return r?r.status!=="closed":!1});let s="ready";i.status==="closed"?s="done":o?s="blocked":i.awaiting?s="human":i.status==="in_progress"&&(s="agent"),e.push({...i,is_blocked:o,column:s})}return e}async fetchInfo(){const e=[];for(const i of this.tickCache.values())i.type==="epic"&&e.push({id:i.id,title:i.title});return{repoName:this.projectId,epics:e}}async fetchTick(e){const i=this.tickCache.get(e);if(!i)throw new Error(`Tick not found: ${e}`);const o=[];if(i.blocked_by&&i.blocked_by.length>0)for(const r of i.blocked_by){const l=this.tickCache.get(r);l?o.push({id:l.id,title:l.title,status:l.status}):o.push({id:r,title:`Tick ${r}`,status:"unknown"})}const s=o.some(r=>r.status!=="closed"&&r.status!=="unknown");let a="ready";return i.status==="closed"?a="done":s?a="blocked":i.awaiting?a="human":i.status==="in_progress"&&(a="agent"),{...i,isBlocked:s,column:a,notesList:je(i.notes),blockerDetails:o}}async fetchActivity(e){return[]}handleMessage(e){try{const i=JSON.parse(e.data);switch(i.type){case"state_full":this.handleStateFullMessage(i);break;case"tick_updated":case"tick_created":this.handleTickUpdateMessage(i);break;case"tick_deleted":this.handleTickDeleteMessage(i);break;case"connected":console.log("[CloudComms] Connection confirmed:",i.connectionId);break;case"error":console.error("[CloudComms] Server error:",i.message),this.emitConnection({type:"connection:error",message:i.message});break;case"local_status":this.handleLocalStatusMessage(i);break;case"run_event":break;default:console.warn("[CloudComms] Unknown message type:",i.type)}}catch(i){console.error("[CloudComms] Failed to parse message:",i)}}handleStateFullMessage(e){console.log("[CloudComms] Received full state:",Object.keys(e.ticks).length,"ticks"),this.tickCache.clear();for(const[o,s]of Object.entries(e.ticks))this.tickCache.set(o,s);const i=new Map(Object.entries(e.ticks));this.emitTick({type:"tick:bulk",ticks:i})}handleTickUpdateMessage(e){console.log("[CloudComms] Tick updated:",e.tick.id),this.tickCache.set(e.tick.id,e.tick),this.emitTick({type:"tick:updated",tick:e.tick})}handleTickDeleteMessage(e){console.log("[CloudComms] Tick deleted:",e.id),this.tickCache.delete(e.id),this.emitTick({type:"tick:deleted",tickId:e.id})}handleLocalStatusMessage(e){console.log("[CloudComms] Local agent status:",e.connected?"online":"offline"),this.localAgentConnected=e.connected,this.emitConnection({type:"connection:local-status",connected:e.connected})}emitTick(e){for(const i of this.tickHandlers)try{i(e)}catch(o){console.error("[CloudComms] Error in tick handler:",o)}}emitConnection(e){for(const i of this.connectionHandlers)try{i(e)}catch(o){console.error("[CloudComms] Error in connection handler:",o)}}checkWritable(){if(!this.connected)throw new de("Not connected to server");if(!this.localAgentConnected)throw new ul("Cannot write: local agent is offline")}sendMessage(e){var i;if(((i=this.ws)==null?void 0:i.readyState)!==WebSocket.OPEN)throw new de("WebSocket not connected");this.ws.send(JSON.stringify(e))}async tickOperation(e,i,o){const s=`/api/projects/${encodeURIComponent(this.projectId)}/ticks/${encodeURIComponent(e)}/${i}`,a=localStorage.getItem("token")||"",r=await fetch(s,{method:"POST",headers:{"Content-Type":"application/json",...a?{Authorization:`Bearer ${a}`}:{}},body:o?JSON.stringify(o):void 0});if(!r.ok){const l=await r.json().catch(()=>({error:r.statusText}));throw new Error(l.error||`Failed to ${i} tick`)}return r.json()}generateTickId(){const e="abcdefghijklmnopqrstuvwxyz0123456789";let i="";for(let o=0;o<3;o++)i+=e.charAt(Math.floor(Math.random()*e.length));return i}}const he=rt(null),pe=rt("disconnected"),js=oe([pe,Mt,Xe],(t,e,i)=>!e||t!=="connected"?t:i?"connected":"disconnected");function Vs(t){switch(t.type){case"tick:updated":console.log("[CommsStore] Tick updated:",t.tick.id),ge(t.tick),window.dispatchEvent(new CustomEvent("tick-update-for-roadmap"));break;case"tick:deleted":console.log("[CommsStore] Tick deleted:",t.tickId),ll(t.tickId),window.dispatchEvent(new CustomEvent("tick-update-for-roadmap"));break;case"tick:bulk":console.log("[CommsStore] Bulk tick sync:",t.ticks.size,"ticks"),nl(t.ticks),window.dispatchEvent(new CustomEvent("tick-update-for-roadmap"));break;case"activity:updated":window.dispatchEvent(new CustomEvent("activity-update"));break}}function Ws(t){switch(t.type){case"connection:connected":console.log("[CommsStore] Connected"),pe.set("connected"),Zo(!0);break;case"connection:disconnected":console.log("[CommsStore] Disconnected"),pe.set("disconnected"),Zo(!1);break;case"connection:local-status":console.log("[CommsStore] Local agent status:",t.connected?"online":"offline"),Qn(t.connected);break;case"connection:error":console.error("[CommsStore] Connection error:",t.message),Ve(t.message);break}}let is=!1,xe=[];async function $o(){To(),console.log("[CommsStore] Initializing local mode"),pe.set("connecting"),wi(!0);const t=new fl;xe.push(t.onTick(Vs)),xe.push(t.onConnection(Ws)),he.set(t);try{await t.connect(),console.log("[CommsStore] Local mode connected")}catch(e){console.error("[CommsStore] Failed to connect:",e),Ve(`Connection failed: ${e}`)}}async function ki(t){To(),console.log("[CommsStore] Initializing cloud mode for project:",t),pe.set("connecting"),wi(!0);const e=new vl(t);xe.push(e.onTick(Vs)),xe.push(e.onConnection(Ws)),he.set(e),Ns(t);try{await e.connect(),console.log("[CommsStore] Cloud mode connected")}catch(i){console.error("[CommsStore] Failed to connect:",i),Ve(`Connection failed: ${i}`)}}async function yl(){const t=Mt.get(),e=He.get();t&&e?await ki(e):await $o()}function wl(){To(),pe.set("disconnected")}function To(){for(const e of xe)e();xe=[];const t=he.get();t&&(t.disconnect(),he.set(null))}function ft(){const t=he.get();if(!t)throw new Error("CommsClient not initialized");return t}async function Us(t){return ft().createTick(t)}async function kl(t,e){return ft().updateTick(t,e)}async function xl(t){return ft().deleteTick(t)}async function qs(t,e){return ft().addNote(t,e)}async function Ys(t){return ft().approveTick(t)}async function Ks(t,e){return ft().rejectTick(t,e)}async function Gs(t,e){return ft().closeTick(t,e)}async function Xs(t){return ft().reopenTick(t)}async function Qs(){return ft().fetchTicks()}async function Js(){return ft().fetchInfo()}async function So(t){return ft().fetchTick(t)}async function Eo(t){return ft().fetchActivity(t)}function Zs(){if(is){console.log("[CommsStore] Already initialized, skipping");return}is=!0,console.log("[CommsStore] Setting up auto-connect"),Mt.subscribe(t=>{const e=He.get();console.log("[CommsStore] Cloud mode changed:",t,"projectId:",e),t&&e?ki(e):t||$o()}),He.subscribe(t=>{const e=Mt.get();console.log("[CommsStore] Project ID changed:",t,"isCloudMode:",e),e&&t&&!he.get()&&ki(t)})}const os=Object.freeze(Object.defineProperty({__proto__:null,$commsClient:he,$connectionStatus:pe,$effectiveConnectionStatus:js,addNote:qs,approveTick:Ys,closeTick:Gs,createTick:Us,deleteTick:xl,disconnectComms:wl,fetchActivity:Eo,fetchInfo:Js,fetchTickDetails:So,fetchTicks:Qs,getCommsClient:ft,initCloudComms:ki,initComms:yl,initCommsAutoConnect:Zs,initLocalComms:$o,rejectTick:Ks,reopenTick:Xs,updateTickViaComms:kl},Symbol.toStringTag,{value:"Module"}));var _l=Object.defineProperty,Cl=Object.getOwnPropertyDescriptor,Hi=(t,e,i,o)=>{for(var s=o>1?void 0:o?Cl(e,i):e,a=t.length-1,r;a>=0;a--)(r=t[a])&&(s=(o?r(e,i,s):r(s))||s);return o&&s&&_l(e,i,s),s};const $l={done:"var(--green, #a6e3a1)",active:"var(--blue, #89b4fa)",ready:"var(--yellow, #f9e2af)",queued:"var(--surface2, #585b70)",gated:"var(--peach, #fab387)"},Tl={done:"Done",active:"Active",ready:"Needs planning",queued:"Queued",gated:"Gated"};let _e=class extends $t{constructor(){super(...arguments),this.roadmap=null,this.loading=!1,this.error=null}_close(){this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}_handleBackdropClick(t){t.target.classList.contains("overlay")&&this._close()}_handleEpicClick(t){ne(t),this._close()}_pct(t){return t.children_total===0?0:Math.round(t.children_closed/t.children_total*100)}_renderEpicCard(t){const e=$l[t.status]??"var(--surface2)",i=this._pct(t);return h`
      <div
        class="epic-card"
  ...
  `;lt([Mn({context:Bn}),y()],tt.prototype,"boardState",2);lt([y()],tt.prototype,"selectedEpic",2);lt([y()],tt.prototype,"searchTerm",2);lt([y()],tt.prototype,"activeColumn",2);lt([y()],tt.prototype,"isMobile",2);lt([y()],tt.prototype,"focusedColumnIndex",2);lt([y()],tt.prototype,"focusedTickIndex",2);lt([y()],tt.prototype,"showKeyboardHelp",2);lt([y()],tt.prototype,"showCreateDialog",2);lt([y()],tt.prototype,"showMobileFilterDrawer",2);lt([y()],tt.prototype,"showDashboard",2);lt([y()],tt.prototype,"dashboardActivities",2);lt([y()],tt.prototype,"showRoadmap",2);tt=lt([Lt("tick-board")],tt);const ta=6048e5,Dl=864e5,Al=6e4,Ol=36e5,ri=43200,ss=1440,as=Symbol.for("constructDateFrom");function Vt(t,e){return typeof t=="function"?t(e):t&&typeof t=="object"&&as in t?t[as](e):t instanceof Date?new t.constructor(e):new Date(e)}function q(t,e){return Vt(e||t,t)}let zl={};function Je(){return zl}function We(t,e){var l,d,u,p;const i=Je(),o=(e==null?void 0:e.weekStartsOn)??((d=(l=e==null?void 0:e.locale)==null?void 0:l.options)==null?void 0:d.weekStartsOn)??i.weekStartsOn??((p=(u=i.locale)==null?void 0:u.options)==null?void 0:p.weekStartsOn)??0,s=q(t,e==null?void 0:e.in),a=s.getDay(),r=(a<o?7:0)+a-o;return s.setDate(s.getDate()-r),s.setHours(0,0,0,0),s}function xi(t,e){return We(t,{...e,weekStartsOn:1})}function ea(t,e){const i=q(t,e==null?void 0:e.in),o=i.getFullYear(),s=Vt(i,0);s.setFullYear(o+1,0,4),s.setHours(0,0,0,0);const a=xi(s),r=Vt(i,0);r.setFullYear(o,0,4),r.setHours(0,0,0,0);const l=xi(r);return i.getTime()>=a.getTime()?o+1:i.getTime()>=l.getTime()?o:o-1}function _i(t){const e=q(t),i=new Date(Date.UTC(e.getFullYear(),e.getMonth(),e.getDate(),e.getHours(),e.getMinutes(),e.getSeconds(),e.getMilliseconds()));return i.setUTCFullYear(e.getFullYear()),+t-+i}function Ze(t,...e){const i=Vt.bind(null,t||e.find(o=>typeof o=="object"));return e.map(i)}function rs(t,e){const i=q(t,e==null?void 0:e.in);return i.setHours(0,0,0,0),i}function Ml(t,e,i){const[o,s]=Ze(i==null?void 0:i.in,t,e),a=rs(o),r=rs(s),l=+a-_i(a),d=+r-_i(r);return Math.round((l-d)/Dl)}function Pl(t,e){const i=ea(t,e),o=Vt(t,0);return o.setFullYear(i,0,4),o.setHours(0,0,0,0),xi(o)}function ui(t,e){const i=+q(t)-+q(e);return i<0?-1:i>0?1:i}function Ll(t){return Vt(t,Date.now())}function Il(t){return t instanceof Date||typeof t=="object"&&Object.prototype.toString.call(t)==="[object Date]"}function Rl(t){return!(!Il(t)&&typeof t!="number"||isNaN(+q(t)))}function Fl(t,e,i){const[o,s]=Ze(i==null?void 0:i.in,t,e),a=o.getFullYear()-s.getFullYear(),r=o.getMonth()-s.getMonth();return a*12+r}function Do(t){return e=>{const o=(t?Math[t]:Math.trunc)(e);return o===0?0:o}}function Nl(t,e,i){const[o,s]=Ze(i==null?void 0:i.in,t,e),a=(+o-+s)/Ol;return Do(i==null?void 0:i.roundingMethod)(a)}function ia(t,e){return+q(t)-+q(e)}function Bl(t,e,i){const o=ia(t,e)/Al;return Do(i==null?void 0:i.roundingMethod)(o)}function Hl(t,e){const i=q(t,e==null?void 0:e.in);return i.setHours(23,59,59,999),i}function jl(t,e){const i=q(t,e==null?void 0:e.in),o=i.getMonth();return i.setFullYear(i.getFullYear(),o+1,0),i.setHours(23,59,59,999),i}function Vl(t,e){const i=q(t,e==null?void 0:e.in);return+Hl(i,e)==+jl(i,e)}function Wl(t,e,i){const[o,s,a]=Ze(i==null?void 0:i.in,t,t,e),r=ui(s,a),l=Math.abs(Fl(s,a));if(l<1)return 0;s.getMonth()===1&&s.getDate()>27&&s.setDate(30),s.setMonth(s.getMonth()-r*l);let d=ui(s,a)===-r;Vl(o)&&l===1&&ui(o,a)===1&&(d=!1);const u=r*(l-+d);return u===0?0:u}function Ul(t,e,i){const o=ia(t,e)/1e3;return Do(i==null?void 0:i.roundingMethod)(o)}function ql(t,e){const i=q(t,e==null?void 0:e.in);return i.setFullYear(i.getFullYear(),0,1),i.setHours(0,0,0,0),i}const Yl={lessThanXSeconds:{one:"less than a second",other:"less than {{count}} seconds"},xSeconds:{one:"1 second",other:"{{count}} seconds"},halfAMinute:"half a minute",lessThanXMinutes:{one:"less than a minute",other:"less than {{count}} minutes"},xMinutes:{one:"1 minute",other:"{{count}} minutes"},aboutXHours:{one:"about 1 hour",other:"about {{count}} hours"},xHours:{one:"1 hour",other:"{{count}} hours"},xDays:{one:"1 day",other:"{{count}} days"},aboutXWeeks:{one:"about 1 week",other:"about {{count}} weeks"},xWeeks:{one:"1 week",other:"{{count}} weeks"},aboutXMonths:{one:"about 1 month",other:"about {{count}} months"},xMonths:{one:"1 month",other:"{{count}} months"},aboutXYears:{one:"about 1 year",other:"about {{count}} years"},xYears:{one:"1 year",other:"{{count}} years"},overXYears:{one:"over 1 year",other:"over {{count}} years"},almostXYears:{one:"almost 1 year",other:"almost {{count}} years"}},Kl=(t,e,i)=>{let o;const s=Yl[t];return typeof s=="string"?o=s:e===1?o=s.one:o=s.other.replace("{{count}}",e.toString()),i!=null&&i.addSuffix?i.comparison&&i.comparison>0?"in "+o:o+" ago":o};function Qi(t){return(e={})=>{const i=e.width?String(e.width):t.defaultWidth;return t.formats[i]||t.formats[t.defaultWidth]}}const Gl={full:"EEEE, MMMM do, y",long:"MMMM do, y",medium:"MMM d, y",short:"MM/dd/yyyy"},Xl={full:"h:mm:ss a zzzz",long:"h:mm:ss a z",medium:"h:mm:ss a",short:"h:mm a"},Ql={full:"{{date}} 'at' {{time}}",long:"{{date}} 'at' {{time}}",medium:"{{date}}, {{time}}",short:"{{date}}, {{time}}"},Jl={date:Qi({formats:Gl,defaultWidth:"full"}),time:Qi({formats:Xl,defaultWidth:"full"}),dateTime:Qi({formats:Ql,defaultWidth:"full"})},Zl={lastWeek:"'last' eeee 'at' p",yesterday:"'yesterday at' p",today:"'today at' p",tomorrow:"'tomorrow at' p",nextWeek:"eeee 'at' p",other:"P"},tc=(t,e,i,o)=>Zl[t];function Le(t){return(e,i)=>{const o=i!=null&&i.context?String(i.context):"standalone";let s;if(o==="formatting"&&t.formattingValues){const r=t.defaultFormattingWidth||t.defaultWidth,l=i!=null&&i.width?String(i.width):r;s=t.formattingValues[l]||t.formattingValues[r]}else{const r=t.defaultWidth,l=i!=null&&i.width?String(i.width):t.defaultWidth;s=t.values[l]||t.values[r]}const a=t.argumentCallback?t.argumentCallback(e):e;return s[a]}}const ec={narrow:["B","A"],abbreviated:["BC","AD"],wide:["Before Christ","Anno Domini"]},ic={narrow:["1","2","3","4"],abbreviated:["Q1","Q2","Q3","Q4"],wide:["1st quarter","2nd quarter","3rd quarter","4th quarter"]},oc={narrow:["J","F","M","A","M","J","J","A","S","O","N","D"],abbreviated:["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],wide:["January","February","March","April","May","June","July","August","September","October","November","December"]},sc={narrow:["S","M","T","W","T","F","S"],short:["Su","Mo","Tu","We","Th","Fr","Sa"],abbreviated:["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],wide:["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"]},ac={narrow:{am:"a",pm:"p",midnight:"mi",noon:"n",morning:"morning",afternoon:"afternoon",evening:"evening",night:"night"},abbreviated:{am:"AM",pm:"PM",midnight:"midnight",noon:"noon",morning:"morning",afternoon:"afternoon",evening:"evening",night:"night"},wide:{am:"a.m.",pm:"p.m.",midnight:"midnight",noon:"noon",morning:"morning",afternoon:"afternoon",evening:"evening",night:"night"}},rc={narrow:{am:"a",pm:"p",midnight:"mi",noon:"n",morning:"in the morning",afternoon:"in the afternoon",evening:"in the evening",night:"at night"},abbreviated:{am:"AM",pm:"PM",midnight:"midnight",noon:"noon",morning:"in the morning",afternoon:"in the afternoon",evening:"in the evening",night:"at night"},wide:{am:"a.m.",pm:"p.m.",midnight:"midnight",noon:"noon",morning:"in the morning",afternoon:"in the afternoon",evening:"in the evening",night:"at night"}},nc=(t,e)=>{const i=Number(t),o=i%100;if(o>20||o<10)switch(o%10){case 1:return i+"st";case 2:return i+"nd";case 3:return i+"rd"}return i+"th"},lc={ordinalNumber:nc,era:Le({values:ec,defaultWidth:"wide"}),quarter:Le({values:ic,defaultWidth:"wide",argumentCallback:t=>t-1}),month:Le({values:oc,defaultWidth:"wide"}),day:Le({values:sc,defaultWidth:"wide"}),dayPeriod:Le({values:ac,defaultWidth:"wide",formattingValues:rc,defaultFormattingWidth:"wide"})};function Ie(t){return(e,i={})=>{const o=i.width,s=o&&t.matchPatterns[o]||t.matchPatterns[t.defaultMatchWidth],a=e.match(s);if(!a)return null;const r=a[0],l=o&&t.parsePatterns[o]||t.parsePatterns[t.defaultParseWidth],d=Array.isArray(l)?dc(l,f=>f.test(r)):cc(l,f=>f.test(r));let u;u=t.valueCallback?t.valueCallback(d):d,u=i.valueCallback?i.valueCallback(u):u;const p=e.slice(r.length);return{value:u,rest:p}}}function cc(t,e){for(const i in t)if(Object.prototype.hasOwnProperty.call(t,i)&&e(t[i]))return i}function dc(t,e){for(let i=0;i<t.length;i++)if(e(t[i]))return i}function uc(t){return(e,i={})=>{const o=e.match(t.matchPattern);if(!o)return null;const s=o[0],a=e.match(t.parsePattern);if(!a)return null;let r=t.valueCallback?t.valueCallback(a[0]):a[0];r=i.valueCallback?i.valueCallback(r):r;const l=e.slice(s.length);return{value:r,rest:l}}}const hc=/^(\d+)(th|st|nd|rd)?/i,pc=/\d+/i,fc={narrow:/^(b|a)/i,abbreviated:/^(b\.?\s?c\.?|b\.?\s?c\.?\s?e\.?|a\.?\s?d\.?|c\.?\s?e\.?)/i,wide:/^(before christ|before common era|anno domini|common era)/i},mc={any:[/^b/i,/^(a|c)/i]},bc={narrow:/^[1234]/i,abbreviated:/^q[1234]/i,wide:/^[1234](th|st|nd|rd)? quarter/i},gc={any:[/1/i,/2/i,/3/i,/4/i]},vc={narrow:/^[jfmasond]/i,abbreviated:/^(jan|feb|mar|apr|may|jun|jul|aug|sep|oct|nov|dec)/i,wide:/^(january|february|march|april|may|june|july|august|september|october|november|december)/i},yc={narrow:[/^j/i,/^f/i,/^m/i,/^a/i,/^m/i,/^j/i,/^j/i,/^a/i,/^s/i,/^o/i,/^n/i,/^d/i],any:[/^ja/i,/^f/i,/^mar/i,/^ap/i,/^may/i,/^jun/i,/^jul/i,/^au/i,/^s/i,/^o/i,/^n/i,/^d/i]},wc={narrow:/^[smtwf]/i,short:/^(su|mo|tu|we|th|fr|sa)/i,abbreviated:/^(sun|mon|tue|wed|thu|fri|sat)/i,wide:/^(sunday|monday|tuesday|wednesday|thursday|friday|saturday)/i},kc={narrow:[/^s/i,/^m/i,/^t/i,/^w/i,/^t/i,/^f/i,/^s/i],any:[/^su/i,/^m/i,/^tu/i,/^w/i,/^th/i,/^f/i,/^sa/i]},xc={narrow:/^(a|p|mi|n|(in the|at) (morning|afternoon|evening|night))/i,any:/^([ap]\.?\s?m\.?|midnight|noon|(in the|at) (morning|afternoon|evening|night))/i},_c={any:{am:/^a/i,pm:/^p/i,midnight:/^mi/i,noon:/^no/i,morning:/morning/i,afternoon:/afternoon/i,evening:/evening/i,night:/night/i}},Cc={ordinalNumber:uc({matchPattern:hc,parsePattern:pc,valueCallback:t=>parseInt(t,10)}),era:Ie({matchPatterns:fc,defaultMatchWidth:"wide",parsePatterns:mc,defaultParseWidth:"any"}),quarter:Ie({matchPatterns:bc,defaultMatchWidth:"wide",parsePatterns:gc,defaultParseWidth:"any",valueCallback:t=>t+1}),month:Ie({matchPatterns:vc,defaultMatchWidth:"wide",parsePatterns:yc,defaultParseWidth:"any"}),day:Ie({matchPatterns:wc,defaultMatchWidth:"wide",parsePatterns:kc,defaultParseWidth:"any"}),dayPeriod:Ie({matchPatterns:xc,defaultMatchWidth:"any",parsePatterns:_c,defaultParseWidth:"any"})},oa={code:"en-US",formatDistance:Kl,formatLong:Jl,formatRelative:tc,localize:lc,match:Cc,options:{weekStartsOn:0,firstWeekContainsDate:1}};function $c(t,e){const i=q(t,e==null?void 0:e.in);return Ml(i,ql(i))+1}function Tc(t,e){const i=q(t,e==null?void 0:e.in),o=+xi(i)-+Pl(i);return Math.round(o/ta)+1}function sa(t,e){var p,f,g,m;const i=q(t,e==null?void 0:e.in),o=i.getFullYear(),s=Je(),a=(e==null?void 0:e.firstWeekContainsDate)??((f=(p=e==null?void 0:e.locale)==null?void 0:p.options)==null?void 0:f.firstWeekContainsDate)??s.firstWeekContainsDate??((m=(g=s.locale)==null?void 0:g.options)==null?void 0:m.firstWeekContainsDate)??1,r=Vt((e==null?void 0:e.in)||t,0);r.setFullYear(o+1,0,a),r.setHours(0,0,0,0);const l=We(r,e),d=Vt((e==null?void 0:e.in)||t,0);d.setFullYear(o,0,a),d.setHours(0,0,0,0);const u=We(d,e);return+i>=+l?o+1:+i>=+u?o:o-1}function Sc(t,e){var l,d,u,p;const i=Je(),o=(e==null?void 0:e.firstWeekContainsDate)??((d=(l=e==null?void 0:e.locale)==null?void 0:l.options)==null?void 0:d.firstWeekContainsDate)??i.firstWeekContainsDate??((p=(u=i.locale)==null?void 0:u.options)==null?void 0:p.firstWeekContainsDate)??1,s=sa(t,e),a=Vt((e==null?void 0:e.in)||t,0);return a.setFullYear(s,0,o),a.setHours(0,0,0,0),We(a,e)}function Ec(t,e){const i=q(t,e==null?void 0:e.in),o=+We(i,e)-+Sc(i,e);return Math.round(o/ta)+1}function O(t,e){const i=t<0?"-":"",o=Math.abs(t).toString().padStart(e,"0");return i+o}const Qt={y(t,e){const i=t.getFullYear(),o=i>0?i:1-i;return O(e==="yy"?o%100:o,e.length)},M(t,e){const i=t.getMonth();return e==="M"?String(i+1):O(i+1,2)},d(t,e){return O(t.getDate(),e.length)},a(t,e){const i=t.getHours()/12>=1?"pm":"am";switch(e){case"a":case"aa":return i.toUpperCase();case"aaa":return i;case"aaaaa":return i[0];case"aaaa":default:return i==="am"?"a.m.":"p.m."}},h(t,e){return O(t.getHours()%12||12,e.length)},H(t,e){return O(t.getHours(),e.length)},m(t,e){return O(t.getMinutes(),e.length)},s(t,e){return O(t.getSeconds(),e.length)},S(t,e){const i=e.length,o=t.getMilliseconds(),s=Math.trunc(o*Math.pow(10,i-3));return O(s,e.length)}},be={midnight:"midnight",noon:"noon",morning:"morning",afternoon:"afternoon",evening:"evening",night:"night"},ns={G:function(t,e,i){const o=t.getFullYear()>0?1:0;switch(e){case"G":case"GG":case"GGG":return i.era(o,{width:"abbreviated"});case"GGGGG":return i.era(o,{width:"narrow"});case"GGGG":default:return i.era(o,{width:"wide"})}},y:function(t,e,i){if(e==="yo"){const o=t.getFullYear(),s=o>0?o:1-o;return i.ordinalNumber(s,{unit:"year"})}return Qt.y(t,e)},Y:function(t,e,i,o){const s=sa(t,o),a=s>0?s:1-s;if(e==="YY"){const r=a%100;return O(r,2)}return e==="Yo"?i.ordinalNumber(a,{unit:"year"}):O(a,e.length)},R:function(t,e){const i=ea(t);return O(i,e.length)},u:function(t,e){const i=t.getFullYear();return O(i,e.length)},Q:function(t,e,i){const o=Math.ceil((t.getMonth()+1)/3);switch(e){case"Q":return String(o);case"QQ":return O(o,2);case"Qo":return i.ordinalNumber(o,{unit:"quarter"});case"QQQ":return i.quarter(o,{width:"abbreviated",context:"formatting"});case"QQQQQ":return i.quarter(o,{width:"narrow",context:"formatting"});case"QQQQ":default:return i.quarter(o,{width:"wide",context:"formatting"})}},q:function(t,e,i){const o=Math.ceil((t.getMonth()+1)/3);switch(e){case"q":return String(o);case"qq":return O(o,2);case"qo":return i.ordinalNumber(o,{unit:"quarter"});case"qqq":return i.quarter(o,{width:"abbreviated",context:"standalone"});case"qqqqq":return i.quarter(o,{width:"narrow",context:"standalone"});case"qqqq":default:return i.quarter(o,{width:"wide",context:"standalone"})}},M:function(t,e,i){const o=t.getMonth();switch(e){case"M":case"MM":return Qt.M(t,e);case"Mo":return i.ordinalNumber(o+1,{unit:"month"});case"MMM":return i.month(o,{width:"abbreviated",context:"formatting"});case"MMMMM":return i.month(o,{width:"narrow",context:"formatting"});case"MMMM":default:return i.month(o,{width:"wide",context:"formatting"})}},L:function(t,e,i){const o=t.getMonth();switch(e){case"L":return String(o+1);case"LL":return O(o+1,2);case"Lo":return i.ordinalNumber(o+1,{unit:"month"});case"LLL":return i.month(o,{width:"abbreviated",context:"standalone"});case"LLLLL":return i.month(o,{width:"narrow",context:"standalone"});case"LLLL":default:return i.month(o,{width:"wide",context:"standalone"})}},w:function(t,e,i,o){const s=Ec(t,o);return e==="wo"?i.ordinalNumber(s,{unit:"week"}):O(s,e.length)},I:function(t,e,i){const o=Tc(t);return e==="Io"?i.ordinalNumber(o,{unit:"week"}):O(o,e.length)},d:function(t,e,i){return e==="do"?i.ordinalNumber(t.getDate(),{unit:"date"}):Qt.d(t,e)},D:function(t,e,i){const o=$c(t);return e==="Do"?i.ordinalNumber(o,{unit:"dayOfYear"}):O(o,e.length)},E:function(t,e,i){const o=t.getDay();switch(e){case"E":case"EE":case"EEE":return i.day(o,{width:"abbreviated",context:"formatting"});case"EEEEE":return i.day(o,{width:"narrow",context:"formatting"});case"EEEEEE":return i.day(o,{width:"short",context:"formatting"});case"EEEE":default:return i.day(o,{width:"wide",context:"formatting"})}},e:function(t,e,i,o){const s=t.getDay(),a=(s-o.weekStartsOn+8)%7||7;switch(e){case"e":return String(a);case"ee":return O(a,2);case"eo":return i.ordinalNumber(a,{unit:"day"});case"eee":return i.day(s,{width:"abbreviated",context:"formatting"});case"eeeee":return i.day(s,{width:"narrow",context:"formatting"});case"eeeeee":return i.day(s,{width:"short",context:"formatting"});case"eeee":default:return i.day(s,{width:"wide",context:"formatting"})}},c:function(t,e,i,o){const s=t.getDay(),a=(s-o.weekStartsOn+8)%7||7;switch(e){case"c":return String(a);case"cc":return O(a,e.length);case"co":return i.ordinalNumber(a,{unit:"day"});case"ccc":return i.day(s,{width:"abbreviated",context:"standalone"});case"ccccc":return i.day(s,{width:"narrow",context:"standalone"});case"cccccc":return i.day(s,{width:"short",context:"standalone"});case"cccc":default:return i.day(s,{width:"wide",context:"standalone"})}},i:function(t,e,i){const o=t.getDay(),s=o===0?7:o;switch(e){case"i":return String(s);case"ii":return O(s,e.length);case"io":return i.ordinalNumber(s,{unit:"day"});case"iii":return i.day(o,{width:"abbreviated",context:"formatting"});case"iiiii":return i.day(o,{width:"narrow",context:"formatting"});case"iiiiii":return i.day(o,{width:"short",context:"formatting"});case"iiii":default:return i.day(o,{width:"wide",context:"formatting"})}},a:function(t,e,i){const s=t.getHours()/12>=1?"pm":"am";switch(e){case"a":case"aa":return i.dayPeriod(s,{width:"abbreviated",context:"formatting"});case"aaa":return i.dayPeriod(s,{width:"abbreviated",context:"formatting"}).toLowerCase();case"aaaaa":return i.dayPeriod(s,{width:"narrow",context:"formatting"});case"aaaa":default:return i.dayPeriod(s,{width:"wide",context:"formatting"})}},b:function(t,e,i){const o=t.getHours();let s;switch(o===12?s=be.noon:o===0?s=be.midnight:s=o/12>=1?"pm":"am",e){case"b":case"bb":return i.dayPeriod(s,{width:"abbreviated",context:"formatting"});case"bbb":return i.dayPeriod(s,{width:"abbreviated",context:"formatting"}).toLowerCase();case"bbbbb":return i.dayPeriod(s,{width:"narrow",context:"formatting"});case"bbbb":default:return i.dayPeriod(s,{width:"wide",context:"formatting"})}},B:function(t,e,i){const o=t.getHours();let s;switch(o>=17?s=be.evening:o>=12?s=be.afternoon:o>=4?s=be.morning:s=be.night,e){case"B":case"BB":case"BBB":return i.dayPeriod(s,{width:"abbreviated",context:"formatting"});case"BBBBB":return i.dayPeriod(s,{width:"narrow",context:"formatting"});case"BBBB":default:return i.dayPeriod(s,{width:"wide",context:"formatting"})}},h:function(t,e,i){if(e==="ho"){let o=t.getHours()%12;return o===0&&(o=12),i.ordinalNumber(o,{unit:"hour"})}return Qt.h(t,e)},H:function(t,e,i){return e==="Ho"?i.ordinalNumber(t.getHours(),{unit:"hour"}):Qt.H(t,e)},K:function(t,e,i){const o=t.getHours()%12;return e==="Ko"?i.ordinalNumber(o,{unit:"hour"}):O(o,e.length)},k:function(t,e,i){let o=t.getHours();return o===0&&(o=24),e==="ko"?i.ordinalNumber(o,{unit:"hour"}):O(o,e.length)},m:function(t,e,i){return e==="mo"?i.ordinalNumber(t.getMinutes(),{unit:"minute"}):Qt.m(t,e)},s:function(t,e,i){return e==="so"?i.ordinalNumber(t.getSeconds(),{unit:"second"}):Qt.s(t,e)},S:function(t,e){return Qt.S(t,e)},X:function(t,e,i){const o=t.getTimezoneOffset();if(o===0)return"Z";switch(e){case"X":return cs(o);case"XXXX":case"XX":return le(o);case"XXXXX":case"XXX":default:return le(o,":")}},x:function(t,e,i){const o=t.getTimezoneOffset();switch(e){case"x":return cs(o);case"xxxx":case"xx":return le(o);case"xxxxx":case"xxx":default:return le(o,":")}},O:function(t,e,i){const o=t.getTimezoneOffset();switch(e){case"O":case"OO":case"OOO":return"GMT"+ls(o,":");case"OOOO":default:return"GMT"+le(o,":")}},z:function(t,e,i){const o=t.getTimezoneOffset();switch(e){case"z":case"zz":case"zzz":return"GMT"+ls(o,":");case"zzzz":default:return"GMT"+le(o,":")}},t:function(t,e,i){const o=Math.trunc(+t/1e3);return O(o,e.length)},T:function(t,e,i){return O(+t,e.length)}};function ls(t,e=""){const i=t>0?"-":"+",o=Math.abs(t),s=Math.trunc(o/60),a=o%60;return a===0?i+String(s):i+String(s)+e+O(a,2)}function cs(t,e){return t%60===0?(t>0?"-":"+")+O(Math.abs(t)/60,2):le(t,e)}function le(t,e=""){const i=t>0?"-":"+",o=Math.abs(t),s=O(Math.trunc(o/60),2),a=O(o%60,2);return i+s+e+a}const ds=(t,e)=>{switch(t){case"P":return e.date({width:"short"});case"PP":return e.date({width:"medium"});case"PPP":return e.date({width:"long"});case"PPPP":default:return e.date({width:"full"})}},aa=(t,e)=>{switch(t){case"p":return e.time({width:"short"});case"pp":return e.time({width:"medium"});case"ppp":return e.time({width:"long"});case"pppp":default:return e.time({width:"full"})}},Dc=(t,e)=>{const i=t.match(/(P+)(p+)?/)||[],o=i[1],s=i[2];if(!s)return ds(t,e);let a;switch(o){case"P":a=e.dateTime({width:"short"});break;case"PP":a=e.dateTime({width:"medium"});break;case"PPP":a=e.dateTime({width:"long"});break;case"PPPP":default:a=e.dateTime({width:"full"});break}return a.replace("{{date}}",ds(o,e)).replace("{{time}}",aa(s,e))},Ac={p:aa,P:Dc},Oc=/^D+$/,zc=/^Y+$/,Mc=["D","DD","YY","YYYY"];function Pc(t){return Oc.test(t)}function Lc(t){return zc.test(t)}function Ic(t,e,i){const o=Rc(t,e,i);if(console.warn(o),Mc.includes(t))throw new RangeError(o)}function Rc(t,e,i){const o=t[0]==="Y"?"years":"days of the month";return`Use \`${t.toLowerCase()}\` instead of \`${t}\` (in \`${e}\`) for formatting ${o} to the input \`${i}\`; see: https://github.com/date-fns/date-fns/blob/master/docs/unicodeTokens.md`}const Fc=/[yYQqMLwIdDecihHKkms]o|(\w)\1*|''|'(''|[^'])+('|$)|./g,Nc=/P+p+|P+|p+|''|'(''|[^'])+('|$)|./g,Bc=/^'([^]*?)'?$/,Hc=/''/g,jc=/[a-zA-Z]/;function Vc(t,e,i){var p,f,g,m;const o=Je(),s=o.locale??oa,a=o.firstWeekContainsDate??((f=(p=o.locale)==null?void 0:p.options)==null?void 0:f.firstWeekContainsDate)??1,r=o.weekStartsOn??((m=(g=o.locale)==null?void 0:g.options)==null?void 0:m.weekStartsOn)??0,l=q(t,i==null?void 0:i.in);if(!Rl(l))throw new RangeError("Invalid time value");let d=e.match(Nc).map(b=>{const v=b[0];if(v==="p"||v==="P"){const C=Ac[v];return C(b,s.formatLong)}return b}).join("").match(Fc).map(b=>{if(b==="''")return{isToken:!1,value:"'"};const v=b[0];if(v==="'")return{isToken:!1,value:Wc(b)};if(ns[v])return{isToken:!0,value:b};if(v.match(jc))throw new RangeError("Format string contains an unescaped latin alphabet character `"+v+"`");return{isToken:!1,value:b}});s.localize.preprocessor&&(d=s.localize.preprocessor(l,d));const u={firstWeekContainsDate:a,weekStartsOn:r,locale:s};return d.map(b=>{if(!b.isToken)return b.value;const v=b.value;(Lc(v)||Pc(v))&&Ic(v,e,String(t));const C=ns[v[0]];return C(l,v,s.localize,u)}).join("")}function Wc(t){const e=t.match(Bc);return e?e[1].replace(Hc,"'"):t}function Uc(t,e,i){const o=Je(),s=(i==null?void 0:i.locale)??o.locale??oa,a=2520,r=ui(t,e);if(isNaN(r))throw new RangeError("Invalid time value");const l=Object.assign({},i,{addSuffix:i==null?void 0:i.addSuffix,comparison:r}),[d,u]=Ze(i==null?void 0:i.in,...r>0?[e,t]:[t,e]),p=Ul(u,d),f=(_i(u)-_i(d))/1e3,g=Math.round((p-f)/60);let m;if(g<2)return i!=null&&i.includeSeconds?p<5?s.formatDistance("lessThanXSeconds",5,l):p<10?s.formatDistance("lessThanXSeconds",10,l):p<20?s.formatDistance("lessThanXSeconds",20,l):p<40?s.formatDistance("halfAMinute",0,l):p<60?s.formatDistance("lessThanXMinutes",1,l):s.formatDistance("xMinutes",1,l):g===0?s.formatDistance("lessThanXMinutes",1,l):s.formatDistance("xMinutes",g,l);if(g<45)return s.formatDistance("xMinutes",g,l);if(g<90)return s.formatDistance("aboutXHours",1,l);if(g<ss){const b=Math.round(g/60);return s.formatDistance("aboutXHours",b,l)}else{if(g<a)return s.formatDistance("xDays",1,l);if(g<ri){const b=Math.round(g/ss);return s.formatDistance("xDays",b,l)}else if(g<ri*2)return m=Math.round(g/ri),s.formatDistance("aboutXMonths",m,l)}if(m=Wl(u,d),m<12){const b=Math.round(g/ri);return s.formatDistance("xMonths",b,l)}else{const b=m%12,v=Math.trunc(m/12);return b<3?s.formatDistance("aboutXYears",v,l):b<9?s.formatDistance("overXYears",v,l):s.formatDistance("almostXYears",v+1,l)}}function qc(t,e){return Uc(t,Ll(t),e)}var Yc=Object.defineProperty,Kc=Object.getOwnPropertyDescriptor,me=(t,e,i,o)=>{for(var s=o>1?void 0:o?Kc(e,i):e,a=t.length-1,r;a>=0;a--)(r=t[a])&&(s=(o?r(e,i,s):r(s))||s);return o&&s&&Yc(e,i,s),s};const us={0:"var(--red)",1:"var(--peach)",2:"var(--yellow)",3:"var(--green)",4:"var(--subtext0)"},Gc={0:"Critical",1:"High",2:"Medium",3:"Low",4:"Backlog"};let Wt=class extends $t{constructor(){super(...arguments),this.selected=!1,this.focused=!1,this.elapsedTime=""}connectedCallback(){super.connectedCallback(),this.updateElapsedTime(),this.updateTimerId=setInterval(()=>this.updateElapsedTime(),3e4)}disconnectedCallback(){super.disconnectedCallback(),this.updateTimerId&&(clearInterval(this.updateTimerId),this.updateTimerId=void 0)}updated(t){t.has("focused")&&this.focused&&this.cardElement&&this.cardElement.scrollIntoView({behavior:"smooth",block:"nearest"}),t.has("tick")&&this.updateElapsedTime()}updateElapsedTime(){var a;if(((a=this.tick)==null?void 0:a.status)!=="in_progress"||!this.tick.started_at){this.elapsedTime="";return}const t=new Date(this.tick.started_at),e=new Date,i=Bl(e,t),o=Nl(e,t),s=i%60;o>0?this.elapsedTime=`${o}h ${s}m`:this.elapsedTime=`${i}m`}handleClick(){this.dispatchEvent(new CustomEvent("tick-selected",{detail:{tick:this.tick},bubbles:!0,composed:!0}))}getPriorityColor(){return us[this.tick.priority]??us[2]}getPriorityLabel(){return Gc[this.tick.priority]??"Unknown"}renderElapsedBadge(){if(!this.elapsedTime||!this.tick.started_at)return null;const t=new Date(this.tick.started_at).toLocaleString();return h`
  ...
  `;me([c({attribute:!1})],Wt.prototype,"tick",2);me([c({type:Boolean})],Wt.prototype,"selected",2);me([c({type:Boolean})],Wt.prototype,"focused",2);me([c({type:String,attribute:"epic-name"})],Wt.prototype,"epicName",2);me([x(".card")],Wt.prototype,"cardElement",2);me([y()],Wt.prototype,"elapsedTime",2);Wt=me([Lt("tick-card")],Wt);var Xc=Object.defineProperty,Qc=Object.getOwnPropertyDescriptor,Ee=(t,e,i,o)=>{for(var s=o>1?void 0:o?Qc(e,i):e,a=t.length-1,r;a>=0;a--)(r=t[a])&&(s=(o?r(e,i,s):r(s))||s);return o&&s&&Xc(e,i,s),s};const Jc={blocked:"var(--red)",ready:"var(--yellow)",agent:"var(--blue)",human:"var(--mauve)",done:"var(--green)"},Zc={blocked:"Blocked",ready:"Ready",agent:"In Progress",human:"Needs Human",done:"Done"},td={blocked:"⊘",ready:"▶",agent:"●",human:"👤",done:"✓"};let ee=class extends $t{constructor(){super(...arguments),this.name="ready",this.color="",this.ticks=[],this.epicNames={},this.focusedTickId=""}getColumnColor(){return this.color||Jc[this.name]||"var(--blue)"}getColumnDisplayName(){return Zc[this.name]||this.name}getColumnIcon(){return td[this.name]||"•"}handleTickSelected(t){this.dispatchEvent(new CustomEvent("tick-selected",{detail:t.detail,bubbles:!0,composed:!0}))}render(){const t=this.getColumnColor(),e=this.getColumnDisplayName(),i=this.getColumnIcon(),o=this.ticks.length;return h`
  ...
  `;J([c({attribute:!1})],j.prototype,"tick",2);J([c({type:Boolean})],j.prototype,"open",2);J([c({attribute:!1})],j.prototype,"notesList",2);J([c({attribute:!1})],j.prototype,"blockerDetails",2);J([c({type:String,attribute:"parent-title"})],j.prototype,"parentTitle",2);J([c({type:Boolean,attribute:"readonly-mode"})],j.prototype,"readonlyMode",2);J([y()],j.prototype,"loading",2);J([y()],j.prototype,"errorMessage",2);J([y()],j.prototype,"showRejectInput",2);J([y()],j.prototype,"showCloseInput",2);J([y()],j.prototype,"rejectReason",2);J([y()],j.prototype,"closeReason",2);J([y()],j.prototype,"newNoteText",2);J([y()],j.prototype,"addingNote",2);J([y()],j.prototype,"addNoteError",2);J([y()],j.prototype,"optimisticNote",2);j=J([Lt("tick-detail-drawer")],j);var rd=Object.defineProperty,nd=Object.getOwnPropertyDescriptor,mt=(t,e,i,o)=>{for(var s=o>1?void 0:o?nd(e,i):e,a=t.length-1,r;a>=0;a--)(r=t[a])&&(s=(o?r(e,i,s):r(s))||s);return o&&s&&rd(e,i,s),s};const ld=[{value:"task",label:"Task"},{value:"epic",label:"Epic"},{value:"bug",label:"Bug"},{value:"feature",label:"Feature"},{value:"chore",label:"Chore"}],cd=[{value:0,label:"0 - Critical"},{value:1,label:"1 - High"},{value:2,label:"2 - Medium"},{value:3,label:"3 - Low"},{value:4,label:"4 - Backlog"}];let at=class extends $t{constructor(){super(...arguments),this.open=!1,this.epics=[],this.loading=!1,this.error=null,this.tickTitle="",this.tickDescription="",this.type="task",this.priority=2,this.parent="",this.labels="",this.awaiting=""}resetForm(){this.tickTitle="",this.tickDescription="",this.type="task",this.priority=2,this.parent="",this.labels="",this.awaiting="",this.error=null,this.loading=!1}handleDialogRequestClose(t){if(this.loading){t.preventDefault();return}this.handleClose()}handleClose(){this.resetForm(),this.dispatchEvent(new CustomEvent("dialog-close",{bubbles:!0,composed:!0}))}handleTitleInput(t){const e=t.target;this.tickTitle=e.value}handleDescriptionInput(t){const e=t.target;this.tickDescription=e.value}handleTypeChange(t){const e=t.target;this.type=e.value}handlePriorityChange(t){const e=t.target;this.priority=parseInt(e.value,10)}handleParentChange(t){const e=t.target;this.parent=e.value}handleLabelsInput(t){const e=t.target;this.labels=e.value}handleAwaitingChange(t){const e=t.target;this.awaiting=e.value}async handleSubmit(){var e;if(!this.tickTitle.trim()){this.error="Title is required",(e=this.titleInput)==null||e.focus();return}this.loading=!0,this.error=null;const t={title:this.tickTitle.trim(),type:this.type,priority:this.priority};this.tickDescription.trim()&&(t.description=this.tickDescription.trim()),this.parent&&(t.parent=this.parent),this.awaiting&&(t.awaiting=this.awaiting);try{const i=await Us(t);this.dispatchEvent(new CustomEvent("tick-created",{detail:{tick:i,labels:this.labels?this.labels.split(",").map(o=>o.trim()).filter(Boolean):[],awaiting:this.awaiting},bubbles:!0,composed:!0})),this.handleClose()}catch(i){i instanceof Rs?this.error=i.body||i.message:i instanceof Error?this.error=i.message:this.error="Failed to create tick"}finally{this.loading=!1}}render(){return h`
      <sl-dialog
  ...
  `;De([x("sl-dropdown")],ie.prototype,"dropdown",2);De([y()],ie.prototype,"activities",2);De([y()],ie.prototype,"loading",2);De([y()],ie.prototype,"unreadCount",2);De([y()],ie.prototype,"lastSeenTimestamp",2);ie=De([Lt("tick-activity-feed")],ie);var gd=Object.defineProperty,vd=Object.getOwnPropertyDescriptor,Ft=(t,e,i,o)=>{for(var s=o>1?void 0:o?vd(e,i):e,a=t.length-1,r;a>=0;a--)(r=t[a])&&(s=(o?r(e,i,s):r(s))||s);return o&&s&&gd(e,i,s),s};const ps=[{id:"blocked",name:"Blocked",color:"var(--red)",icon:"⊘"},{id:"ready",name:"Agent Queue",color:"var(--blue)",icon:"▶"},{id:"agent",name:"In Progress",color:"var(--peach)",icon:"●"},{id:"human",name:"Needs Human",color:"var(--yellow)",icon:"👤"},{id:"done",name:"Done",color:"var(--green)",icon:"✓"}];let et=class extends $t{constructor(){super(...arguments),this.ticks=[],this.epics=[],this.open=!1,this.activities=[],this.repoName="",this._focusedAttentionIndex=-1,this._detailTick=null,this._detailNotes=[],this._detailLoading=!1,this._handleKeyDown=t=>{if(t.key==="Escape"){if(t.stopPropagation(),this._detailTick){this._closeDetailPane();return}this._close();return}const e=this._getHumanTicks(),i=Math.min(e.length,6)-1;switch(t.key){case"j":case"ArrowDown":t.preventDefault(),t.stopPropagation(),i>=0&&(this._focusedAttentionIndex=Math.min(this._focusedAttentionIndex+1,i));break;case"k":case"ArrowUp":t.preventDefault(),t.stopPropagation(),i>=0&&(this._focusedAttentionIndex=Math.max(this._focusedAttentionIndex-1,0));break;case"Enter":case"i":this._focusedAttentionIndex>=0&&this._focusedAttentionIndex<=i&&(t.preventDefault(),t.stopPropagation(),this._handleTickClick(e[this._focusedAttentionIndex].id));break;case"a":if(this._focusedAttentionIndex>=0&&this._focusedAttentionIndex<=i){t.preventDefault(),t.stopPropagation();const o=e[this._focusedAttentionIndex];this.dispatchEvent(new CustomEvent("tick-resume",{detail:{tickId:o.id}}))}break;case"t":if(this._focusedAttentionIndex>=0&&this._focusedAttentionIndex<=i){t.preventDefault(),t.stopPropagation();const o=e[this._focusedAttentionIndex];this.dispatchEvent(new CustomEvent("tick-retry",{detail:{tickId:o.id}}))}break}}}connectedCallback(){super.connectedCallback(),this.addEventListener("keydown",this._handleKeyDown)}updated(t){super.updated(t),t.has("open")&&this.open&&(this._focusedAttentionIndex=-1,this._closeDetailPane())}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("keydown",this._handleKeyDown)}_close(){this.dispatchEvent(new CustomEvent("close"))}_handleBackdropClick(t){t.target.classList.contains("overlay")&&this._close()}_handleEpicClick(t){this.dispatchEvent(new CustomEvent("epic-select",{detail:{epicId:t}})),this._close()}_handleTickClick(t){this._openDetailPane(t)}_handleOpenOnBoard(t){this.dispatchEvent(new CustomEvent("tick-select",{detail:{tickId:t}})),this._close()}async _openDetailPane(t){var i,o;const e=this.ticks.find(s=>s.id===t);if(e){this._detailTick=e,this._detailNotes=je(e.notes),this._detailLoading=!0;try{const s=await So(t).catch(()=>null);if(((i=this._detailTick)==null?void 0:i.id)!==t)return;s&&(this._detailTick={...e,...s,is_blocked:e.is_blocked,column:e.column},this._detailNotes=je(s.notes))}catch{}finally{((o=this._detailTick)==null?void 0:o.id)===t&&(this._detailLoading=!1)}}}_closeDetailPane(){this._detailTick=null,this._detailNotes=[],this._detailLoading=!1}_getColumnCounts(){const t={blocked:0,ready:0,agent:0,human:0,done:0};for(const e of this.ticks)e.type!=="epic"&&t[e.column]!==void 0&&t[e.column]++;return t}_getTotalNonEpicTicks(){return this.ticks.filter(t=>t.type!=="epic").length}_getEpicProgress(t){const e=this.ticks.filter(u=>u.parent===t&&u.type!=="epic"),i=e.length,o=e.filter(u=>u.column==="done").length,s=e.filter(u=>u.column==="agent").length,a=e.filter(u=>u.column==="human").length,r=e.filter(u=>u.column==="blocked").length,l=e.filter(u=>u.column==="ready").length,d=i>0?Math.round(o/i*100):0;return{total:i,done:o,inProgress:s,needsHuman:a,blocked:r,ready:l,pct:d}}_getHumanTicks(){return this.ticks.filter(t=>t.column==="human"&&t.type!=="epic")}_getActivityIcon(t){switch(t){case"create":return"➕";case"close":return"✅";case"update":return"✏️";case"approve":return"👍";case"reject":return"👎";case"note":return"💬";case"reopen":return"🔄";default:return"•"}}_formatRelativeTime(t){const e=new Date(t),o=new Date().getTime()-e.getTime(),s=Math.floor(o/6e4);if(s<1)return"now";if(s<60)return`${s}m ago`;const a=Math.floor(s/60);return a<24?`${a}h ago`:`${Math.floor(a/24)}d ago`}_getAwaitingLabel(t){if(t.awaiting)switch(t.awaiting){case"approval":return"Awaiting approval";case"review":return"Awaiting review";case"input":return"Awaiting input";case"content":return"Awaiting content";case"escalation":return"Escalated";case"checkpoint":return"Checkpoint";case"work":return"Manual work needed";default:return"Needs attention"}return"Needs attention"}_getPriorityLabel(t){return et.PRIORITY_LABELS[t]??"Unknown"}_getPriorityColor(t){return et.PRIORITY_COLORS[t]??"var(--subtext0)"}_formatTimestamp(t){return new Date(t).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric",hour:"numeric",minute:"2-digit"})}_formatDuration(t){if(t<1e3)return`${t}ms`;const e=Math.floor(t/1e3);return e<60?`${e}s`:`${Math.floor(e/60)}m ${e%60}s`}_formatTokenCount(t){return t>=1e6?`${(t/1e6).toFixed(1)}M`:t>=1e3?`${(t/1e3).toFixed(1)}K`:t.toString()}_formatCost(t){return t===0?"$0.00":t<.01?`$${t.toFixed(4)}`:t<1?`$${t.toFixed(3)}`:`$${t.toFixed(2)}`}_truncate(t,e=60){return t.length<=e?t:t.slice(0,e)+"..."}render(){if(!this.open)return w;const t=this._getColumnCounts(),e=this._getTotalNonEpicTicks(),i=this._getHumanTicks();return h`
      <div class="overlay" @click=${this._handleBackdropClick} tabindex="-1">
        <div class="dashboard">
          ${this._renderHeader()}
  ...
  `;et.PRIORITY_LABELS={0:"Critical",1:"High",2:"Medium",3:"Low",4:"Backlog"};et.PRIORITY_COLORS={0:"var(--red)",1:"var(--peach)",2:"var(--yellow)",3:"var(--green)",4:"var(--subtext0)"};Ft([c({type:Array})],et.prototype,"ticks",2);Ft([c({type:Array})],et.prototype,"epics",2);Ft([c({type:Boolean,reflect:!0})],et.prototype,"open",2);Ft([c({type:Array})],et.prototype,"activities",2);Ft([c({type:String,attribute:"repo-name"})],et.prototype,"repoName",2);Ft([y()],et.prototype,"_focusedAttentionIndex",2);Ft([y()],et.prototype,"_detailTick",2);Ft([y()],et.prototype,"_detailNotes",2);Ft([y()],et.prototype,"_detailLoading",2);et=Ft([Lt("tickflow-dashboard")],et);to("./shoelace");"serviceWorker"in navigator&&window.addEventListener("load",async()=>{try{const t=await navigator.serviceWorker.register("./sw.js");console.log("[PWA] Service worker registered:",t.scope),t.addEventListener("updatefound",()=>{const e=t.installing;e&&e.addEventListener("statechange",()=>{e.state==="installed"&&navigator.serviceWorker.controller&&window.showToast&&window.showToast({message:"A new version is available. Refresh to update.",variant:"primary",duration:1e4})})}),navigator.serviceWorker.addEventListener("message",e=>{var i;((i=e.data)==null?void 0:i.type)==="SW_ACTIVATED"&&console.log("[PWA] Service worker activated:",e.data.version)})}catch(t){console.error("[PWA] Service worker registration failed:",t)}});
