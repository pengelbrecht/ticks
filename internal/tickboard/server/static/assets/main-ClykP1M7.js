var So=Object.defineProperty;var Eo=(e,t,i)=>t in e?So(e,t,{enumerable:!0,configurable:!0,writable:!0,value:i}):e[t]=i;var N=(e,t,i)=>Eo(e,typeof t!="symbol"?t+"":t,i);import{i as $,n as u,a as oe,b as c,r as w,E as Ot,A as g,e as C,u as Cr,t as me}from"./ticks-logo-DYgrblNn.js";var zo=$`
  :host {
    --track-width: 2px;
...
`;const zs=new Set,It=new Map;let xt,Ys="ltr",Ks="en";const ba=typeof MutationObserver<"u"&&typeof document<"u"&&typeof document.documentElement<"u";if(ba){const e=new MutationObserver(va);Ys=document.documentElement.dir||"ltr",Ks=document.documentElement.lang||navigator.language,e.observe(document.documentElement,{attributes:!0,attributeFilter:["dir","lang"]})}function ga(...e){e.map(t=>{const i=t.$code.toLowerCase();It.has(i)?It.set(i,Object.assign(Object.assign({},It.get(i)),t)):It.set(i,t),xt||(xt=t)}),va()}function va(){ba&&(Ys=document.documentElement.dir||"ltr",Ks=document.documentElement.lang||navigator.language),[...zs.keys()].map(e=>{typeof e.requestUpdate=="function"&&e.requestUpdate()})}let Ro=class{constructor(t){this.host=t,this.host.addController(this)}hostConnected(){zs.add(this.host)}hostDisconnected(){zs.delete(this.host)}dir(){return`${this.host.dir||Ys}`.toLowerCase()}lang(){return`${this.host.lang||Ks}`.toLowerCase()}getTranslationData(t){var i,s;const r=new Intl.Locale(t.replace(/_/g,"-")),a=r==null?void 0:r.language.toLowerCase(),o=(s=(i=r==null?void 0:r.region)===null||i===void 0?void 0:i.toLowerCase())!==null&&s!==void 0?s:"",n=It.get(`${a}-${o}`),h=It.get(a);return{locale:r,language:a,region:o,primary:n,secondary:h}}exists(t,i){var s;const{primary:r,secondary:a}=this.getTranslationData((s=i.lang)!==null&&s!==void 0?s:this.lang());return i=Object.assign({includeFallback:!1},i),!!(r&&r[t]||a&&a[t]||i.includeFallback&&xt&&xt[t])}term(t,...i){const{primary:s,secondary:r}=this.getTranslationData(this.lang());let a;if(s&&s[t])a=s[t];else if(r&&r[t])a=r[t];else if(xt&&xt[t])a=xt[t];else return console.error(`No translation found for: ${String(t)}`),String(t);return typeof a=="function"?a(...i):a}date(t,i){return t=new Date(t),new Intl.DateTimeFormat(this.lang(),i).format(t)}number(t,i){return t=Number(t),isNaN(t)?"":new Intl.NumberFormat(this.lang(),i).format(t)}relativeTime(t,i,s){return new Intl.RelativeTimeFormat(this.lang(),s).format(t,i)}};var ya={$code:"en",$name:"English",$dir:"ltr",carousel:"Carousel",clearEntry:"Clear entry",close:"Close",copied:"Copied",copy:"Copy",currentValue:"Current value",error:"Error",goToSlide:(e,t)=>`Go to slide ${e} of ${t}`,hidePassword:"Hide password",loading:"Loading",nextSlide:"Next slide",numOptionsSelected:e=>e===0?"No options selected":e===1?"1 option selected":`${e} options selected`,previousSlide:"Previous slide",progress:"Progress",remove:"Remove",resize:"Resize",scrollToEnd:"Scroll to end",scrollToStart:"Scroll to start",selectAColorFromTheScreen:"Select a color from the screen",showPassword:"Show password",slideNum:e=>`Slide ${e}`,toggleColorFormat:"Toggle color format"};ga(ya);var Ao=ya,ne=class extends Ro{};ga(Ao);var H=$`
  :host {
...
`,rt=class{constructor(e,...t){this.slotNames=[],this.handleSlotChange=i=>{const s=i.target;(this.slotNames.includes("[default]")&&!s.name||s.name&&this.slotNames.includes(s.name))&&this.host.requestUpdate()},(this.host=e).addController(this),this.slotNames=t}hasDefaultSlot(){return[...this.host.childNodes].some(e=>{if(e.nodeType===e.TEXT_NODE&&e.textContent.trim()!=="")return!0;if(e.nodeType===e.ELEMENT_NODE){const t=e;if(t.tagName.toLowerCase()==="sl-visually-hidden")return!1;if(!t.hasAttribute("slot"))return!0}return!1})}hasNamedSlot(e){return this.host.querySelector(`:scope > [slot="${e}"]`)!==null}test(e){return e==="[default]"?this.hasDefaultSlot():this.hasNamedSlot(e)}hostConnected(){this.host.shadowRoot.addEventListener("slotchange",this.handleSlotChange)}hostDisconnected(){this.host.shadowRoot.removeEventListener("slotchange",this.handleSlotChange)}};function Vo(e){if(!e)return"";const t=e.assignedNodes({flatten:!0});let i="";return[...t].forEach(s=>{s.nodeType===Node.TEXT_NODE&&(i+=s.textContent)}),i}var Rs="";function As(e){Rs=e}function Wo(e=""){if(!Rs){const t=[...document.getElementsByTagName("script")],i=t.find(s=>s.hasAttribute("data-shoelace"));if(i)As(i.getAttribute("data-shoelace"));else{const s=t.find(a=>/shoelace(\.min)?\.js($|\?)/.test(a.src)||/shoelace-autoloader(\.min)?\.js($|\?)/.test(a.src));let r="";s&&(r=s.getAttribute("src")),As(r.split("/").slice(0,-1).join("/"))}}return Rs.replace(/\/$/,"")+(e?`/${e.replace(/^\//,"")}`:"")}var qo={name:"default",resolver:e=>Wo(`assets/icons/${e}.svg`)},Yo=qo,Sr={caret:`
  ...
  `},Ko={name:"system",resolver:e=>e in Sr?`data:image/svg+xml,${encodeURIComponent(Sr[e])}`:""},Go=Ko,Xo=[Yo,Go],Os=[];function Qo(e){Os.push(e)}function Zo(e){Os=Os.filter(t=>t!==e)}function Er(e){return Xo.find(t=>t.name===e)}var Jo=$`
  :host {
    display: inline-block;
    width: 1em;
    height: 1em;
...
`;function S(e,t){const i=st({waitUntilFirstUpdate:!1},t);return(s,r)=>{const{update:a}=s,o=Array.isArray(e)?e:[e];s.update=function(n){o.forEach(h=>{const d=h;if(n.has(d)){const p=n.get(d),f=this[d];p!==f&&(!i.waitUntilFirstUpdate||this.hasUpdated)&&this[r](p,f)}}),a.call(this,n)}}}/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const en=(e,t)=>(e==null?void 0:e._$litType$)!==void 0,xa=e=>e.strings===void 0,tn={},sn=(e,t=tn)=>e._$AH=t;var Gt=Symbol(),_i=Symbol(),ks,xs=new Map,se=class extends P{constructor(){super(...arguments),this.initialRender=!1,this.svg=null,this.label="",this.library="default"}async resolveIcon(e,t){var i;let s;if(t!=null&&t.spriteSheet)return this.svg=c`<svg part="svg">
        <use part="use" href="${e}"></use>
      </svg>`,this.svg;try{if(s=await fetch(e,{mode:"cors"}),!s.ok)return s.status===410?Gt:_i}catch{return _i}try{const r=document.createElement("div");r.innerHTML=await s.text();const a=r.firstElementChild;if(((i=a==null?void 0:a.tagName)==null?void 0:i.toLowerCase())!=="svg")return Gt;ks||(ks=new DOMParser);const n=ks.parseFromString(a.outerHTML,"text/html").body.querySelector("svg");return n?(n.part.add("svg"),document.adoptNode(n)):Gt}catch{return Gt}}connectedCallback(){super.connectedCallback(),Qo(this)}firstUpdated(){this.initialRender=!0,this.setIcon()}disconnectedCallback(){super.disconnectedCallback(),Zo(this)}getIconSource(){const e=Er(this.library);return this.name&&e?{url:e.resolver(this.name),fromLibrary:!0}:{url:this.src,fromLibrary:!1}}handleLabelChange(){typeof this.label=="string"&&this.label.length>0?(this.setAttribute("role","img"),this.setAttribute("aria-label",this.label),this.removeAttribute("aria-hidden")):(this.removeAttribute("role"),this.removeAttribute("aria-label"),this.setAttribute("aria-hidden","true"))}async setIcon(){var e;const{url:t,fromLibrary:i}=this.getIconSource(),s=i?Er(this.library):void 0;if(!t){this.svg=null;return}let r=xs.get(t);if(r||(r=this.resolveIcon(t,s),xs.set(t,r)),!this.initialRender)return;const a=await r;if(a===_i&&xs.delete(t),t===this.getIconSource().url){if(en(a)){if(this.svg=a,s){await this.updateComplete;const o=this.shadowRoot.querySelector("[part='svg']");typeof s.mutator=="function"&&o&&s.mutator(o)}return}switch(a){case _i:case Gt:this.svg=null,this.emit("sl-error");break;default:this.svg=a.cloneNode(!0),(e=s==null?void 0:s.mutator)==null||e.call(s,this.svg),this.emit("sl-load")}}}render(){return this.svg}};se.styles=[H,Jo];l([w()],se.prototype,"svg",2);l([u({reflect:!0})],se.prototype,"name",2);l([u()],se.prototype,"src",2);l([u()],se.prototype,"label",2);l([u({reflect:!0})],se.prototype,"library",2);l([S("label")],se.prototype,"handleLabelChange",1);l([S(["name","src","library"])],se.prototype,"setIcon",1);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */const x=e=>e??g;var L=class extends P{constructor(){super(...arguments),this.formControlController=new hi(this,{assumeInteractionOn:["click"]}),this.hasSlotController=new rt(this,"[default]","prefix","suffix"),this.localize=new ne(this),this.hasFocus=!1,this.invalid=!1,this.title="",this.variant="default",this.size="medium",this.caret=!1,this.disabled=!1,this.loading=!1,this.outline=!1,this.pill=!1,this.circle=!1,this.type="button",this.name="",this.value="",this.href="",this.rel="noreferrer noopener"}get validity(){return this.isButton()?this.button.validity:Xs}get validationMessage(){return this.isButton()?this.button.validationMessage:""}firstUpdated(){this.isButton()&&this.formControlController.updateValidity()}handleBlur(){this.hasFocus=!1,this.emit("sl-blur")}handleFocus(){this.hasFocus=!0,this.emit("sl-focus")}handleClick(){this.type==="submit"&&this.formControlController.submit(this),this.type==="reset"&&this.formControlController.reset(this)}handleInvalid(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)}isButton(){return!this.href}isLink(){return!!this.href}handleDisabledChange(){this.isButton()&&this.formControlController.setValidity(this.disabled)}click(){this.button.click()}focus(e){this.button.focus(e)}blur(){this.button.blur()}checkValidity(){return this.isButton()?this.button.checkValidity():!0}getForm(){return this.formControlController.getForm()}reportValidity(){return this.isButton()?this.button.reportValidity():!0}setCustomValidity(e){this.isButton()&&(this.button.setCustomValidity(e),this.formControlController.updateValidity())}render(){const e=this.isLink(),t=e?Pi`a`:Pi`button`;return Oi`
    ...
    `}};L.styles=[H,Uo];L.dependencies={"sl-icon":se,"sl-spinner":Zi};l([C(".button")],L.prototype,"button",2);l([w()],L.prototype,"hasFocus",2);l([w()],L.prototype,"invalid",2);l([u()],L.prototype,"title",2);l([u({reflect:!0})],L.prototype,"variant",2);l([u({reflect:!0})],L.prototype,"size",2);l([u({type:Boolean,reflect:!0})],L.prototype,"caret",2);l([u({type:Boolean,reflect:!0})],L.prototype,"disabled",2);l([u({type:Boolean,reflect:!0})],L.prototype,"loading",2);l([u({type:Boolean,reflect:!0})],L.prototype,"outline",2);l([u({type:Boolean,reflect:!0})],L.prototype,"pill",2);l([u({type:Boolean,reflect:!0})],L.prototype,"circle",2);l([u()],L.prototype,"type",2);l([u()],L.prototype,"name",2);l([u()],L.prototype,"value",2);l([u()],L.prototype,"href",2);l([u()],L.prototype,"target",2);l([u()],L.prototype,"rel",2);l([u()],L.prototype,"download",2);l([u()],L.prototype,"form",2);l([u({attribute:"formaction"})],L.prototype,"formAction",2);l([u({attribute:"formenctype"})],L.prototype,"formEnctype",2);l([u({attribute:"formmethod"})],L.prototype,"formMethod",2);l([u({attribute:"formnovalidate",type:Boolean})],L.prototype,"formNoValidate",2);l([u({attribute:"formtarget"})],L.prototype,"formTarget",2);l([S("disabled",{waitUntilFirstUpdate:!0})],L.prototype,"handleDisabledChange",1);L.define("sl-button");var on=$`
  :host {
    display: block;
  }
...
`,Qs=(e="value")=>(t,i)=>{const s=t.constructor,r=s.prototype.attributeChangedCallback;s.prototype.attributeChangedCallback=function(a,o,n){var h;const d=s.getPropertyOptions(e),p=typeof d.attribute=="string"?d.attribute:e;if(a===p){const f=d.converter||Cr,m=(typeof f=="function"?f:(h=f==null?void 0:f.fromAttribute)!=null?h:Cr.fromAttribute)(n,d.type);this[e]!==m&&(this[i]=m)}r.call(this,a,o,n)}},ts=$`
...
`,Z=class extends P{constructor(){super(...arguments),this.hasFocus=!1,this.label="",this.disabled=!1}handleBlur(){this.hasFocus=!1,this.emit("sl-blur")}handleFocus(){this.hasFocus=!0,this.emit("sl-focus")}handleClick(e){this.disabled&&(e.preventDefault(),e.stopPropagation())}click(){this.button.click()}focus(e){this.button.focus(e)}blur(){this.button.blur()}render(){const e=!!this.href,t=e?Pi`a`:Pi`button`;return Oi`
    ...
    `}};Z.styles=[H,ln];Z.dependencies={"sl-icon":se};l([C(".icon-button")],Z.prototype,"button",2);l([w()],Z.prototype,"hasFocus",2);l([u()],Z.prototype,"name",2);l([u()],Z.prototype,"library",2);l([u()],Z.prototype,"src",2);l([u()],Z.prototype,"href",2);l([u()],Z.prototype,"target",2);l([u()],Z.prototype,"download",2);l([u()],Z.prototype,"label",2);l([u({type:Boolean,reflect:!0})],Z.prototype,"disabled",2);var St=class extends P{constructor(){super(...arguments),this.localize=new ne(this),this.variant="neutral",this.size="medium",this.pill=!1,this.removable=!1}handleRemoveClick(){this.emit("sl-remove")}render(){return c`
      <span
        part="base"
    ...
    `}};St.styles=[H,nn];St.dependencies={"sl-icon-button":Z};l([u({reflect:!0})],St.prototype,"variant",2);l([u({reflect:!0})],St.prototype,"size",2);l([u({type:Boolean,reflect:!0})],St.prototype,"pill",2);l([u({type:Boolean})],St.prototype,"removable",2);var cn=$`
  :host {
    display: block;
  }
...
`;function dn(e,t){return{top:Math.round(e.getBoundingClientRect().top-t.getBoundingClientRect().top),left:Math.round(e.getBoundingClientRect().left-t.getBoundingClientRect().left)}}var Is=new Set;function un(){const e=document.documentElement.clientWidth;return Math.abs(window.innerWidth-e)}function hn(){const e=Number(getComputedStyle(document.body).paddingRight.replace(/px/,""));return isNaN(e)||!e?0:e}function ii(e){if(Is.add(e),!document.documentElement.classList.contains("sl-scroll-lock")){const t=un()+hn();let i=getComputedStyle(document.documentElement).scrollbarGutter;(!i||i==="auto")&&(i="stable"),t<2&&(i=""),document.documentElement.style.setProperty("--sl-scroll-lock-gutter",i),document.documentElement.classList.add("sl-scroll-lock"),document.documentElement.style.setProperty("--sl-scroll-lock-size",`${t}px`)}}function si(e){Is.delete(e),Is.size===0&&(document.documentElement.classList.remove("sl-scroll-lock"),document.documentElement.style.removeProperty("--sl-scroll-lock-size"))}function Ds(e,t,i="vertical",s="smooth"){const r=dn(e,t),a=r.top+t.scrollTop,o=r.left+t.scrollLeft,n=t.scrollLeft,h=t.scrollLeft+t.offsetWidth,d=t.scrollTop,p=t.scrollTop+t.offsetHeight;(i==="horizontal"||i==="both")&&(o<n?t.scrollTo({left:o,behavior:s}):o+e.clientWidth>h&&t.scrollTo({left:o-t.offsetWidth+e.clientWidth,behavior:s})),(i==="vertical"||i==="both")&&(a<d?t.scrollTo({top:a,behavior:s}):a+e.clientHeight>p&&t.scrollTo({top:a-t.offsetHeight+e.clientHeight,behavior:s}))}var pn=$`
  :host {
...
`;const ut=Math.min,ve=Math.max,Fi=Math.round,Ci=Math.floor,Ve=e=>({x:e,y:e}),mn={left:"right",right:"left",bottom:"top",top:"bottom"},fn={start:"end",end:"start"};function Ms(e,t,i){return ve(e,ut(t,i))}function Nt(e,t){return typeof e=="function"?e(t):e}function ht(e){return e.split("-")[0]}function Bt(e){return e.split("-")[1]}function Ca(e){return e==="x"?"y":"x"}function Zs(e){return e==="y"?"height":"width"}const bn=new Set(["top","bottom"]);function Je(e){return bn.has(ht(e))?"y":"x"}function Js(e){return Ca(Je(e))}function gn(e,t,i){i===void 0&&(i=!1);const s=Bt(e),r=Js(e),a=Zs(r);let o=r==="x"?s===(i?"end":"start")?"right":"left":s==="start"?"bottom":"top";return t.reference[a]>t.floating[a]&&(o=Ni(o)),[o,Ni(o)]}function vn(e){const t=Ni(e);return[Ps(e),t,Ps(t)]}function Ps(e){return e.replace(/start|end/g,t=>fn[t])}const Rr=["left","right"],Ar=["right","left"],yn=["top","bottom"],wn=["bottom","top"];function kn(e,t,i){switch(e){case"top":case"bottom":return i?t?Ar:Rr:t?Rr:Ar;case"left":case"right":return t?yn:wn;default:return[]}}function xn(e,t,i,s){const r=Bt(e);let a=kn(ht(e),i==="start",s);return r&&(a=a.map(o=>o+"-"+r),t&&(a=a.concat(a.map(Ps)))),a}function Ni(e){return e.replace(/left|right|bottom|top/g,t=>mn[t])}function _n(e){return{top:0,right:0,bottom:0,left:0,...e}}function $a(e){return typeof e!="number"?_n(e):{top:e,right:e,bottom:e,left:e}}function Bi(e){const{x:t,y:i,width:s,height:r}=e;return{width:s,height:r,top:i,left:t,right:t+s,bottom:i+r,x:t,y:i}}function Or(e,t,i){let{reference:s,floating:r}=e;const a=Je(t),o=Js(t),n=Zs(o),h=ht(t),d=a==="y",p=s.x+s.width/2-r.width/2,f=s.y+s.height/2-r.height/2,b=s[n]/2-r[n]/2;let m;switch(h){case"top":m={x:p,y:s.y-r.height};break;case"bottom":m={x:p,y:s.y+s.height};break;case"right":m={x:s.x+s.width,y:f};break;case"left":m={x:s.x-r.width,y:f};break;default:m={x:s.x,y:s.y}}switch(Bt(t)){case"start":m[o]-=b*(i&&d?-1:1);break;case"end":m[o]+=b*(i&&d?-1:1);break}return m}const Cn=async(e,t,i)=>{const{placement:s="bottom",strategy:r="absolute",middleware:a=[],platform:o}=i,n=a.filter(Boolean),h=await(o.isRTL==null?void 0:o.isRTL(t));let d=await o.getElementRects({reference:e,floating:t,strategy:r}),{x:p,y:f}=Or(d,s,h),b=s,m={},v=0;for(let y=0;y<n.length;y++){const{name:k,fn:_}=n[y],{x:E,y:O,data:Y,reset:j}=await _({x:p,y:f,initialPlacement:s,placement:b,strategy:r,middlewareData:m,rects:d,platform:o,elements:{reference:e,floating:t}});p=E??p,f=O??f,m={...m,[k]:{...m[k],...Y}},j&&v<=50&&(v++,typeof j=="object"&&(j.placement&&(b=j.placement),j.rects&&(d=j.rects===!0?await o.getElementRects({reference:e,floating:t,strategy:r}):j.rects),{x:p,y:f}=Or(d,b,h)),y=-1)}return{x:p,y:f,placement:b,strategy:r,middlewareData:m}};async function er(e,t){var i;t===void 0&&(t={});const{x:s,y:r,platform:a,rects:o,elements:n,strategy:h}=e,{boundary:d="clippingAncestors",rootBoundary:p="viewport",elementContext:f="floating",altBoundary:b=!1,padding:m=0}=Nt(t,e),v=$a(m),k=n[b?f==="floating"?"reference":"floating":f],_=Bi(await a.getClippingRect({element:(i=await(a.isElement==null?void 0:a.isElement(k)))==null||i?k:k.contextElement||await(a.getDocumentElement==null?void 0:a.getDocumentElement(n.floating)),boundary:d,rootBoundary:p,strategy:h})),E=f==="floating"?{x:s,y:r,width:o.floating.width,height:o.floating.height}:o.reference,O=await(a.getOffsetParent==null?void 0:a.getOffsetParent(n.floating)),Y=await(a.isElement==null?void 0:a.isElement(O))?await(a.getScale==null?void 0:a.getScale(O))||{x:1,y:1}:{x:1,y:1},j=Bi(a.convertOffsetParentRelativeRectToViewportRelativeRect?await a.convertOffsetParentRelativeRectToViewportRelativeRect({elements:n,rect:E,offsetParent:O,strategy:h}):E);return{top:(_.top-j.top+v.top)/Y.y,bottom:(j.bottom-_.bottom+v.bottom)/Y.y,left:(_.left-j.left+v.left)/Y.x,right:(j.right-_.right+v.right)/Y.x}}const $n=e=>({name:"arrow",options:e,async fn(t){const{x:i,y:s,placement:r,rects:a,platform:o,elements:n,middlewareData:h}=t,{element:d,padding:p=0}=Nt(e,t)||{};if(d==null)return{};const f=$a(p),b={x:i,y:s},m=Js(r),v=Zs(m),y=await o.getDimensions(d),k=m==="y",_=k?"top":"left",E=k?"bottom":"right",O=k?"clientHeight":"clientWidth",Y=a.reference[v]+a.reference[m]-b[m]-a.floating[v],j=b[m]-a.reference[m],de=await(o.getOffsetParent==null?void 0:o.getOffsetParent(d));let W=de?de[O]:0;(!W||!await(o.isElement==null?void 0:o.isElement(de)))&&(W=n.floating[O]||a.floating[v]);const Ge=Y/2-j/2,Be=W/2-y[v]/2-1,Te=ut(f[_],Be),at=ut(f[E],Be),He=Te,ot=W-y[v]-at,ue=W/2-y[v]/2+Ge,yt=Ms(He,ue,ot),Xe=!h.arrow&&Bt(r)!=null&&ue!==yt&&a.reference[v]/2-(ue<He?Te:at)-y[v]/2<0,Ee=Xe?ue<He?ue-He:ue-ot:0;return{[m]:b[m]+Ee,data:{[m]:yt,centerOffset:ue-yt-Ee,...Xe&&{alignmentOffset:Ee}},reset:Xe}}}),Tn=function(e){return e===void 0&&(e={}),{name:"flip",options:e,async fn(t){var i,s;const{placement:r,middlewareData:a,rects:o,initialPlacement:n,platform:h,elements:d}=t,{mainAxis:p=!0,crossAxis:f=!0,fallbackPlacements:b,fallbackStrategy:m="bestFit",fallbackAxisSideDirection:v="none",flipAlignment:y=!0,...k}=Nt(e,t);if((i=a.arrow)!=null&&i.alignmentOffset)return{};const _=ht(r),E=Je(n),O=ht(n)===n,Y=await(h.isRTL==null?void 0:h.isRTL(d.floating)),j=b||(O||!y?[Ni(n)]:vn(n)),de=v!=="none";!b&&de&&j.push(...xn(n,y,v,Y));const W=[n,...j],Ge=await er(t,k),Be=[];let Te=((s=a.flip)==null?void 0:s.overflows)||[];if(p&&Be.push(Ge[_]),f){const ue=gn(r,o,Y);Be.push(Ge[ue[0]],Ge[ue[1]])}if(Te=[...Te,{placement:r,overflows:Be}],!Be.every(ue=>ue<=0)){var at,He;const ue=(((at=a.flip)==null?void 0:at.index)||0)+1,yt=W[ue];if(yt&&(!(f==="alignment"?E!==Je(yt):!1)||Te.every(ze=>Je(ze.placement)===E?ze.overflows[0]>0:!0)))return{data:{index:ue,overflows:Te},reset:{placement:yt}};let Xe=(He=Te.filter(Ee=>Ee.overflows[0]<=0).sort((Ee,ze)=>Ee.overflows[1]-ze.overflows[1])[0])==null?void 0:He.placement;if(!Xe)switch(m){case"bestFit":{var ot;const Ee=(ot=Te.filter(ze=>{if(de){const nt=Je(ze.placement);return nt===E||nt==="y"}return!0}).map(ze=>[ze.placement,ze.overflows.filter(nt=>nt>0).reduce((nt,To)=>nt+To,0)]).sort((ze,nt)=>ze[1]-nt[1])[0])==null?void 0:ot[0];Ee&&(Xe=Ee);break}case"initialPlacement":Xe=n;break}if(r!==Xe)return{reset:{placement:Xe}}}return{}}}},Sn=new Set(["left","top"]);async function En(e,t){const{placement:i,platform:s,elements:r}=e,a=await(s.isRTL==null?void 0:s.isRTL(r.floating)),o=ht(i),n=Bt(i),h=Je(i)==="y",d=Sn.has(o)?-1:1,p=a&&h?-1:1,f=Nt(t,e);let{mainAxis:b,crossAxis:m,alignmentAxis:v}=typeof f=="number"?{mainAxis:f,crossAxis:0,alignmentAxis:null}:{mainAxis:f.mainAxis||0,crossAxis:f.crossAxis||0,alignmentAxis:f.alignmentAxis};return n&&typeof v=="number"&&(m=n==="end"?v*-1:v),h?{x:m*p,y:b*d}:{x:b*d,y:m*p}}const zn=function(e){return e===void 0&&(e=0),{name:"offset",options:e,async fn(t){var i,s;const{x:r,y:a,placement:o,middlewareData:n}=t,h=await En(t,e);return o===((i=n.offset)==null?void 0:i.placement)&&(s=n.arrow)!=null&&s.alignmentOffset?{}:{x:r+h.x,y:a+h.y,data:{...h,placement:o}}}}},Rn=function(e){return e===void 0&&(e={}),{name:"shift",options:e,async fn(t){const{x:i,y:s,placement:r}=t,{mainAxis:a=!0,crossAxis:o=!1,limiter:n={fn:k=>{let{x:_,y:E}=k;return{x:_,y:E}}},...h}=Nt(e,t),d={x:i,y:s},p=await er(t,h),f=Je(ht(r)),b=Ca(f);let m=d[b],v=d[f];if(a){const k=b==="y"?"top":"left",_=b==="y"?"bottom":"right",E=m+p[k],O=m-p[_];m=Ms(E,m,O)}if(o){const k=f==="y"?"top":"left",_=f==="y"?"bottom":"right",E=v+p[k],O=v-p[_];v=Ms(E,v,O)}const y=n.fn({...t,[b]:m,[f]:v});return{...y,data:{x:y.x-i,y:y.y-s,enabled:{[b]:a,[f]:o}}}}}},An=function(e){return e===void 0&&(e={}),{name:"size",options:e,async fn(t){var i,s;const{placement:r,rects:a,platform:o,elements:n}=t,{apply:h=()=>{},...d}=Nt(e,t),p=await er(t,d),f=ht(r),b=Bt(r),m=Je(r)==="y",{width:v,height:y}=a.floating;let k,_;f==="top"||f==="bottom"?(k=f,_=b===(await(o.isRTL==null?void 0:o.isRTL(n.floating))?"start":"end")?"left":"right"):(_=f,k=b==="end"?"top":"bottom");const E=y-p.top-p.bottom,O=v-p.left-p.right,Y=ut(y-p[k],E),j=ut(v-p[_],O),de=!t.middlewareData.shift;let W=Y,Ge=j;if((i=t.middlewareData.shift)!=null&&i.enabled.x&&(Ge=O),(s=t.middlewareData.shift)!=null&&s.enabled.y&&(W=E),de&&!b){const Te=ve(p.left,0),at=ve(p.right,0),He=ve(p.top,0),ot=ve(p.bottom,0);m?Ge=v-2*(Te!==0||at!==0?Te+at:ve(p.left,p.right)):W=y-2*(He!==0||ot!==0?He+ot:ve(p.top,p.bottom))}await h({...t,availableWidth:Ge,availableHeight:W});const Be=await o.getDimensions(n.floating);return v!==Be.width||y!==Be.height?{reset:{rects:!0}}:{}}}};function is(){return typeof window<"u"}function Ht(e){return Ta(e)?(e.nodeName||"").toLowerCase():"#document"}function ye(e){var t;return(e==null||(t=e.ownerDocument)==null?void 0:t.defaultView)||window}function Ye(e){var t;return(t=(Ta(e)?e.ownerDocument:e.document)||window.document)==null?void 0:t.documentElement}function Ta(e){return is()?e instanceof Node||e instanceof ye(e).Node:!1}function Ie(e){return is()?e instanceof Element||e instanceof ye(e).Element:!1}function We(e){return is()?e instanceof HTMLElement||e instanceof ye(e).HTMLElement:!1}function Ir(e){return!is()||typeof ShadowRoot>"u"?!1:e instanceof ShadowRoot||e instanceof ye(e).ShadowRoot}const On=new Set(["inline","contents"]);function pi(e){const{overflow:t,overflowX:i,overflowY:s,display:r}=De(e);return/auto|scroll|overlay|hidden|clip/.test(t+s+i)&&!On.has(r)}const In=new Set(["table","td","th"]);function Dn(e){return In.has(Ht(e))}const Mn=[":popover-open",":modal"];function ss(e){return Mn.some(t=>{try{return e.matches(t)}catch{return!1}})}const Pn=["transform","translate","scale","rotate","perspective"],Ln=["transform","translate","scale","rotate","perspective","filter"],Fn=["paint","layout","strict","content"];function rs(e){const t=tr(),i=Ie(e)?De(e):e;return Pn.some(s=>i[s]?i[s]!=="none":!1)||(i.containerType?i.containerType!=="normal":!1)||!t&&(i.backdropFilter?i.backdropFilter!=="none":!1)||!t&&(i.filter?i.filter!=="none":!1)||Ln.some(s=>(i.willChange||"").includes(s))||Fn.some(s=>(i.contain||"").includes(s))}function Nn(e){let t=pt(e);for(;We(t)&&!Mt(t);){if(rs(t))return t;if(ss(t))return null;t=pt(t)}return null}function tr(){return typeof CSS>"u"||!CSS.supports?!1:CSS.supports("-webkit-backdrop-filter","none")}const Bn=new Set(["html","body","#document"]);function Mt(e){return Bn.has(Ht(e))}function De(e){return ye(e).getComputedStyle(e)}function as(e){return Ie(e)?{scrollLeft:e.scrollLeft,scrollTop:e.scrollTop}:{scrollLeft:e.scrollX,scrollTop:e.scrollY}}function pt(e){if(Ht(e)==="html")return e;const t=e.assignedSlot||e.parentNode||Ir(e)&&e.host||Ye(e);return Ir(t)?t.host:t}function Sa(e){const t=pt(e);return Mt(t)?e.ownerDocument?e.ownerDocument.body:e.body:We(t)&&pi(t)?t:Sa(t)}function oi(e,t,i){var s;t===void 0&&(t=[]),i===void 0&&(i=!0);const r=Sa(e),a=r===((s=e.ownerDocument)==null?void 0:s.body),o=ye(r);if(a){const n=Ls(o);return t.concat(o,o.visualViewport||[],pi(r)?r:[],n&&i?oi(n):[])}return t.concat(r,oi(r,[],i))}function Ls(e){return e.parent&&Object.getPrototypeOf(e.parent)?e.frameElement:null}function Ea(e){const t=De(e);let i=parseFloat(t.width)||0,s=parseFloat(t.height)||0;const r=We(e),a=r?e.offsetWidth:i,o=r?e.offsetHeight:s,n=Fi(i)!==a||Fi(s)!==o;return n&&(i=a,s=o),{width:i,height:s,$:n}}function ir(e){return Ie(e)?e:e.contextElement}function Dt(e){const t=ir(e);if(!We(t))return Ve(1);const i=t.getBoundingClientRect(),{width:s,height:r,$:a}=Ea(t);let o=(a?Fi(i.width):i.width)/s,n=(a?Fi(i.height):i.height)/r;return(!o||!Number.isFinite(o))&&(o=1),(!n||!Number.isFinite(n))&&(n=1),{x:o,y:n}}const Hn=Ve(0);function za(e){const t=ye(e);return!tr()||!t.visualViewport?Hn:{x:t.visualViewport.offsetLeft,y:t.visualViewport.offsetTop}}function jn(e,t,i){return t===void 0&&(t=!1),!i||t&&i!==ye(e)?!1:t}function Ct(e,t,i,s){t===void 0&&(t=!1),i===void 0&&(i=!1);const r=e.getBoundingClientRect(),a=ir(e);let o=Ve(1);t&&(s?Ie(s)&&(o=Dt(s)):o=Dt(e));const n=jn(a,i,s)?za(a):Ve(0);let h=(r.left+n.x)/o.x,d=(r.top+n.y)/o.y,p=r.width/o.x,f=r.height/o.y;if(a){const b=ye(a),m=s&&Ie(s)?ye(s):s;let v=b,y=Ls(v);for(;y&&s&&m!==v;){const k=Dt(y),_=y.getBoundingClientRect(),E=De(y),O=_.left+(y.clientLeft+parseFloat(E.paddingLeft))*k.x,Y=_.top+(y.clientTop+parseFloat(E.paddingTop))*k.y;h*=k.x,d*=k.y,p*=k.x,f*=k.y,h+=O,d+=Y,v=ye(y),y=Ls(v)}}return Bi({width:p,height:f,x:h,y:d})}function os(e,t){const i=as(e).scrollLeft;return t?t.left+i:Ct(Ye(e)).left+i}function Ra(e,t){const i=e.getBoundingClientRect(),s=i.left+t.scrollLeft-os(e,i),r=i.top+t.scrollTop;return{x:s,y:r}}function Un(e){let{elements:t,rect:i,offsetParent:s,strategy:r}=e;const a=r==="fixed",o=Ye(s),n=t?ss(t.floating):!1;if(s===o||n&&a)return i;let h={scrollLeft:0,scrollTop:0},d=Ve(1);const p=Ve(0),f=We(s);if((f||!f&&!a)&&((Ht(s)!=="body"||pi(o))&&(h=as(s)),We(s))){const m=Ct(s);d=Dt(s),p.x=m.x+s.clientLeft,p.y=m.y+s.clientTop}const b=o&&!f&&!a?Ra(o,h):Ve(0);return{width:i.width*d.x,height:i.height*d.y,x:i.x*d.x-h.scrollLeft*d.x+p.x+b.x,y:i.y*d.y-h.scrollTop*d.y+p.y+b.y}}function Vn(e){return Array.from(e.getClientRects())}function Wn(e){const t=Ye(e),i=as(e),s=e.ownerDocument.body,r=ve(t.scrollWidth,t.clientWidth,s.scrollWidth,s.clientWidth),a=ve(t.scrollHeight,t.clientHeight,s.scrollHeight,s.clientHeight);let o=-i.scrollLeft+os(e);const n=-i.scrollTop;return De(s).direction==="rtl"&&(o+=ve(t.clientWidth,s.clientWidth)-r),{width:r,height:a,x:o,y:n}}const Dr=25;function qn(e,t){const i=ye(e),s=Ye(e),r=i.visualViewport;let a=s.clientWidth,o=s.clientHeight,n=0,h=0;if(r){a=r.width,o=r.height;const p=tr();(!p||p&&t==="fixed")&&(n=r.offsetLeft,h=r.offsetTop)}const d=os(s);if(d<=0){const p=s.ownerDocument,f=p.body,b=getComputedStyle(f),m=p.compatMode==="CSS1Compat"&&parseFloat(b.marginLeft)+parseFloat(b.marginRight)||0,v=Math.abs(s.clientWidth-f.clientWidth-m);v<=Dr&&(a-=v)}else d<=Dr&&(a+=d);return{width:a,height:o,x:n,y:h}}const Yn=new Set(["absolute","fixed"]);function Kn(e,t){const i=Ct(e,!0,t==="fixed"),s=i.top+e.clientTop,r=i.left+e.clientLeft,a=We(e)?Dt(e):Ve(1),o=e.clientWidth*a.x,n=e.clientHeight*a.y,h=r*a.x,d=s*a.y;return{width:o,height:n,x:h,y:d}}function Mr(e,t,i){let s;if(t==="viewport")s=qn(e,i);else if(t==="document")s=Wn(Ye(e));else if(Ie(t))s=Kn(t,i);else{const r=za(e);s={x:t.x-r.x,y:t.y-r.y,width:t.width,height:t.height}}return Bi(s)}function Aa(e,t){const i=pt(e);return i===t||!Ie(i)||Mt(i)?!1:De(i).position==="fixed"||Aa(i,t)}function Gn(e,t){const i=t.get(e);if(i)return i;let s=oi(e,[],!1).filter(n=>Ie(n)&&Ht(n)!=="body"),r=null;const a=De(e).position==="fixed";let o=a?pt(e):e;for(;Ie(o)&&!Mt(o);){const n=De(o),h=rs(o);!h&&n.position==="fixed"&&(r=null),(a?!h&&!r:!h&&n.position==="static"&&!!r&&Yn.has(r.position)||pi(o)&&!h&&Aa(e,o))?s=s.filter(p=>p!==o):r=n,o=pt(o)}return t.set(e,s),s}function Xn(e){let{element:t,boundary:i,rootBoundary:s,strategy:r}=e;const o=[...i==="clippingAncestors"?ss(t)?[]:Gn(t,this._c):[].concat(i),s],n=o[0],h=o.reduce((d,p)=>{const f=Mr(t,p,r);return d.top=ve(f.top,d.top),d.right=ut(f.right,d.right),d.bottom=ut(f.bottom,d.bottom),d.left=ve(f.left,d.left),d},Mr(t,n,r));return{width:h.right-h.left,height:h.bottom-h.top,x:h.left,y:h.top}}function Qn(e){const{width:t,height:i}=Ea(e);return{width:t,height:i}}function Zn(e,t,i){const s=We(t),r=Ye(t),a=i==="fixed",o=Ct(e,!0,a,t);let n={scrollLeft:0,scrollTop:0};const h=Ve(0);function d(){h.x=os(r)}if(s||!s&&!a)if((Ht(t)!=="body"||pi(r))&&(n=as(t)),s){const m=Ct(t,!0,a,t);h.x=m.x+t.clientLeft,h.y=m.y+t.clientTop}else r&&d();a&&!s&&r&&d();const p=r&&!s&&!a?Ra(r,n):Ve(0),f=o.left+n.scrollLeft-h.x-p.x,b=o.top+n.scrollTop-h.y-p.y;return{x:f,y:b,width:o.width,height:o.height}}function _s(e){return De(e).position==="static"}function Pr(e,t){if(!We(e)||De(e).position==="fixed")return null;if(t)return t(e);let i=e.offsetParent;return Ye(e)===i&&(i=i.ownerDocument.body),i}function Oa(e,t){const i=ye(e);if(ss(e))return i;if(!We(e)){let r=pt(e);for(;r&&!Mt(r);){if(Ie(r)&&!_s(r))return r;r=pt(r)}return i}let s=Pr(e,t);for(;s&&Dn(s)&&_s(s);)s=Pr(s,t);return s&&Mt(s)&&_s(s)&&!rs(s)?i:s||Nn(e)||i}const Jn=async function(e){const t=this.getOffsetParent||Oa,i=this.getDimensions,s=await i(e.floating);return{reference:Zn(e.reference,await t(e.floating),e.strategy),floating:{x:0,y:0,width:s.width,height:s.height}}};function el(e){return De(e).direction==="rtl"}const Ii={convertOffsetParentRelativeRectToViewportRelativeRect:Un,getDocumentElement:Ye,getClippingRect:Xn,getOffsetParent:Oa,getElementRects:Jn,getClientRects:Vn,getDimensions:Qn,getScale:Dt,isElement:Ie,isRTL:el};function Ia(e,t){return e.x===t.x&&e.y===t.y&&e.width===t.width&&e.height===t.height}function tl(e,t){let i=null,s;const r=Ye(e);function a(){var n;clearTimeout(s),(n=i)==null||n.disconnect(),i=null}function o(n,h){n===void 0&&(n=!1),h===void 0&&(h=1),a();const d=e.getBoundingClientRect(),{left:p,top:f,width:b,height:m}=d;if(n||t(),!b||!m)return;const v=Ci(f),y=Ci(r.clientWidth-(p+b)),k=Ci(r.clientHeight-(f+m)),_=Ci(p),O={rootMargin:-v+"px "+-y+"px "+-k+"px "+-_+"px",threshold:ve(0,ut(1,h))||1};let Y=!0;function j(de){const W=de[0].intersectionRatio;if(W!==h){if(!Y)return o();W?o(!1,W):s=setTimeout(()=>{o(!1,1e-7)},1e3)}W===1&&!Ia(d,e.getBoundingClientRect())&&o(),Y=!1}try{i=new IntersectionObserver(j,{...O,root:r.ownerDocument})}catch{i=new IntersectionObserver(j,O)}i.observe(e)}return o(!0),a}function il(e,t,i,s){s===void 0&&(s={});const{ancestorScroll:r=!0,ancestorResize:a=!0,elementResize:o=typeof ResizeObserver=="function",layoutShift:n=typeof IntersectionObserver=="function",animationFrame:h=!1}=s,d=ir(e),p=r||a?[...d?oi(d):[],...oi(t)]:[];p.forEach(_=>{r&&_.addEventListener("scroll",i,{passive:!0}),a&&_.addEventListener("resize",i)});const f=d&&n?tl(d,i):null;let b=-1,m=null;o&&(m=new ResizeObserver(_=>{let[E]=_;E&&E.target===d&&m&&(m.unobserve(t),cancelAnimationFrame(b),b=requestAnimationFrame(()=>{var O;(O=m)==null||O.observe(t)})),i()}),d&&!h&&m.observe(d),m.observe(t));let v,y=h?Ct(e):null;h&&k();function k(){const _=Ct(e);y&&!Ia(y,_)&&i(),y=_,v=requestAnimationFrame(k)}return i(),()=>{var _;p.forEach(E=>{r&&E.removeEventListener("scroll",i),a&&E.removeEventListener("resize",i)}),f==null||f(),(_=m)==null||_.disconnect(),m=null,h&&cancelAnimationFrame(v)}}const sl=zn,rl=Rn,al=Tn,Lr=An,ol=$n,nl=(e,t,i)=>{const s=new Map,r={platform:Ii,...i},a={...r.platform,_c:s};return Cn(e,t,{...r,platform:a})};function ll(e){return cl(e)}function Cs(e){return e.assignedSlot?e.assignedSlot:e.parentNode instanceof ShadowRoot?e.parentNode.host:e.parentNode}function cl(e){for(let t=e;t;t=Cs(t))if(t instanceof Element&&getComputedStyle(t).display==="none")return null;for(let t=Cs(e);t;t=Cs(t)){if(!(t instanceof Element))continue;const i=getComputedStyle(t);if(i.display!=="contents"&&(i.position!=="static"||rs(i)||t.tagName==="BODY"))return t}return null}function dl(e){return e!==null&&typeof e=="object"&&"getBoundingClientRect"in e&&("contextElement"in e?e.contextElement instanceof Element:!0)}var F=class extends P{constructor(){super(...arguments),this.localize=new ne(this),this.active=!1,this.placement="top",this.strategy="absolute",this.distance=0,this.skidding=0,this.arrow=!1,this.arrowPlacement="anchor",this.arrowPadding=10,this.flip=!1,this.flipFallbackPlacements="",this.flipFallbackStrategy="best-fit",this.flipPadding=0,this.shift=!1,this.shiftPadding=0,this.autoSizePadding=0,this.hoverBridge=!1,this.updateHoverBridge=()=>{if(this.hoverBridge&&this.anchorEl){const e=this.anchorEl.getBoundingClientRect(),t=this.popup.getBoundingClientRect(),i=this.placement.includes("top")||this.placement.includes("bottom");let s=0,r=0,a=0,o=0,n=0,h=0,d=0,p=0;i?e.top<t.top?(s=e.left,r=e.bottom,a=e.right,o=e.bottom,n=t.left,h=t.top,d=t.right,p=t.top):(s=t.left,r=t.bottom,a=t.right,o=t.bottom,n=e.left,h=e.top,d=e.right,p=e.top):e.left<t.left?(s=e.right,r=e.top,a=t.left,o=t.top,n=e.right,h=e.bottom,d=t.left,p=t.bottom):(s=t.right,r=t.top,a=e.left,o=e.top,n=t.right,h=t.bottom,d=e.left,p=e.bottom),this.style.setProperty("--hover-bridge-top-left-x",`${s}px`),this.style.setProperty("--hover-bridge-top-left-y",`${r}px`),this.style.setProperty("--hover-bridge-top-right-x",`${a}px`),this.style.setProperty("--hover-bridge-top-right-y",`${o}px`),this.style.setProperty("--hover-bridge-bottom-left-x",`${n}px`),this.style.setProperty("--hover-bridge-bottom-left-y",`${h}px`),this.style.setProperty("--hover-bridge-bottom-right-x",`${d}px`),this.style.setProperty("--hover-bridge-bottom-right-y",`${p}px`)}}}async connectedCallback(){super.connectedCallback(),await this.updateComplete,this.start()}disconnectedCallback(){super.disconnectedCallback(),this.stop()}async updated(e){super.updated(e),e.has("active")&&(this.active?this.start():this.stop()),e.has("anchor")&&this.handleAnchorChange(),this.active&&(await this.updateComplete,this.reposition())}async handleAnchorChange(){if(await this.stop(),this.anchor&&typeof this.anchor=="string"){const e=this.getRootNode();this.anchorEl=e.getElementById(this.anchor)}else this.anchor instanceof Element||dl(this.anchor)?this.anchorEl=this.anchor:this.anchorEl=this.querySelector('[slot="anchor"]');this.anchorEl instanceof HTMLSlotElement&&(this.anchorEl=this.anchorEl.assignedElements({flatten:!0})[0]),this.anchorEl&&this.active&&this.start()}start(){!this.anchorEl||!this.active||(this.cleanup=il(this.anchorEl,this.popup,()=>{this.reposition()}))}async stop(){return new Promise(e=>{this.cleanup?(this.cleanup(),this.cleanup=void 0,this.removeAttribute("data-current-placement"),this.style.removeProperty("--auto-size-available-width"),this.style.removeProperty("--auto-size-available-height"),requestAnimationFrame(()=>e())):e()})}reposition(){if(!this.active||!this.anchorEl)return;const e=[sl({mainAxis:this.distance,crossAxis:this.skidding})];this.sync?e.push(Lr({apply:({rects:i})=>{const s=this.sync==="width"||this.sync==="both",r=this.sync==="height"||this.sync==="both";this.popup.style.width=s?`${i.reference.width}px`:"",this.popup.style.height=r?`${i.reference.height}px`:""}})):(this.popup.style.width="",this.popup.style.height=""),this.flip&&e.push(al({boundary:this.flipBoundary,fallbackPlacements:this.flipFallbackPlacements,fallbackStrategy:this.flipFallbackStrategy==="best-fit"?"bestFit":"initialPlacement",padding:this.flipPadding})),this.shift&&e.push(rl({boundary:this.shiftBoundary,padding:this.shiftPadding})),this.autoSize?e.push(Lr({boundary:this.autoSizeBoundary,padding:this.autoSizePadding,apply:({availableWidth:i,availableHeight:s})=>{this.autoSize==="vertical"||this.autoSize==="both"?this.style.setProperty("--auto-size-available-height",`${s}px`):this.style.removeProperty("--auto-size-available-height"),this.autoSize==="horizontal"||this.autoSize==="both"?this.style.setProperty("--auto-size-available-width",`${i}px`):this.style.removeProperty("--auto-size-available-width")}})):(this.style.removeProperty("--auto-size-available-width"),this.style.removeProperty("--auto-size-available-height")),this.arrow&&e.push(ol({element:this.arrowEl,padding:this.arrowPadding}));const t=this.strategy==="absolute"?i=>Ii.getOffsetParent(i,ll):Ii.getOffsetParent;nl(this.anchorEl,this.popup,{placement:this.placement,middleware:e,strategy:this.strategy,platform:ui(st({},Ii),{getOffsetParent:t})}).then(({x:i,y:s,middlewareData:r,placement:a})=>{const o=this.localize.dir()==="rtl",n={top:"bottom",right:"left",bottom:"top",left:"right"}[a.split("-")[0]];if(this.setAttribute("data-current-placement",a),Object.assign(this.popup.style,{left:`${i}px`,top:`${s}px`}),this.arrow){const h=r.arrow.x,d=r.arrow.y;let p="",f="",b="",m="";if(this.arrowPlacement==="start"){const v=typeof h=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"";p=typeof d=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"",f=o?v:"",m=o?"":v}else if(this.arrowPlacement==="end"){const v=typeof h=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"";f=o?"":v,m=o?v:"",b=typeof d=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:""}else this.arrowPlacement==="center"?(m=typeof h=="number"?"calc(50% - var(--arrow-size-diagonal))":"",p=typeof d=="number"?"calc(50% - var(--arrow-size-diagonal))":""):(m=typeof h=="number"?`${h}px`:"",p=typeof d=="number"?`${d}px`:"");Object.assign(this.arrowEl.style,{top:p,right:f,bottom:b,left:m,[n]:"calc(var(--arrow-size-diagonal) * -1)"})}}),requestAnimationFrame(()=>this.updateHoverBridge()),this.emit("sl-reposition")}render(){return c`
    ...
    `}};F.styles=[H,pn];l([C(".popup")],F.prototype,"popup",2);l([C(".popup__arrow")],F.prototype,"arrowEl",2);l([u()],F.prototype,"anchor",2);l([u({type:Boolean,reflect:!0})],F.prototype,"active",2);l([u({reflect:!0})],F.prototype,"placement",2);l([u({reflect:!0})],F.prototype,"strategy",2);l([u({type:Number})],F.prototype,"distance",2);l([u({type:Number})],F.prototype,"skidding",2);l([u({type:Boolean})],F.prototype,"arrow",2);l([u({attribute:"arrow-placement"})],F.prototype,"arrowPlacement",2);l([u({attribute:"arrow-padding",type:Number})],F.prototype,"arrowPadding",2);l([u({type:Boolean})],F.prototype,"flip",2);l([u({attribute:"flip-fallback-placements",converter:{fromAttribute:e=>e.split(" ").map(t=>t.trim()).filter(t=>t!==""),toAttribute:e=>e.join(" ")}})],F.prototype,"flipFallbackPlacements",2);l([u({attribute:"flip-fallback-strategy"})],F.prototype,"flipFallbackStrategy",2);l([u({type:Object})],F.prototype,"flipBoundary",2);l([u({attribute:"flip-padding",type:Number})],F.prototype,"flipPadding",2);l([u({type:Boolean})],F.prototype,"shift",2);l([u({type:Object})],F.prototype,"shiftBoundary",2);l([u({attribute:"shift-padding",type:Number})],F.prototype,"shiftPadding",2);l([u({attribute:"auto-size"})],F.prototype,"autoSize",2);l([u()],F.prototype,"sync",2);l([u({type:Object})],F.prototype,"autoSizeBoundary",2);l([u({attribute:"auto-size-padding",type:Number})],F.prototype,"autoSizePadding",2);l([u({attribute:"hover-bridge",type:Boolean})],F.prototype,"hoverBridge",2);var Da=new Map,ul=new WeakMap;function hl(e){return e??{keyframes:[],options:{duration:0}}}function Fr(e,t){return t.toLowerCase()==="rtl"?{keyframes:e.rtlKeyframes||e.keyframes,options:e.options}:e}function B(e,t){Da.set(e,hl(t))}function G(e,t,i){const s=ul.get(e);if(s!=null&&s[t])return Fr(s[t],i.dir);const r=Da.get(t);return r?Fr(r,i.dir):{keyframes:[],options:{duration:0}}}function be(e,t){return new Promise(i=>{function s(r){r.target===e&&(e.removeEventListener(t,s),i())}e.addEventListener(t,s)})}function X(e,t,i){return new Promise(s=>{if((i==null?void 0:i.duration)===1/0)throw new Error("Promise-based animations must be finite.");const r=e.animate(t,ui(st({},i),{duration:pl()?0:i.duration}));r.addEventListener("cancel",s,{once:!0}),r.addEventListener("finish",s,{once:!0})})}function Nr(e){return e=e.toString().toLowerCase(),e.indexOf("ms")>-1?parseFloat(e):e.indexOf("s")>-1?parseFloat(e)*1e3:parseFloat(e)}function pl(){return window.matchMedia("(prefers-reduced-motion: reduce)").matches}function ee(e){return Promise.all(e.getAnimations().map(t=>new Promise(i=>{t.cancel(),requestAnimationFrame(i)})))}function Br(e,t){return e.map(i=>ui(st({},i),{height:i.height==="auto"?`${t}px`:i.height}))}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let Fs=class extends es{constructor(t){if(super(t),this.it=g,t.type!==Ze.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===g||t==null)return this._t=void 0,this.it=t;if(t===Ot)return t;if(typeof t!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.it)return this._t;this.it=t;const i=[t];return i.raw=i,this._t={_$litType$:this.constructor.resultType,strings:i,values:[]}}};Fs.directiveName="unsafeHTML",Fs.resultType=1;const sr=Ji(Fs);var z=class extends P{constructor(){super(...arguments),this.formControlController=new hi(this,{assumeInteractionOn:["sl-blur","sl-input"]}),this.hasSlotController=new rt(this,"help-text","label"),this.localize=new ne(this),this.typeToSelectString="",this.hasFocus=!1,this.displayLabel="",this.selectedOptions=[],this.valueHasChanged=!1,this.name="",this._value="",this.defaultValue="",this.size="medium",this.placeholder="",this.multiple=!1,this.maxOptionsVisible=3,this.disabled=!1,this.clearable=!1,this.open=!1,this.hoist=!1,this.filled=!1,this.pill=!1,this.label="",this.placement="bottom",this.helpText="",this.form="",this.required=!1,this.getTag=e=>c`
      <sl-tag
        part="tag"
        exportparts="
              base:tag__base,
...
`,Se=class extends P{constructor(){super(...arguments),this.localize=new ne(this),this.isInitialized=!1,this.current=!1,this.selected=!1,this.hasHover=!1,this.value="",this.disabled=!1}connectedCallback(){super.connectedCallback(),this.setAttribute("role","option"),this.setAttribute("aria-selected","false")}handleDefaultSlotChange(){this.isInitialized?customElements.whenDefined("sl-select").then(()=>{const e=this.closest("sl-select");e&&e.handleDefaultSlotChange()}):this.isInitialized=!0}handleMouseEnter(){this.hasHover=!0}handleMouseLeave(){this.hasHover=!1}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false")}handleSelectedChange(){this.setAttribute("aria-selected",this.selected?"true":"false")}handleValueChange(){typeof this.value!="string"&&(this.value=String(this.value)),this.value.includes(" ")&&(console.error("Option values cannot include a space. All spaces have been replaced with underscores.",this),this.value=this.value.replace(/ /g,"_"))}getTextLabel(){const e=this.childNodes;let t="";return[...e].forEach(i=>{i.nodeType===Node.ELEMENT_NODE&&(i.hasAttribute("slot")||(t+=i.textContent)),i.nodeType===Node.TEXT_NODE&&(t+=i.textContent)}),t.trim()}render(){return c`
      <div
        part="base"
    ...
    `}};Se.styles=[H,ml];Se.dependencies={"sl-icon":se};l([C(".option__label")],Se.prototype,"defaultSlot",2);l([w()],Se.prototype,"current",2);l([w()],Se.prototype,"selected",2);l([w()],Se.prototype,"hasHover",2);l([u({reflect:!0})],Se.prototype,"value",2);l([u({type:Boolean,reflect:!0})],Se.prototype,"disabled",2);l([S("disabled")],Se.prototype,"handleDisabledChange",1);l([S("selected")],Se.prototype,"handleSelectedChange",1);l([S("value")],Se.prototype,"handleValueChange",1);Se.define("sl-option");var fl=$`
  :host {
    --size: 25rem;
...
`;function*rr(e=document.activeElement){e!=null&&(yield e,"shadowRoot"in e&&e.shadowRoot&&e.shadowRoot.mode!=="closed"&&(yield*Ho(rr(e.shadowRoot.activeElement))))}function Ma(){return[...rr()].pop()}var Hr=new WeakMap;function Pa(e){let t=Hr.get(e);return t||(t=window.getComputedStyle(e,null),Hr.set(e,t)),t}function bl(e){if(typeof e.checkVisibility=="function")return e.checkVisibility({checkOpacity:!1,checkVisibilityCSS:!0});const t=Pa(e);return t.visibility!=="hidden"&&t.display!=="none"}function gl(e){const t=Pa(e),{overflowY:i,overflowX:s}=t;return i==="scroll"||s==="scroll"?!0:i!=="auto"||s!=="auto"?!1:e.scrollHeight>e.clientHeight&&i==="auto"||e.scrollWidth>e.clientWidth&&s==="auto"}function vl(e){const t=e.tagName.toLowerCase(),i=Number(e.getAttribute("tabindex"));if(e.hasAttribute("tabindex")&&(isNaN(i)||i<=-1)||e.hasAttribute("disabled")||e.closest("[inert]"))return!1;if(t==="input"&&e.getAttribute("type")==="radio"){const a=e.getRootNode(),o=`input[type='radio'][name="${e.getAttribute("name")}"]`,n=a.querySelector(`${o}:checked`);return n?n===e:a.querySelector(o)===e}return bl(e)?(t==="audio"||t==="video")&&e.hasAttribute("controls")||e.hasAttribute("tabindex")||e.hasAttribute("contenteditable")&&e.getAttribute("contenteditable")!=="false"||["button","input","select","textarea","a","audio","video","summary","iframe"].includes(t)?!0:gl(e):!1}function yl(e){var t,i;const s=Ns(e),r=(t=s[0])!=null?t:null,a=(i=s[s.length-1])!=null?i:null;return{start:r,end:a}}function wl(e,t){var i;return((i=e.getRootNode({composed:!0}))==null?void 0:i.host)!==t}function Ns(e){const t=new WeakMap,i=[];function s(r){if(r instanceof Element){if(r.hasAttribute("inert")||r.closest("[inert]")||t.has(r))return;t.set(r,!0),!i.includes(r)&&vl(r)&&i.push(r),r instanceof HTMLSlotElement&&wl(r,e)&&r.assignedElements({flatten:!0}).forEach(a=>{s(a)}),r.shadowRoot!==null&&r.shadowRoot.mode==="open"&&s(r.shadowRoot)}for(const a of r.children)s(a)}return s(e),i.sort((r,a)=>{const o=Number(r.getAttribute("tabindex"))||0;return(Number(a.getAttribute("tabindex"))||0)-o})}var Xt=[],La=class{constructor(e){this.tabDirection="forward",this.handleFocusIn=()=>{this.isActive()&&this.checkFocus()},this.handleKeyDown=t=>{var i;if(t.key!=="Tab"||this.isExternalActivated||!this.isActive())return;const s=Ma();if(this.previousFocus=s,this.previousFocus&&this.possiblyHasTabbableChildren(this.previousFocus))return;t.shiftKey?this.tabDirection="backward":this.tabDirection="forward";const r=Ns(this.element);let a=r.findIndex(n=>n===s);this.previousFocus=this.currentFocus;const o=this.tabDirection==="forward"?1:-1;for(;;){a+o>=r.length?a=0:a+o<0?a=r.length-1:a+=o,this.previousFocus=this.currentFocus;const n=r[a];if(this.tabDirection==="backward"&&this.previousFocus&&this.possiblyHasTabbableChildren(this.previousFocus)||n&&this.possiblyHasTabbableChildren(n))return;t.preventDefault(),this.currentFocus=n,(i=this.currentFocus)==null||i.focus({preventScroll:!1});const h=[...rr()];if(h.includes(this.currentFocus)||!h.includes(this.previousFocus))break}setTimeout(()=>this.checkFocus())},this.handleKeyUp=()=>{this.tabDirection="forward"},this.element=e,this.elementsWithTabbableControls=["iframe"]}activate(){Xt.push(this.element),document.addEventListener("focusin",this.handleFocusIn),document.addEventListener("keydown",this.handleKeyDown),document.addEventListener("keyup",this.handleKeyUp)}deactivate(){Xt=Xt.filter(e=>e!==this.element),this.currentFocus=null,document.removeEventListener("focusin",this.handleFocusIn),document.removeEventListener("keydown",this.handleKeyDown),document.removeEventListener("keyup",this.handleKeyUp)}isActive(){return Xt[Xt.length-1]===this.element}activateExternal(){this.isExternalActivated=!0}deactivateExternal(){this.isExternalActivated=!1}checkFocus(){if(this.isActive()&&!this.isExternalActivated){const e=Ns(this.element);if(!this.element.matches(":focus-within")){const t=e[0],i=e[e.length-1],s=this.tabDirection==="forward"?t:i;typeof(s==null?void 0:s.focus)=="function"&&(this.currentFocus=s,s.focus({preventScroll:!1}))}}}possiblyHasTabbableChildren(e){return this.elementsWithTabbableControls.includes(e.tagName.toLowerCase())||e.hasAttribute("controls")}},ar=e=>{var t;const{activeElement:i}=document;i&&e.contains(i)&&((t=document.activeElement)==null||t.blur())};function jr(e){return e.charAt(0).toUpperCase()+e.slice(1)}var xe=class extends P{constructor(){super(...arguments),this.hasSlotController=new rt(this,"footer"),this.localize=new ne(this),this.modal=new La(this),this.open=!1,this.label="",this.placement="end",this.contained=!1,this.noHeader=!1,this.handleDocumentKeyDown=e=>{this.contained||e.key==="Escape"&&this.modal.isActive()&&this.open&&(e.stopImmediatePropagation(),this.requestClose("keyboard"))}}firstUpdated(){this.drawer.hidden=!this.open,this.open&&(this.addOpenListeners(),this.contained||(this.modal.activate(),ii(this)))}disconnectedCallback(){super.disconnectedCallback(),si(this),this.removeOpenListeners()}requestClose(e){if(this.emit("sl-request-close",{cancelable:!0,detail:{source:e}}).defaultPrevented){const i=G(this,"drawer.denyClose",{dir:this.localize.dir()});X(this.panel,i.keyframes,i.options);return}this.hide()}addOpenListeners(){var e;"CloseWatcher"in window?((e=this.closeWatcher)==null||e.destroy(),this.contained||(this.closeWatcher=new CloseWatcher,this.closeWatcher.onclose=()=>this.requestClose("keyboard"))):document.addEventListener("keydown",this.handleDocumentKeyDown)}removeOpenListeners(){var e;document.removeEventListener("keydown",this.handleDocumentKeyDown),(e=this.closeWatcher)==null||e.destroy()}async handleOpenChange(){if(this.open){this.emit("sl-show"),this.addOpenListeners(),this.originalTrigger=document.activeElement,this.contained||(this.modal.activate(),ii(this));const e=this.querySelector("[autofocus]");e&&e.removeAttribute("autofocus"),await Promise.all([ee(this.drawer),ee(this.overlay)]),this.drawer.hidden=!1,requestAnimationFrame(()=>{this.emit("sl-initial-focus",{cancelable:!0}).defaultPrevented||(e?e.focus({preventScroll:!0}):this.panel.focus({preventScroll:!0})),e&&e.setAttribute("autofocus","")});const t=G(this,`drawer.show${jr(this.placement)}`,{dir:this.localize.dir()}),i=G(this,"drawer.overlay.show",{dir:this.localize.dir()});await Promise.all([X(this.panel,t.keyframes,t.options),X(this.overlay,i.keyframes,i.options)]),this.emit("sl-after-show")}else{ar(this),this.emit("sl-hide"),this.removeOpenListeners(),this.contained||(this.modal.deactivate(),si(this)),await Promise.all([ee(this.drawer),ee(this.overlay)]);const e=G(this,`drawer.hide${jr(this.placement)}`,{dir:this.localize.dir()}),t=G(this,"drawer.overlay.hide",{dir:this.localize.dir()});await Promise.all([X(this.overlay,t.keyframes,t.options).then(()=>{this.overlay.hidden=!0}),X(this.panel,e.keyframes,e.options).then(()=>{this.panel.hidden=!0})]),this.drawer.hidden=!0,this.overlay.hidden=!1,this.panel.hidden=!1;const i=this.originalTrigger;typeof(i==null?void 0:i.focus)=="function"&&setTimeout(()=>i.focus()),this.emit("sl-after-hide")}}handleNoModalChange(){this.open&&!this.contained&&(this.modal.activate(),ii(this)),this.open&&this.contained&&(this.modal.deactivate(),si(this))}async show(){if(!this.open)return this.open=!0,be(this,"sl-after-show")}async hide(){if(this.open)return this.open=!1,be(this,"sl-after-hide")}render(){return c`
    ...
    `}};xe.styles=[H,fl];xe.dependencies={"sl-icon-button":Z};l([C(".drawer")],xe.prototype,"drawer",2);l([C(".drawer__panel")],xe.prototype,"panel",2);l([C(".drawer__overlay")],xe.prototype,"overlay",2);l([u({type:Boolean,reflect:!0})],xe.prototype,"open",2);l([u({reflect:!0})],xe.prototype,"label",2);l([u({reflect:!0})],xe.prototype,"placement",2);l([u({type:Boolean,reflect:!0})],xe.prototype,"contained",2);l([u({attribute:"no-header",type:Boolean,reflect:!0})],xe.prototype,"noHeader",2);l([S("open",{waitUntilFirstUpdate:!0})],xe.prototype,"handleOpenChange",1);l([S("contained",{waitUntilFirstUpdate:!0})],xe.prototype,"handleNoModalChange",1);B("drawer.showTop",{keyframes:[{opacity:0,translate:"0 -100%"},{opacity:1,translate:"0 0"}],options:{duration:250,easing:"ease"}});B("drawer.hideTop",{keyframes:[{opacity:1,translate:"0 0"},{opacity:0,translate:"0 -100%"}],options:{duration:250,easing:"ease"}});B("drawer.showEnd",{keyframes:[{opacity:0,translate:"100%"},{opacity:1,translate:"0"}],rtlKeyframes:[{opacity:0,translate:"-100%"},{opacity:1,translate:"0"}],options:{duration:250,easing:"ease"}});B("drawer.hideEnd",{keyframes:[{opacity:1,translate:"0"},{opacity:0,translate:"100%"}],rtlKeyframes:[{opacity:1,translate:"0"},{opacity:0,translate:"-100%"}],options:{duration:250,easing:"ease"}});B("drawer.showBottom",{keyframes:[{opacity:0,translate:"0 100%"},{opacity:1,translate:"0 0"}],options:{duration:250,easing:"ease"}});B("drawer.hideBottom",{keyframes:[{opacity:1,translate:"0 0"},{opacity:0,translate:"0 100%"}],options:{duration:250,easing:"ease"}});B("drawer.showStart",{keyframes:[{opacity:0,translate:"-100%"},{opacity:1,translate:"0"}],rtlKeyframes:[{opacity:0,translate:"100%"},{opacity:1,translate:"0"}],options:{duration:250,easing:"ease"}});B("drawer.hideStart",{keyframes:[{opacity:1,translate:"0"},{opacity:0,translate:"-100%"}],rtlKeyframes:[{opacity:1,translate:"0"},{opacity:0,translate:"100%"}],options:{duration:250,easing:"ease"}});B("drawer.denyClose",{keyframes:[{scale:1},{scale:1.01},{scale:1}],options:{duration:250}});B("drawer.overlay.show",{keyframes:[{opacity:0},{opacity:1}],options:{duration:250}});B("drawer.overlay.hide",{keyframes:[{opacity:1},{opacity:0}],options:{duration:250}});xe.define("sl-drawer");var kl=$`
  :host {
    --width: 31rem;
    --header-spacing: var(--sl-spacing-large);
    --body-spacing: var(--sl-spacing-large);
...
`,Ke=class extends P{constructor(){super(...arguments),this.hasSlotController=new rt(this,"footer"),this.localize=new ne(this),this.modal=new La(this),this.open=!1,this.label="",this.noHeader=!1,this.handleDocumentKeyDown=e=>{e.key==="Escape"&&this.modal.isActive()&&this.open&&(e.stopPropagation(),this.requestClose("keyboard"))}}firstUpdated(){this.dialog.hidden=!this.open,this.open&&(this.addOpenListeners(),this.modal.activate(),ii(this))}disconnectedCallback(){super.disconnectedCallback(),this.modal.deactivate(),si(this),this.removeOpenListeners()}requestClose(e){if(this.emit("sl-request-close",{cancelable:!0,detail:{source:e}}).defaultPrevented){const i=G(this,"dialog.denyClose",{dir:this.localize.dir()});X(this.panel,i.keyframes,i.options);return}this.hide()}addOpenListeners(){var e;"CloseWatcher"in window?((e=this.closeWatcher)==null||e.destroy(),this.closeWatcher=new CloseWatcher,this.closeWatcher.onclose=()=>this.requestClose("keyboard")):document.addEventListener("keydown",this.handleDocumentKeyDown)}removeOpenListeners(){var e;(e=this.closeWatcher)==null||e.destroy(),document.removeEventListener("keydown",this.handleDocumentKeyDown)}async handleOpenChange(){if(this.open){this.emit("sl-show"),this.addOpenListeners(),this.originalTrigger=document.activeElement,this.modal.activate(),ii(this);const e=this.querySelector("[autofocus]");e&&e.removeAttribute("autofocus"),await Promise.all([ee(this.dialog),ee(this.overlay)]),this.dialog.hidden=!1,requestAnimationFrame(()=>{this.emit("sl-initial-focus",{cancelable:!0}).defaultPrevented||(e?e.focus({preventScroll:!0}):this.panel.focus({preventScroll:!0})),e&&e.setAttribute("autofocus","")});const t=G(this,"dialog.show",{dir:this.localize.dir()}),i=G(this,"dialog.overlay.show",{dir:this.localize.dir()});await Promise.all([X(this.panel,t.keyframes,t.options),X(this.overlay,i.keyframes,i.options)]),this.emit("sl-after-show")}else{ar(this),this.emit("sl-hide"),this.removeOpenListeners(),this.modal.deactivate(),await Promise.all([ee(this.dialog),ee(this.overlay)]);const e=G(this,"dialog.hide",{dir:this.localize.dir()}),t=G(this,"dialog.overlay.hide",{dir:this.localize.dir()});await Promise.all([X(this.overlay,t.keyframes,t.options).then(()=>{this.overlay.hidden=!0}),X(this.panel,e.keyframes,e.options).then(()=>{this.panel.hidden=!0})]),this.dialog.hidden=!0,this.overlay.hidden=!1,this.panel.hidden=!1,si(this);const i=this.originalTrigger;typeof(i==null?void 0:i.focus)=="function"&&setTimeout(()=>i.focus()),this.emit("sl-after-hide")}}async show(){if(!this.open)return this.open=!0,be(this,"sl-after-show")}async hide(){if(this.open)return this.open=!1,be(this,"sl-after-hide")}render(){return c`
    ...
    `}};Ke.styles=[H,kl];Ke.dependencies={"sl-icon-button":Z};l([C(".dialog")],Ke.prototype,"dialog",2);l([C(".dialog__panel")],Ke.prototype,"panel",2);l([C(".dialog__overlay")],Ke.prototype,"overlay",2);l([u({type:Boolean,reflect:!0})],Ke.prototype,"open",2);l([u({reflect:!0})],Ke.prototype,"label",2);l([u({attribute:"no-header",type:Boolean,reflect:!0})],Ke.prototype,"noHeader",2);l([S("open",{waitUntilFirstUpdate:!0})],Ke.prototype,"handleOpenChange",1);B("dialog.show",{keyframes:[{opacity:0,scale:.8},{opacity:1,scale:1}],options:{duration:250,easing:"ease"}});B("dialog.hide",{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.8}],options:{duration:250,easing:"ease"}});B("dialog.denyClose",{keyframes:[{scale:1},{scale:1.02},{scale:1}],options:{duration:250}});B("dialog.overlay.show",{keyframes:[{opacity:0},{opacity:1}],options:{duration:250}});B("dialog.overlay.hide",{keyframes:[{opacity:1},{opacity:0}],options:{duration:250}});Ke.define("sl-dialog");var xl=$`
  :host {
    display: inline-flex;
  }
...
`,mi=class extends P{constructor(){super(...arguments),this.variant="primary",this.pill=!1,this.pulse=!1}render(){return c`
      <span
        part="base"
    ...
    `}};mi.styles=[H,xl];l([u({reflect:!0})],mi.prototype,"variant",2);l([u({type:Boolean,reflect:!0})],mi.prototype,"pill",2);l([u({type:Boolean,reflect:!0})],mi.prototype,"pulse",2);mi.define("sl-badge");var _l=$`
  :host {
    display: contents;
...
`,_e=class wt extends P{constructor(){super(...arguments),this.hasSlotController=new rt(this,"icon","suffix"),this.localize=new ne(this),this.open=!1,this.closable=!1,this.variant="primary",this.duration=1/0,this.remainingTime=this.duration}static get toastStack(){return this.currentToastStack||(this.currentToastStack=Object.assign(document.createElement("div"),{className:"sl-toast-stack"})),this.currentToastStack}firstUpdated(){this.base.hidden=!this.open}restartAutoHide(){this.handleCountdownChange(),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval),this.open&&this.duration<1/0&&(this.autoHideTimeout=window.setTimeout(()=>this.hide(),this.duration),this.remainingTime=this.duration,this.remainingTimeInterval=window.setInterval(()=>{this.remainingTime-=100},100))}pauseAutoHide(){var t;(t=this.countdownAnimation)==null||t.pause(),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval)}resumeAutoHide(){var t;this.duration<1/0&&(this.autoHideTimeout=window.setTimeout(()=>this.hide(),this.remainingTime),this.remainingTimeInterval=window.setInterval(()=>{this.remainingTime-=100},100),(t=this.countdownAnimation)==null||t.play())}handleCountdownChange(){if(this.open&&this.duration<1/0&&this.countdown){const{countdownElement:t}=this,i="100%",s="0";this.countdownAnimation=t.animate([{width:i},{width:s}],{duration:this.duration,easing:"linear"})}}handleCloseClick(){this.hide()}async handleOpenChange(){if(this.open){this.emit("sl-show"),this.duration<1/0&&this.restartAutoHide(),await ee(this.base),this.base.hidden=!1;const{keyframes:t,options:i}=G(this,"alert.show",{dir:this.localize.dir()});await X(this.base,t,i),this.emit("sl-after-show")}else{ar(this),this.emit("sl-hide"),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval),await ee(this.base);const{keyframes:t,options:i}=G(this,"alert.hide",{dir:this.localize.dir()});await X(this.base,t,i),this.base.hidden=!0,this.emit("sl-after-hide")}}handleDurationChange(){this.restartAutoHide()}async show(){if(!this.open)return this.open=!0,be(this,"sl-after-show")}async hide(){if(this.open)return this.open=!1,be(this,"sl-after-hide")}async toast(){return new Promise(t=>{this.handleCountdownChange(),wt.toastStack.parentElement===null&&document.body.append(wt.toastStack),wt.toastStack.appendChild(this),requestAnimationFrame(()=>{this.clientWidth,this.show()}),this.addEventListener("sl-after-hide",()=>{wt.toastStack.removeChild(this),t(),wt.toastStack.querySelector("sl-alert")===null&&wt.toastStack.remove()},{once:!0})})}render(){return c`
    ...
    `}};_e.styles=[H,_l];_e.dependencies={"sl-icon-button":Z};l([C('[part~="base"]')],_e.prototype,"base",2);l([C(".alert__countdown-elapsed")],_e.prototype,"countdownElement",2);l([u({type:Boolean,reflect:!0})],_e.prototype,"open",2);l([u({type:Boolean,reflect:!0})],_e.prototype,"closable",2);l([u({reflect:!0})],_e.prototype,"variant",2);l([u({type:Number})],_e.prototype,"duration",2);l([u({type:String,reflect:!0})],_e.prototype,"countdown",2);l([w()],_e.prototype,"remainingTime",2);l([S("open",{waitUntilFirstUpdate:!0})],_e.prototype,"handleOpenChange",1);l([S("duration")],_e.prototype,"handleDurationChange",1);var Cl=_e;B("alert.show",{keyframes:[{opacity:0,scale:.8},{opacity:1,scale:1}],options:{duration:250,easing:"ease"}});B("alert.hide",{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.8}],options:{duration:250,easing:"ease"}});Cl.define("sl-alert");var $l=$`
  :host {
    display: block;
  }
...
`,A=class extends P{constructor(){super(...arguments),this.formControlController=new hi(this,{assumeInteractionOn:["sl-blur","sl-input"]}),this.hasSlotController=new rt(this,"help-text","label"),this.hasFocus=!1,this.title="",this.name="",this.value="",this.size="medium",this.filled=!1,this.label="",this.helpText="",this.placeholder="",this.rows=4,this.resize="vertical",this.disabled=!1,this.readonly=!1,this.form="",this.required=!1,this.spellcheck=!0,this.defaultValue=""}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(()=>this.setTextareaHeight()),this.updateComplete.then(()=>{this.setTextareaHeight(),this.resizeObserver.observe(this.input)})}firstUpdated(){this.formControlController.updateValidity()}disconnectedCallback(){var e;super.disconnectedCallback(),this.input&&((e=this.resizeObserver)==null||e.unobserve(this.input))}handleBlur(){this.hasFocus=!1,this.emit("sl-blur")}handleChange(){this.value=this.input.value,this.setTextareaHeight(),this.emit("sl-change")}handleFocus(){this.hasFocus=!0,this.emit("sl-focus")}handleInput(){this.value=this.input.value,this.emit("sl-input")}handleInvalid(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)}setTextareaHeight(){this.resize==="auto"?(this.sizeAdjuster.style.height=`${this.input.clientHeight}px`,this.input.style.height="auto",this.input.style.height=`${this.input.scrollHeight}px`):this.input.style.height=""}handleDisabledChange(){this.formControlController.setValidity(this.disabled)}handleRowsChange(){this.setTextareaHeight()}async handleValueChange(){await this.updateComplete,this.formControlController.updateValidity(),this.setTextareaHeight()}focus(e){this.input.focus(e)}blur(){this.input.blur()}select(){this.input.select()}scrollPosition(e){if(e){typeof e.top=="number"&&(this.input.scrollTop=e.top),typeof e.left=="number"&&(this.input.scrollLeft=e.left);return}return{top:this.input.scrollTop,left:this.input.scrollTop}}setSelectionRange(e,t,i="none"){this.input.setSelectionRange(e,t,i)}setRangeText(e,t,i,s="preserve"){const r=t??this.input.selectionStart,a=i??this.input.selectionEnd;this.input.setRangeText(e,r,a,s),this.value!==this.input.value&&(this.value=this.input.value,this.setTextareaHeight())}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(e){this.input.setCustomValidity(e),this.formControlController.updateValidity()}render(){const e=this.hasSlotController.test("label"),t=this.hasSlotController.test("help-text"),i=this.label?!0:!!e,s=this.helpText?!0:!!t;return c`
    ...
    `}};A.styles=[H,ts,$l];l([C(".textarea__control")],A.prototype,"input",2);l([C(".textarea__size-adjuster")],A.prototype,"sizeAdjuster",2);l([w()],A.prototype,"hasFocus",2);l([u()],A.prototype,"title",2);l([u()],A.prototype,"name",2);l([u()],A.prototype,"value",2);l([u({reflect:!0})],A.prototype,"size",2);l([u({type:Boolean,reflect:!0})],A.prototype,"filled",2);l([u()],A.prototype,"label",2);l([u({attribute:"help-text"})],A.prototype,"helpText",2);l([u()],A.prototype,"placeholder",2);l([u({type:Number})],A.prototype,"rows",2);l([u()],A.prototype,"resize",2);l([u({type:Boolean,reflect:!0})],A.prototype,"disabled",2);l([u({type:Boolean,reflect:!0})],A.prototype,"readonly",2);l([u({reflect:!0})],A.prototype,"form",2);l([u({type:Boolean,reflect:!0})],A.prototype,"required",2);l([u({type:Number})],A.prototype,"minlength",2);l([u({type:Number})],A.prototype,"maxlength",2);l([u()],A.prototype,"autocapitalize",2);l([u()],A.prototype,"autocorrect",2);l([u()],A.prototype,"autocomplete",2);l([u({type:Boolean})],A.prototype,"autofocus",2);l([u()],A.prototype,"enterkeyhint",2);l([u({type:Boolean,converter:{fromAttribute:e=>!(!e||e==="false"),toAttribute:e=>e?"true":"false"}})],A.prototype,"spellcheck",2);l([u()],A.prototype,"inputmode",2);l([Qs()],A.prototype,"defaultValue",2);l([S("disabled",{waitUntilFirstUpdate:!0})],A.prototype,"handleDisabledChange",1);l([S("rows",{waitUntilFirstUpdate:!0})],A.prototype,"handleRowsChange",1);l([S("value",{waitUntilFirstUpdate:!0})],A.prototype,"handleValueChange",1);A.define("sl-textarea");var Tl=$`
  :host {
    display: inline-block;
  }
...
`,le=class extends P{constructor(){super(...arguments),this.localize=new ne(this),this.open=!1,this.placement="bottom-start",this.disabled=!1,this.stayOpenOnSelect=!1,this.distance=0,this.skidding=0,this.hoist=!1,this.sync=void 0,this.handleKeyDown=e=>{this.open&&e.key==="Escape"&&(e.stopPropagation(),this.hide(),this.focusOnTrigger())},this.handleDocumentKeyDown=e=>{var t;if(e.key==="Escape"&&this.open&&!this.closeWatcher){e.stopPropagation(),this.focusOnTrigger(),this.hide();return}if(e.key==="Tab"){if(this.open&&((t=document.activeElement)==null?void 0:t.tagName.toLowerCase())==="sl-menu-item"){e.preventDefault(),this.hide(),this.focusOnTrigger();return}const i=(s,r)=>{if(!s)return null;const a=s.closest(r);if(a)return a;const o=s.getRootNode();return o instanceof ShadowRoot?i(o.host,r):null};setTimeout(()=>{var s;const r=((s=this.containingElement)==null?void 0:s.getRootNode())instanceof ShadowRoot?Ma():document.activeElement;(!this.containingElement||i(r,this.containingElement.tagName.toLowerCase())!==this.containingElement)&&this.hide()})}},this.handleDocumentMouseDown=e=>{const t=e.composedPath();this.containingElement&&!t.includes(this.containingElement)&&this.hide()},this.handlePanelSelect=e=>{const t=e.target;!this.stayOpenOnSelect&&t.tagName.toLowerCase()==="sl-menu"&&(this.hide(),this.focusOnTrigger())}}connectedCallback(){super.connectedCallback(),this.containingElement||(this.containingElement=this)}firstUpdated(){this.panel.hidden=!this.open,this.open&&(this.addOpenListeners(),this.popup.active=!0)}disconnectedCallback(){super.disconnectedCallback(),this.removeOpenListeners(),this.hide()}focusOnTrigger(){const e=this.trigger.assignedElements({flatten:!0})[0];typeof(e==null?void 0:e.focus)=="function"&&e.focus()}getMenu(){return this.panel.assignedElements({flatten:!0}).find(e=>e.tagName.toLowerCase()==="sl-menu")}handleTriggerClick(){this.open?this.hide():(this.show(),this.focusOnTrigger())}async handleTriggerKeyDown(e){if([" ","Enter"].includes(e.key)){e.preventDefault(),this.handleTriggerClick();return}const t=this.getMenu();if(t){const i=t.getAllItems(),s=i[0],r=i[i.length-1];["ArrowDown","ArrowUp","Home","End"].includes(e.key)&&(e.preventDefault(),this.open||(this.show(),await this.updateComplete),i.length>0&&this.updateComplete.then(()=>{(e.key==="ArrowDown"||e.key==="Home")&&(t.setCurrentItem(s),s.focus()),(e.key==="ArrowUp"||e.key==="End")&&(t.setCurrentItem(r),r.focus())}))}}handleTriggerKeyUp(e){e.key===" "&&e.preventDefault()}handleTriggerSlotChange(){this.updateAccessibleTrigger()}updateAccessibleTrigger(){const t=this.trigger.assignedElements({flatten:!0}).find(s=>yl(s).start);let i;if(t){switch(t.tagName.toLowerCase()){case"sl-button":case"sl-icon-button":i=t.button;break;default:i=t}i.setAttribute("aria-haspopup","true"),i.setAttribute("aria-expanded",this.open?"true":"false")}}async show(){if(!this.open)return this.open=!0,be(this,"sl-after-show")}async hide(){if(this.open)return this.open=!1,be(this,"sl-after-hide")}reposition(){this.popup.reposition()}addOpenListeners(){var e;this.panel.addEventListener("sl-select",this.handlePanelSelect),"CloseWatcher"in window?((e=this.closeWatcher)==null||e.destroy(),this.closeWatcher=new CloseWatcher,this.closeWatcher.onclose=()=>{this.hide(),this.focusOnTrigger()}):this.panel.addEventListener("keydown",this.handleKeyDown),document.addEventListener("keydown",this.handleDocumentKeyDown),document.addEventListener("mousedown",this.handleDocumentMouseDown)}removeOpenListeners(){var e;this.panel&&(this.panel.removeEventListener("sl-select",this.handlePanelSelect),this.panel.removeEventListener("keydown",this.handleKeyDown)),document.removeEventListener("keydown",this.handleDocumentKeyDown),document.removeEventListener("mousedown",this.handleDocumentMouseDown),(e=this.closeWatcher)==null||e.destroy()}async handleOpenChange(){if(this.disabled){this.open=!1;return}if(this.updateAccessibleTrigger(),this.open){this.emit("sl-show"),this.addOpenListeners(),await ee(this),this.panel.hidden=!1,this.popup.active=!0;const{keyframes:e,options:t}=G(this,"dropdown.show",{dir:this.localize.dir()});await X(this.popup.popup,e,t),this.emit("sl-after-show")}else{this.emit("sl-hide"),this.removeOpenListeners(),await ee(this);const{keyframes:e,options:t}=G(this,"dropdown.hide",{dir:this.localize.dir()});await X(this.popup.popup,e,t),this.panel.hidden=!0,this.popup.active=!1,this.emit("sl-after-hide")}}render(){return c`
      <sl-popup
        part="base"
    ...
    `}};le.styles=[H,Tl];le.dependencies={"sl-popup":F};l([C(".dropdown")],le.prototype,"popup",2);l([C(".dropdown__trigger")],le.prototype,"trigger",2);l([C(".dropdown__panel")],le.prototype,"panel",2);l([u({type:Boolean,reflect:!0})],le.prototype,"open",2);l([u({reflect:!0})],le.prototype,"placement",2);l([u({type:Boolean,reflect:!0})],le.prototype,"disabled",2);l([u({attribute:"stay-open-on-select",type:Boolean,reflect:!0})],le.prototype,"stayOpenOnSelect",2);l([u({attribute:!1})],le.prototype,"containingElement",2);l([u({type:Number})],le.prototype,"distance",2);l([u({type:Number})],le.prototype,"skidding",2);l([u({type:Boolean})],le.prototype,"hoist",2);l([u({reflect:!0})],le.prototype,"sync",2);l([S("open",{waitUntilFirstUpdate:!0})],le.prototype,"handleOpenChange",1);B("dropdown.show",{keyframes:[{opacity:0,scale:.9},{opacity:1,scale:1}],options:{duration:100,easing:"ease"}});B("dropdown.hide",{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.9}],options:{duration:100,easing:"ease"}});le.define("sl-dropdown");var Sl=$`
  :host {
    display: block;
    position: relative;
    background: var(--sl-panel-background-color);
...
`,or=class extends P{connectedCallback(){super.connectedCallback(),this.setAttribute("role","menu")}handleClick(e){const t=["menuitem","menuitemcheckbox"],i=e.composedPath(),s=i.find(n=>{var h;return t.includes(((h=n==null?void 0:n.getAttribute)==null?void 0:h.call(n,"role"))||"")});if(!s||i.find(n=>{var h;return((h=n==null?void 0:n.getAttribute)==null?void 0:h.call(n,"role"))==="menu"})!==this)return;const o=s;o.type==="checkbox"&&(o.checked=!o.checked),this.emit("sl-select",{detail:{item:o}})}handleKeyDown(e){if(e.key==="Enter"||e.key===" "){const t=this.getCurrentItem();e.preventDefault(),e.stopPropagation(),t==null||t.click()}else if(["ArrowDown","ArrowUp","Home","End"].includes(e.key)){const t=this.getAllItems(),i=this.getCurrentItem();let s=i?t.indexOf(i):0;t.length>0&&(e.preventDefault(),e.stopPropagation(),e.key==="ArrowDown"?s++:e.key==="ArrowUp"?s--:e.key==="Home"?s=0:e.key==="End"&&(s=t.length-1),s<0&&(s=t.length-1),s>t.length-1&&(s=0),this.setCurrentItem(t[s]),t[s].focus())}}handleMouseDown(e){const t=e.target;this.isMenuItem(t)&&this.setCurrentItem(t)}handleSlotChange(){const e=this.getAllItems();e.length>0&&this.setCurrentItem(e[0])}isMenuItem(e){var t;return e.tagName.toLowerCase()==="sl-menu-item"||["menuitem","menuitemcheckbox","menuitemradio"].includes((t=e.getAttribute("role"))!=null?t:"")}getAllItems(){return[...this.defaultSlot.assignedElements({flatten:!0})].filter(e=>!(e.inert||!this.isMenuItem(e)))}getCurrentItem(){return this.getAllItems().find(e=>e.getAttribute("tabindex")==="0")}setCurrentItem(e){this.getAllItems().forEach(i=>{i.setAttribute("tabindex",i===e?"0":"-1")})}render(){return c`
      ...
      ></slot>
    `}};or.styles=[H,Sl];l([C("slot")],or.prototype,"defaultSlot",2);or.define("sl-menu");var El=$`
  :host {
    --submenu-offset: -2px;
 ...
 */const Il=()=>new Dl;class Dl{}const $s=new WeakMap,Ml=Ji(class extends Ol{render(e){return g}update(e,[t]){var s;const i=t!==this.G;return i&&this.G!==void 0&&this.rt(void 0),(i||this.lt!==this.ct)&&(this.G=t,this.ht=(s=e.options)==null?void 0:s.host,this.rt(this.ct=e.element)),g}rt(e){if(this.isConnected||(e=void 0),typeof this.G=="function"){const t=this.ht??globalThis;let i=$s.get(t);i===void 0&&(i=new WeakMap,$s.set(t,i)),i.get(this.G)!==void 0&&this.G.call(this.ht,void 0),i.set(this.G,e),e!==void 0&&this.G.call(this.ht,e)}else this.G.value=e}get lt(){var e,t;return typeof this.G=="function"?(e=$s.get(this.ht??globalThis))==null?void 0:e.get(this.G):(t=this.G)==null?void 0:t.value}disconnected(){this.lt===this.ct&&this.rt(void 0)}reconnected(){this.rt(this.ct)}});var Pl=class{constructor(e,t){this.popupRef=Il(),this.enableSubmenuTimer=-1,this.isConnected=!1,this.isPopupConnected=!1,this.skidding=0,this.submenuOpenDelay=100,this.handleMouseMove=i=>{this.host.style.setProperty("--safe-triangle-cursor-x",`${i.clientX}px`),this.host.style.setProperty("--safe-triangle-cursor-y",`${i.clientY}px`)},this.handleMouseOver=()=>{this.hasSlotController.test("submenu")&&this.enableSubmenu()},this.handleKeyDown=i=>{switch(i.key){case"Escape":case"Tab":this.disableSubmenu();break;case"ArrowLeft":i.target!==this.host&&(i.preventDefault(),i.stopPropagation(),this.host.focus(),this.disableSubmenu());break;case"ArrowRight":case"Enter":case" ":this.handleSubmenuEntry(i);break}},this.handleClick=i=>{var s;i.target===this.host?(i.preventDefault(),i.stopPropagation()):i.target instanceof Element&&(i.target.tagName==="sl-menu-item"||(s=i.target.role)!=null&&s.startsWith("menuitem"))&&this.disableSubmenu()},this.handleFocusOut=i=>{i.relatedTarget&&i.relatedTarget instanceof Element&&this.host.contains(i.relatedTarget)||this.disableSubmenu()},this.handlePopupMouseover=i=>{i.stopPropagation()},this.handlePopupReposition=()=>{const i=this.host.renderRoot.querySelector("slot[name='submenu']"),s=i==null?void 0:i.assignedElements({flatten:!0}).filter(d=>d.localName==="sl-menu")[0],r=getComputedStyle(this.host).direction==="rtl";if(!s)return;const{left:a,top:o,width:n,height:h}=s.getBoundingClientRect();this.host.style.setProperty("--safe-triangle-submenu-start-x",`${r?a+n:a}px`),this.host.style.setProperty("--safe-triangle-submenu-start-y",`${o}px`),this.host.style.setProperty("--safe-triangle-submenu-end-x",`${r?a+n:a}px`),this.host.style.setProperty("--safe-triangle-submenu-end-y",`${o+h}px`)},(this.host=e).addController(this),this.hasSlotController=t}hostConnected(){this.hasSlotController.test("submenu")&&!this.host.disabled&&this.addListeners()}hostDisconnected(){this.removeListeners()}hostUpdated(){this.hasSlotController.test("submenu")&&!this.host.disabled?(this.addListeners(),this.updateSkidding()):this.removeListeners()}addListeners(){this.isConnected||(this.host.addEventListener("mousemove",this.handleMouseMove),this.host.addEventListener("mouseover",this.handleMouseOver),this.host.addEventListener("keydown",this.handleKeyDown),this.host.addEventListener("click",this.handleClick),this.host.addEventListener("focusout",this.handleFocusOut),this.isConnected=!0),this.isPopupConnected||this.popupRef.value&&(this.popupRef.value.addEventListener("mouseover",this.handlePopupMouseover),this.popupRef.value.addEventListener("sl-reposition",this.handlePopupReposition),this.isPopupConnected=!0)}removeListeners(){this.isConnected&&(this.host.removeEventListener("mousemove",this.handleMouseMove),this.host.removeEventListener("mouseover",this.handleMouseOver),this.host.removeEventListener("keydown",this.handleKeyDown),this.host.removeEventListener("click",this.handleClick),this.host.removeEventListener("focusout",this.handleFocusOut),this.isConnected=!1),this.isPopupConnected&&this.popupRef.value&&(this.popupRef.value.removeEventListener("mouseover",this.handlePopupMouseover),this.popupRef.value.removeEventListener("sl-reposition",this.handlePopupReposition),this.isPopupConnected=!1)}handleSubmenuEntry(e){const t=this.host.renderRoot.querySelector("slot[name='submenu']");if(!t){console.error("Cannot activate a submenu if no corresponding menuitem can be found.",this);return}let i=null;for(const s of t.assignedElements())if(i=s.querySelectorAll("sl-menu-item, [role^='menuitem']"),i.length!==0)break;if(!(!i||i.length===0)){i[0].setAttribute("tabindex","0");for(let s=1;s!==i.length;++s)i[s].setAttribute("tabindex","-1");this.popupRef.value&&(e.preventDefault(),e.stopPropagation(),this.popupRef.value.active?i[0]instanceof HTMLElement&&i[0].focus():(this.enableSubmenu(!1),this.host.updateComplete.then(()=>{i[0]instanceof HTMLElement&&i[0].focus()}),this.host.requestUpdate()))}}setSubmenuState(e){this.popupRef.value&&this.popupRef.value.active!==e&&(this.popupRef.value.active=e,this.host.requestUpdate())}enableSubmenu(e=!0){e?(window.clearTimeout(this.enableSubmenuTimer),this.enableSubmenuTimer=window.setTimeout(()=>{this.setSubmenuState(!0)},this.submenuOpenDelay)):this.setSubmenuState(!0)}disableSubmenu(){window.clearTimeout(this.enableSubmenuTimer),this.setSubmenuState(!1)}updateSkidding(){var e;if(!((e=this.host.parentElement)!=null&&e.computedStyleMap))return;const t=this.host.parentElement.computedStyleMap(),s=["padding-top","border-top-width","margin-top"].reduce((r,a)=>{var o;const n=(o=t.get(a))!=null?o:new CSSUnitValue(0,"px"),d=(n instanceof CSSUnitValue?n:new CSSUnitValue(0,"px")).to("px");return r-d.value},0);this.skidding=s}isExpanded(){return this.popupRef.value?this.popupRef.value.active:!1}renderSubmenu(){const e=getComputedStyle(this.host).direction==="rtl";return this.isConnected?c`
    ...
    `}};Ce.styles=[H,El];Ce.dependencies={"sl-icon":se,"sl-popup":F,"sl-spinner":Zi};l([C("slot:not([name])")],Ce.prototype,"defaultSlot",2);l([C(".menu-item")],Ce.prototype,"menuItem",2);l([u()],Ce.prototype,"type",2);l([u({type:Boolean,reflect:!0})],Ce.prototype,"checked",2);l([u()],Ce.prototype,"value",2);l([u({type:Boolean,reflect:!0})],Ce.prototype,"loading",2);l([u({type:Boolean,reflect:!0})],Ce.prototype,"disabled",2);l([S("checked")],Ce.prototype,"handleCheckedChange",1);l([S("disabled")],Ce.prototype,"handleDisabledChange",1);l([S("type")],Ce.prototype,"handleTypeChange",1);Ce.define("sl-menu-item");se.define("sl-icon");var Ll=$`
  :host {
...
`,ns=class extends P{constructor(){super(...arguments),this.vertical=!1}connectedCallback(){super.connectedCallback(),this.setAttribute("role","separator")}handleVerticalChange(){this.setAttribute("aria-orientation",this.vertical?"vertical":"horizontal")}};ns.styles=[H,Ll];l([u({type:Boolean,reflect:!0})],ns.prototype,"vertical",2);l([S("vertical")],ns.prototype,"handleVerticalChange",1);ns.define("sl-divider");var Fl=$`
  :host {
    --max-width: 20rem;
    --hide-delay: 0ms;
    --show-delay: 150ms;
...
`,re=class extends P{constructor(){super(),this.localize=new ne(this),this.content="",this.placement="top",this.disabled=!1,this.distance=8,this.open=!1,this.skidding=0,this.trigger="hover focus",this.hoist=!1,this.handleBlur=()=>{this.hasTrigger("focus")&&this.hide()},this.handleClick=()=>{this.hasTrigger("click")&&(this.open?this.hide():this.show())},this.handleFocus=()=>{this.hasTrigger("focus")&&this.show()},this.handleDocumentKeyDown=e=>{e.key==="Escape"&&(e.stopPropagation(),this.hide())},this.handleMouseOver=()=>{if(this.hasTrigger("hover")){const e=Nr(getComputedStyle(this).getPropertyValue("--show-delay"));clearTimeout(this.hoverTimeout),this.hoverTimeout=window.setTimeout(()=>this.show(),e)}},this.handleMouseOut=()=>{if(this.hasTrigger("hover")){const e=Nr(getComputedStyle(this).getPropertyValue("--hide-delay"));clearTimeout(this.hoverTimeout),this.hoverTimeout=window.setTimeout(()=>this.hide(),e)}},this.addEventListener("blur",this.handleBlur,!0),this.addEventListener("focus",this.handleFocus,!0),this.addEventListener("click",this.handleClick),this.addEventListener("mouseover",this.handleMouseOver),this.addEventListener("mouseout",this.handleMouseOut)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this.closeWatcher)==null||e.destroy(),document.removeEventListener("keydown",this.handleDocumentKeyDown)}firstUpdated(){this.body.hidden=!this.open,this.open&&(this.popup.active=!0,this.popup.reposition())}hasTrigger(e){return this.trigger.split(" ").includes(e)}async handleOpenChange(){var e,t;if(this.open){if(this.disabled)return;this.emit("sl-show"),"CloseWatcher"in window?((e=this.closeWatcher)==null||e.destroy(),this.closeWatcher=new CloseWatcher,this.closeWatcher.onclose=()=>{this.hide()}):document.addEventListener("keydown",this.handleDocumentKeyDown),await ee(this.body),this.body.hidden=!1,this.popup.active=!0;const{keyframes:i,options:s}=G(this,"tooltip.show",{dir:this.localize.dir()});await X(this.popup.popup,i,s),this.popup.reposition(),this.emit("sl-after-show")}else{this.emit("sl-hide"),(t=this.closeWatcher)==null||t.destroy(),document.removeEventListener("keydown",this.handleDocumentKeyDown),await ee(this.body);const{keyframes:i,options:s}=G(this,"tooltip.hide",{dir:this.localize.dir()});await X(this.popup.popup,i,s),this.popup.active=!1,this.body.hidden=!0,this.emit("sl-after-hide")}}async handleOptionsChange(){this.hasUpdated&&(await this.updateComplete,this.popup.reposition())}handleDisabledChange(){this.disabled&&this.open&&this.hide()}async show(){if(!this.open)return this.open=!0,be(this,"sl-after-show")}async hide(){if(this.open)return this.open=!1,be(this,"sl-after-hide")}render(){return c`
    ...
    `}};re.styles=[H,Fl];re.dependencies={"sl-popup":F};l([C("slot:not([name])")],re.prototype,"defaultSlot",2);l([C(".tooltip__body")],re.prototype,"body",2);l([C("sl-popup")],re.prototype,"popup",2);l([u()],re.prototype,"content",2);l([u()],re.prototype,"placement",2);l([u({type:Boolean,reflect:!0})],re.prototype,"disabled",2);l([u({type:Number})],re.prototype,"distance",2);l([u({type:Boolean,reflect:!0})],re.prototype,"open",2);l([u({type:Number})],re.prototype,"skidding",2);l([u()],re.prototype,"trigger",2);l([u({type:Boolean})],re.prototype,"hoist",2);l([S("open",{waitUntilFirstUpdate:!0})],re.prototype,"handleOpenChange",1);l([S(["content","distance","hoist","placement","skidding"])],re.prototype,"handleOptionsChange",1);l([S("disabled")],re.prototype,"handleDisabledChange",1);B("tooltip.show",{keyframes:[{opacity:0,scale:.8},{opacity:1,scale:1}],options:{duration:150,easing:"ease"}});B("tooltip.hide",{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.8}],options:{duration:150,easing:"ease"}});re.define("sl-tooltip");var Nl=$`
  :host {
    display: inline-block;
  }
...
`,ie=class extends P{constructor(){super(...arguments),this.formControlController=new hi(this,{value:e=>e.checked?e.value||"on":void 0,defaultValue:e=>e.defaultChecked,setValue:(e,t)=>e.checked=t}),this.hasSlotController=new rt(this,"help-text"),this.hasFocus=!1,this.title="",this.name="",this.size="medium",this.disabled=!1,this.checked=!1,this.indeterminate=!1,this.defaultChecked=!1,this.form="",this.required=!1,this.helpText=""}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}firstUpdated(){this.formControlController.updateValidity()}handleClick(){this.checked=!this.checked,this.indeterminate=!1,this.emit("sl-change")}handleBlur(){this.hasFocus=!1,this.emit("sl-blur")}handleInput(){this.emit("sl-input")}handleInvalid(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)}handleFocus(){this.hasFocus=!0,this.emit("sl-focus")}handleDisabledChange(){this.formControlController.setValidity(this.disabled)}handleStateChange(){this.input.checked=this.checked,this.input.indeterminate=this.indeterminate,this.formControlController.updateValidity()}click(){this.input.click()}focus(e){this.input.focus(e)}blur(){this.input.blur()}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(e){this.input.setCustomValidity(e),this.formControlController.updateValidity()}render(){const e=this.hasSlotController.test("help-text"),t=this.helpText?!0:!!e;return c`
    ...
    `}};ie.styles=[H,ts,Nl];ie.dependencies={"sl-icon":se};l([C('input[type="checkbox"]')],ie.prototype,"input",2);l([w()],ie.prototype,"hasFocus",2);l([u()],ie.prototype,"title",2);l([u()],ie.prototype,"name",2);l([u()],ie.prototype,"value",2);l([u({reflect:!0})],ie.prototype,"size",2);l([u({type:Boolean,reflect:!0})],ie.prototype,"disabled",2);l([u({type:Boolean,reflect:!0})],ie.prototype,"checked",2);l([u({type:Boolean,reflect:!0})],ie.prototype,"indeterminate",2);l([Qs("checked")],ie.prototype,"defaultChecked",2);l([u({reflect:!0})],ie.prototype,"form",2);l([u({type:Boolean,reflect:!0})],ie.prototype,"required",2);l([u({attribute:"help-text"})],ie.prototype,"helpText",2);l([S("disabled",{waitUntilFirstUpdate:!0})],ie.prototype,"handleDisabledChange",1);l([S(["checked","indeterminate"],{waitUntilFirstUpdate:!0})],ie.prototype,"handleStateChange",1);ie.define("sl-checkbox");var Bl=$`
  :host {
    --indicator-color: var(--sl-color-primary-600);
...
`,ls=class extends P{constructor(){super(...arguments),this.observedElements=[],this.disabled=!1}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(e=>{this.emit("sl-resize",{detail:{entries:e}})}),this.disabled||this.startObserver()}disconnectedCallback(){super.disconnectedCallback(),this.stopObserver()}handleSlotChange(){this.disabled||this.startObserver()}startObserver(){const e=this.shadowRoot.querySelector("slot");if(e!==null){const t=e.assignedElements({flatten:!0});this.observedElements.forEach(i=>this.resizeObserver.unobserve(i)),this.observedElements=[],t.forEach(i=>{this.resizeObserver.observe(i),this.observedElements.push(i)})}}stopObserver(){this.resizeObserver.disconnect()}handleDisabledChange(){this.disabled?this.stopObserver():this.startObserver()}render(){return c` <slot @slotchange=${this.handleSlotChange}></slot> `}};ls.styles=[H,Hl];l([u({type:Boolean,reflect:!0})],ls.prototype,"disabled",2);l([S("disabled",{waitUntilFirstUpdate:!0})],ls.prototype,"handleDisabledChange",1);var ae=class extends P{constructor(){super(...arguments),this.tabs=[],this.focusableTabs=[],this.panels=[],this.localize=new ne(this),this.hasScrollControls=!1,this.shouldHideScrollStartButton=!1,this.shouldHideScrollEndButton=!1,this.placement="top",this.activation="auto",this.noScrollControls=!1,this.fixedScrollControls=!1,this.scrollOffset=1}connectedCallback(){const e=Promise.all([customElements.whenDefined("sl-tab"),customElements.whenDefined("sl-tab-panel")]);super.connectedCallback(),this.resizeObserver=new ResizeObserver(()=>{this.repositionIndicator(),this.updateScrollControls()}),this.mutationObserver=new MutationObserver(t=>{const i=t.filter(({target:s})=>{if(s===this)return!0;if(s.closest("sl-tab-group")!==this)return!1;const r=s.tagName.toLowerCase();return r==="sl-tab"||r==="sl-tab-panel"});if(i.length!==0){if(i.some(s=>!["aria-labelledby","aria-controls"].includes(s.attributeName))&&setTimeout(()=>this.setAriaLabels()),i.some(s=>s.attributeName==="disabled"))this.syncTabsAndPanels();else if(i.some(s=>s.attributeName==="active")){const r=i.filter(a=>a.attributeName==="active"&&a.target.tagName.toLowerCase()==="sl-tab").map(a=>a.target).find(a=>a.active);r&&this.setActiveTab(r)}}}),this.updateComplete.then(()=>{this.syncTabsAndPanels(),this.mutationObserver.observe(this,{attributes:!0,attributeFilter:["active","disabled","name","panel"],childList:!0,subtree:!0}),this.resizeObserver.observe(this.nav),e.then(()=>{new IntersectionObserver((i,s)=>{var r;i[0].intersectionRatio>0&&(this.setAriaLabels(),this.setActiveTab((r=this.getActiveTab())!=null?r:this.tabs[0],{emitEvents:!1}),s.unobserve(i[0].target))}).observe(this.tabGroup)})})}disconnectedCallback(){var e,t;super.disconnectedCallback(),(e=this.mutationObserver)==null||e.disconnect(),this.nav&&((t=this.resizeObserver)==null||t.unobserve(this.nav))}getAllTabs(){return this.shadowRoot.querySelector('slot[name="nav"]').assignedElements()}getAllPanels(){return[...this.body.assignedElements()].filter(e=>e.tagName.toLowerCase()==="sl-tab-panel")}getActiveTab(){return this.tabs.find(e=>e.active)}handleClick(e){const i=e.target.closest("sl-tab");(i==null?void 0:i.closest("sl-tab-group"))===this&&i!==null&&this.setActiveTab(i,{scrollBehavior:"smooth"})}handleKeyDown(e){const i=e.target.closest("sl-tab");if((i==null?void 0:i.closest("sl-tab-group"))===this&&(["Enter"," "].includes(e.key)&&i!==null&&(this.setActiveTab(i,{scrollBehavior:"smooth"}),e.preventDefault()),["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Home","End"].includes(e.key))){const r=this.tabs.find(n=>n.matches(":focus")),a=this.localize.dir()==="rtl";let o=null;if((r==null?void 0:r.tagName.toLowerCase())==="sl-tab"){if(e.key==="Home")o=this.focusableTabs[0];else if(e.key==="End")o=this.focusableTabs[this.focusableTabs.length-1];else if(["top","bottom"].includes(this.placement)&&e.key===(a?"ArrowRight":"ArrowLeft")||["start","end"].includes(this.placement)&&e.key==="ArrowUp"){const n=this.tabs.findIndex(h=>h===r);o=this.findNextFocusableTab(n,"backward")}else if(["top","bottom"].includes(this.placement)&&e.key===(a?"ArrowLeft":"ArrowRight")||["start","end"].includes(this.placement)&&e.key==="ArrowDown"){const n=this.tabs.findIndex(h=>h===r);o=this.findNextFocusableTab(n,"forward")}if(!o)return;o.tabIndex=0,o.focus({preventScroll:!0}),this.activation==="auto"?this.setActiveTab(o,{scrollBehavior:"smooth"}):this.tabs.forEach(n=>{n.tabIndex=n===o?0:-1}),["top","bottom"].includes(this.placement)&&Ds(o,this.nav,"horizontal"),e.preventDefault()}}}handleScrollToStart(){this.nav.scroll({left:this.localize.dir()==="rtl"?this.nav.scrollLeft+this.nav.clientWidth:this.nav.scrollLeft-this.nav.clientWidth,behavior:"smooth"})}handleScrollToEnd(){this.nav.scroll({left:this.localize.dir()==="rtl"?this.nav.scrollLeft-this.nav.clientWidth:this.nav.scrollLeft+this.nav.clientWidth,behavior:"smooth"})}setActiveTab(e,t){if(t=st({emitEvents:!0,scrollBehavior:"auto"},t),e!==this.activeTab&&!e.disabled){const i=this.activeTab;this.activeTab=e,this.tabs.forEach(s=>{s.active=s===this.activeTab,s.tabIndex=s===this.activeTab?0:-1}),this.panels.forEach(s=>{var r;return s.active=s.name===((r=this.activeTab)==null?void 0:r.panel)}),this.syncIndicator(),["top","bottom"].includes(this.placement)&&Ds(this.activeTab,this.nav,"horizontal",t.scrollBehavior),t.emitEvents&&(i&&this.emit("sl-tab-hide",{detail:{name:i.panel}}),this.emit("sl-tab-show",{detail:{name:this.activeTab.panel}}))}}setAriaLabels(){this.tabs.forEach(e=>{const t=this.panels.find(i=>i.name===e.panel);t&&(e.setAttribute("aria-controls",t.getAttribute("id")),t.setAttribute("aria-labelledby",e.getAttribute("id")))})}repositionIndicator(){const e=this.getActiveTab();if(!e)return;const t=e.clientWidth,i=e.clientHeight,s=this.localize.dir()==="rtl",r=this.getAllTabs(),o=r.slice(0,r.indexOf(e)).reduce((n,h)=>({left:n.left+h.clientWidth,top:n.top+h.clientHeight}),{left:0,top:0});switch(this.placement){case"top":case"bottom":this.indicator.style.width=`${t}px`,this.indicator.style.height="auto",this.indicator.style.translate=s?`${-1*o.left}px`:`${o.left}px`;break;case"start":case"end":this.indicator.style.width="auto",this.indicator.style.height=`${i}px`,this.indicator.style.translate=`0 ${o.top}px`;break}}syncTabsAndPanels(){this.tabs=this.getAllTabs(),this.focusableTabs=this.tabs.filter(e=>!e.disabled),this.panels=this.getAllPanels(),this.syncIndicator(),this.updateComplete.then(()=>this.updateScrollControls())}findNextFocusableTab(e,t){let i=null;const s=t==="forward"?1:-1;let r=e+s;for(;e<this.tabs.length;){if(i=this.tabs[r]||null,i===null){t==="forward"?i=this.focusableTabs[0]:i=this.focusableTabs[this.focusableTabs.length-1];break}if(!i.disabled)break;r+=s}return i}updateScrollButtons(){this.hasScrollControls&&!this.fixedScrollControls&&(this.shouldHideScrollStartButton=this.scrollFromStart()<=this.scrollOffset,this.shouldHideScrollEndButton=this.isScrolledToEnd())}isScrolledToEnd(){return this.scrollFromStart()+this.nav.clientWidth>=this.nav.scrollWidth-this.scrollOffset}scrollFromStart(){return this.localize.dir()==="rtl"?-this.nav.scrollLeft:this.nav.scrollLeft}updateScrollControls(){this.noScrollControls?this.hasScrollControls=!1:this.hasScrollControls=["top","bottom"].includes(this.placement)&&this.nav.scrollWidth>this.nav.clientWidth+1,this.updateScrollButtons()}syncIndicator(){this.getActiveTab()?(this.indicator.style.display="block",this.repositionIndicator()):this.indicator.style.display="none"}show(e){const t=this.tabs.find(i=>i.panel===e);t&&this.setActiveTab(t,{scrollBehavior:"smooth"})}render(){const e=this.localize.dir()==="rtl";return c`
    ...
    `}};ae.styles=[H,Bl];ae.dependencies={"sl-icon-button":Z,"sl-resize-observer":ls};l([C(".tab-group")],ae.prototype,"tabGroup",2);l([C(".tab-group__body")],ae.prototype,"body",2);l([C(".tab-group__nav")],ae.prototype,"nav",2);l([C(".tab-group__indicator")],ae.prototype,"indicator",2);l([w()],ae.prototype,"hasScrollControls",2);l([w()],ae.prototype,"shouldHideScrollStartButton",2);l([w()],ae.prototype,"shouldHideScrollEndButton",2);l([u()],ae.prototype,"placement",2);l([u()],ae.prototype,"activation",2);l([u({attribute:"no-scroll-controls",type:Boolean})],ae.prototype,"noScrollControls",2);l([u({attribute:"fixed-scroll-controls",type:Boolean})],ae.prototype,"fixedScrollControls",2);l([jo({passive:!0})],ae.prototype,"updateScrollButtons",1);l([S("noScrollControls",{waitUntilFirstUpdate:!0})],ae.prototype,"updateScrollControls",1);l([S("placement",{waitUntilFirstUpdate:!0})],ae.prototype,"syncIndicator",1);ae.define("sl-tab-group");var jl=(e,t)=>{let i=0;return function(...s){window.clearTimeout(i),i=window.setTimeout(()=>{e.call(this,...s)},t)}},Ur=(e,t,i)=>{const s=e[t];e[t]=function(...r){s.call(this,...r),i.call(this,s,...r)}};(()=>{if(typeof window>"u")return;if(!("onscrollend"in window)){const t=new Set,i=new WeakMap,s=a=>{for(const o of a.changedTouches)t.add(o.identifier)},r=a=>{for(const o of a.changedTouches)t.delete(o.identifier)};document.addEventListener("touchstart",s,!0),document.addEventListener("touchend",r,!0),document.addEventListener("touchcancel",r,!0),Ur(EventTarget.prototype,"addEventListener",function(a,o){if(o!=="scrollend")return;const n=jl(()=>{t.size?n():this.dispatchEvent(new Event("scrollend"))},100);a.call(this,"scroll",n,{passive:!0}),i.set(this,n)}),Ur(EventTarget.prototype,"removeEventListener",function(a,o){if(o!=="scrollend")return;const n=i.get(this);n&&a.call(this,"scroll",n,{passive:!0})})}})();var Ul=$`
  :host {
    display: inline-block;
  }
...
`,Vl=0,Pe=class extends P{constructor(){super(...arguments),this.localize=new ne(this),this.attrId=++Vl,this.componentId=`sl-tab-${this.attrId}`,this.panel="",this.active=!1,this.closable=!1,this.disabled=!1,this.tabIndex=0}connectedCallback(){super.connectedCallback(),this.setAttribute("role","tab")}handleCloseClick(e){e.stopPropagation(),this.emit("sl-close")}handleActiveChange(){this.setAttribute("aria-selected",this.active?"true":"false")}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false"),this.disabled&&!this.active?this.tabIndex=-1:this.tabIndex=0}render(){return this.id=this.id.length>0?this.id:this.componentId,c`
      <div
        part="base"
    ...
    `}};Pe.styles=[H,Ul];Pe.dependencies={"sl-icon-button":Z};l([C(".tab")],Pe.prototype,"tab",2);l([u({reflect:!0})],Pe.prototype,"panel",2);l([u({type:Boolean,reflect:!0})],Pe.prototype,"active",2);l([u({type:Boolean,reflect:!0})],Pe.prototype,"closable",2);l([u({type:Boolean,reflect:!0})],Pe.prototype,"disabled",2);l([u({type:Number,reflect:!0})],Pe.prototype,"tabIndex",2);l([S("active")],Pe.prototype,"handleActiveChange",1);l([S("disabled")],Pe.prototype,"handleDisabledChange",1);Pe.define("sl-tab");var Wl=$`
  :host {
    --padding: 0;
...
`,ql=0,fi=class extends P{constructor(){super(...arguments),this.attrId=++ql,this.componentId=`sl-tab-panel-${this.attrId}`,this.name="",this.active=!1}connectedCallback(){super.connectedCallback(),this.id=this.id.length>0?this.id:this.componentId,this.setAttribute("role","tabpanel")}handleActiveChange(){this.setAttribute("aria-hidden",this.active?"false":"true")}render(){return c`
      <slot
        part="base"
        class=${M({"tab-panel":!0,"tab-panel--active":this.active})}
      ></slot>
    `}};fi.styles=[H,Wl];l([u({reflect:!0})],fi.prototype,"name",2);l([u({type:Boolean,reflect:!0})],fi.prototype,"active",2);l([S("active")],fi.prototype,"handleActiveChange",1);fi.define("sl-tab-panel");Zi.define("sl-spinner");Z.define("sl-icon-button");var Yl=$`
  :host {
    display: block;
  }
...
`,Le=class extends P{constructor(){super(...arguments),this.localize=new ne(this),this.open=!1,this.disabled=!1}firstUpdated(){this.body.style.height=this.open?"auto":"0",this.open&&(this.details.open=!0),this.detailsObserver=new MutationObserver(e=>{for(const t of e)t.type==="attributes"&&t.attributeName==="open"&&(this.details.open?this.show():this.hide())}),this.detailsObserver.observe(this.details,{attributes:!0})}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this.detailsObserver)==null||e.disconnect()}handleSummaryClick(e){e.preventDefault(),this.disabled||(this.open?this.hide():this.show(),this.header.focus())}handleSummaryKeyDown(e){(e.key==="Enter"||e.key===" ")&&(e.preventDefault(),this.open?this.hide():this.show()),(e.key==="ArrowUp"||e.key==="ArrowLeft")&&(e.preventDefault(),this.hide()),(e.key==="ArrowDown"||e.key==="ArrowRight")&&(e.preventDefault(),this.show())}async handleOpenChange(){if(this.open){if(this.details.open=!0,this.emit("sl-show",{cancelable:!0}).defaultPrevented){this.open=!1,this.details.open=!1;return}await ee(this.body);const{keyframes:t,options:i}=G(this,"details.show",{dir:this.localize.dir()});await X(this.body,Br(t,this.body.scrollHeight),i),this.body.style.height="auto",this.emit("sl-after-show")}else{if(this.emit("sl-hide",{cancelable:!0}).defaultPrevented){this.details.open=!0,this.open=!0;return}await ee(this.body);const{keyframes:t,options:i}=G(this,"details.hide",{dir:this.localize.dir()});await X(this.body,Br(t,this.body.scrollHeight),i),this.body.style.height="auto",this.details.open=!1,this.emit("sl-after-hide")}}async show(){if(!(this.open||this.disabled))return this.open=!0,be(this,"sl-after-show")}async hide(){if(!(!this.open||this.disabled))return this.open=!1,be(this,"sl-after-hide")}render(){const e=this.localize.dir()==="rtl";return c`
    ...
    `}};Le.styles=[H,Yl];Le.dependencies={"sl-icon":se};l([C(".details")],Le.prototype,"details",2);l([C(".details__header")],Le.prototype,"header",2);l([C(".details__body")],Le.prototype,"body",2);l([C(".details__expand-icon-slot")],Le.prototype,"expandIconSlot",2);l([u({type:Boolean,reflect:!0})],Le.prototype,"open",2);l([u()],Le.prototype,"summary",2);l([u({type:Boolean,reflect:!0})],Le.prototype,"disabled",2);l([S("open",{waitUntilFirstUpdate:!0})],Le.prototype,"handleOpenChange",1);B("details.show",{keyframes:[{height:"0",opacity:"0"},{height:"auto",opacity:"1"}],options:{duration:250,easing:"linear"}});B("details.hide",{keyframes:[{height:"auto",opacity:"1"},{height:"0",opacity:"0"}],options:{duration:250,easing:"linear"}});Le.define("sl-details");const Kl="modulepreload",Gl=function(e,t){return new URL(e,t).href},Vr={},Wr=function(t,i,s){let r=Promise.resolve();if(i&&i.length>0){const o=document.getElementsByTagName("link"),n=document.querySelector("meta[property=csp-nonce]"),h=(n==null?void 0:n.nonce)||(n==null?void 0:n.getAttribute("nonce"));r=Promise.allSettled(i.map(d=>{if(d=Gl(d,s),d in Vr)return;Vr[d]=!0;const p=d.endsWith(".css"),f=p?'[rel="stylesheet"]':"";if(!!s)for(let v=o.length-1;v>=0;v--){const y=o[v];if(y.href===d&&(!p||y.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${d}"]${f}`))return;const m=document.createElement("link");if(m.rel=p?"stylesheet":Kl,p||(m.as="script"),m.crossOrigin="",m.href=d,h&&m.setAttribute("nonce",h),document.head.appendChild(m),p)return new Promise((v,y)=>{m.addEventListener("load",v),m.addEventListener("error",()=>y(new Error(`Unable to preload CSS for ${d}`)))})}))}function a(o){const n=new Event("vite:preloadError",{cancelable:!0});if(n.payload=o,window.dispatchEvent(n),!n.defaultPrevented)throw o}return r.then(o=>{for(const n of o||[])n.status==="rejected"&&a(n.reason);return t().catch(a)})};/**
 * @license
...
`);for(const s of i){const r=s.trim();if(!r)continue;const a={text:r};if(r.length>=18&&r[4]==="-"&&r[7]==="-"&&r[10]===" "&&r[13]===":"){const o=r.indexOf(" - ",16);if(o!==-1){a.timestamp=r.slice(0,16);let n=r.slice(o+3);if(n.startsWith("(from: ")){const h=n.indexOf(") ");h!==-1?(a.author=n.slice(7,h),a.text=n.slice(h+2)):a.text=n}else a.text=n}}t.push(a)}return t}async function vc(e,t){const i=e.startsWith("/")?"./"+e.slice(1):e,s=await fetch(i,t);if(!s.ok){const r=await s.text();throw new Na(`API request failed: ${s.status} ${s.statusText}`,s.status,r)}return s.json()}async function yc(){return vc("/api/roadmap")}const Me=pc({}),ji=fe(null),Ba=fe(""),gi=fe(!0),hs=fe(null),wc=vt(Me,e=>Object.values(e)),kc=vt(Me,e=>{const t=Date.now()-432e5;return Object.values(e).filter(i=>i.type!=="epic"?!1:i.status!=="closed"?!0:i.closed_at?new Date(i.closed_at).getTime()>t:!1).map(i=>({id:i.id,title:i.title}))}),ps=vt([Me,ji],(e,t)=>t&&e[t]||null),xc=vt(ps,e=>e?li(e.notes):[]),_c=vt([Me,ps],(e,t)=>{var i;return(i=t==null?void 0:t.blocked_by)!=null&&i.length?t.blocked_by.map(s=>{const r=e[s];return r?{id:r.id,title:r.title,status:r.status}:null}).filter(s=>s!==null):[]}),Cc=vt([Me,ps],(e,t)=>{if(!(t!=null&&t.parent))return"";const i=e[t.parent];return(i==null?void 0:i.title)||""});function $c(e,t){return e.status==="closed"||!e.blocked_by||e.blocked_by.length===0?!1:e.blocked_by.some(i=>{const s=t[i];return s?s.status!=="closed":!1})}function Ui(e,t={}){const i=$c(e,t);let s;return e.status==="closed"?s="done":i?s="blocked":e.awaiting?s="human":e.status==="in_progress"?s="agent":s="ready",{...e,is_blocked:i,column:s}}function Tc(e){const t={};for(const s of e)t[s.id]=s;const i={};for(const s of e)i[s.id]=Ui(s,t);Me.set(i),gi.set(!1),hs.set(null)}function Sc(e){const t={};for(const[s,r]of e)t[s]=r;const i={};for(const[s,r]of e)i[s]=Ui(r,t);Me.set(i),gi.set(!1),hs.set(null)}function At(e){var o;const t=Me.get(),i={};for(const[n,h]of Object.entries(t))i[n]=h;i[e.id]=e;const s=Ui(e,i),r={...t};r[e.id]=s;const a=t[e.id];if((a==null?void 0:a.status)!==e.status)for(const[n,h]of Object.entries(t))n!==e.id&&(o=h.blocked_by)!=null&&o.includes(e.id)&&(r[n]=Ui(h,i));Me.set(r)}function Ec(e){const t=Me.get(),{[e]:i,...s}=t;Me.set(s),ji.get()===e&&ji.set(null)}function dt(e){ji.set(e)}function Ha(e){Ba.set(e)}function Vi(e){gi.set(e)}function ci(e){hs.set(e),gi.set(!1)}const ja=fe(null),Bs=fe(!1),Hs=fe(null);async function Ua(){Bs.set(!0),Hs.set(null);try{const e=await yc();ja.set(e)}catch(e){Hs.set(e instanceof Error?e.message:String(e))}finally{Bs.set(!1)}}typeof window<"u"&&window.addEventListener("tick-update-for-roadmap",()=>{Ua().catch(()=>{})});class zc extends Error{constructor(t="Cannot write: local agent is offline"){super(t),this.name="ReadOnlyError"}}class _t extends Error{constructor(t){super(t),this.name="ConnectionError"}}const Rc="",Kr=1e3,Ac=3e4;class Oc{constructor(t=Rc){this.tickHandlers=new Set,this.runHandlers=new Set,this.contextHandlers=new Set,this.connectionHandlers=new Set,this.eventSource=null,this.runEventSources=new Map,this.reconnectDelay=Kr,this.reconnectTimeout=null,this.connected=!1,this.baseUrl=t}async connect(){return this.disconnectMainSSE(),new Promise((t,i)=>{try{this.eventSource=new EventSource(`${this.baseUrl}/api/events`),this.eventSource.addEventListener("connected",()=>{this.connected=!0,this.reconnectDelay=Kr,console.log("[LocalComms] Connected to SSE"),this.emitConnection({type:"connection:connected"}),t()}),this.eventSource.addEventListener("update",s=>{this.handleUpdateEvent(s)}),this.eventSource.onerror=()=>{var r;console.log("[LocalComms] SSE connection error");const s=this.connected;this.connected=!1,s&&this.emitConnection({type:"connection:disconnected"}),(r=this.eventSource)==null||r.close(),this.eventSource=null,this.scheduleReconnect(),s||i(new _t("Failed to connect to SSE endpoint"))}}catch(s){i(new _t(`Failed to create EventSource: ${s}`))}})}disconnect(){this.reconnectTimeout&&(clearTimeout(this.reconnectTimeout),this.reconnectTimeout=null),this.disconnectMainSSE();for(const[t,i]of this.runEventSources)i.close(),console.log(`[LocalComms] Closed run stream for epic ${t}`);this.runEventSources.clear(),this.connected&&(this.connected=!1,this.emitConnection({type:"connection:disconnected"}))}disconnectMainSSE(){this.eventSource&&(this.eventSource.close(),this.eventSource=null)}scheduleReconnect(){this.reconnectTimeout&&clearTimeout(this.reconnectTimeout),this.reconnectTimeout=setTimeout(()=>{console.log(`[LocalComms] Reconnecting after ${this.reconnectDelay}ms...`),this.connect().catch(t=>{console.error("[LocalComms] Reconnect failed:",t)})},this.reconnectDelay),this.reconnectDelay=Math.min(this.reconnectDelay*2,Ac)}onTick(t){return this.tickHandlers.add(t),()=>this.tickHandlers.delete(t)}onRun(t){return this.runHandlers.add(t),()=>this.runHandlers.delete(t)}onContext(t){return this.contextHandlers.add(t),()=>this.contextHandlers.delete(t)}onConnection(t){return this.connectionHandlers.add(t),()=>this.connectionHandlers.delete(t)}subscribeRun(t){if(this.runEventSources.has(t))return console.log(`[LocalComms] Already subscribed to run stream for ${t}`),()=>this.unsubscribeRun(t);const i=new EventSource(`${this.baseUrl}/api/run-stream/${t}`);return this.runEventSources.set(t,i),i.addEventListener("connected",()=>{console.log(`[LocalComms] Run stream connected for ${t}`),this.emitConnection({type:"connection:connected",epicId:t})}),i.addEventListener("task-started",s=>{this.handleRunEvent(t,"task-started",s)}),i.addEventListener("task-update",s=>{this.handleRunEvent(t,"task-update",s)}),i.addEventListener("tool-activity",s=>{this.handleRunEvent(t,"tool-activity",s)}),i.addEventListener("task-completed",s=>{this.handleRunEvent(t,"task-completed",s)}),i.addEventListener("epic-started",s=>{this.handleRunEvent(t,"epic-started",s)}),i.addEventListener("epic-completed",s=>{this.handleRunEvent(t,"epic-completed",s)}),i.addEventListener("task-awaiting",s=>{this.handleRunEvent(t,"task-awaiting",s)}),i.addEventListener("context-generating",s=>{this.handleContextEvent(t,"context:generating",s)}),i.addEventListener("context-generated",s=>{this.handleContextEvent(t,"context:generated",s)}),i.addEventListener("context-loaded",s=>{this.handleContextEvent(t,"context:loaded",s)}),i.addEventListener("context-failed",s=>{this.handleContextEvent(t,"context:failed",s)}),i.addEventListener("context-skipped",s=>{this.handleContextEvent(t,"context:skipped",s)}),i.onerror=()=>{console.log(`[LocalComms] Run stream error for ${t}`),i.close(),this.runEventSources.delete(t)},()=>this.unsubscribeRun(t)}unsubscribeRun(t){const i=this.runEventSources.get(t);i&&(i.close(),this.runEventSources.delete(t),console.log(`[LocalComms] Unsubscribed from run stream for ${t}`))}async createTick(t){const i=await fetch(`${this.baseUrl}/api/ticks`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)});if(!i.ok)throw new Error(`Failed to create tick: ${i.statusText}`);return i.json()}async updateTick(t,i){const s=await fetch(`${this.baseUrl}/api/ticks/${t}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify(i)});if(!s.ok)throw new Error(`Failed to update tick: ${s.statusText}`);return s.json()}async deleteTick(t){const i=await fetch(`${this.baseUrl}/api/ticks/${t}`,{method:"DELETE"});if(!i.ok)throw new Error(`Failed to delete tick: ${i.statusText}`)}async addNote(t,i){const s=await fetch(`${this.baseUrl}/api/ticks/${t}/note`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({message:i})});if(!s.ok)throw new Error(`Failed to add note: ${s.statusText}`);return s.json()}async approveTick(t){const i=await fetch(`${this.baseUrl}/api/ticks/${t}/approve`,{method:"POST"});if(!i.ok)throw new Error(`Failed to approve tick: ${i.statusText}`);return i.json()}async rejectTick(t,i){const s=await fetch(`${this.baseUrl}/api/ticks/${t}/reject`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({reason:i})});if(!s.ok)throw new Error(`Failed to reject tick: ${s.statusText}`);return s.json()}async closeTick(t,i){const s=await fetch(`${this.baseUrl}/api/ticks/${t}/close`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({reason:i})});if(!s.ok)throw new Error(`Failed to close tick: ${s.statusText}`);return s.json()}async reopenTick(t){const i=await fetch(`${this.baseUrl}/api/ticks/${t}/reopen`,{method:"POST"});if(!i.ok)throw new Error(`Failed to reopen tick: ${i.statusText}`);return i.json()}async fetchTicks(){const t=await fetch(`${this.baseUrl}/api/ticks`);if(!t.ok)throw new Error(`Failed to fetch ticks: ${t.statusText}`);return(await t.json()).ticks.map(s=>({...s,is_blocked:s.isBlocked,verification_status:s.verificationStatus}))}async fetchInfo(){const t=await fetch(`${this.baseUrl}/api/info`);if(!t.ok)throw new Error(`Failed to fetch info: ${t.statusText}`);return t.json()}async fetchTick(t){const i=await fetch(`${this.baseUrl}/api/ticks/${t}`);if(!i.ok)throw new Error(`Failed to fetch tick: ${i.statusText}`);return i.json()}async fetchActivity(t){const i=t!==void 0?`${this.baseUrl}/api/activity?limit=${t}`:`${this.baseUrl}/api/activity`,s=await fetch(i);if(!s.ok)throw new Error(`Failed to fetch activity: ${s.statusText}`);return(await s.json()).activities}async fetchRecord(t){const i=await fetch(`${this.baseUrl}/api/records/${t}`);if(i.status===404)return null;if(!i.ok)throw new Error(`Failed to fetch record: ${i.statusText}`);return i.json()}async fetchRunStatus(t){const i=await fetch(`${this.baseUrl}/api/run-status/${t}`);if(!i.ok)throw new Error(`Failed to fetch run status: ${i.statusText}`);return i.json()}async fetchContext(t){const i=await fetch(`${this.baseUrl}/api/context/${t}`);if(i.status===404)return null;if(!i.ok)throw new Error(`Failed to fetch context: ${i.statusText}`);return i.text()}isConnected(){return this.connected}isReadOnly(){return!1}getConnectionInfo(){return{mode:"local",connected:this.connected,baseUrl:this.baseUrl||window.location.origin}}handleUpdateEvent(t){try{const i=JSON.parse(t.data);if(console.log("[LocalComms] Received update event:",i),i.type==="activity"){this.emitTick({type:"activity:updated"});return}const{type:s,tickId:r}=i;if(!r){console.warn("[LocalComms] Update event missing tickId:",i);return}s==="create"||s==="update"?this.fetchAndEmitTick(r):s==="delete"&&this.emitTick({type:"tick:deleted",tickId:r})}catch(i){console.error("[LocalComms] Failed to parse update event:",i)}}async fetchAndEmitTick(t){try{const i=await fetch(`${this.baseUrl}/api/ticks/${t}`);if(!i.ok)throw new Error(`HTTP ${i.status}`);const s=await i.json();this.emitTick({type:"tick:updated",tick:s})}catch(i){console.error(`[LocalComms] Failed to fetch tick ${t}:`,i),this.emitConnection({type:"connection:error",message:`Failed to fetch tick ${t}: ${i}`})}}handleRunEvent(t,i,s){try{const r=JSON.parse(s.data),a=new Date().toISOString();let o;switch(i){case"task-started":o={type:"run:task-started",taskId:r.taskId,epicId:t,status:r.status||"running",numTurns:r.numTurns||0,metrics:this.normalizeMetrics(r.metrics),timestamp:a};break;case"task-update":o={type:"run:task-update",taskId:r.taskId,epicId:t,output:r.output,status:r.status,numTurns:r.numTurns,metrics:this.normalizeMetrics(r.metrics),activeTool:r.activeTool?this.normalizeToolInfo(r.activeTool):void 0,timestamp:a};break;case"task-completed":o={type:"run:task-completed",taskId:r.taskId,epicId:t,success:r.success??!0,numTurns:r.numTurns||0,metrics:this.normalizeMetrics(r.metrics),timestamp:a};break;case"tool-activity":o={type:"run:tool-activity",taskId:r.taskId,epicId:t,tool:this.normalizeToolInfo(r.tool||r.activeTool),timestamp:a};break;case"epic-started":o={type:"run:epic-started",epicId:t,status:r.status||"running",message:r.message,timestamp:a};break;case"epic-completed":o={type:"run:epic-completed",epicId:t,success:r.success??!0,timestamp:a};break;case"task-awaiting":o={type:"run:task-awaiting",taskId:r.taskId,epicId:t,awaitingType:r.status||"work",reason:r.message,timestamp:a};break;default:console.warn(`[LocalComms] Unknown run event type: ${i}`);return}this.emitRun(o)}catch(r){console.error(`[LocalComms] Failed to parse run event ${i}:`,r)}}handleContextEvent(t,i,s){try{const r=JSON.parse(s.data);let a;switch(i){case"context:generating":a={type:"context:generating",epicId:t,taskCount:r.taskCount||0};break;case"context:generated":a={type:"context:generated",epicId:t,tokenCount:r.tokenCount||0};break;case"context:loaded":a={type:"context:loaded",epicId:t};break;case"context:failed":a={type:"context:failed",epicId:t,message:r.message||"Context generation failed"};break;case"context:skipped":a={type:"context:skipped",epicId:t,reason:r.reason||"Unknown reason"};break;default:return}this.emitContext(a)}catch(r){console.error(`[LocalComms] Failed to parse context event ${i}:`,r)}}emitTick(t){for(const i of this.tickHandlers)try{i(t)}catch(s){console.error("[LocalComms] Error in tick handler:",s)}}emitRun(t){for(const i of this.runHandlers)try{i(t)}catch(s){console.error("[LocalComms] Error in run handler:",s)}}emitContext(t){for(const i of this.contextHandlers)try{i(t)}catch(s){console.error("[LocalComms] Error in context handler:",s)}}emitConnection(t){for(const i of this.connectionHandlers)try{i(t)}catch(s){console.error("[LocalComms] Error in connection handler:",s)}}normalizeMetrics(t){if(t)return{inputTokens:t.input_tokens||t.inputTokens||0,outputTokens:t.output_tokens||t.outputTokens||0,cacheReadTokens:t.cache_read_tokens||t.cacheReadTokens||0,cacheCreationTokens:t.cache_creation_tokens||t.cacheCreationTokens||0,costUsd:t.cost_usd||t.costUsd||0,durationMs:t.duration_ms||t.durationMs||0}}normalizeToolInfo(t){return t?{name:t.name||"Unknown",input:t.input,output:t.output,durationMs:t.duration_ms||t.duration||t.durationMs,isError:t.is_error||t.isError}:{name:"Unknown"}}}const Ic=10,Dc=1e3,Mc=3e4;class Pc{constructor(t){this.tickHandlers=new Set,this.runHandlers=new Set,this.contextHandlers=new Set,this.connectionHandlers=new Set,this.ws=null,this.connected=!1,this.localAgentConnected=!1,this.reconnectAttempts=0,this.reconnectTimer=null,this.runSubscriptions=new Set,this.tickCache=new Map,this.runStates=new Map,this.projectId=t}async connect(){return this.closeWebSocket(),new Promise((t,i)=>{try{const s=window.location.protocol==="https:"?"wss:":"ws:",r=window.location.host,a=localStorage.getItem("token")||"",o=`${s}//${r}/api/projects/${encodeURIComponent(this.projectId)}/sync?type=cloud`;console.log("[CloudComms] Connecting to",o);const n=["ticks-v1",`token-${encodeURIComponent(a)}`];this.ws=new WebSocket(o,n);let h=!1;this.ws.onopen=()=>{console.log("[CloudComms] WebSocket connected"),this.connected=!0,this.reconnectAttempts=0,h||(h=!0,t()),this.emitConnection({type:"connection:connected"})},this.ws.onmessage=d=>{this.handleMessage(d)},this.ws.onclose=d=>{console.log("[CloudComms] WebSocket closed:",d.code,d.reason);const p=this.connected;this.connected=!1,this.ws=null,p&&this.emitConnection({type:"connection:disconnected"}),this.scheduleReconnect(),h||(h=!0,i(new _t(`WebSocket closed: ${d.code} ${d.reason}`)))},this.ws.onerror=d=>{console.error("[CloudComms] WebSocket error:",d),h||(h=!0,i(new _t("WebSocket connection error"))),this.emitConnection({type:"connection:error",message:"WebSocket connection error"})}}catch(s){i(new _t(`Failed to create WebSocket: ${s}`))}})}disconnect(){this.reconnectTimer!==null&&(clearTimeout(this.reconnectTimer),this.reconnectTimer=null),this.closeWebSocket(),this.runSubscriptions.clear(),this.connected&&(this.connected=!1,this.emitConnection({type:"connection:disconnected"}))}closeWebSocket(){this.ws&&(this.ws.close(),this.ws=null)}scheduleReconnect(){if(this.reconnectAttempts>=Ic){console.error("[CloudComms] Max reconnect attempts reached"),this.emitConnection({type:"connection:error",message:"Connection lost - max reconnect attempts reached"});return}const t=Math.min(Dc*Math.pow(2,this.reconnectAttempts),Mc);this.reconnectAttempts++,console.log(`[CloudComms] Reconnecting in ${t}ms (attempt ${this.reconnectAttempts})`),this.reconnectTimer=setTimeout(()=>{this.reconnectTimer=null,this.connect().catch(i=>{console.error("[CloudComms] Reconnect failed:",i)})},t)}onTick(t){return this.tickHandlers.add(t),()=>this.tickHandlers.delete(t)}onRun(t){return this.runHandlers.add(t),()=>this.runHandlers.delete(t)}onContext(t){return this.contextHandlers.add(t),()=>this.contextHandlers.delete(t)}onConnection(t){return this.connectionHandlers.add(t),()=>this.connectionHandlers.delete(t)}subscribeRun(t){return this.runSubscriptions.add(t),console.log(`[CloudComms] Subscribed to run events for ${t}`),()=>{this.runSubscriptions.delete(t),console.log(`[CloudComms] Unsubscribed from run events for ${t}`)}}async createTick(t){this.checkWritable();const i={id:this.generateTickId(),title:t.title,description:t.description||"",type:t.type||"task",status:"open",priority:t.priority??2,parent:t.parent,labels:t.labels,blocked_by:t.blocked_by,awaiting:t.awaiting,owner:"",created_by:"",created_at:new Date().toISOString(),updated_at:new Date().toISOString()};return this.sendMessage({type:"tick_update",tick:i}),i}async updateTick(t,i){this.checkWritable();const s={id:t,title:i.title||"",description:i.description||"",status:i.status||"open",priority:i.priority??2,labels:i.labels,blocked_by:i.blocked_by,type:"task",owner:"",created_by:"",created_at:new Date().toISOString(),updated_at:new Date().toISOString()};return this.sendMessage({type:"tick_update",tick:s}),s}async deleteTick(t){this.checkWritable(),this.sendMessage({type:"tick_delete",id:t})}async addNote(t,i){return this.checkWritable(),this.tickOperation(t,"note",{message:i})}async approveTick(t){return this.checkWritable(),this.tickOperation(t,"approve")}async rejectTick(t,i){return this.checkWritable(),this.tickOperation(t,"reject",{reason:i})}async closeTick(t,i){return this.checkWritable(),this.tickOperation(t,"close",{reason:i})}async reopenTick(t){return this.checkWritable(),this.tickOperation(t,"reopen")}isConnected(){var t;return this.connected&&((t=this.ws)==null?void 0:t.readyState)===WebSocket.OPEN}isReadOnly(){return!this.localAgentConnected}getConnectionInfo(){return{mode:"cloud",connected:this.connected,localAgentConnected:this.localAgentConnected,projectId:this.projectId,baseUrl:window.location.origin}}async fetchTicks(){const t=[];for(const i of this.tickCache.values()){const s=(i.blocked_by||[]).some(a=>{const o=this.tickCache.get(a);return o?o.status!=="closed":!1});let r="ready";i.status==="closed"?r="done":s?r="blocked":i.awaiting?r="human":i.status==="in_progress"&&(r="agent"),t.push({...i,is_blocked:s,column:r})}return t}async fetchInfo(){const t=[];for(const i of this.tickCache.values())i.type==="epic"&&t.push({id:i.id,title:i.title});return{repoName:this.projectId,epics:t}}async fetchTick(t){const i=this.tickCache.get(t);if(!i)throw new Error(`Tick not found: ${t}`);const s=[];if(i.blocked_by&&i.blocked_by.length>0)for(const o of i.blocked_by){const n=this.tickCache.get(o);n?s.push({id:n.id,title:n.title,status:n.status}):s.push({id:o,title:`Tick ${o}`,status:"unknown"})}const r=s.some(o=>o.status!=="closed"&&o.status!=="unknown");let a="ready";return i.status==="closed"?a="done":r?a="blocked":i.awaiting?a="human":i.status==="in_progress"&&(a="agent"),{...i,isBlocked:r,column:a,notesList:li(i.notes),blockerDetails:s}}async fetchActivity(t){return[]}async fetchRecord(t){return null}async fetchRunStatus(t){var s,r;const i=this.runStates.get(t);return i?{epicId:t,isRunning:i.isRunning,activeTask:i.activeTaskId?{tickId:i.activeTaskId,title:((s=this.tickCache.get(i.activeTaskId))==null?void 0:s.title)||i.activeTaskId,status:"running",numTurns:0,metrics:{input_tokens:0,output_tokens:0,cache_read_tokens:0,cache_creation_tokens:0,cost_usd:0,duration_ms:0},lastUpdated:((r=i.lastEvent)==null?void 0:r.timestamp)||new Date().toISOString()}:void 0}:{epicId:t,isRunning:!1}}async fetchContext(t){return null}handleMessage(t){try{const i=JSON.parse(t.data);switch(i.type){case"state_full":this.handleStateFullMessage(i);break;case"tick_updated":case"tick_created":this.handleTickUpdateMessage(i);break;case"tick_deleted":this.handleTickDeleteMessage(i);break;case"connected":console.log("[CloudComms] Connection confirmed:",i.connectionId);break;case"error":console.error("[CloudComms] Server error:",i.message),this.emitConnection({type:"connection:error",message:i.message});break;case"local_status":this.handleLocalStatusMessage(i);break;case"run_event":this.handleRunEventMessage(i);break;default:console.warn("[CloudComms] Unknown message type:",i.type)}}catch(i){console.error("[CloudComms] Failed to parse message:",i)}}handleStateFullMessage(t){console.log("[CloudComms] Received full state:",Object.keys(t.ticks).length,"ticks"),this.tickCache.clear();for(const[s,r]of Object.entries(t.ticks))this.tickCache.set(s,r);const i=new Map(Object.entries(t.ticks));this.emitTick({type:"tick:bulk",ticks:i})}handleTickUpdateMessage(t){console.log("[CloudComms] Tick updated:",t.tick.id),this.tickCache.set(t.tick.id,t.tick),this.emitTick({type:"tick:updated",tick:t.tick})}handleTickDeleteMessage(t){console.log("[CloudComms] Tick deleted:",t.id),this.tickCache.delete(t.id),this.emitTick({type:"tick:deleted",tickId:t.id})}handleLocalStatusMessage(t){console.log("[CloudComms] Local agent status:",t.connected?"online":"offline"),this.localAgentConnected=t.connected,this.emitConnection({type:"connection:local-status",connected:t.connected})}handleRunEventMessage(t){const{epicId:i,taskId:s,event:r}=t;if(console.log(`[CloudComms] Received run_event: epic=${i} type=${r.type} subscriptions=${[...this.runSubscriptions].join(",")}`),!this.runSubscriptions.has(i)&&this.runSubscriptions.size>0){console.log(`[CloudComms] Skipping run_event - not subscribed to ${i}`);return}const a=r.timestamp||new Date().toISOString();let o;switch(r.type){case"task-started":o={type:"run:task-started",taskId:s||"",epicId:i,status:r.status||"running",numTurns:r.numTurns||0,metrics:this.normalizeMetrics(r.metrics),timestamp:a},this.runStates.set(i,{isRunning:!0,activeTaskId:s,lastEvent:o});break;case"task-update":o={type:"run:task-update",taskId:s||"",epicId:i,output:r.output,status:r.status,numTurns:r.numTurns,metrics:this.normalizeMetrics(r.metrics),activeTool:r.activeTool?this.normalizeToolInfo(r.activeTool):void 0,timestamp:a};const n=this.runStates.get(i);n&&(n.lastEvent=o);break;case"task-completed":o={type:"run:task-completed",taskId:s||"",epicId:i,success:r.success??!0,numTurns:r.numTurns||0,metrics:this.normalizeMetrics(r.metrics),timestamp:a};const h=this.runStates.get(i);h&&(h.activeTaskId=void 0,h.lastEvent=o);break;case"tool-activity":o={type:"run:tool-activity",taskId:s||"",epicId:i,tool:r.activeTool?this.normalizeToolInfo(r.activeTool):{name:"Unknown"},timestamp:a};break;case"epic-started":o={type:"run:epic-started",epicId:i,status:r.status||"running",message:r.message,timestamp:a},this.runStates.set(i,{isRunning:!0,lastEvent:o});break;case"epic-completed":o={type:"run:epic-completed",epicId:i,success:r.success??!0,timestamp:a},this.runStates.set(i,{isRunning:!1,lastEvent:o});break;case"context-generating":{const d={type:"context:generating",epicId:i,taskCount:r.taskCount||0};this.emitContext(d);return}case"context-generated":{const d={type:"context:generated",epicId:i,tokenCount:r.tokenCount||0};this.emitContext(d);return}case"context-loaded":{const d={type:"context:loaded",epicId:i};this.emitContext(d);return}case"context-failed":{const d={type:"context:failed",epicId:i,error:r.message||"Context generation failed"};this.emitContext(d);return}case"context-skipped":{const d={type:"context:skipped",epicId:i,reason:r.message||"Context generation skipped"};this.emitContext(d);return}default:console.warn("[CloudComms] Unknown run event type:",r.type);return}this.emitRun(o)}emitTick(t){for(const i of this.tickHandlers)try{i(t)}catch(s){console.error("[CloudComms] Error in tick handler:",s)}}emitRun(t){for(const i of this.runHandlers)try{i(t)}catch(s){console.error("[CloudComms] Error in run handler:",s)}}emitContext(t){for(const i of this.contextHandlers)try{i(t)}catch(s){console.error("[CloudComms] Error in context handler:",s)}}emitConnection(t){for(const i of this.connectionHandlers)try{i(t)}catch(s){console.error("[CloudComms] Error in connection handler:",s)}}checkWritable(){if(!this.connected)throw new _t("Not connected to server");if(!this.localAgentConnected)throw new zc("Cannot write: local agent is offline")}sendMessage(t){var i;if(((i=this.ws)==null?void 0:i.readyState)!==WebSocket.OPEN)throw new _t("WebSocket not connected");this.ws.send(JSON.stringify(t))}async tickOperation(t,i,s){const r=`/api/projects/${encodeURIComponent(this.projectId)}/ticks/${encodeURIComponent(t)}/${i}`,a=localStorage.getItem("token")||"",o=await fetch(r,{method:"POST",headers:{"Content-Type":"application/json",...a?{Authorization:`Bearer ${a}`}:{}},body:s?JSON.stringify(s):void 0});if(!o.ok){const n=await o.json().catch(()=>({error:o.statusText}));throw new Error(n.error||`Failed to ${i} tick`)}return o.json()}generateTickId(){const t="abcdefghijklmnopqrstuvwxyz0123456789";let i="";for(let s=0;s<3;s++)i+=t.charAt(Math.floor(Math.random()*t.length));return i}normalizeMetrics(t){if(t)return{inputTokens:t.inputTokens||0,outputTokens:t.outputTokens||0,cacheReadTokens:t.cacheReadTokens||0,cacheCreationTokens:t.cacheCreationTokens||0,costUsd:t.costUsd||0,durationMs:t.durationMs||0}}normalizeToolInfo(t){return t?{name:t.name||"Unknown",input:t.input,durationMs:t.duration}:{name:"Unknown"}}}const mt=fe(null),et=fe("disconnected"),Va=vt([et,qe,bi],(e,t,i)=>!t||e!=="connected"?e:i?"connected":"disconnected"),js=new Set;function nr(e){return js.add(e),()=>js.delete(e)}function Lc(e){for(const t of js)try{t(e)}catch(i){console.error("[CommsStore] Error in run event listener:",i)}}const Us=new Set;function Wa(e){return Us.add(e),()=>Us.delete(e)}function Fc(e){for(const t of Us)try{t(e)}catch(i){console.error("[CommsStore] Error in context event listener:",i)}}function qa(e){switch(e.type){case"tick:updated":console.log("[CommsStore] Tick updated:",e.tick.id),At(e.tick),window.dispatchEvent(new CustomEvent("tick-update-for-roadmap"));break;case"tick:deleted":console.log("[CommsStore] Tick deleted:",e.tickId),Ec(e.tickId),window.dispatchEvent(new CustomEvent("tick-update-for-roadmap"));break;case"tick:bulk":console.log("[CommsStore] Bulk tick sync:",e.ticks.size,"ticks"),Sc(e.ticks),window.dispatchEvent(new CustomEvent("tick-update-for-roadmap"));break;case"activity:updated":window.dispatchEvent(new CustomEvent("activity-update"));break}}function Ya(e){Lc(e)}function Ka(e){Fc(e)}function Ga(e){switch(e.type){case"connection:connected":console.log("[CommsStore] Connected"),et.set("connected"),Yr(!0);break;case"connection:disconnected":console.log("[CommsStore] Disconnected"),et.set("disconnected"),Yr(!1);break;case"connection:local-status":console.log("[CommsStore] Local agent status:",e.connected?"online":"offline"),gc(e.connected);break;case"connection:error":console.error("[CommsStore] Connection error:",e.message),ci(e.message);break}}let Gr=!1,Ue=[];async function lr(){cr(),console.log("[CommsStore] Initializing local mode"),et.set("connecting"),Vi(!0);const e=new Oc;Ue.push(e.onTick(qa)),Ue.push(e.onRun(Ya)),Ue.push(e.onContext(Ka)),Ue.push(e.onConnection(Ga)),mt.set(e);try{await e.connect(),console.log("[CommsStore] Local mode connected")}catch(t){console.error("[CommsStore] Failed to connect:",t),ci(`Connection failed: ${t}`)}}async function Wi(e){cr(),console.log("[CommsStore] Initializing cloud mode for project:",e),et.set("connecting"),Vi(!0);const t=new Pc(e);Ue.push(t.onTick(qa)),Ue.push(t.onRun(Ya)),Ue.push(t.onContext(Ka)),Ue.push(t.onConnection(Ga)),mt.set(t),Ha(e);try{await t.connect(),console.log("[CommsStore] Cloud mode connected")}catch(i){console.error("[CommsStore] Failed to connect:",i),ci(`Connection failed: ${i}`)}}async function Nc(){const e=qe.get(),t=ni.get();e&&t?await Wi(t):await lr()}function Bc(){cr(),et.set("disconnected")}function cr(){for(const t of Ue)t();Ue=[];const e=mt.get();e&&(e.disconnect(),mt.set(null))}function dr(e){const t=mt.get();return t?t.subscribeRun(e):(console.warn("[CommsStore] Cannot subscribe to run: no client"),()=>{})}function ce(){const e=mt.get();if(!e)throw new Error("CommsClient not initialized");return e}async function Xa(e){return ce().createTick(e)}async function Hc(e,t){return ce().updateTick(e,t)}async function jc(e){return ce().deleteTick(e)}async function Qa(e,t){return ce().addNote(e,t)}async function Za(e){return ce().approveTick(e)}async function Ja(e,t){return ce().rejectTick(e,t)}async function eo(e,t){return ce().closeTick(e,t)}async function to(e){return ce().reopenTick(e)}async function io(){return ce().fetchTicks()}async function so(){return ce().fetchInfo()}async function ur(e){return ce().fetchTick(e)}async function hr(e){return ce().fetchActivity(e)}async function pr(e){return ce().fetchRecord(e)}async function ro(e){return ce().fetchRunStatus(e)}async function ao(e){return ce().fetchContext(e)}function oo(){if(Gr){console.log("[CommsStore] Already initialized, skipping");return}Gr=!0,console.log("[CommsStore] Setting up auto-connect"),qe.subscribe(e=>{const t=ni.get();console.log("[CommsStore] Cloud mode changed:",e,"projectId:",t),e&&t?Wi(t):e||lr()}),ni.subscribe(e=>{const t=qe.get();console.log("[CommsStore] Project ID changed:",e,"isCloudMode:",t),t&&e&&!mt.get()&&Wi(e)})}const Xr=Object.freeze(Object.defineProperty({__proto__:null,$commsClient:mt,$connectionStatus:et,$effectiveConnectionStatus:Va,addNote:Qa,approveTick:Za,closeTick:eo,createTick:Xa,deleteTick:jc,disconnectComms:Bc,fetchActivity:hr,fetchContext:ao,fetchInfo:so,fetchRecord:pr,fetchRunStatus:ro,fetchTickDetails:ur,fetchTicks:io,getCommsClient:ce,initCloudComms:Wi,initComms:Nc,initCommsAutoConnect:oo,initLocalComms:lr,onContextEvent:Wa,onRunEvent:nr,rejectTick:Ja,reopenTick:to,subscribeRun:dr,updateTickViaComms:Hc},Symbol.toStringTag,{value:"Module"}));var Uc=Object.defineProperty,Vc=Object.getOwnPropertyDescriptor,ms=(e,t,i,s)=>{for(var r=s>1?void 0:s?Vc(t,i):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(r=(s?o(t,i,r):o(r))||r);return s&&r&&Uc(t,i,r),r};const Wc={done:"var(--green, #a6e3a1)",active:"var(--blue, #89b4fa)",ready:"var(--yellow, #f9e2af)",queued:"var(--surface2, #585b70)",gated:"var(--peach, #fab387)"},qc={done:"Done",active:"Active",ready:"Needs planning",queued:"Queued",gated:"Gated"};let Pt=class extends oe{constructor(){super(...arguments),this.roadmap=null,this.loading=!1,this.error=null}_close(){this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}_handleBackdropClick(e){e.target.classList.contains("overlay")&&this._close()}_handleEpicClick(e){dt(e),this._close()}_pct(e){return e.children_total===0?0:Math.round(e.children_closed/e.children_total*100)}_renderEpicCard(e){const t=Wc[e.status]??"var(--surface2)",i=this._pct(e);return c`
      ...
      >
        ...
        <div class="epic-info">
          ...
          <div class="badges">
            <span class="badge badge-status">${qc[e.status]}</span>

            ${e.awaiting_type?c`<span class="badge badge-awaiting">⏳ ${e.awaiting_type}</span>`:g}

            ${e.blocked_by&&e.blocked_by.length>0?e.blocked_by.map(s=>c`
    ...
    `}_renderWave(e,t){return c`
      <div class="wave-group">
        <div class="wave-label">Wave ${t+1}</div>
        ${e.map(i=>this._renderEpicCard(i))}
      </div>
    `}_renderBody(){var t;if(this.loading)return c`<div class="state-box"><span class="spinner">⟳</span> Loading roadmap…</div>`;if(this.error)return c`<div class="state-box error">Failed to load roadmap: ${this.error}</div>`;const e=((t=this.roadmap)==null?void 0:t.waves)??null;return!e||e.length===0?c`<div class="state-box">No epics found — roadmap is empty.</div>`:c`
      <div class="body">
  ...
  `;ms([u({attribute:!1})],Pt.prototype,"roadmap",2);ms([u({type:Boolean})],Pt.prototype,"loading",2);ms([u({attribute:!1})],Pt.prototype,"error",2);Pt=ms([me("roadmap-view")],Pt);var Yc=Object.defineProperty,Kc=Object.getOwnPropertyDescriptor,K=(e,t,i,s)=>{for(var r=s>1?void 0:s?Kc(t,i):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(r=(s?o(t,i,r):o(r))||r);return s&&r&&Yc(t,i,r),r};console.log("[TickBoard] Initializing comms module");oo();const Ss=[{id:"blocked",name:"Blocked",color:"var(--red)",icon:"⊘"},{id:"ready",name:"Agent Queue",color:"var(--blue)",icon:"▶"},{id:"agent",name:"In Progress",color:"var(--peach)",icon:"●"},{id:"human",name:"Needs Human",color:"var(--yellow)",icon:"👤"},{id:"done",name:"Done",color:"var(--green)",icon:"✓"}],je=["blocked","ready","agent","human","done"];let V=class extends oe{constructor(){super(...arguments),this.boardState={...nc},this.ticksController=new J.StoreController(this,wc),this.epicsController=new J.StoreController(this,kc),this.repoNameController=new J.StoreController(this,Ba),this.selectedTickController=new J.StoreController(this,ps),this.selectedTickNotesController=new J.StoreController(this,xc),this.selectedTickBlockersController=new J.StoreController(this,_c),this.selectedTickParentTitleController=new J.StoreController(this,Cc),this.loadingController=new J.StoreController(this,gi),this.errorController=new J.StoreController(this,hs),this.isCloudModeController=new J.StoreController(this,qe),this.localClientConnectedController=new J.StoreController(this,bi),this.isReadOnlyController=new J.StoreController(this,fc),this.connectionStatusController=new J.StoreController(this,Va),this.roadmapController=new J.StoreController(this,ja),this.roadmapLoadingController=new J.StoreController(this,Bs),this.roadmapErrorController=new J.StoreController(this,Hs),this.selectedEpic="",this.searchTerm="",this.activeColumn="blocked",this.isMobile=window.matchMedia("(max-width: 480px)").matches,this.focusedColumnIndex=-1,this.focusedTickIndex=-1,this.showKeyboardHelp=!1,this.showCreateDialog=!1,this.showMobileFilterDrawer=!1,this.showDashboard=!1,this.dashboardActivities=[],this.showRoadmap=!1,this.showRunPanel=!1,this.runStatus=null,this.runPanelEpicId=null,this.runStreamConnected=!1,this.activeToolInfo=null,this.runMetrics=null,this.awaitingTasks=[],this.mediaQuery=window.matchMedia("(max-width: 480px)"),this.runStreamUnsubscribe=null,this.runEventUnsubscribe=null,this.runPollInterval=null,this.handleKeyDown=e=>{if(!(this.loading||this.error||this.isInputFocused())&&!(this.showDashboard&&e.key!=="Escape"&&e.key!=="d"&&e.key!=="m"&&e.key!=="?")&&!(this.showRoadmap&&e.key!=="Escape"&&e.key!=="m"&&e.key!=="?"))switch(this.showKeyboardHelp&&e.key!=="?"&&(this.showKeyboardHelp=!1),e.key){case"?":e.preventDefault(),this.showKeyboardHelp=!this.showKeyboardHelp;break;case"j":case"ArrowDown":e.preventDefault(),this.navigateVertical(1);break;case"k":case"ArrowUp":e.preventDefault(),this.navigateVertical(-1);break;case"h":case"ArrowLeft":e.preventDefault(),this.navigateHorizontal(-1);break;case"l":case"ArrowRight":e.preventDefault(),this.navigateHorizontal(1);break;case"Enter":e.preventDefault(),this.openFocusedTick();break;case"Escape":e.preventDefault(),this.handleEscape();break;case"n":e.preventDefault(),this.handleCreateClick();break;case"/":e.preventDefault(),this.focusSearchInput();break;case"r":!e.metaKey&&!e.ctrlKey&&!e.shiftKey&&!e.altKey&&(e.preventDefault(),this.toggleRunPanel());break;case"d":!e.metaKey&&!e.ctrlKey&&!e.shiftKey&&!e.altKey&&(e.preventDefault(),this.toggleDashboard());break;case"m":!e.metaKey&&!e.ctrlKey&&!e.shiftKey&&!e.altKey&&(e.preventDefault(),this.toggleRoadmap());break}},this.handleMediaChange=e=>{this.isMobile=e.matches,this.updateBoardState()}}get ticks(){return this.ticksController.value}get epics(){return this.epicsController.value}get repoName(){return this.repoNameController.value}get selectedTick(){return this.selectedTickController.value}get selectedTickNotes(){return this.selectedTickNotesController.value}get selectedTickBlockers(){return this.selectedTickBlockersController.value}get selectedTickParentTitle(){return this.selectedTickParentTitleController.value}get loading(){return this.loadingController.value}get error(){return this.errorController.value}get isCloudMode(){return this.isCloudModeController.value}get localClientConnected(){return this.localClientConnectedController.value}get isReadOnly(){return this.isReadOnlyController.value}get connectionStatus(){return this.connectionStatusController.value}get roadmapData(){return this.roadmapController.value}get roadmapLoading(){return this.roadmapLoadingController.value}get roadmapError(){return this.roadmapErrorController.value}connectedCallback(){super.connectedCallback(),this.mediaQuery.addEventListener("change",this.handleMediaChange),document.addEventListener("keydown",this.handleKeyDown),this.detectCloudMode(),this.runEventUnsubscribe=nr(e=>this.handleRunEvent(e)),this.isCloudMode||(this.loadData(),this.startRunStatusPolling())}detectCloudMode(){const e=window.location.pathname.match(/^\/p\/(.+?)(?:\/|$)/);if(e){const i=decodeURIComponent(e[1]);console.log("[TickBoard] Cloud mode detected, project:",i),Ts(i);return}const t=localStorage.getItem("ticks_project");if(t){console.log("[TickBoard] Cloud mode from localStorage, project:",t),Ts(t);return}if(window.location.hostname==="ticks.sh"||window.location.hostname.endsWith(".ticks.sh")){const i=new URLSearchParams(window.location.search).get("project");if(i){console.log("[TickBoard] Cloud mode from query param, project:",i),Ts(i);return}}console.log("[TickBoard] Local mode"),bc()}async loadData(){if(this.isCloudMode){console.log("[TickBoard] Cloud mode: waiting for data from CloudCommsClient"),Vi(!0);return}Vi(!0),ci(null);try{const[e,t]=await Promise.all([io(),so()]);Tc(e),Ha(t.repoName),this.updateBoardState()}catch(e){ci(e instanceof Error?e.message:"Failed to load data"),console.error("Failed to load board data:",e)}}disconnectedCallback(){var e;super.disconnectedCallback(),this.mediaQuery.removeEventListener("change",this.handleMediaChange),document.removeEventListener("keydown",this.handleKeyDown),(e=this.runEventUnsubscribe)==null||e.call(this),this.runEventUnsubscribe=null,this.unsubscribeRunStream(),this.stopRunStatusPolling()}startRunStatusPolling(){this.runPollInterval=setInterval(()=>{this.checkForActiveRuns()},5e3),this.checkForActiveRuns()}stopRunStatusPolling(){this.runPollInterval&&(clearInterval(this.runPollInterval),this.runPollInterval=null)}async checkForActiveRuns(){var e,t,i;if(this.epics.length!==0){for(const s of this.epics)try{const r=await ro(s.id);if(r.isRunning){this.runStatus=r,this.runPanelEpicId!==s.id&&(this.runPanelEpicId=s.id,this.subscribeToRunStream(s.id)),(e=r.activeTask)!=null&&e.metrics&&(this.runMetrics=this.convertApiMetrics(r.activeTask.metrics)),(t=r.activeTask)!=null&&t.activeTool&&(this.activeToolInfo={name:r.activeTask.activeTool.name,input:r.activeTask.activeTool.input,output:r.activeTask.activeTool.output,durationMs:r.activeTask.activeTool.duration_ms,isError:r.activeTask.activeTool.is_error,isComplete:!1}),r.awaitingTasks&&(this.awaitingTasks=r.awaitingTasks);return}}catch{}(i=this.runStatus)!=null&&i.isRunning&&(this.runStatus={...this.runStatus,isRunning:!1})}}convertApiMetrics(e){return{inputTokens:e.input_tokens,outputTokens:e.output_tokens,cacheReadTokens:e.cache_read_tokens,cacheCreationTokens:e.cache_creation_tokens,costUsd:e.cost_usd,durationMs:e.duration_ms}}subscribeToRunStream(e){this.unsubscribeRunStream(),console.log("[RunStream] Subscribing to epic:",e),this.runStreamUnsubscribe=dr(e),this.runStreamConnected=!0}unsubscribeRunStream(){this.runStreamUnsubscribe&&(this.runStreamUnsubscribe(),this.runStreamUnsubscribe=null),this.runStreamConnected=!1}handleRunEvent(e){var i,s;const t=e.epicId;if(!(this.runPanelEpicId&&t!==this.runPanelEpicId))switch(e.type){case"run:task-started":this.runStatus={epicId:t,isRunning:!0,activeTask:{tickId:e.taskId,title:"",status:"running",numTurns:e.numTurns||0,metrics:e.metrics?{input_tokens:e.metrics.inputTokens,output_tokens:e.metrics.outputTokens,cache_read_tokens:e.metrics.cacheReadTokens,cache_creation_tokens:e.metrics.cacheCreationTokens,cost_usd:e.metrics.costUsd,duration_ms:e.metrics.durationMs}:{input_tokens:0,output_tokens:0,cache_read_tokens:0,cache_creation_tokens:0,cost_usd:0,duration_ms:0},lastUpdated:e.timestamp}},this.activeToolInfo=null;break;case"run:task-update":e.metrics&&(this.runMetrics={inputTokens:e.metrics.inputTokens,outputTokens:e.metrics.outputTokens,cacheReadTokens:e.metrics.cacheReadTokens,cacheCreationTokens:e.metrics.cacheCreationTokens,costUsd:e.metrics.costUsd,durationMs:e.metrics.durationMs}),e.activeTool&&(this.activeToolInfo={name:e.activeTool.name,input:e.activeTool.input,output:e.activeTool.output,durationMs:e.activeTool.durationMs,isComplete:!1}),(i=this.runStatus)!=null&&i.activeTask&&(this.runStatus={...this.runStatus,activeTask:{...this.runStatus.activeTask,numTurns:e.numTurns??this.runStatus.activeTask.numTurns,lastUpdated:e.timestamp}});break;case"run:tool-activity":this.activeToolInfo={name:e.tool.name,input:e.tool.input,output:e.tool.output,durationMs:e.tool.durationMs,isComplete:!1};break;case"run:task-completed":console.log("[RunStream] Task completed:",e.taskId),this.activeToolInfo=null,this.runStatus&&(this.runStatus={...this.runStatus,isRunning:!1,activeTask:void 0});break;case"run:epic-started":console.log("[RunStream] Epic started:",t),this.runStatus={epicId:t,isRunning:!0};break;case"run:epic-completed":console.log("[RunStream] Epic completed:",t),this.runStatus={epicId:t,isRunning:!1},this.activeToolInfo=null;break;case"run:task-awaiting":{console.log("[RunStream] Task awaiting:",e.taskId,e.awaitingType);const r=this.ticks.find(n=>n.id===e.taskId),a={tickId:e.taskId,title:(r==null?void 0:r.title)||e.taskId,awaitingType:e.awaitingType,signalReason:e.reason},o=this.awaitingTasks.findIndex(n=>n.tickId===e.taskId);o>=0?this.awaitingTasks=[...this.awaitingTasks.slice(0,o),a,...this.awaitingTasks.slice(o+1)]:this.awaitingTasks=[...this.awaitingTasks,a],(s=window.showToast)==null||s.call(window,{message:`Task ${e.taskId} needs human action: ${e.awaitingType}`,variant:"warning"});break}}}toggleRunPanel(){var e;this.showRunPanel=!this.showRunPanel,this.showRunPanel&&((e=this.runStatus)!=null&&e.isRunning)&&this.runStatus.epicId&&this.runPanelEpicId!==this.runStatus.epicId&&(this.runPanelEpicId=this.runStatus.epicId,this.subscribeToRunStream(this.runStatus.epicId))}closeRunPanel(){this.showRunPanel=!1}isInputFocused(){var s;let e=document.activeElement;for(;(s=e==null?void 0:e.shadowRoot)!=null&&s.activeElement;)e=e.shadowRoot.activeElement;if(!e)return!1;const t=e.tagName.toLowerCase();if(t==="input"||t==="textarea"||t==="select"||e.getAttribute("contenteditable")==="true")return!0;let i=e;for(;i;){const r=i.tagName.toLowerCase();if(r.startsWith("sl-")&&(r.includes("input")||r.includes("textarea")||r.includes("select")))return!0;const a=i.getRootNode();i=a instanceof ShadowRoot?a.host:null}return!1}getFocusedColumnTicks(){return this.focusedColumnIndex<0||this.focusedColumnIndex>=je.length?[]:this.getColumnTicks(je[this.focusedColumnIndex])}initializeFocus(){for(let e=0;e<je.length;e++)if(this.getColumnTicks(je[e]).length>0){this.focusedColumnIndex=e,this.focusedTickIndex=0;return}this.focusedColumnIndex=0,this.focusedTickIndex=-1}clearFocus(){this.focusedColumnIndex=-1,this.focusedTickIndex=-1}navigateVertical(e){if(this.focusedColumnIndex<0){this.initializeFocus();return}const t=this.getFocusedColumnTicks();if(t.length===0)return;let i=this.focusedTickIndex+e;i<0?i=t.length-1:i>=t.length&&(i=0),this.focusedTickIndex=i}navigateHorizontal(e){if(this.focusedColumnIndex<0){this.initializeFocus();return}let t=this.focusedColumnIndex+e;t<0?t=je.length-1:t>=je.length&&(t=0),this.focusedColumnIndex=t;const i=this.getColumnTicks(je[t]);i.length===0?this.focusedTickIndex=-1:this.focusedTickIndex>=i.length?this.focusedTickIndex=i.length-1:this.focusedTickIndex<0&&(this.focusedTickIndex=0),this.isMobile&&(this.activeColumn=je[t],this.updateBoardState())}openFocusedTick(){if(this.focusedColumnIndex<0||this.focusedTickIndex<0)return;const e=this.getFocusedColumnTicks();this.focusedTickIndex<e.length&&dt(e[this.focusedTickIndex].id)}handleEscape(){this.showRoadmap?this.showRoadmap=!1:this.showDashboard?this.showDashboard=!1:this.showKeyboardHelp?this.showKeyboardHelp=!1:this.selectedTick?dt(null):this.showRunPanel?this.showRunPanel=!1:this.clearFocus()}async toggleDashboard(){if(this.showDashboard=!this.showDashboard,this.showDashboard)try{this.dashboardActivities=await hr(20)}catch{this.dashboardActivities=[]}}async toggleRoadmap(){this.showRoadmap=!this.showRoadmap,this.showRoadmap&&await Ua()}handleDashboardEpicSelect(e){this.selectedEpic=e.detail.epicId,this.showDashboard=!1,this.updateBoardState()}handleDashboardTickSelect(e){dt(e.detail.tickId),this.showDashboard=!1}async handleDashboardTickResume(e){var i,s,r;const{tickId:t}=e.detail;try{const a=await Wr(()=>Promise.resolve().then(()=>Xr),void 0,import.meta.url).then(o=>o.approveTick(t));At({...a,is_blocked:(((i=a.blocked_by)==null?void 0:i.length)??0)>0,column:"ready"}),this.awaitingTasks=this.awaitingTasks.filter(o=>o.tickId!==t),(s=window.showToast)==null||s.call(window,{message:`Resumed tick ${t}`,variant:"success"})}catch(a){(r=window.showToast)==null||r.call(window,{message:`Failed to resume ${t}: ${a instanceof Error?a.message:a}`,variant:"danger"})}}async handleDashboardTickRetry(e){var i,s,r;const{tickId:t}=e.detail;try{const a=await Wr(()=>Promise.resolve().then(()=>Xr),void 0,import.meta.url).then(o=>o.reopenTick(t));At({...a,is_blocked:(((i=a.blocked_by)==null?void 0:i.length)??0)>0,column:"ready"}),this.awaitingTasks=this.awaitingTasks.filter(o=>o.tickId!==t),(s=window.showToast)==null||s.call(window,{message:`Retrying tick ${t}`,variant:"success"})}catch(a){(r=window.showToast)==null||r.call(window,{message:`Failed to retry ${t}: ${a instanceof Error?a.message:a}`,variant:"danger"})}}focusSearchInput(){var t;const e=(t=this.shadowRoot)==null?void 0:t.querySelector("tick-header");if(e!=null&&e.shadowRoot){const i=e.shadowRoot.querySelector("sl-input");i&&i.focus()}}getFocusedTickId(){if(this.focusedColumnIndex<0||this.focusedTickIndex<0)return null;const e=this.getFocusedColumnTicks();return this.focusedTickIndex<e.length?e[this.focusedTickIndex].id:null}updateBoardState(){this.boardState={ticks:this.ticks,epics:this.epics,selectedEpic:this.selectedEpic,searchTerm:this.searchTerm,activeColumn:this.activeColumn,isMobile:this.isMobile}}handleSearchChange(e){this.searchTerm=e.detail.value,this.updateBoardState()}handleEpicFilterChange(e){this.selectedEpic=e.detail.value,this.updateBoardState()}handleCreateClick(){this.showCreateDialog=!0}handleCreateDialogClose(){this.showCreateDialog=!1}handleTickCreated(e){var i;const{tick:t}=e.detail;At(t),this.showCreateDialog=!1,this.updateBoardState(),(i=window.showToast)==null||i.call(window,{message:`Created tick ${t.id}`,variant:"success"})}handleMenuToggle(){console.log("Menu toggle clicked")}handleMobileMenuToggle(){this.showMobileFilterDrawer=!0}handleMobileTabChange(e){const i=e.target.querySelector("sl-tab[active]");if(i){const s=i.getAttribute("panel");s&&je.includes(s)&&(this.activeColumn=s,this.focusedColumnIndex=je.indexOf(s),this.focusedTickIndex=this.getColumnTicks(s).length>0?0:-1,this.updateBoardState())}}handleMobileSearchInput(e){const t=e.target;this.searchTerm=t.value,this.updateBoardState()}handleMobileEpicFilterChange(e){const t=e.target;this.selectedEpic=t.value,this.updateBoardState()}handleActivityClick(e){const t=e.detail.tickId,i=this.ticks.find(s=>s.id===t);i?dt(i.id):window.showToast&&window.showToast({message:`Tick ${t} not found in current view`,variant:"warning"})}async handleTickSelected(e){const t=e.detail.tick;if(dt(t.id),!this.isCloudMode)try{const i=await ur(t.id);At(i)}catch(i){console.error("Failed to fetch tick details:",i)}}handleDrawerClose(){dt(null)}handleTickUpdated(e){const{tick:t}=e.detail;At(t),this.updateBoardState(),(!t.awaiting||t.status==="closed")&&(this.awaitingTasks=this.awaitingTasks.filter(i=>i.tickId!==t.id))}getFilteredTicks(){let e=this.ticks;if(this.searchTerm){const t=this.searchTerm.toLowerCase();e=e.filter(i=>i.id.toLowerCase().includes(t)||i.title.toLowerCase().includes(t)||i.description&&i.description.toLowerCase().includes(t))}return this.selectedEpic&&(e=e.filter(t=>t.parent===this.selectedEpic)),e}getColumnTicks(e){return this.getFilteredTicks().filter(t=>t.column===e)}getEpicNames(){const e={};for(const t of this.epics)e[t.id]=t.title;return e}renderRunPanel(){var i,s;const e=((i=this.runStatus)==null?void 0:i.isRunning)&&this.runStatus.activeTask,t=((s=this.epics.find(r=>r.id===this.runPanelEpicId))==null?void 0:s.title)||this.runPanelEpicId||"Unknown Epic";return c`
    ...
    `}renderActiveRun(){var t;const e=(t=this.runStatus)==null?void 0:t.activeTask;return e?c`
      <!-- Task info bar -->
      <div class="run-info-bar">
        ...
        ${this.runMetrics?c`<run-metrics .metrics=${this.runMetrics} ?live=${!0}></run-metrics>`:g}
      </div>

      <!-- Tool activity indicator -->
      ${this.activeToolInfo?c`
            <tool-activity
    ...
    `:g}renderAwaitingTasks(){const e={work:"🔧",approval:"✅",input:"💬",review:"👀",content:"📝",escalation:"🚨",checkpoint:"📍"};return c`
        ...
        <div class="awaiting-list">
          ${this.awaitingTasks.map(t=>c`
            <div class="awaiting-item" @click=${()=>this.handleAwaitingTaskClick(t.tickId)}>
              ...
              ${t.signalReason?c`<div class="awaiting-item-reason">${t.signalReason}</div>`:g}
            </div>
          `)}
        </div>
      </div>
    `}handleAwaitingTaskClick(e){dt(e)}renderNoRunState(){return c`
    ...
    `}render(){var t;if(this.loading)return c`
      ...
      `;const e=this.getEpicNames();return c`
      <tick-header
          ...
          ${Ss.map((i,s)=>c`
            <sl-tab-panel name=${i.id}>
              <div class="mobile-column-content">
                ${this.getColumnTicks(i.id).length===0?c`
                      <div class="mobile-empty-state">
                        <div class="empty-icon">${i.icon}</div>
                        <div>No ticks in ${i.name}</div>
                      </div>
                    `:this.getColumnTicks(i.id).map(r=>c`
                      <tick-card
                        .tick=${r}
  ...
  `;K([Jl({context:oc}),w()],V.prototype,"boardState",2);K([w()],V.prototype,"selectedEpic",2);K([w()],V.prototype,"searchTerm",2);K([w()],V.prototype,"activeColumn",2);K([w()],V.prototype,"isMobile",2);K([w()],V.prototype,"focusedColumnIndex",2);K([w()],V.prototype,"focusedTickIndex",2);K([w()],V.prototype,"showKeyboardHelp",2);K([w()],V.prototype,"showCreateDialog",2);K([w()],V.prototype,"showMobileFilterDrawer",2);K([w()],V.prototype,"showDashboard",2);K([w()],V.prototype,"dashboardActivities",2);K([w()],V.prototype,"showRoadmap",2);K([w()],V.prototype,"showRunPanel",2);K([w()],V.prototype,"runStatus",2);K([w()],V.prototype,"runPanelEpicId",2);K([w()],V.prototype,"runStreamConnected",2);K([w()],V.prototype,"activeToolInfo",2);K([w()],V.prototype,"runMetrics",2);K([w()],V.prototype,"awaitingTasks",2);V=K([me("tick-board")],V);const no=6048e5,Gc=864e5,Xc=6e4,Qc=36e5,Ei=43200,Qr=1440,Zr=Symbol.for("constructDateFrom");function tt(e,t){return typeof e=="function"?e(t):e&&typeof e=="object"&&Zr in e?e[Zr](t):e instanceof Date?new e.constructor(t):new Date(t)}function te(e,t){return tt(t||e,e)}let Zc={};function vi(){return Zc}function di(e,t){var n,h,d,p;const i=vi(),s=(t==null?void 0:t.weekStartsOn)??((h=(n=t==null?void 0:t.locale)==null?void 0:n.options)==null?void 0:h.weekStartsOn)??i.weekStartsOn??((p=(d=i.locale)==null?void 0:d.options)==null?void 0:p.weekStartsOn)??0,r=te(e,t==null?void 0:t.in),a=r.getDay(),o=(a<s?7:0)+a-s;return r.setDate(r.getDate()-o),r.setHours(0,0,0,0),r}function qi(e,t){return di(e,{...t,weekStartsOn:1})}function lo(e,t){const i=te(e,t==null?void 0:t.in),s=i.getFullYear(),r=tt(i,0);r.setFullYear(s+1,0,4),r.setHours(0,0,0,0);const a=qi(r),o=tt(i,0);o.setFullYear(s,0,4),o.setHours(0,0,0,0);const n=qi(o);return i.getTime()>=a.getTime()?s+1:i.getTime()>=n.getTime()?s:s-1}function Yi(e){const t=te(e),i=new Date(Date.UTC(t.getFullYear(),t.getMonth(),t.getDate(),t.getHours(),t.getMinutes(),t.getSeconds(),t.getMilliseconds()));return i.setUTCFullYear(t.getFullYear()),+e-+i}function yi(e,...t){const i=tt.bind(null,e||t.find(s=>typeof s=="object"));return t.map(i)}function Jr(e,t){const i=te(e,t==null?void 0:t.in);return i.setHours(0,0,0,0),i}function Jc(e,t,i){const[s,r]=yi(i==null?void 0:i.in,e,t),a=Jr(s),o=Jr(r),n=+a-Yi(a),h=+o-Yi(o);return Math.round((n-h)/Gc)}function ed(e,t){const i=lo(e,t),s=tt(e,0);return s.setFullYear(i,0,4),s.setHours(0,0,0,0),qi(s)}function Mi(e,t){const i=+te(e)-+te(t);return i<0?-1:i>0?1:i}function td(e){return tt(e,Date.now())}function id(e){return e instanceof Date||typeof e=="object"&&Object.prototype.toString.call(e)==="[object Date]"}function sd(e){return!(!id(e)&&typeof e!="number"||isNaN(+te(e)))}function rd(e,t,i){const[s,r]=yi(i==null?void 0:i.in,e,t),a=s.getFullYear()-r.getFullYear(),o=s.getMonth()-r.getMonth();return a*12+o}function mr(e){return t=>{const s=(e?Math[e]:Math.trunc)(t);return s===0?0:s}}function ad(e,t,i){const[s,r]=yi(i==null?void 0:i.in,e,t),a=(+s-+r)/Qc;return mr(i==null?void 0:i.roundingMethod)(a)}function co(e,t){return+te(e)-+te(t)}function od(e,t,i){const s=co(e,t)/Xc;return mr(i==null?void 0:i.roundingMethod)(s)}function nd(e,t){const i=te(e,t==null?void 0:t.in);return i.setHours(23,59,59,999),i}function ld(e,t){const i=te(e,t==null?void 0:t.in),s=i.getMonth();return i.setFullYear(i.getFullYear(),s+1,0),i.setHours(23,59,59,999),i}function cd(e,t){const i=te(e,t==null?void 0:t.in);return+nd(i,t)==+ld(i,t)}function dd(e,t,i){const[s,r,a]=yi(i==null?void 0:i.in,e,e,t),o=Mi(r,a),n=Math.abs(rd(r,a));if(n<1)return 0;r.getMonth()===1&&r.getDate()>27&&r.setDate(30),r.setMonth(r.getMonth()-o*n);let h=Mi(r,a)===-o;cd(s)&&n===1&&Mi(s,a)===1&&(h=!1);const d=o*(n-+h);return d===0?0:d}function ud(e,t,i){const s=co(e,t)/1e3;return mr(i==null?void 0:i.roundingMethod)(s)}function hd(e,t){const i=te(e,t==null?void 0:t.in);return i.setFullYear(i.getFullYear(),0,1),i.setHours(0,0,0,0),i}const pd={lessThanXSeconds:{one:"less than a second",other:"less than {{count}} seconds"},xSeconds:{one:"1 second",other:"{{count}} seconds"},halfAMinute:"half a minute",lessThanXMinutes:{one:"less than a minute",other:"less than {{count}} minutes"},xMinutes:{one:"1 minute",other:"{{count}} minutes"},aboutXHours:{one:"about 1 hour",other:"about {{count}} hours"},xHours:{one:"1 hour",other:"{{count}} hours"},xDays:{one:"1 day",other:"{{count}} days"},aboutXWeeks:{one:"about 1 week",other:"about {{count}} weeks"},xWeeks:{one:"1 week",other:"{{count}} weeks"},aboutXMonths:{one:"about 1 month",other:"about {{count}} months"},xMonths:{one:"1 month",other:"{{count}} months"},aboutXYears:{one:"about 1 year",other:"about {{count}} years"},xYears:{one:"1 year",other:"{{count}} years"},overXYears:{one:"over 1 year",other:"over {{count}} years"},almostXYears:{one:"almost 1 year",other:"almost {{count}} years"}},md=(e,t,i)=>{let s;const r=pd[e];return typeof r=="string"?s=r:t===1?s=r.one:s=r.other.replace("{{count}}",t.toString()),i!=null&&i.addSuffix?i.comparison&&i.comparison>0?"in "+s:s+" ago":s};function Es(e){return(t={})=>{const i=t.width?String(t.width):e.defaultWidth;return e.formats[i]||e.formats[e.defaultWidth]}}const fd={full:"EEEE, MMMM do, y",long:"MMMM do, y",medium:"MMM d, y",short:"MM/dd/yyyy"},bd={full:"h:mm:ss a zzzz",long:"h:mm:ss a z",medium:"h:mm:ss a",short:"h:mm a"},gd={full:"{{date}} 'at' {{time}}",long:"{{date}} 'at' {{time}}",medium:"{{date}}, {{time}}",short:"{{date}}, {{time}}"},vd={date:Es({formats:fd,defaultWidth:"full"}),time:Es({formats:bd,defaultWidth:"full"}),dateTime:Es({formats:gd,defaultWidth:"full"})},yd={lastWeek:"'last' eeee 'at' p",yesterday:"'yesterday at' p",today:"'today at' p",tomorrow:"'tomorrow at' p",nextWeek:"eeee 'at' p",other:"P"},wd=(e,t,i,s)=>yd[e];function Qt(e){return(t,i)=>{const s=i!=null&&i.context?String(i.context):"standalone";let r;if(s==="formatting"&&e.formattingValues){const o=e.defaultFormattingWidth||e.defaultWidth,n=i!=null&&i.width?String(i.width):o;r=e.formattingValues[n]||e.formattingValues[o]}else{const o=e.defaultWidth,n=i!=null&&i.width?String(i.width):e.defaultWidth;r=e.values[n]||e.values[o]}const a=e.argumentCallback?e.argumentCallback(t):t;return r[a]}}const kd={narrow:["B","A"],abbreviated:["BC","AD"],wide:["Before Christ","Anno Domini"]},xd={narrow:["1","2","3","4"],abbreviated:["Q1","Q2","Q3","Q4"],wide:["1st quarter","2nd quarter","3rd quarter","4th quarter"]},_d={narrow:["J","F","M","A","M","J","J","A","S","O","N","D"],abbreviated:["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],wide:["January","February","March","April","May","June","July","August","September","October","November","December"]},Cd={narrow:["S","M","T","W","T","F","S"],short:["Su","Mo","Tu","We","Th","Fr","Sa"],abbreviated:["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],wide:["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"]},$d={narrow:{am:"a",pm:"p",midnight:"mi",noon:"n",morning:"morning",afternoon:"afternoon",evening:"evening",night:"night"},abbreviated:{am:"AM",pm:"PM",midnight:"midnight",noon:"noon",morning:"morning",afternoon:"afternoon",evening:"evening",night:"night"},wide:{am:"a.m.",pm:"p.m.",midnight:"midnight",noon:"noon",morning:"morning",afternoon:"afternoon",evening:"evening",night:"night"}},Td={narrow:{am:"a",pm:"p",midnight:"mi",noon:"n",morning:"in the morning",afternoon:"in the afternoon",evening:"in the evening",night:"at night"},abbreviated:{am:"AM",pm:"PM",midnight:"midnight",noon:"noon",morning:"in the morning",afternoon:"in the afternoon",evening:"in the evening",night:"at night"},wide:{am:"a.m.",pm:"p.m.",midnight:"midnight",noon:"noon",morning:"in the morning",afternoon:"in the afternoon",evening:"in the evening",night:"at night"}},Sd=(e,t)=>{const i=Number(e),s=i%100;if(s>20||s<10)switch(s%10){case 1:return i+"st";case 2:return i+"nd";case 3:return i+"rd"}return i+"th"},Ed={ordinalNumber:Sd,era:Qt({values:kd,defaultWidth:"wide"}),quarter:Qt({values:xd,defaultWidth:"wide",argumentCallback:e=>e-1}),month:Qt({values:_d,defaultWidth:"wide"}),day:Qt({values:Cd,defaultWidth:"wide"}),dayPeriod:Qt({values:$d,defaultWidth:"wide",formattingValues:Td,defaultFormattingWidth:"wide"})};function Zt(e){return(t,i={})=>{const s=i.width,r=s&&e.matchPatterns[s]||e.matchPatterns[e.defaultMatchWidth],a=t.match(r);if(!a)return null;const o=a[0],n=s&&e.parsePatterns[s]||e.parsePatterns[e.defaultParseWidth],h=Array.isArray(n)?Rd(n,f=>f.test(o)):zd(n,f=>f.test(o));let d;d=e.valueCallback?e.valueCallback(h):h,d=i.valueCallback?i.valueCallback(d):d;const p=t.slice(o.length);return{value:d,rest:p}}}function zd(e,t){for(const i in e)if(Object.prototype.hasOwnProperty.call(e,i)&&t(e[i]))return i}function Rd(e,t){for(let i=0;i<e.length;i++)if(t(e[i]))return i}function Ad(e){return(t,i={})=>{const s=t.match(e.matchPattern);if(!s)return null;const r=s[0],a=t.match(e.parsePattern);if(!a)return null;let o=e.valueCallback?e.valueCallback(a[0]):a[0];o=i.valueCallback?i.valueCallback(o):o;const n=t.slice(r.length);return{value:o,rest:n}}}const Od=/^(\d+)(th|st|nd|rd)?/i,Id=/\d+/i,Dd={narrow:/^(b|a)/i,abbreviated:/^(b\.?\s?c\.?|b\.?\s?c\.?\s?e\.?|a\.?\s?d\.?|c\.?\s?e\.?)/i,wide:/^(before christ|before common era|anno domini|common era)/i},Md={any:[/^b/i,/^(a|c)/i]},Pd={narrow:/^[1234]/i,abbreviated:/^q[1234]/i,wide:/^[1234](th|st|nd|rd)? quarter/i},Ld={any:[/1/i,/2/i,/3/i,/4/i]},Fd={narrow:/^[jfmasond]/i,abbreviated:/^(jan|feb|mar|apr|may|jun|jul|aug|sep|oct|nov|dec)/i,wide:/^(january|february|march|april|may|june|july|august|september|october|november|december)/i},Nd={narrow:[/^j/i,/^f/i,/^m/i,/^a/i,/^m/i,/^j/i,/^j/i,/^a/i,/^s/i,/^o/i,/^n/i,/^d/i],any:[/^ja/i,/^f/i,/^mar/i,/^ap/i,/^may/i,/^jun/i,/^jul/i,/^au/i,/^s/i,/^o/i,/^n/i,/^d/i]},Bd={narrow:/^[smtwf]/i,short:/^(su|mo|tu|we|th|fr|sa)/i,abbreviated:/^(sun|mon|tue|wed|thu|fri|sat)/i,wide:/^(sunday|monday|tuesday|wednesday|thursday|friday|saturday)/i},Hd={narrow:[/^s/i,/^m/i,/^t/i,/^w/i,/^t/i,/^f/i,/^s/i],any:[/^su/i,/^m/i,/^tu/i,/^w/i,/^th/i,/^f/i,/^sa/i]},jd={narrow:/^(a|p|mi|n|(in the|at) (morning|afternoon|evening|night))/i,any:/^([ap]\.?\s?m\.?|midnight|noon|(in the|at) (morning|afternoon|evening|night))/i},Ud={any:{am:/^a/i,pm:/^p/i,midnight:/^mi/i,noon:/^no/i,morning:/morning/i,afternoon:/afternoon/i,evening:/evening/i,night:/night/i}},Vd={ordinalNumber:Ad({matchPattern:Od,parsePattern:Id,valueCallback:e=>parseInt(e,10)}),era:Zt({matchPatterns:Dd,defaultMatchWidth:"wide",parsePatterns:Md,defaultParseWidth:"any"}),quarter:Zt({matchPatterns:Pd,defaultMatchWidth:"wide",parsePatterns:Ld,defaultParseWidth:"any",valueCallback:e=>e+1}),month:Zt({matchPatterns:Fd,defaultMatchWidth:"wide",parsePatterns:Nd,defaultParseWidth:"any"}),day:Zt({matchPatterns:Bd,defaultMatchWidth:"wide",parsePatterns:Hd,defaultParseWidth:"any"}),dayPeriod:Zt({matchPatterns:jd,defaultMatchWidth:"any",parsePatterns:Ud,defaultParseWidth:"any"})},uo={code:"en-US",formatDistance:md,formatLong:vd,formatRelative:wd,localize:Ed,match:Vd,options:{weekStartsOn:0,firstWeekContainsDate:1}};function Wd(e,t){const i=te(e,t==null?void 0:t.in);return Jc(i,hd(i))+1}function qd(e,t){const i=te(e,t==null?void 0:t.in),s=+qi(i)-+ed(i);return Math.round(s/no)+1}function ho(e,t){var p,f,b,m;const i=te(e,t==null?void 0:t.in),s=i.getFullYear(),r=vi(),a=(t==null?void 0:t.firstWeekContainsDate)??((f=(p=t==null?void 0:t.locale)==null?void 0:p.options)==null?void 0:f.firstWeekContainsDate)??r.firstWeekContainsDate??((m=(b=r.locale)==null?void 0:b.options)==null?void 0:m.firstWeekContainsDate)??1,o=tt((t==null?void 0:t.in)||e,0);o.setFullYear(s+1,0,a),o.setHours(0,0,0,0);const n=di(o,t),h=tt((t==null?void 0:t.in)||e,0);h.setFullYear(s,0,a),h.setHours(0,0,0,0);const d=di(h,t);return+i>=+n?s+1:+i>=+d?s:s-1}function Yd(e,t){var n,h,d,p;const i=vi(),s=(t==null?void 0:t.firstWeekContainsDate)??((h=(n=t==null?void 0:t.locale)==null?void 0:n.options)==null?void 0:h.firstWeekContainsDate)??i.firstWeekContainsDate??((p=(d=i.locale)==null?void 0:d.options)==null?void 0:p.firstWeekContainsDate)??1,r=ho(e,t),a=tt((t==null?void 0:t.in)||e,0);return a.setFullYear(r,0,s),a.setHours(0,0,0,0),di(a,t)}function Kd(e,t){const i=te(e,t==null?void 0:t.in),s=+di(i,t)-+Yd(i,t);return Math.round(s/no)+1}function I(e,t){const i=e<0?"-":"",s=Math.abs(e).toString().padStart(t,"0");return i+s}const ct={y(e,t){const i=e.getFullYear(),s=i>0?i:1-i;return I(t==="yy"?s%100:s,t.length)},M(e,t){const i=e.getMonth();return t==="M"?String(i+1):I(i+1,2)},d(e,t){return I(e.getDate(),t.length)},a(e,t){const i=e.getHours()/12>=1?"pm":"am";switch(t){case"a":case"aa":return i.toUpperCase();case"aaa":return i;case"aaaaa":return i[0];case"aaaa":default:return i==="am"?"a.m.":"p.m."}},h(e,t){return I(e.getHours()%12||12,t.length)},H(e,t){return I(e.getHours(),t.length)},m(e,t){return I(e.getMinutes(),t.length)},s(e,t){return I(e.getSeconds(),t.length)},S(e,t){const i=t.length,s=e.getMilliseconds(),r=Math.trunc(s*Math.pow(10,i-3));return I(r,t.length)}},Rt={midnight:"midnight",noon:"noon",morning:"morning",afternoon:"afternoon",evening:"evening",night:"night"},ea={G:function(e,t,i){const s=e.getFullYear()>0?1:0;switch(t){case"G":case"GG":case"GGG":return i.era(s,{width:"abbreviated"});case"GGGGG":return i.era(s,{width:"narrow"});case"GGGG":default:return i.era(s,{width:"wide"})}},y:function(e,t,i){if(t==="yo"){const s=e.getFullYear(),r=s>0?s:1-s;return i.ordinalNumber(r,{unit:"year"})}return ct.y(e,t)},Y:function(e,t,i,s){const r=ho(e,s),a=r>0?r:1-r;if(t==="YY"){const o=a%100;return I(o,2)}return t==="Yo"?i.ordinalNumber(a,{unit:"year"}):I(a,t.length)},R:function(e,t){const i=lo(e);return I(i,t.length)},u:function(e,t){const i=e.getFullYear();return I(i,t.length)},Q:function(e,t,i){const s=Math.ceil((e.getMonth()+1)/3);switch(t){case"Q":return String(s);case"QQ":return I(s,2);case"Qo":return i.ordinalNumber(s,{unit:"quarter"});case"QQQ":return i.quarter(s,{width:"abbreviated",context:"formatting"});case"QQQQQ":return i.quarter(s,{width:"narrow",context:"formatting"});case"QQQQ":default:return i.quarter(s,{width:"wide",context:"formatting"})}},q:function(e,t,i){const s=Math.ceil((e.getMonth()+1)/3);switch(t){case"q":return String(s);case"qq":return I(s,2);case"qo":return i.ordinalNumber(s,{unit:"quarter"});case"qqq":return i.quarter(s,{width:"abbreviated",context:"standalone"});case"qqqqq":return i.quarter(s,{width:"narrow",context:"standalone"});case"qqqq":default:return i.quarter(s,{width:"wide",context:"standalone"})}},M:function(e,t,i){const s=e.getMonth();switch(t){case"M":case"MM":return ct.M(e,t);case"Mo":return i.ordinalNumber(s+1,{unit:"month"});case"MMM":return i.month(s,{width:"abbreviated",context:"formatting"});case"MMMMM":return i.month(s,{width:"narrow",context:"formatting"});case"MMMM":default:return i.month(s,{width:"wide",context:"formatting"})}},L:function(e,t,i){const s=e.getMonth();switch(t){case"L":return String(s+1);case"LL":return I(s+1,2);case"Lo":return i.ordinalNumber(s+1,{unit:"month"});case"LLL":return i.month(s,{width:"abbreviated",context:"standalone"});case"LLLLL":return i.month(s,{width:"narrow",context:"standalone"});case"LLLL":default:return i.month(s,{width:"wide",context:"standalone"})}},w:function(e,t,i,s){const r=Kd(e,s);return t==="wo"?i.ordinalNumber(r,{unit:"week"}):I(r,t.length)},I:function(e,t,i){const s=qd(e);return t==="Io"?i.ordinalNumber(s,{unit:"week"}):I(s,t.length)},d:function(e,t,i){return t==="do"?i.ordinalNumber(e.getDate(),{unit:"date"}):ct.d(e,t)},D:function(e,t,i){const s=Wd(e);return t==="Do"?i.ordinalNumber(s,{unit:"dayOfYear"}):I(s,t.length)},E:function(e,t,i){const s=e.getDay();switch(t){case"E":case"EE":case"EEE":return i.day(s,{width:"abbreviated",context:"formatting"});case"EEEEE":return i.day(s,{width:"narrow",context:"formatting"});case"EEEEEE":return i.day(s,{width:"short",context:"formatting"});case"EEEE":default:return i.day(s,{width:"wide",context:"formatting"})}},e:function(e,t,i,s){const r=e.getDay(),a=(r-s.weekStartsOn+8)%7||7;switch(t){case"e":return String(a);case"ee":return I(a,2);case"eo":return i.ordinalNumber(a,{unit:"day"});case"eee":return i.day(r,{width:"abbreviated",context:"formatting"});case"eeeee":return i.day(r,{width:"narrow",context:"formatting"});case"eeeeee":return i.day(r,{width:"short",context:"formatting"});case"eeee":default:return i.day(r,{width:"wide",context:"formatting"})}},c:function(e,t,i,s){const r=e.getDay(),a=(r-s.weekStartsOn+8)%7||7;switch(t){case"c":return String(a);case"cc":return I(a,t.length);case"co":return i.ordinalNumber(a,{unit:"day"});case"ccc":return i.day(r,{width:"abbreviated",context:"standalone"});case"ccccc":return i.day(r,{width:"narrow",context:"standalone"});case"cccccc":return i.day(r,{width:"short",context:"standalone"});case"cccc":default:return i.day(r,{width:"wide",context:"standalone"})}},i:function(e,t,i){const s=e.getDay(),r=s===0?7:s;switch(t){case"i":return String(r);case"ii":return I(r,t.length);case"io":return i.ordinalNumber(r,{unit:"day"});case"iii":return i.day(s,{width:"abbreviated",context:"formatting"});case"iiiii":return i.day(s,{width:"narrow",context:"formatting"});case"iiiiii":return i.day(s,{width:"short",context:"formatting"});case"iiii":default:return i.day(s,{width:"wide",context:"formatting"})}},a:function(e,t,i){const r=e.getHours()/12>=1?"pm":"am";switch(t){case"a":case"aa":return i.dayPeriod(r,{width:"abbreviated",context:"formatting"});case"aaa":return i.dayPeriod(r,{width:"abbreviated",context:"formatting"}).toLowerCase();case"aaaaa":return i.dayPeriod(r,{width:"narrow",context:"formatting"});case"aaaa":default:return i.dayPeriod(r,{width:"wide",context:"formatting"})}},b:function(e,t,i){const s=e.getHours();let r;switch(s===12?r=Rt.noon:s===0?r=Rt.midnight:r=s/12>=1?"pm":"am",t){case"b":case"bb":return i.dayPeriod(r,{width:"abbreviated",context:"formatting"});case"bbb":return i.dayPeriod(r,{width:"abbreviated",context:"formatting"}).toLowerCase();case"bbbbb":return i.dayPeriod(r,{width:"narrow",context:"formatting"});case"bbbb":default:return i.dayPeriod(r,{width:"wide",context:"formatting"})}},B:function(e,t,i){const s=e.getHours();let r;switch(s>=17?r=Rt.evening:s>=12?r=Rt.afternoon:s>=4?r=Rt.morning:r=Rt.night,t){case"B":case"BB":case"BBB":return i.dayPeriod(r,{width:"abbreviated",context:"formatting"});case"BBBBB":return i.dayPeriod(r,{width:"narrow",context:"formatting"});case"BBBB":default:return i.dayPeriod(r,{width:"wide",context:"formatting"})}},h:function(e,t,i){if(t==="ho"){let s=e.getHours()%12;return s===0&&(s=12),i.ordinalNumber(s,{unit:"hour"})}return ct.h(e,t)},H:function(e,t,i){return t==="Ho"?i.ordinalNumber(e.getHours(),{unit:"hour"}):ct.H(e,t)},K:function(e,t,i){const s=e.getHours()%12;return t==="Ko"?i.ordinalNumber(s,{unit:"hour"}):I(s,t.length)},k:function(e,t,i){let s=e.getHours();return s===0&&(s=24),t==="ko"?i.ordinalNumber(s,{unit:"hour"}):I(s,t.length)},m:function(e,t,i){return t==="mo"?i.ordinalNumber(e.getMinutes(),{unit:"minute"}):ct.m(e,t)},s:function(e,t,i){return t==="so"?i.ordinalNumber(e.getSeconds(),{unit:"second"}):ct.s(e,t)},S:function(e,t){return ct.S(e,t)},X:function(e,t,i){const s=e.getTimezoneOffset();if(s===0)return"Z";switch(t){case"X":return ia(s);case"XXXX":case"XX":return kt(s);case"XXXXX":case"XXX":default:return kt(s,":")}},x:function(e,t,i){const s=e.getTimezoneOffset();switch(t){case"x":return ia(s);case"xxxx":case"xx":return kt(s);case"xxxxx":case"xxx":default:return kt(s,":")}},O:function(e,t,i){const s=e.getTimezoneOffset();switch(t){case"O":case"OO":case"OOO":return"GMT"+ta(s,":");case"OOOO":default:return"GMT"+kt(s,":")}},z:function(e,t,i){const s=e.getTimezoneOffset();switch(t){case"z":case"zz":case"zzz":return"GMT"+ta(s,":");case"zzzz":default:return"GMT"+kt(s,":")}},t:function(e,t,i){const s=Math.trunc(+e/1e3);return I(s,t.length)},T:function(e,t,i){return I(+e,t.length)}};function ta(e,t=""){const i=e>0?"-":"+",s=Math.abs(e),r=Math.trunc(s/60),a=s%60;return a===0?i+String(r):i+String(r)+t+I(a,2)}function ia(e,t){return e%60===0?(e>0?"-":"+")+I(Math.abs(e)/60,2):kt(e,t)}function kt(e,t=""){const i=e>0?"-":"+",s=Math.abs(e),r=I(Math.trunc(s/60),2),a=I(s%60,2);return i+r+t+a}const sa=(e,t)=>{switch(e){case"P":return t.date({width:"short"});case"PP":return t.date({width:"medium"});case"PPP":return t.date({width:"long"});case"PPPP":default:return t.date({width:"full"})}},po=(e,t)=>{switch(e){case"p":return t.time({width:"short"});case"pp":return t.time({width:"medium"});case"ppp":return t.time({width:"long"});case"pppp":default:return t.time({width:"full"})}},Gd=(e,t)=>{const i=e.match(/(P+)(p+)?/)||[],s=i[1],r=i[2];if(!r)return sa(e,t);let a;switch(s){case"P":a=t.dateTime({width:"short"});break;case"PP":a=t.dateTime({width:"medium"});break;case"PPP":a=t.dateTime({width:"long"});break;case"PPPP":default:a=t.dateTime({width:"full"});break}return a.replace("{{date}}",sa(s,t)).replace("{{time}}",po(r,t))},Xd={p:po,P:Gd},Qd=/^D+$/,Zd=/^Y+$/,Jd=["D","DD","YY","YYYY"];function eu(e){return Qd.test(e)}function tu(e){return Zd.test(e)}function iu(e,t,i){const s=su(e,t,i);if(console.warn(s),Jd.includes(e))throw new RangeError(s)}function su(e,t,i){const s=e[0]==="Y"?"years":"days of the month";return`Use \`${e.toLowerCase()}\` instead of \`${e}\` (in \`${t}\`) for formatting ${s} to the input \`${i}\`; see: https://github.com/date-fns/date-fns/blob/master/docs/unicodeTokens.md`}const ru=/[yYQqMLwIdDecihHKkms]o|(\w)\1*|''|'(''|[^'])+('|$)|./g,au=/P+p+|P+|p+|''|'(''|[^'])+('|$)|./g,ou=/^'([^]*?)'?$/,nu=/''/g,lu=/[a-zA-Z]/;function cu(e,t,i){var p,f,b,m;const s=vi(),r=s.locale??uo,a=s.firstWeekContainsDate??((f=(p=s.locale)==null?void 0:p.options)==null?void 0:f.firstWeekContainsDate)??1,o=s.weekStartsOn??((m=(b=s.locale)==null?void 0:b.options)==null?void 0:m.weekStartsOn)??0,n=te(e,i==null?void 0:i.in);if(!sd(n))throw new RangeError("Invalid time value");let h=t.match(au).map(v=>{const y=v[0];if(y==="p"||y==="P"){const k=Xd[y];return k(v,r.formatLong)}return v}).join("").match(ru).map(v=>{if(v==="''")return{isToken:!1,value:"'"};const y=v[0];if(y==="'")return{isToken:!1,value:du(v)};if(ea[y])return{isToken:!0,value:v};if(y.match(lu))throw new RangeError("Format string contains an unescaped latin alphabet character `"+y+"`");return{isToken:!1,value:v}});r.localize.preprocessor&&(h=r.localize.preprocessor(n,h));const d={firstWeekContainsDate:a,weekStartsOn:o,locale:r};return h.map(v=>{if(!v.isToken)return v.value;const y=v.value;(tu(y)||eu(y))&&iu(y,t,String(e));const k=ea[y[0]];return k(n,y,r.localize,d)}).join("")}function du(e){const t=e.match(ou);return t?t[1].replace(nu,"'"):e}function uu(e,t,i){const s=vi(),r=(i==null?void 0:i.locale)??s.locale??uo,a=2520,o=Mi(e,t);if(isNaN(o))throw new RangeError("Invalid time value");const n=Object.assign({},i,{addSuffix:i==null?void 0:i.addSuffix,comparison:o}),[h,d]=yi(i==null?void 0:i.in,...o>0?[t,e]:[e,t]),p=ud(d,h),f=(Yi(d)-Yi(h))/1e3,b=Math.round((p-f)/60);let m;if(b<2)return i!=null&&i.includeSeconds?p<5?r.formatDistance("lessThanXSeconds",5,n):p<10?r.formatDistance("lessThanXSeconds",10,n):p<20?r.formatDistance("lessThanXSeconds",20,n):p<40?r.formatDistance("halfAMinute",0,n):p<60?r.formatDistance("lessThanXMinutes",1,n):r.formatDistance("xMinutes",1,n):b===0?r.formatDistance("lessThanXMinutes",1,n):r.formatDistance("xMinutes",b,n);if(b<45)return r.formatDistance("xMinutes",b,n);if(b<90)return r.formatDistance("aboutXHours",1,n);if(b<Qr){const v=Math.round(b/60);return r.formatDistance("aboutXHours",v,n)}else{if(b<a)return r.formatDistance("xDays",1,n);if(b<Ei){const v=Math.round(b/Qr);return r.formatDistance("xDays",v,n)}else if(b<Ei*2)return m=Math.round(b/Ei),r.formatDistance("aboutXMonths",m,n)}if(m=dd(d,h),m<12){const v=Math.round(b/Ei);return r.formatDistance("xMonths",v,n)}else{const v=m%12,y=Math.trunc(m/12);return v<3?r.formatDistance("aboutXYears",y,n):v<9?r.formatDistance("overXYears",y,n):r.formatDistance("almostXYears",y+1,n)}}function hu(e,t){return uu(e,td(e),t)}var pu=Object.defineProperty,mu=Object.getOwnPropertyDescriptor,Et=(e,t,i,s)=>{for(var r=s>1?void 0:s?mu(t,i):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(r=(s?o(t,i,r):o(r))||r);return s&&r&&pu(t,i,r),r};const ra={0:"var(--red)",1:"var(--peach)",2:"var(--yellow)",3:"var(--green)",4:"var(--subtext0)"},fu={0:"Critical",1:"High",2:"Medium",3:"Low",4:"Backlog"};let it=class extends oe{constructor(){super(...arguments),this.selected=!1,this.focused=!1,this.elapsedTime=""}connectedCallback(){super.connectedCallback(),this.updateElapsedTime(),this.updateTimerId=setInterval(()=>this.updateElapsedTime(),3e4)}disconnectedCallback(){super.disconnectedCallback(),this.updateTimerId&&(clearInterval(this.updateTimerId),this.updateTimerId=void 0)}updated(e){e.has("focused")&&this.focused&&this.cardElement&&this.cardElement.scrollIntoView({behavior:"smooth",block:"nearest"}),e.has("tick")&&this.updateElapsedTime()}updateElapsedTime(){var a;if(((a=this.tick)==null?void 0:a.status)!=="in_progress"||!this.tick.started_at){this.elapsedTime="";return}const e=new Date(this.tick.started_at),t=new Date,i=od(t,e),s=ad(t,e),r=i%60;s>0?this.elapsedTime=`${s}h ${r}m`:this.elapsedTime=`${i}m`}handleClick(){this.dispatchEvent(new CustomEvent("tick-selected",{detail:{tick:this.tick},bubbles:!0,composed:!0}))}getPriorityColor(){return ra[this.tick.priority]??ra[2]}getPriorityLabel(){return fu[this.tick.priority]??"Unknown"}renderVerificationBadge(){const e=this.tick.verification_status;if(!e)return null;switch(e){case"verified":return c`<span class="meta-badge verified">✓ verified</span>`;case"failed":return c`<span class="meta-badge verification-failed">✗ failed</span>`;case"pending":return c`<span class="meta-badge verification-pending">⋯ pending</span>`;default:return null}}render(){const{tick:e,selected:t,focused:i,epicName:s}=this;return c`
      <div
      ...
      >
        ...
        <div class="card-meta">
          ...
          ${e.is_blocked?c`<span class="meta-badge blocked">⊘ blocked</span>`:null}
          ${e.manual?c`<span class="meta-badge manual">👤 manual</span>`:null}
          ${e.awaiting?c`<span class="meta-badge awaiting">⏳ ${e.awaiting}</span>`:null}
          ${this.renderVerificationBadge()}
        </div>

        ${s?c`<div class="epic-name">${s}</div>`:null}

        ${this.elapsedTime?c`<div class="working-time">⏱ Working for ${this.elapsedTime}</div>`:null}
      </div>
    `}};it.styles=$`
    :host {
      display: block;
  ...
  `;Et([u({attribute:!1})],it.prototype,"tick",2);Et([u({type:Boolean})],it.prototype,"selected",2);Et([u({type:Boolean})],it.prototype,"focused",2);Et([u({type:String,attribute:"epic-name"})],it.prototype,"epicName",2);Et([C(".card")],it.prototype,"cardElement",2);Et([w()],it.prototype,"elapsedTime",2);it=Et([me("tick-card")],it);var bu=Object.defineProperty,gu=Object.getOwnPropertyDescriptor,Ut=(e,t,i,s)=>{for(var r=s>1?void 0:s?gu(t,i):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(r=(s?o(t,i,r):o(r))||r);return s&&r&&bu(t,i,r),r};const vu={blocked:"var(--red)",ready:"var(--yellow)",agent:"var(--blue)",human:"var(--mauve)",done:"var(--green)"},yu={blocked:"Blocked",ready:"Ready",agent:"In Progress",human:"Needs Human",done:"Done"},wu={blocked:"⊘",ready:"▶",agent:"●",human:"👤",done:"✓"};let ft=class extends oe{constructor(){super(...arguments),this.name="ready",this.color="",this.ticks=[],this.epicNames={},this.focusedTickId=""}getColumnColor(){return this.color||vu[this.name]||"var(--blue)"}getColumnDisplayName(){return yu[this.name]||this.name}getColumnIcon(){return wu[this.name]||"•"}handleTickSelected(e){this.dispatchEvent(new CustomEvent("tick-selected",{detail:e.detail,bubbles:!0,composed:!0}))}render(){const e=this.getColumnColor(),t=this.getColumnDisplayName(),i=this.getColumnIcon(),s=this.ticks.length;return c`
  ...
  `;Ut([u({type:String})],ft.prototype,"name",2);Ut([u({type:String})],ft.prototype,"color",2);Ut([u({attribute:!1})],ft.prototype,"ticks",2);Ut([u({type:Object,attribute:!1})],ft.prototype,"epicNames",2);Ut([u({type:String,attribute:"focused-tick-id"})],ft.prototype,"focusedTickId",2);ft=Ut([me("tick-column")],ft);var ku=Object.defineProperty,xu=Object.getOwnPropertyDescriptor,Fe=(e,t,i,s)=>{for(var r=s>1?void 0:s?xu(t,i):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(r=(s?o(t,i,r):o(r))||r);return s&&r&&ku(t,i,r),r};let we=class extends oe{constructor(){super(...arguments),this.repoName="",this.epics=[],this.selectedEpic="",this.searchTerm="",this.runPanelOpen=!1,this.runActive=!1,this.awaitingCount=0,this.readonlyMode=!1,this.connectionStatus="disconnected",this.debounceTimeout=null}handleSearchInput(e){const i=e.target.value;this.debounceTimeout&&clearTimeout(this.debounceTimeout),this.debounceTimeout=setTimeout(()=>{this.dispatchEvent(new CustomEvent("search-change",{detail:{value:i},bubbles:!0,composed:!0}))},300)}handleEpicFilterChange(e){const t=e.target;this.dispatchEvent(new CustomEvent("epic-filter-change",{detail:{value:t.value},bubbles:!0,composed:!0}))}handleCreateClick(){this.dispatchEvent(new CustomEvent("create-click",{bubbles:!0,composed:!0}))}handleMenuToggle(){this.dispatchEvent(new CustomEvent("menu-toggle",{bubbles:!0,composed:!0}))}handleActivityClick(e){this.dispatchEvent(new CustomEvent("activity-click",{detail:e.detail,bubbles:!0,composed:!0}))}handleRunPanelToggle(){this.dispatchEvent(new CustomEvent("run-panel-toggle",{bubbles:!0,composed:!0}))}handleDashboardToggle(){this.dispatchEvent(new CustomEvent("dashboard-toggle",{bubbles:!0,composed:!0}))}handleRoadmapToggle(){this.dispatchEvent(new CustomEvent("roadmap-toggle",{bubbles:!0,composed:!0}))}getConnectionTooltip(){switch(this.connectionStatus){case"connected":return"Connected to server";case"connecting":return"Connecting...";case"disconnected":return"Disconnected from server"}}disconnectedCallback(){super.disconnectedCallback(),this.debounceTimeout&&clearTimeout(this.debounceTimeout)}render(){return c`
      <header>
        <div class="header-left">
          ...
          ${this.readonlyMode?c`<a href="/app" style="text-decoration: none;"><ticks-logo variant="logotype" .size=${24}></ticks-logo></a>`:c`<ticks-logo variant="logotype" .size=${24}></ticks-logo>`}
          <sl-tooltip content=${this.getConnectionTooltip()}>
            <span class="connection-status ${this.connectionStatus}"></span>
          </sl-tooltip>
          ${this.repoName?c`<span class="repo-badge">${this.repoName}</span>`:null}
          ${this.readonlyMode?c`
        ...
        <div class="header-right">
          ...
          <sl-tooltip content="Live run panel (r)">
            ...
            >
              <sl-icon name="terminal"></sl-icon>
              ${this.awaitingCount>0?c`<sl-badge variant="warning" pill pulse>${this.awaitingCount}</sl-badge>`:g}
            </sl-button>
          </sl-tooltip>
  ...
  `;Fe([u({type:String,attribute:"repo-name"})],we.prototype,"repoName",2);Fe([u({attribute:!1})],we.prototype,"epics",2);Fe([u({type:String,attribute:"selected-epic"})],we.prototype,"selectedEpic",2);Fe([u({type:String,attribute:"search-term"})],we.prototype,"searchTerm",2);Fe([u({type:Boolean,attribute:"run-panel-open"})],we.prototype,"runPanelOpen",2);Fe([u({type:Boolean,attribute:"run-active"})],we.prototype,"runActive",2);Fe([u({type:Number,attribute:"awaiting-count"})],we.prototype,"awaitingCount",2);Fe([u({type:Boolean,attribute:"readonly-mode"})],we.prototype,"readonlyMode",2);Fe([u({type:String,attribute:"connection-status"})],we.prototype,"connectionStatus",2);Fe([w()],we.prototype,"debounceTimeout",2);we=Fe([me("tick-header")],we);var _u=Object.defineProperty,Cu=Object.getOwnPropertyDescriptor,fs=(e,t,i,s)=>{for(var r=s>1?void 0:s?Cu(t,i):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(r=(s?o(t,i,r):o(r))||r);return s&&r&&_u(t,i,r),r};let Lt=class extends oe{constructor(){super(...arguments),this.record=null,this.loading=!1,this.error=""}formatTimestamp(e){return new Date(e).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric",hour:"numeric",minute:"2-digit"})}formatTokenCount(e){return e>=1e6?`${(e/1e6).toFixed(1)}M`:e>=1e3?`${(e/1e3).toFixed(1)}K`:e.toString()}formatCost(e){return e===0?"$0.00":e<.01?`$${e.toFixed(4)}`:e<1?`$${e.toFixed(3)}`:`$${e.toFixed(2)}`}formatDuration(e){if(e<1e3)return`${e}ms`;const t=Math.floor(e/1e3);if(t<60)return`${t}s`;const i=Math.floor(t/60),s=t%60;return`${i}m ${s}s`}truncateText(e,t=50){return e.length<=t?e:e.slice(0,t)+"..."}renderSummary(e){const t=e.metrics.input_tokens+e.metrics.output_tokens,i=e.success?"success":"error";return c`
      <div class="summary-section">
        ...
        ${!e.success&&e.error_msg?c`<div class="error-box"><strong>Error:</strong> ${e.error_msg}</div>`:g}
      </div>
    `}renderMetrics(e){const t=e.metrics;return c`
    ...
    `}renderOutput(e){return e.output?c`
      <sl-details summary="Output">
        <div class="content-block">${e.output}</div>
      </sl-details>
    `:g}renderThinking(e){return e.thinking?c`
      <sl-details summary="Thinking">
        <div class="content-block">${e.thinking}</div>
      </sl-details>
    `:g}renderToolItem(e){return c`
      <li class="tool-item">
        <span class="tool-name ${e.is_error?"error":""}">${e.name}</span>
        ${e.input?c`<span class="tool-input-preview">${this.truncateText(e.input)}</span>`:g}
        <span class="tool-duration">${this.formatDuration(e.duration_ms)}</span>
        ${e.is_error?c`<sl-icon class="tool-error-icon" name="x-circle-fill"></sl-icon>`:g}
      </li>
    `}renderTools(e){return!e.tools||e.tools.length===0?g:c`
      <sl-details summary="Tools (${e.tools.length})">
        <ul class="tools-list">
          ${e.tools.map(t=>this.renderToolItem(t))}
        </ul>
      </sl-details>
    `}renderVerifierResult(e){const t=e.passed?"passed":"failed";return c`
      <div class="verifier-item ${t}">
        ...
        <div class="verifier-content">
          ...
          ${e.error?c`<div class="verifier-error">${e.error}</div>`:g}
          ${e.output?c`<div class="verifier-output">${e.output}</div>`:g}
        </div>
      </div>
    `}renderVerification(e){if(!e.verification)return g;const t=e.verification,i=t.all_passed?"passed":"failed",s=t.results||[];return c`
    ...
    `}render(){if(this.loading)return c`
        <div class="loading">
          <sl-spinner></sl-spinner>
          <span>Loading run record...</span>
        </div>
      `;if(this.error)return c`<div class="error">${this.error}</div>`;if(!this.record)return c`<div class="empty">No run record available</div>`;const e=this.record,t=e.success?"success":"error";return c`
  ...
  `;fs([u({attribute:!1})],Lt.prototype,"record",2);fs([u({type:Boolean})],Lt.prototype,"loading",2);fs([u({type:String})],Lt.prototype,"error",2);Lt=fs([me("run-record")],Lt);var $u=Object.defineProperty,Tu=Object.getOwnPropertyDescriptor,q=(e,t,i,s)=>{for(var r=s>1?void 0:s?Tu(t,i):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(r=(s?o(t,i,r):o(r))||r);return s&&r&&$u(t,i,r),r};const Su={0:"Critical",1:"High",2:"Medium",3:"Low",4:"Backlog"},aa={0:"var(--red)",1:"var(--peach)",2:"var(--yellow)",3:"var(--green)",4:"var(--subtext0)"};let U=class extends oe{constructor(){super(...arguments),this.tick=null,this.open=!1,this.notesList=[],this.blockerDetails=[],this.readonlyMode=!1,this.loading=!1,this.errorMessage="",this.showRejectInput=!1,this.showCloseInput=!1,this.rejectReason="",this.closeReason="",this.newNoteText="",this.addingNote=!1,this.addNoteError="",this.optimisticNote=null,this.runRecord=null,this.loadingRunRecord=!1,this.runRecordError="",this.expandedSections=new Set,this.activeTab="overview",this.isCloudModeController=new J.StoreController(this,qe)}get isCloudMode(){return this.isCloudModeController.value}handleDrawerHide(){this.resetActionState(),this.dispatchEvent(new CustomEvent("drawer-close",{bubbles:!0,composed:!0}))}updated(e){e.has("tick")&&(this.resetActionState(),this.tick&&this.tick.type==="task"&&this.loadRunRecord())}async loadRunRecord(){if(this.tick){if(this.isCloudMode){this.loadingRunRecord=!1;return}this.loadingRunRecord=!0,this.runRecordError="",this.runRecord=null;try{this.runRecord=await pr(this.tick.id)}catch(e){this.runRecordError=e instanceof Error?e.message:"Failed to load run history"}finally{this.loadingRunRecord=!1}}}handleTickLinkClick(e){this.dispatchEvent(new CustomEvent("tick-link-click",{detail:{tickId:e},bubbles:!0,composed:!0}))}resetActionState(){this.showRejectInput=!1,this.showCloseInput=!1,this.rejectReason="",this.closeReason="",this.errorMessage="",this.newNoteText="",this.addingNote=!1,this.addNoteError="",this.optimisticNote=null,this.runRecord=null,this.loadingRunRecord=!1,this.runRecordError="",this.expandedSections=new Set,this.activeTab="overview"}emitTickUpdated(e){this.dispatchEvent(new CustomEvent("tick-updated",{detail:{tick:e},bubbles:!0,composed:!0}))}async handleApprove(){var e;if(this.tick){this.loading=!0,this.errorMessage="";try{const t=await Za(this.tick.id),i={...t,is_blocked:(((e=t.blocked_by)==null?void 0:e.length)??0)>0,column:"ready"};this.emitTickUpdated(i),this.resetActionState()}catch(t){this.errorMessage=t instanceof Error?t.message:"Failed to approve tick"}finally{this.loading=!1}}}handleRejectClick(){this.showRejectInput=!0,this.showCloseInput=!1}handleRejectCancel(){this.showRejectInput=!1,this.rejectReason=""}async handleRejectConfirm(){var e;if(!(!this.tick||!this.rejectReason.trim())){this.loading=!0,this.errorMessage="";try{const t=await Ja(this.tick.id,this.rejectReason.trim()),i={...t,is_blocked:(((e=t.blocked_by)==null?void 0:e.length)??0)>0,column:"ready"};this.emitTickUpdated(i),this.resetActionState()}catch(t){this.errorMessage=t instanceof Error?t.message:"Failed to reject tick"}finally{this.loading=!1}}}handleCloseClick(){this.showCloseInput=!0,this.showRejectInput=!1}handleCloseCancel(){this.showCloseInput=!1,this.closeReason=""}async handleCloseConfirm(){var e;if(this.tick){this.loading=!0,this.errorMessage="";try{const t=await eo(this.tick.id,this.closeReason.trim()||void 0),i={...t,is_blocked:(((e=t.blocked_by)==null?void 0:e.length)??0)>0,column:"done"};this.emitTickUpdated(i),this.resetActionState()}catch(t){this.errorMessage=t instanceof Error?t.message:"Failed to close tick"}finally{this.loading=!1}}}async handleReopen(){var e;if(this.tick){this.loading=!0,this.errorMessage="";try{const t=await to(this.tick.id),i={...t,is_blocked:(((e=t.blocked_by)==null?void 0:e.length)??0)>0,column:"ready"};this.emitTickUpdated(i),this.resetActionState()}catch(t){this.errorMessage=t instanceof Error?t.message:"Failed to reopen tick"}finally{this.loading=!1}}}async handleAddNote(){var t;if(!this.tick||!this.newNoteText.trim())return;const e=this.newNoteText.trim();this.addingNote=!0,this.addNoteError="",this.optimisticNote={timestamp:new Date().toISOString(),author:"You",text:e},this.newNoteText="";try{const i=await Qa(this.tick.id,e);this.optimisticNote=null;const s={...i,is_blocked:(((t=i.blocked_by)==null?void 0:t.length)??0)>0,column:"ready",notesList:li(i.notes)};this.emitTickUpdated(s)}catch(i){this.optimisticNote=null,this.newNoteText=e,this.addNoteError=i instanceof Error?i.message:"Failed to add note"}finally{this.addingNote=!1}}formatTimestamp(e){return new Date(e).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric",hour:"numeric",minute:"2-digit"})}getPriorityLabel(e){return Su[e]??"Unknown"}getPriorityColor(e){return aa[e]??aa[2]}formatStartedAt(e){const t=new Date(e),i=hu(t,{addSuffix:!0}),s=cu(t,"h:mm a");return`${i} (${s})`}renderActions(){const e=this.tick;if(!e)return g;const t=e.status==="open",i=e.status==="closed",s=!!e.awaiting,r=!!e.requires,a=t&&s,o=t&&!r,n=i;return!a&&!o&&!n?g:c`
      <div class="section">
    ...
    `}renderBlockers(){return!this.blockerDetails||this.blockerDetails.length===0?c`<span class="empty-text">None</span>`:c`
      <ul class="link-list">
        ${this.blockerDetails.map(e=>c`
            <li>
              <a
    ...
    `}renderParent(){var e;return(e=this.tick)!=null&&e.parent?c`
      <a
        class="tick-link"
        @click=${()=>this.handleTickLinkClick(this.tick.parent)}
      >
        <span class="link-id">${this.tick.parent}</span>
        ${this.parentTitle?c`<span class="link-title">${this.parentTitle}</span>`:g}
      </a>
    `:c`<span class="empty-text">None</span>`}renderLabels(){var e;return!((e=this.tick)!=null&&e.labels)||this.tick.labels.length===0?c`<span class="empty-text">None</span>`:c`
      <div class="labels-container">
        ${this.tick.labels.map(t=>c`<span class="label-badge">${t}</span>`)}
      </div>
    `}renderNoteItem(e,t=!1){return c`
      <li class="note-item ${t?"note-optimistic":""}">
        <div class="note-header">
          <span class="note-author">${e.author??"Unknown"}</span>
          ${e.timestamp?c`<span class="note-timestamp"
                >${this.formatTimestamp(e.timestamp)}</span
              >`:g}
        </div>
        <div class="note-text">${e.text}</div>
        ${t?c`<div class="note-sending">Sending...</div>`:g}
      </li>
    `}renderNotes(){const e=this.notesList&&this.notesList.length>0||this.optimisticNote;return c`
      ${e?c`
          ...
          `:c`<span class="empty-text">No notes yet</span>`}
    ...
    `}toggleSection(e){const t=new Set(this.expandedSections);t.has(e)?t.delete(e):t.add(e),this.expandedSections=t}formatRunTimestamp(e){return new Date(e).toLocaleString("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit"})}formatTokenCount(e){return e>=1e6?`${(e/1e6).toFixed(1)}M`:e>=1e3?`${(e/1e3).toFixed(1)}K`:e.toString()}formatCost(e){return e===0?"$0.00":e<.01?`$${e.toFixed(4)}`:e<1?`$${e.toFixed(3)}`:`$${e.toFixed(2)}`}formatDuration(e){if(e<1e3)return`${e}ms`;const t=Math.floor(e/1e3);if(t<60)return`${t}s`;const i=Math.floor(t/60),s=t%60;return`${i}m ${s}s`}truncateText(e,t=60){return e.length<=t?e:e.slice(0,t)+"..."}renderVerification(){var s;if(((s=this.tick)==null?void 0:s.type)!=="task"||!this.runRecord)return g;const e=this.runRecord.verification;if(!e)return this.tick.status==="closed"?c`
          ...
          <sl-divider></sl-divider>
        `:g;const t=e.all_passed,i=e.results||[];return c`
      <div class="section">
        <div class="section-title">Verification</div>
      ...
      <sl-divider></sl-divider>
    `}renderVerifierResult(e){const t=e.passed,i=this.expandedSections.has(`verifier-${e.verifier}`);return c`
      <div class="verifier-item ${t?"passed":"failed"}">
        ...
        <div class="verifier-content">
          ...
          ${e.output?c`
                ...
                ${i?c`<div class="verifier-output">${e.output}</div>`:g}
              `:g}
        </div>
      </div>
    `}renderRunHistory(){var s;if(((s=this.tick)==null?void 0:s.type)!=="task")return g;if(this.loadingRunRecord)return c`
        <div class="section">
        ...
        <sl-divider></sl-divider>
      `;if(this.runRecordError)return c`
        <div class="section">
          <div class="section-title">Run History</div>
        ...
        <sl-divider></sl-divider>
      `;if(!this.runRecord)return c`
        <div class="section">
          <div class="section-title">Run History</div>
          <span class="no-run-history">No run history available</span>
        </div>
        <sl-divider></sl-divider>
      `;const e=this.runRecord,t=this.expandedSections.has("run-main"),i=e.metrics.input_tokens+e.metrics.output_tokens;return c`
      <div class="section">
        <div class="section-title">Run History</div>
      ...
      <sl-divider></sl-divider>
    `}renderRunRecordBody(e){return c`
      <div class="run-record-body">
        ...
        ${e.metrics.cache_read_tokens>0?c`
              <div class="run-detail-row">
            ...
            `:g}
        ${e.metrics.cache_creation_tokens>0?c`
              <div class="run-detail-row">
        ...
        ${e.output?c`
              <div class="run-collapsible">
                ...
                ${this.expandedSections.has("run-output")?c`
        ...
        ${e.thinking?c`
              <div class="run-collapsible">
                ...
                ${this.expandedSections.has("run-thinking")?c`
                      <div class="run-collapsible-content">
                        ${e.thinking}
                      </div>
                    `:g}
        ...
        ${e.tools&&e.tools.length>0?c`
              <div class="run-collapsible">
                ...
                ${this.expandedSections.has("run-tools")?c`
                      <ul class="tools-list">
                        ${e.tools.map(t=>this.renderToolItem(t))}
                      </ul>
                    `:g}
    ...
    `}renderToolItem(e){return c`
      <li class="tool-item">
        <span class="tool-name ${e.is_error?"error":""}">${e.name}</span>
        ${e.input?c`<span class="tool-input-preview">${this.truncateText(e.input)}</span>`:g}
        <span class="tool-duration">${this.formatDuration(e.duration_ms)}</span>
        ${e.is_error?c`<sl-icon name="x-circle-fill" style="color: var(--red); font-size: 0.75rem;"></sl-icon>`:g}
      </li>
    `}renderRunTab(){var e;return((e=this.tick)==null?void 0:e.type)!=="task"?c`
    ...
    `}shouldShowRunTab(){var e,t;return((e=this.tick)==null?void 0:e.type)==="task"&&((t=this.tick)==null?void 0:t.status)==="closed"}renderDetailsContent(){const e=this.tick;return e?c`
      <div class="drawer-content">
        ...
        <div class="section">
          ...
          <div class="meta-row">
            ...
            ${e.manual?c`<span class="meta-badge manual">👤 Manual</span>`:g}
            ${e.awaiting?c`<span class="meta-badge awaiting">⏳ ${e.awaiting}</span>`:g}
            ${e.verdict?c`<span class="meta-badge verdict-${e.verdict}"
                  >${e.verdict}</span
                >`:g}
            ${this.blockerDetails&&this.blockerDetails.length>0?c`<span class="meta-badge blocked">⊘ Blocked</span>`:g}
          </div>

          <!-- Started time for in_progress ticks -->
          ${e.status==="in_progress"&&e.started_at?c`
        ...
        <div class="section">
          ...
          ${e.description?c`<div class="description">${e.description}</div>`:c`<span class="empty-text">No description</span>`}
        </div>
    ...
    `:g}render(){const e=this.tick,t=this.shouldShowRunTab();return c`
      <sl-drawer
      ...
      >
        ${e?t?c`
              ...
              `:this.renderDetailsContent():c`<div class="drawer-content">
  ...
  `;mo([w()],Ki.prototype,"toasts",2);Ki=mo([me("tick-toast-stack")],Ki);var Lu=Object.defineProperty,Fu=Object.getOwnPropertyDescriptor,Vt=(e,t,i,s)=>{for(var r=s>1?void 0:s?Fu(t,i):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(r=(s?o(t,i,r):o(r))||r);return s&&r&&Lu(t,i,r),r};let bt=class extends oe{constructor(){super(...arguments),this.activities=[],this.loading=!0,this.unreadCount=0,this.lastSeenTimestamp=null,this.pollInterval=null,this.sseListener=null,this.escapeHandler=null}connectedCallback(){super.connectedCallback(),this.loadLastSeenTimestamp(),this.loadActivities(),this.startPolling(),this.listenForSSE()}disconnectedCallback(){super.disconnectedCallback(),this.stopPolling(),this.stopSSEListener()}loadLastSeenTimestamp(){try{this.lastSeenTimestamp=localStorage.getItem("activity-last-seen")}catch{}}saveLastSeenTimestamp(){if(this.activities.length>0){const e=this.activities[0].ts;try{localStorage.setItem("activity-last-seen",e),this.lastSeenTimestamp=e}catch{}}}async loadActivities(){if(qe.get()){this.loading=!1;return}try{this.activities=await hr(20),this.updateUnreadCount()}catch(e){console.error("Failed to load activities:",e)}finally{this.loading=!1}}updateUnreadCount(){if(!this.lastSeenTimestamp){this.unreadCount=this.activities.length;return}this.unreadCount=this.activities.filter(e=>e.ts>this.lastSeenTimestamp).length}startPolling(){this.pollInterval=setInterval(()=>{this.loadActivities()},3e4)}stopPolling(){this.pollInterval&&(clearInterval(this.pollInterval),this.pollInterval=null)}listenForSSE(){this.sseListener=()=>{this.loadActivities()},window.addEventListener("activity-update",this.sseListener)}stopSSEListener(){this.sseListener&&(window.removeEventListener("activity-update",this.sseListener),this.sseListener=null)}handleDropdownShow(){this.saveLastSeenTimestamp(),this.unreadCount=0,this.escapeHandler=e=>{e.key==="Escape"&&this.closeDropdown()},document.addEventListener("keydown",this.escapeHandler)}handleDropdownHide(){this.escapeHandler&&(document.removeEventListener("keydown",this.escapeHandler),this.escapeHandler=null)}closeDropdown(){var e;(e=this.dropdown)==null||e.hide()}handleActivityClick(e){this.dispatchEvent(new CustomEvent("activity-click",{detail:{tickId:e.tick},bubbles:!0,composed:!0}))}getActionIcon(e){return{create:"+",update:"~",close:"×",reopen:"↺",note:"✎",approve:"✓",reject:"✗",assign:"→",awaiting:"⏳",block:"⊘",unblock:"⊙"}[e]||"•"}getActionDescription(e){const t=e.action,i=e.actor,s=e.data||{};switch(t){case"create":return`${i} created this tick`;case"update":return`${i} updated this tick`;case"close":return s.reason?`${i} closed: ${s.reason}`:`${i} closed this tick`;case"reopen":return`${i} reopened this tick`;case"note":return`${i} added a note`;case"approve":return`${i} approved this tick`;case"reject":return`${i} rejected this tick`;case"assign":return`${i} assigned to ${s.to||"someone"}`;case"awaiting":return`Waiting for ${s.awaiting||"human action"}`;case"block":return`${i} added a blocker`;case"unblock":return`${i} removed a blocker`;default:return`${i} performed ${t}`}}formatRelativeTime(e){const t=new Date(e),s=new Date().getTime()-t.getTime(),r=Math.floor(s/1e3),a=Math.floor(r/60),o=Math.floor(a/60),n=Math.floor(o/24);return r<60?"just now":a<60?`${a}m ago`:o<24?`${o}h ago`:n<7?`${n}d ago`:t.toLocaleDateString()}isUnread(e){return this.lastSeenTimestamp?e.ts>this.lastSeenTimestamp:!0}render(){return c`
      <sl-dropdown placement="bottom-end" hoist @sl-show=${this.handleDropdownShow} @sl-hide=${this.handleDropdownHide}>
        <div slot="trigger" class="trigger-button">
          ...
          ${this.unreadCount>0?c`<span class="unread-badge">${this.unreadCount>9?"9+":this.unreadCount}</span>`:g}
        </div>
        ...
        <sl-menu>
          ...
          ${this.loading?c`<div class="loading-state">Loading...</div>`:this.activities.length===0?c`<div class="empty-state">No recent activity</div>`:this.activities.map(e=>c`
...
`);try{await navigator.clipboard.writeText(e),window.showToast&&window.showToast({message:"Output copied to clipboard",variant:"success"})}catch(t){console.error("Failed to copy output:",t)}}formatTimestamp(e){return e.toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!1})}ansiToHtml(e){let t=e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;");const i=[],s=/\x1b\[([0-9;]*)m/g;return t=t.replace(s,(r,a)=>{let o=i.length>0?"</span>":"";i.length=0;const n=a?a.split(";").map(Number):[0];for(const h of n)h===0?i.length=0:na[h]?i.push(na[h]):la[h]&&i.push(la[h]);return i.length>0&&(o+=`<span class="${i.join(" ")}">`),o}),i.length>0&&(t+="</span>"),t}getStatusText(){switch(this.connectionStatus){case"connected":return"Connected";case"connecting":return"Connecting...";case"disconnected":return"Disconnected"}}renderOutputContent(){return c`
    ...
    `}render(){return c`
      <div class="output-pane">
        ...
        ${this.activeTab==="output"&&(this.activeTaskId||this.activeTool)?c`
  ...
  `;Ne([u({type:String,attribute:"epic-id"})],ke.prototype,"epicId",2);Ne([u({type:Boolean,attribute:"auto-scroll"})],ke.prototype,"autoScroll",2);Ne([w()],ke.prototype,"lines",2);Ne([w()],ke.prototype,"connectionStatus",2);Ne([w()],ke.prototype,"activeTaskId",2);Ne([w()],ke.prototype,"activeTool",2);Ne([w()],ke.prototype,"lastOutput",2);Ne([w()],ke.prototype,"activeTab",2);Ne([C(".output-container")],ke.prototype,"outputContainer",2);Ne([C("context-pane")],ke.prototype,"contextPane",2);ke=Ne([me("run-output-pane")],ke);var Hu=Object.defineProperty,ju=Object.getOwnPropertyDescriptor,bs=(e,t,i,s)=>{for(var r=s>1?void 0:s?ju(t,i):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(r=(s?o(t,i,r):o(r))||r);return s&&r&&Hu(t,i,r),r};const Uu={Read:"file-earmark-text",Write:"file-earmark-plus",Edit:"pencil-square",Bash:"terminal",Glob:"search",Grep:"file-earmark-code",Task:"list-task",WebFetch:"globe",WebSearch:"search",TodoWrite:"check2-square",AskUserQuestion:"chat-left-dots",NotebookEdit:"journal-code",KillShell:"x-circle",TaskOutput:"box-arrow-right",Skill:"lightning",EnterPlanMode:"map",ExitPlanMode:"check2-circle"},Vu={Read:"var(--blue, #89b4fa)",Write:"var(--green, #a6e3a1)",Edit:"var(--yellow, #f9e2af)",Bash:"var(--peach, #fab387)",Glob:"var(--teal, #94e2d5)",Grep:"var(--sapphire, #74c7ec)",Task:"var(--mauve, #cba6f7)",WebFetch:"var(--sky, #89dceb)",WebSearch:"var(--sky, #89dceb)",TodoWrite:"var(--lavender, #b4befe)",AskUserQuestion:"var(--pink, #f5c2e7)",NotebookEdit:"var(--flamingo, #f2cdcd)",KillShell:"var(--red, #f38ba8)",TaskOutput:"var(--rosewater, #f5e0dc)",Skill:"var(--maroon, #eba0ac)",EnterPlanMode:"var(--lavender, #b4befe)",ExitPlanMode:"var(--green, #a6e3a1)"};let Ft=class extends oe{constructor(){super(...arguments),this.activity=null,this.expanded=!1,this.elapsedMs=0,this.timerInterval=null}connectedCallback(){super.connectedCallback(),this.startTimer()}disconnectedCallback(){super.disconnectedCallback(),this.stopTimer()}updated(e){e.has("activity")&&this.updateTimer()}startTimer(){this.timerInterval||(this.timerInterval=setInterval(()=>{if(this.activity&&!this.activity.isComplete&&this.activity.startedAt){const e=this.activity.startedAt instanceof Date?this.activity.startedAt.getTime():new Date(this.activity.startedAt).getTime();this.elapsedMs=Date.now()-e}},100))}stopTimer(){this.timerInterval&&(clearInterval(this.timerInterval),this.timerInterval=null)}updateTimer(){var e;(e=this.activity)!=null&&e.isComplete?(this.stopTimer(),this.activity.durationMs!==void 0&&(this.elapsedMs=this.activity.durationMs)):this.activity&&!this.timerInterval&&this.startTimer()}getToolIcon(e){return Uu[e]??"gear"}getToolColor(e){return Vu[e]??"var(--mauve, #cba6f7)"}formatDuration(e){if(e<1e3)return`${e}ms`;const t=Math.floor(e/1e3),i=e%1e3;if(t<60)return`${t}.${Math.floor(i/100)}s`;const s=Math.floor(t/60),r=t%60;return`${s}m ${r}s`}truncateInput(e,t=50){return e.length<=t?e:e.slice(0,t)+"..."}getStatusClass(){return this.activity?this.activity.isError?"error":this.activity.isComplete?"complete":"running":""}renderCompact(){const{activity:e}=this;if(!e)return c`
        <div class="empty-state">
          <sl-icon name="gear"></sl-icon>
          <span>No active tool</span>
        </div>
      `;const t=this.getToolColor(e.name),i=this.getStatusClass(),s=e.isComplete&&e.durationMs!==void 0?e.durationMs:this.elapsedMs;return c`
      <div class="tool-compact ${i}" style="--tool-color: ${t}">
        ...
        ${e.input?c`<span class="tool-input-preview">${this.truncateInput(e.input)}</span>`:g}
        ${s>0?c`<span class="tool-duration">${this.formatDuration(s)}</span>`:g}
        ${e.isComplete?c`
    ...
    `}renderExpanded(){const{activity:e}=this;if(!e)return c`
        <div class="empty-state">
          <sl-icon name="gear"></sl-icon>
          <span>No active tool</span>
        </div>
  ...
  `;bs([u({attribute:!1})],Ft.prototype,"activity",2);bs([u({type:Boolean})],Ft.prototype,"expanded",2);bs([w()],Ft.prototype,"elapsedMs",2);Ft=bs([me("tool-activity")],Ft);var Wu=Object.defineProperty,qu=Object.getOwnPropertyDescriptor,wi=(e,t,i,s)=>{for(var r=s>1?void 0:s?qu(t,i):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(r=(s?o(t,i,r):o(r))||r);return s&&r&&Wu(t,i,r),r};let $t=class extends oe{constructor(){super(...arguments),this.metrics=null,this.model="",this.live=!1,this.expanded=!1}formatTokenCount(e){return e>=1e6?`${(e/1e6).toFixed(1)}M`:e>=1e3?`${(e/1e3).toFixed(1)}K`:e.toString()}formatCost(e){return e===0?"$0.00":e<.01?`$${e.toFixed(4)}`:e<1?`$${e.toFixed(3)}`:`$${e.toFixed(2)}`}formatDuration(e){if(e<1e3)return`${e}ms`;const t=Math.floor(e/1e3);if(t<60)return`${t}s`;const i=Math.floor(t/60),s=t%60;return`${i}m ${s}s`}getTotalTokens(){return this.metrics?this.metrics.inputTokens+this.metrics.outputTokens+this.metrics.cacheReadTokens+this.metrics.cacheCreationTokens:0}getTokenPercentage(e){const t=this.getTotalTokens();return t===0?0:e/t*100}renderCompact(){if(!this.metrics)return c`
    ...
    `}renderExpanded(){if(!this.metrics)return c`
        <div class="empty-state">
          <sl-icon name="bar-chart"></sl-icon>
          <span>No metrics available</span>
        </div>
      `;const{inputTokens:e,outputTokens:t,cacheReadTokens:i,cacheCreationTokens:s,costUsd:r,durationMs:a}=this.metrics,o=this.getTotalTokens();return c`
  ...
  `;wi([u({attribute:!1})],$t.prototype,"metrics",2);wi([u({type:String})],$t.prototype,"model",2);wi([u({type:Boolean})],$t.prototype,"live",2);wi([u({type:Boolean})],$t.prototype,"expanded",2);$t=wi([me("run-metrics")],$t);function fr(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var zt=fr();function fo(e){zt=e}var ai={exec:()=>null};function R(e,t=""){let i=typeof e=="string"?e:e.source,s={replace:(r,a)=>{let o=typeof a=="string"?a:a.source;return o=o.replace(he.caret,"$1"),i=i.replace(r,o),s},getRegex:()=>new RegExp(i,t)};return s}var Yu=(()=>{try{return!!new RegExp("(?<=1)(?<!1)")}catch{return!1}})(),he={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceTabs:/^\t+/,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] +\S/,listReplaceTask:/^\[[ xX]\] +/,listTaskCheckbox:/\[[ xX]\]/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,unescapeTest:/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:e=>new RegExp(`^( {0,3}${e})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),hrRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),fencesBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}(?:\`\`\`|~~~)`),headingBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}#`),htmlBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}<(?:[a-z].*>|!--)`,"i")},Ku=/^(?:[ \t]*(?:\n|$))+/,Gu=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,Xu=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,ki=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,Qu=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,br=/(?:[*+-]|\d{1,9}[.)])/,bo=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,go=R(bo).replace(/bull/g,br).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,"").getRegex(),Zu=R(bo).replace(/bull/g,br).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),gr=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,Ju=/^[^\n]+/,vr=/(?!\s*\])(?:\\[\s\S]|[^\[\]\\])+/,eh=R(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label",vr).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),th=R(/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,br).getRegex(),gs="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",yr=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,ih=R("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))","i").replace("comment",yr).replace("tag",gs).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),vo=R(gr).replace("hr",ki).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",gs).getRegex(),sh=R(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",vo).getRegex(),wr={blockquote:sh,code:Gu,def:eh,fences:Xu,heading:Qu,hr:ki,html:ih,lheading:go,list:th,newline:Ku,paragraph:vo,table:ai,text:Ju},ca=R("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",ki).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}	)[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",gs).getRegex(),rh={...wr,lheading:Zu,table:ca,paragraph:R(gr).replace("hr",ki).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",ca).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",gs).getRegex()},ah={...wr,html:R(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",yr).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:ai,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:R(gr).replace("hr",ki).replace("heading",` *#{1,6} *[^
]`).replace("lheading",go).replace("|table","").replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").replace("|tag","").getRegex()},oh=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,nh=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,yo=/^( {2,}|\\)\n(?!\s*$)/,lh=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,vs=/[\p{P}\p{S}]/u,kr=/[\s\p{P}\p{S}]/u,wo=/[^\s\p{P}\p{S}]/u,ch=R(/^((?![*_])punctSpace)/,"u").replace(/punctSpace/g,kr).getRegex(),ko=/(?!~)[\p{P}\p{S}]/u,dh=/(?!~)[\s\p{P}\p{S}]/u,uh=/(?:[^\s\p{P}\p{S}]|~)/u,hh=R(/link|precode-code|html/,"g").replace("link",/\[(?:[^\[\]`]|(?<a>`+)[^`]+\k<a>(?!`))*?\]\((?:\\[\s\S]|[^\\\(\)]|\((?:\\[\s\S]|[^\\\(\)])*\))*\)/).replace("precode-",Yu?"(?<!`)()":"(^^|[^`])").replace("code",/(?<b>`+)[^`]+\k<b>(?!`)/).replace("html",/<(?! )[^<>]*?>/).getRegex(),xo=/^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/,ph=R(xo,"u").replace(/punct/g,vs).getRegex(),mh=R(xo,"u").replace(/punct/g,ko).getRegex(),_o="^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)",fh=R(_o,"gu").replace(/notPunctSpace/g,wo).replace(/punctSpace/g,kr).replace(/punct/g,vs).getRegex(),bh=R(_o,"gu").replace(/notPunctSpace/g,uh).replace(/punctSpace/g,dh).replace(/punct/g,ko).getRegex(),gh=R("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)","gu").replace(/notPunctSpace/g,wo).replace(/punctSpace/g,kr).replace(/punct/g,vs).getRegex(),vh=R(/\\(punct)/,"gu").replace(/punct/g,vs).getRegex(),yh=R(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme",/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email",/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),wh=R(yr).replace("(?:-->|$)","-->").getRegex(),kh=R("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment",wh).replace("attribute",/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),Gi=/(?:\[(?:\\[\s\S]|[^\[\]\\])*\]|\\[\s\S]|`+[^`]*?`+(?!`)|[^\[\]\\`])*?/,xh=R(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]*(?:\n[ \t]*)?)(title))?\s*\)/).replace("label",Gi).replace("href",/<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace("title",/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),Co=R(/^!?\[(label)\]\[(ref)\]/).replace("label",Gi).replace("ref",vr).getRegex(),$o=R(/^!?\[(ref)\](?:\[\])?/).replace("ref",vr).getRegex(),_h=R("reflink|nolink(?!\\()","g").replace("reflink",Co).replace("nolink",$o).getRegex(),da=/[hH][tT][tT][pP][sS]?|[fF][tT][pP]/,xr={_backpedal:ai,anyPunctuation:vh,autolink:yh,blockSkip:hh,br:yo,code:nh,del:ai,emStrongLDelim:ph,emStrongRDelimAst:fh,emStrongRDelimUnd:gh,escape:oh,link:xh,nolink:$o,punctuation:ch,reflink:Co,reflinkSearch:_h,tag:kh,text:lh,url:ai},Ch={...xr,link:R(/^!?\[(label)\]\((.*?)\)/).replace("label",Gi).getRegex(),reflink:R(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",Gi).getRegex()},Vs={...xr,emStrongRDelimAst:bh,emStrongLDelim:mh,url:R(/^((?:protocol):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/).replace("protocol",da).replace("email",/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])((?:\\[\s\S]|[^\\])*?(?:\\[\s\S]|[^\s~\\]))\1(?=[^~]|$)/,text:R(/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|protocol:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/).replace("protocol",da).getRegex()},$h={...Vs,br:R(yo).replace("{2,}","*").getRegex(),text:R(Vs.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()},zi={normal:wr,gfm:rh,pedantic:ah},Jt={normal:xr,gfm:Vs,breaks:$h,pedantic:Ch},Th={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},ua=e=>Th[e];function Qe(e,t){if(t){if(he.escapeTest.test(e))return e.replace(he.escapeReplace,ua)}else if(he.escapeTestNoEncode.test(e))return e.replace(he.escapeReplaceNoEncode,ua);return e}function ha(e){try{e=encodeURI(e).replace(he.percentDecode,"%")}catch{return null}return e}function pa(e,t){var a;let i=e.replace(he.findPipe,(o,n,h)=>{let d=!1,p=n;for(;--p>=0&&h[p]==="\\";)d=!d;return d?"|":" |"}),s=i.split(he.splitPipe),r=0;if(s[0].trim()||s.shift(),s.length>0&&!((a=s.at(-1))!=null&&a.trim())&&s.pop(),t)if(s.length>t)s.splice(t);else for(;s.length<t;)s.push("");for(;r<s.length;r++)s[r]=s[r].trim().replace(he.slashPipe,"|");return s}function ei(e,t,i){let s=e.length;if(s===0)return"";let r=0;for(;r<s&&e.charAt(s-r-1)===t;)r++;return e.slice(0,s-r)}function Sh(e,t){if(e.indexOf(t[1])===-1)return-1;let i=0;for(let s=0;s<e.length;s++)if(e[s]==="\\")s++;else if(e[s]===t[0])i++;else if(e[s]===t[1]&&(i--,i<0))return s;return i>0?-2:-1}function ma(e,t,i,s,r){let a=t.href,o=t.title||null,n=e[1].replace(r.other.outputLinkReplace,"$1");s.state.inLink=!0;let h={type:e[0].charAt(0)==="!"?"image":"link",raw:i,href:a,title:o,text:n,tokens:s.inlineTokens(n)};return s.state.inLink=!1,h}function Eh(e,t,i){let s=e.match(i.other.indentCodeCompensation);if(s===null)return t;let r=s[1];return t.split(`
...
`)}}}fences(e){let t=this.rules.block.fences.exec(e);if(t){let i=t[0],s=Eh(i,t[3]||"",this.rules);return{type:"code",raw:i,lang:t[2]?t[2].trim().replace(this.rules.inline.anyPunctuation,"$1"):t[2],text:s}}}heading(e){let t=this.rules.block.heading.exec(e);if(t){let i=t[2].trim();if(this.rules.other.endingHash.test(i)){let s=ei(i,"#");(this.options.pedantic||!s||this.rules.other.endingSpaceChar.test(s))&&(i=s.trim())}return{type:"heading",raw:t[0],depth:t[1].length,text:i,tokens:this.lexer.inline(i)}}}hr(e){let t=this.rules.block.hr.exec(e);if(t)return{type:"hr",raw:ei(t[0],`
`)}}blockquote(e){let t=this.rules.block.blockquote.exec(e);if(t){let i=ei(t[0],`
`).split(`
`),s="",r="",a=[];for(;i.length>0;){let o=!1,n=[],h;for(h=0;h<i.length;h++)if(this.rules.other.blockquoteStart.test(i[h]))n.push(i[h]),o=!0;else if(!o)n.push(i[h]);else break;i=i.slice(h);let d=n.join(`
...
`,e=e.substring(v.length+1),p=!0),!p){let _=this.rules.other.nextBulletRegex(k),E=this.rules.other.hrRegex(k),O=this.rules.other.fencesBeginRegex(k),Y=this.rules.other.headingBeginRegex(k),j=this.rules.other.htmlBeginRegex(k);for(;e;){let de=e.split(`
`,1)[0],W;if(v=de,this.options.pedantic?(v=v.replace(this.rules.other.listReplaceNesting,"  "),W=v):W=v.replace(this.rules.other.tabCharGlobal,"    "),O.test(v)||Y.test(v)||j.test(v)||_.test(v)||E.test(v))break;if(W.search(this.rules.other.nonSpaceChar)>=k||!v.trim())b+=`
...
`)?"":`
`)+n.raw,d.text+=`
`+n.raw,this.inlineQueue.at(-1).src=d.text):this.tokens.links[n.tag]||(this.tokens.links[n.tag]={href:n.href,title:n.title},i.push(n));continue}if(n=this.tokenizer.table(t)){t=t.substring(n.raw.length),i.push(n);continue}if(n=this.tokenizer.lheading(t)){t=t.substring(n.raw.length),i.push(n);continue}let h=t;if((o=this.options.extensions)!=null&&o.startBlock){let d=1/0,p=t.slice(1),f;this.options.extensions.startBlock.forEach(b=>{f=b.call({lexer:this},p),typeof f=="number"&&f>=0&&(d=Math.min(d,f))}),d<1/0&&d>=0&&(h=t.substring(0,d+1))}if(this.state.top&&(n=this.tokenizer.paragraph(h))){let d=i.at(-1);s&&(d==null?void 0:d.type)==="paragraph"?(d.raw+=(d.raw.endsWith(`
`)?"":`
`)+n.raw,d.text+=`
...
`}strong({tokens:e}){return`<strong>${this.parser.parseInline(e)}</strong>`}em({tokens:e}){return`<em>${this.parser.parseInline(e)}</em>`}codespan({text:e}){return`<code>${Qe(e,!0)}</code>`}br(e){return"<br>"}del({tokens:e}){return`<del>${this.parser.parseInline(e)}</del>`}link({href:e,title:t,tokens:i}){let s=this.parser.parseInline(i),r=ha(e);if(r===null)return s;e=r;let a='<a href="'+e+'"';return t&&(a+=' title="'+Qe(t)+'"'),a+=">"+s+"</a>",a}image({href:e,title:t,text:i,tokens:s}){s&&(i=this.parser.parseInline(s,this.parser.textRenderer));let r=ha(e);if(r===null)return Qe(i);e=r;let a=`<img src="${e}" alt="${i}"`;return t&&(a+=` title="${Qe(t)}"`),a+=">",a}text(e){return"tokens"in e&&e.tokens?this.parser.parseInline(e.tokens):"escaped"in e&&e.escaped?e.text:Qe(e.text)}},_r=class{strong({text:e}){return e}em({text:e}){return e}codespan({text:e}){return e}del({text:e}){return e}html({text:e}){return e}text({text:e}){return e}link({text:e}){return""+e}image({text:e}){return""+e}br(){return""}checkbox({raw:e}){return e}},Oe=class qs{constructor(t){N(this,"options");N(this,"renderer");N(this,"textRenderer");this.options=t||zt,this.options.renderer=this.options.renderer||new Qi,this.renderer=this.options.renderer,this.renderer.options=this.options,this.renderer.parser=this,this.textRenderer=new _r}static parse(t,i){return new qs(i).parse(t)}static parseInline(t,i){return new qs(i).parseInline(t)}parse(t){var s,r;let i="";for(let a=0;a<t.length;a++){let o=t[a];if((r=(s=this.options.extensions)==null?void 0:s.renderers)!=null&&r[o.type]){let h=o,d=this.options.extensions.renderers[h.type].call({parser:this},h);if(d!==!1||!["space","hr","heading","code","table","blockquote","list","html","def","paragraph","text"].includes(h.type)){i+=d||"";continue}}let n=o;switch(n.type){case"space":{i+=this.renderer.space(n);break}case"hr":{i+=this.renderer.hr(n);break}case"heading":{i+=this.renderer.heading(n);break}case"code":{i+=this.renderer.code(n);break}case"table":{i+=this.renderer.table(n);break}case"blockquote":{i+=this.renderer.blockquote(n);break}case"list":{i+=this.renderer.list(n);break}case"checkbox":{i+=this.renderer.checkbox(n);break}case"html":{i+=this.renderer.html(n);break}case"def":{i+=this.renderer.def(n);break}case"paragraph":{i+=this.renderer.paragraph(n);break}case"text":{i+=this.renderer.text(n);break}default:{let h='Token with "'+n.type+'" type was not found.';if(this.options.silent)return console.error(h),"";throw new Error(h)}}}return i}parseInline(t,i=this.renderer){var r,a;let s="";for(let o=0;o<t.length;o++){let n=t[o];if((a=(r=this.options.extensions)==null?void 0:r.renderers)!=null&&a[n.type]){let d=this.options.extensions.renderers[n.type].call({parser:this},n);if(d!==!1||!["escape","html","link","image","strong","em","codespan","br","del","text"].includes(n.type)){s+=d||"";continue}}let h=n;switch(h.type){case"escape":{s+=i.text(h);break}case"html":{s+=i.html(h);break}case"link":{s+=i.link(h);break}case"image":{s+=i.image(h);break}case"checkbox":{s+=i.checkbox(h);break}case"strong":{s+=i.strong(h);break}case"em":{s+=i.em(h);break}case"codespan":{s+=i.codespan(h);break}case"br":{s+=i.br(h);break}case"del":{s+=i.del(h);break}case"text":{s+=i.text(h);break}default:{let d='Token with "'+h.type+'" type was not found.';if(this.options.silent)return console.error(d),"";throw new Error(d)}}}return s}},Ri,ti=(Ri=class{constructor(e){N(this,"options");N(this,"block");this.options=e||zt}preprocess(e){return e}postprocess(e){return e}processAllTokens(e){return e}emStrongMask(e){return e}provideLexer(){return this.block?Ae.lex:Ae.lexInline}provideParser(){return this.block?Oe.parse:Oe.parseInline}},N(Ri,"passThroughHooks",new Set(["preprocess","postprocess","processAllTokens","emStrongMask"])),N(Ri,"passThroughHooksRespectAsync",new Set(["preprocess","postprocess","processAllTokens"])),Ri),zh=class{constructor(...e){N(this,"defaults",fr());N(this,"options",this.setOptions);N(this,"parse",this.parseMarkdown(!0));N(this,"parseInline",this.parseMarkdown(!1));N(this,"Parser",Oe);N(this,"Renderer",Qi);N(this,"TextRenderer",_r);N(this,"Lexer",Ae);N(this,"Tokenizer",Xi);N(this,"Hooks",ti);this.use(...e)}walkTokens(e,t){var s,r;let i=[];for(let a of e)switch(i=i.concat(t.call(this,a)),a.type){case"table":{let o=a;for(let n of o.header)i=i.concat(this.walkTokens(n.tokens,t));for(let n of o.rows)for(let h of n)i=i.concat(this.walkTokens(h.tokens,t));break}case"list":{let o=a;i=i.concat(this.walkTokens(o.items,t));break}default:{let o=a;(r=(s=this.defaults.extensions)==null?void 0:s.childTokens)!=null&&r[o.type]?this.defaults.extensions.childTokens[o.type].forEach(n=>{let h=o[n].flat(1/0);i=i.concat(this.walkTokens(h,t))}):o.tokens&&(i=i.concat(this.walkTokens(o.tokens,t)))}}return i}use(...e){let t=this.defaults.extensions||{renderers:{},childTokens:{}};return e.forEach(i=>{let s={...i};if(s.async=this.defaults.async||s.async||!1,i.extensions&&(i.extensions.forEach(r=>{if(!r.name)throw new Error("extension name required");if("renderer"in r){let a=t.renderers[r.name];a?t.renderers[r.name]=function(...o){let n=r.renderer.apply(this,o);return n===!1&&(n=a.apply(this,o)),n}:t.renderers[r.name]=r.renderer}if("tokenizer"in r){if(!r.level||r.level!=="block"&&r.level!=="inline")throw new Error("extension level must be 'block' or 'inline'");let a=t[r.level];a?a.unshift(r.tokenizer):t[r.level]=[r.tokenizer],r.start&&(r.level==="block"?t.startBlock?t.startBlock.push(r.start):t.startBlock=[r.start]:r.level==="inline"&&(t.startInline?t.startInline.push(r.start):t.startInline=[r.start]))}"childTokens"in r&&r.childTokens&&(t.childTokens[r.name]=r.childTokens)}),s.extensions=t),i.renderer){let r=this.defaults.renderer||new Qi(this.defaults);for(let a in i.renderer){if(!(a in r))throw new Error(`renderer '${a}' does not exist`);if(["options","parser"].includes(a))continue;let o=a,n=i.renderer[o],h=r[o];r[o]=(...d)=>{let p=n.apply(r,d);return p===!1&&(p=h.apply(r,d)),p||""}}s.renderer=r}if(i.tokenizer){let r=this.defaults.tokenizer||new Xi(this.defaults);for(let a in i.tokenizer){if(!(a in r))throw new Error(`tokenizer '${a}' does not exist`);if(["options","rules","lexer"].includes(a))continue;let o=a,n=i.tokenizer[o],h=r[o];r[o]=(...d)=>{let p=n.apply(r,d);return p===!1&&(p=h.apply(r,d)),p}}s.tokenizer=r}if(i.hooks){let r=this.defaults.hooks||new ti;for(let a in i.hooks){if(!(a in r))throw new Error(`hook '${a}' does not exist`);if(["options","block"].includes(a))continue;let o=a,n=i.hooks[o],h=r[o];ti.passThroughHooks.has(a)?r[o]=d=>{if(this.defaults.async&&ti.passThroughHooksRespectAsync.has(a))return(async()=>{let f=await n.call(r,d);return h.call(r,f)})();let p=n.call(r,d);return h.call(r,p)}:r[o]=(...d)=>{if(this.defaults.async)return(async()=>{let f=await n.apply(r,d);return f===!1&&(f=await h.apply(r,d)),f})();let p=n.apply(r,d);return p===!1&&(p=h.apply(r,d)),p}}s.hooks=r}if(i.walkTokens){let r=this.defaults.walkTokens,a=i.walkTokens;s.walkTokens=function(o){let n=[];return n.push(a.call(this,o)),r&&(n=n.concat(r.call(this,o))),n}}this.defaults={...this.defaults,...s}}),this}setOptions(e){return this.defaults={...this.defaults,...e},this}lexer(e,t){return Ae.lex(e,t??this.defaults)}parser(e,t){return Oe.parse(e,t??this.defaults)}parseMarkdown(e){return(t,i)=>{let s={...i},r={...this.defaults,...s},a=this.onError(!!r.silent,!!r.async);if(this.defaults.async===!0&&s.async===!1)return a(new Error("marked(): The async option was set to true by an extension. Remove async: false from the parse options object to return a Promise."));if(typeof t>"u"||t===null)return a(new Error("marked(): input parameter is undefined or null"));if(typeof t!="string")return a(new Error("marked(): input parameter is of type "+Object.prototype.toString.call(t)+", string expected"));if(r.hooks&&(r.hooks.options=r,r.hooks.block=e),r.async)return(async()=>{let o=r.hooks?await r.hooks.preprocess(t):t,n=await(r.hooks?await r.hooks.provideLexer():e?Ae.lex:Ae.lexInline)(o,r),h=r.hooks?await r.hooks.processAllTokens(n):n;r.walkTokens&&await Promise.all(this.walkTokens(h,r.walkTokens));let d=await(r.hooks?await r.hooks.provideParser():e?Oe.parse:Oe.parseInline)(h,r);return r.hooks?await r.hooks.postprocess(d):d})().catch(a);try{r.hooks&&(t=r.hooks.preprocess(t));let o=(r.hooks?r.hooks.provideLexer():e?Ae.lex:Ae.lexInline)(t,r);r.hooks&&(o=r.hooks.processAllTokens(o)),r.walkTokens&&this.walkTokens(o,r.walkTokens);let n=(r.hooks?r.hooks.provideParser():e?Oe.parse:Oe.parseInline)(o,r);return r.hooks&&(n=r.hooks.postprocess(n)),n}catch(o){return a(o)}}}onError(e,t){return i=>{if(i.message+=`
Please report this to https://github.com/markedjs/marked.`,e){let s="<p>An error occurred:</p><pre>"+Qe(i.message+"",!0)+"</pre>";return t?Promise.resolve(s):s}if(t)return Promise.reject(i);throw i}}},Tt=new zh;function D(e,t){return Tt.parse(e,t)}D.options=D.setOptions=function(e){return Tt.setOptions(e),D.defaults=Tt.defaults,fo(D.defaults),D};D.getDefaults=fr;D.defaults=zt;D.use=function(...e){return Tt.use(...e),D.defaults=Tt.defaults,fo(D.defaults),D};D.walkTokens=function(e,t){return Tt.walkTokens(e,t)};D.parseInline=Tt.parseInline;D.Parser=Oe;D.parser=Oe.parse;D.Renderer=Qi;D.TextRenderer=_r;D.Lexer=Ae;D.lexer=Ae.lex;D.Tokenizer=Xi;D.Hooks=ti;D.parse=D;D.options;D.setOptions;D.use;D.walkTokens;D.parseInline;Oe.parse;Ae.lex;var Rh=Object.defineProperty,Ah=Object.getOwnPropertyDescriptor,Wt=(e,t,i,s)=>{for(var r=s>1?void 0:s?Ah(t,i):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(r=(s?o(t,i,r):o(r))||r);return s&&r&&Rh(t,i,r),r};let gt=class extends oe{constructor(){super(...arguments),this.epicId="",this.loading=!1,this.error="",this.content=null,this.renderedHtml="",this.previousEpicId=""}connectedCallback(){super.connectedCallback(),this.epicId&&this.loadContext()}updated(e){e.has("epicId")&&this.epicId!==this.previousEpicId&&(this.previousEpicId=this.epicId,this.loadContext())}async loadContext(){if(!this.epicId){this.content=null,this.renderedHtml="";return}this.loading=!0,this.error="";try{this.content=await ao(this.epicId),this.content?this.renderedHtml=await D.parse(this.content):this.renderedHtml=""}catch(e){console.error("Failed to load context:",e),this.error=e instanceof Error?e.message:"Failed to load context",this.content=null,this.renderedHtml=""}finally{this.loading=!1}}refresh(){this.loadContext()}render(){return this.loading?c`
        <div class="loading">
          <sl-spinner></sl-spinner>
          <span>Loading context...</span>
        </div>
      `:this.error?c`<div class="error">${this.error}</div>`:this.epicId?this.content===null?c`<div class="empty">No context available</div>`:c`
      <div class="markdown-container">
        <div class="markdown-content">
          ${sr(this.renderedHtml)}
        </div>
      </div>
    `:c`<div class="empty">No epic selected</div>`}};gt.styles=$`
    :host {
      display: block;
      height: 100%;
      overflow: hidden;
  ...
  `;Wt([u({type:String})],gt.prototype,"epicId",2);Wt([w()],gt.prototype,"loading",2);Wt([w()],gt.prototype,"error",2);Wt([w()],gt.prototype,"content",2);Wt([w()],gt.prototype,"renderedHtml",2);gt=Wt([me("context-pane")],gt);var Oh=Object.defineProperty,Ih=Object.getOwnPropertyDescriptor,ge=(e,t,i,s)=>{for(var r=s>1?void 0:s?Ih(t,i):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(r=(s?o(t,i,r):o(r))||r);return s&&r&&Oh(t,i,r),r};const fa=[{id:"blocked",name:"Blocked",color:"var(--red)",icon:"⊘"},{id:"ready",name:"Agent Queue",color:"var(--blue)",icon:"▶"},{id:"agent",name:"In Progress",color:"var(--peach)",icon:"●"},{id:"human",name:"Needs Human",color:"var(--yellow)",icon:"👤"},{id:"done",name:"Done",color:"var(--green)",icon:"✓"}];let Q=class extends oe{constructor(){super(...arguments),this.ticks=[],this.epics=[],this.open=!1,this.runStatus=null,this.activities=[],this.repoName="",this._focusedAttentionIndex=-1,this._detailTick=null,this._detailRunRecord=null,this._detailNotes=[],this._detailLoading=!1,this._detailTab="overview",this._detailExpanded=new Set,this._handleKeyDown=e=>{if(e.key==="Escape"){if(e.stopPropagation(),this._detailTick){this._closeDetailPane();return}this._close();return}const t=this._getHumanTicks(),i=Math.min(t.length,6)-1;switch(e.key){case"j":case"ArrowDown":e.preventDefault(),e.stopPropagation(),i>=0&&(this._focusedAttentionIndex=Math.min(this._focusedAttentionIndex+1,i));break;case"k":case"ArrowUp":e.preventDefault(),e.stopPropagation(),i>=0&&(this._focusedAttentionIndex=Math.max(this._focusedAttentionIndex-1,0));break;case"Enter":case"i":this._focusedAttentionIndex>=0&&this._focusedAttentionIndex<=i&&(e.preventDefault(),e.stopPropagation(),this._handleTickClick(t[this._focusedAttentionIndex].id));break;case"a":if(this._focusedAttentionIndex>=0&&this._focusedAttentionIndex<=i){e.preventDefault(),e.stopPropagation();const s=t[this._focusedAttentionIndex];this.dispatchEvent(new CustomEvent("tick-resume",{detail:{tickId:s.id}}))}break;case"t":if(this._focusedAttentionIndex>=0&&this._focusedAttentionIndex<=i){e.preventDefault(),e.stopPropagation();const s=t[this._focusedAttentionIndex];this.dispatchEvent(new CustomEvent("tick-retry",{detail:{tickId:s.id}}))}break}}}connectedCallback(){super.connectedCallback(),this.addEventListener("keydown",this._handleKeyDown)}updated(e){super.updated(e),e.has("open")&&this.open&&(this._focusedAttentionIndex=-1,this._closeDetailPane())}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("keydown",this._handleKeyDown)}_close(){this.dispatchEvent(new CustomEvent("close"))}_handleBackdropClick(e){e.target.classList.contains("overlay")&&this._close()}_handleEpicClick(e){this.dispatchEvent(new CustomEvent("epic-select",{detail:{epicId:e}})),this._close()}_handleTickClick(e){this._openDetailPane(e)}_handleOpenOnBoard(e){this.dispatchEvent(new CustomEvent("tick-select",{detail:{tickId:e}})),this._close()}async _openDetailPane(e){var i,s;const t=this.ticks.find(r=>r.id===e);if(t){this._detailTick=t,this._detailTab="overview",this._detailNotes=li(t.notes),this._detailRunRecord=null,this._detailExpanded=new Set,this._detailLoading=!0;try{const[r,a]=await Promise.all([ur(e).catch(()=>null),t.type==="task"?pr(e).catch(()=>null):Promise.resolve(null)]);if(((i=this._detailTick)==null?void 0:i.id)!==e)return;r&&(this._detailTick={...t,...r,is_blocked:t.is_blocked,column:t.column},this._detailNotes=li(r.notes)),this._detailRunRecord=a}catch{}finally{((s=this._detailTick)==null?void 0:s.id)===e&&(this._detailLoading=!1)}}}_closeDetailPane(){this._detailTick=null,this._detailRunRecord=null,this._detailNotes=[],this._detailLoading=!1,this._detailTab="overview",this._detailExpanded=new Set}_toggleDetailSection(e){const t=new Set(this._detailExpanded);t.has(e)?t.delete(e):t.add(e),this._detailExpanded=t}_getColumnCounts(){const e={blocked:0,ready:0,agent:0,human:0,done:0};for(const t of this.ticks)t.type!=="epic"&&e[t.column]!==void 0&&e[t.column]++;return e}_getTotalNonEpicTicks(){return this.ticks.filter(e=>e.type!=="epic").length}_getEpicProgress(e){const t=this.ticks.filter(d=>d.parent===e&&d.type!=="epic"),i=t.length,s=t.filter(d=>d.column==="done").length,r=t.filter(d=>d.column==="agent").length,a=t.filter(d=>d.column==="human").length,o=t.filter(d=>d.column==="blocked").length,n=t.filter(d=>d.column==="ready").length,h=i>0?Math.round(s/i*100):0;return{total:i,done:s,inProgress:r,needsHuman:a,blocked:o,ready:n,pct:h}}_getHumanTicks(){return this.ticks.filter(e=>e.column==="human"&&e.type!=="epic")}_getActivityIcon(e){switch(e){case"create":return"➕";case"close":return"✅";case"update":return"✏️";case"approve":return"👍";case"reject":return"👎";case"note":return"💬";case"reopen":return"🔄";default:return"•"}}_formatRelativeTime(e){const t=new Date(e),s=new Date().getTime()-t.getTime(),r=Math.floor(s/6e4);if(r<1)return"now";if(r<60)return`${r}m ago`;const a=Math.floor(r/60);return a<24?`${a}h ago`:`${Math.floor(a/24)}d ago`}_getAwaitingLabel(e){if(e.awaiting)switch(e.awaiting){case"approval":return"Awaiting approval";case"review":return"Awaiting review";case"input":return"Awaiting input";case"content":return"Awaiting content";case"escalation":return"Escalated";case"checkpoint":return"Checkpoint";case"work":return"Manual work needed";default:return"Needs attention"}return"Needs attention"}_getPriorityLabel(e){return Q.PRIORITY_LABELS[e]??"Unknown"}_getPriorityColor(e){return Q.PRIORITY_COLORS[e]??"var(--subtext0)"}_formatTimestamp(e){return new Date(e).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric",hour:"numeric",minute:"2-digit"})}_formatDuration(e){if(e<1e3)return`${e}ms`;const t=Math.floor(e/1e3);return t<60?`${t}s`:`${Math.floor(t/60)}m ${t%60}s`}_formatTokenCount(e){return e>=1e6?`${(e/1e6).toFixed(1)}M`:e>=1e3?`${(e/1e3).toFixed(1)}K`:e.toString()}_formatCost(e){return e===0?"$0.00":e<.01?`$${e.toFixed(4)}`:e<1?`$${e.toFixed(3)}`:`$${e.toFixed(2)}`}_truncate(e,t=60){return e.length<=t?e:e.slice(0,t)+"..."}render(){var r;if(!this.open)return g;const e=this._getColumnCounts(),t=this._getTotalNonEpicTicks(),i=this._getHumanTicks(),s=((r=this.runStatus)==null?void 0:r.isRunning)??!1;return c`
    ...
    `}_renderHeader(){return c`
      <div class="dashboard-header">
        <div class="header-left">
          <div class="header-icon">📊</div>
          <div>
            <div class="header-title">Tickflow Dashboard</div>
            ${this.repoName?c`<div class="header-subtitle">${this.repoName}</div>`:g}
          </div>
        </div>
        <div class="header-right">
          <span class="kbd-hint">
    ...
    `}_renderSummaryCards(e,t,i){const s=t>0?Math.round(e.done/t*100):0;return c`
    ...
    `}_renderDistribution(e,t){return t===0?g:c`
      <div class="section">
        <div class="section-title">Task Distribution</div>
        <div class="distribution-bar-container">
          <div class="distribution-bar">
            ${fa.map(i=>{const s=e[i.id]/t*100;return s===0?g:c`
                <div
                  class="distribution-segment segment-${i.id}"
                  style="width: ${s}%"
                  title="${i.name}: ${e[i.id]}"
                >
                  ${s>=8?c`<span>${e[i.id]}</span>`:g}
                </div>
              `})}
          </div>
    ...
    `}_renderEpicProgress(){return this.epics.length===0?g:c`
      <div class="section">
        <div class="section-title">Epic Progress</div>
        <div class="epic-list">
          ${this.epics.map(e=>{const t=this._getEpicProgress(e.id);return c`
    ...
    `}_renderNeedsAttention(e){return c`
      <div class="section">
        <div class="section-title">Needs Attention (${e.length})</div>
        ${e.length===0?c`<div class="empty-section">No ticks need human attention</div>`:c`
              <div class="attention-list">
                ${e.slice(0,6).map((t,i)=>c`
                  <div
                ...
                `)}
                ${e.length>6?c`<div class="empty-section">+${e.length-6} more</div>`:g}
              </div>
              ${e.length>0?c`
    ...
    `}_renderRecentActivity(){return c`
      <div class="section">
        <div class="section-title">Recent Activity</div>
        ${this.activities.length===0?c`<div class="empty-section">No recent activity</div>`:c`
              <div class="activity-list">
                ${this.activities.slice(0,8).map(e=>c`
    ...
    `}_renderRunStatus(e){var t;return c`
      <div class="section">
        ...
        <div class="run-status ${e?"active":"inactive"}">
          ...
          <div class="run-info">
            ...
            ${e&&((t=this.runStatus)!=null&&t.activeTask)?c`
    ...
    `}_renderDetailPane(){const e=this._detailTick;return e?c`
      <div class="detail-pane">
        ...
        <div class="detail-tab-body">
          ${this._detailLoading?c`<div class="detail-loading"><span class="detail-loading-spinner">⟳</span> Loading...</div>`:this._detailTab==="overview"?this._renderDetailOverview(e):this._renderDetailAttempts()}
        </div>
      </div>
    `:g}_renderDetailOverview(e){return c`
      <!-- Badges -->
      <div class="detail-meta-row">
        ...
        ${e.awaiting?c`<span class="detail-meta-badge awaiting">⏳ ${e.awaiting}</span>`:g}
        ${e.is_blocked?c`<span class="detail-meta-badge blocked">⊘ blocked</span>`:g}
        ${e.verification_status==="verified"?c`<span class="detail-meta-badge verified">✓ verified</span>`:e.verification_status==="failed"?c`<span class="detail-meta-badge verification-failed">✗ failed</span>`:g}
      </div>

      <!-- Description -->
      <div class="detail-field">
        <div class="detail-field-label">Description</div>
        ${e.description?c`<div class="detail-description">${e.description}</div>`:c`<div class="detail-field-empty">No description</div>`}
      </div>

      <!-- Acceptance Criteria -->
      ${e.acceptance_criteria?c`
            <div class="detail-field">
      ...
      <!-- Blocked by -->
      ${e.blocked_by&&e.blocked_by.length>0?c`
            <div class="detail-field">
              <div class="detail-field-label">Blocked By</div>
              ${e.blocked_by.map(t=>c`
      ...
      <div class="detail-field">
        ...
        ${this._detailNotes.length>0?c`
              <ul class="detail-notes-list">
                ${this._detailNotes.map(t=>c`
                  <li class="detail-note">
                    <div class="detail-note-header">
                      <span class="detail-note-author">${t.author??"Unknown"}</span>
                      ${t.timestamp?c`<span class="detail-note-time">${this._formatRelativeTime(t.timestamp)}</span>`:g}
                    </div>
                    <div class="detail-note-text">${t.text}</div>
                  </li>
                `)}
              </ul>
            `:c`<div class="detail-field-empty">No notes</div>`}
      </div>
    ...
    `}_renderDetailAttempts(){var i;const e=this._detailRunRecord;if(!e)return c`<div class="detail-field-empty">No run history available for this task.</div>`;const t=e.metrics.input_tokens+e.metrics.output_tokens;return c`
      <!-- Run summary -->
      ...
      <!-- Error message -->
      ${!e.success&&e.error_msg?c`<div class="run-error-banner"><strong>Error:</strong> ${e.error_msg}</div>`:g}
      ...
      ${e.verification?c`
            ...
            ${((i=e.verification.results)==null?void 0:i.map(s=>c`
      ...
      ${e.output?c`
            ...
            ${this._detailExpanded.has("output")?c`<div class="run-collapse-content">${e.output}</div>`:g}
          `:g}
      ...
      ${e.thinking?c`
            ...
            ${this._detailExpanded.has("thinking")?c`<div class="run-collapse-content">${e.thinking}</div>`:g}
          `:g}
