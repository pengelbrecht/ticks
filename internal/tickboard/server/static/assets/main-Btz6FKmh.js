import{i as S,n as c,a as $e,b as h,r as y,E as vt,A as w,e as C,u as Do,t as Le}from"./ticks-logo-DYgrblNn.js";var la=S`
  :host {
    --track-width: 2px;
...
`,qe=class{constructor(e,...t){this.slotNames=[],this.handleSlotChange=i=>{const o=i.target;(this.slotNames.includes("[default]")&&!o.name||o.name&&this.slotNames.includes(o.name))&&this.host.requestUpdate()},(this.host=e).addController(this),this.slotNames=t}hasDefaultSlot(){return[...this.host.childNodes].some(e=>{if(e.nodeType===e.TEXT_NODE&&e.textContent.trim()!=="")return!0;if(e.nodeType===e.ELEMENT_NODE){const t=e;if(t.tagName.toLowerCase()==="sl-visually-hidden")return!1;if(!t.hasAttribute("slot"))return!0}return!1})}hasNamedSlot(e){return this.host.querySelector(`:scope > [slot="${e}"]`)!==null}test(e){return e==="[default]"?this.hasDefaultSlot():this.hasNamedSlot(e)}hostConnected(){this.host.shadowRoot.addEventListener("slotchange",this.handleSlotChange)}hostDisconnected(){this.host.shadowRoot.removeEventListener("slotchange",this.handleSlotChange)}};function _a(e){if(!e)return"";const t=e.assignedNodes({flatten:!0});let i="";return[...t].forEach(o=>{o.nodeType===Node.TEXT_NODE&&(i+=o.textContent)}),i}var Zi="";function eo(e){Zi=e}function Ca(e=""){if(!Zi){const t=[...document.getElementsByTagName("script")],i=t.find(o=>o.hasAttribute("data-shoelace"));if(i)eo(i.getAttribute("data-shoelace"));else{const o=t.find(a=>/shoelace(\.min)?\.js($|\?)/.test(a.src)||/shoelace-autoloader(\.min)?\.js($|\?)/.test(a.src));let s="";o&&(s=o.getAttribute("src")),eo(s.split("/").slice(0,-1).join("/"))}}return Zi.replace(/\/$/,"")+(e?`/${e.replace(/^\//,"")}`:"")}var $a={name:"default",resolver:e=>Ca(`assets/icons/${e}.svg`)},Ta=$a,Mo={caret:`
  ...
  `},Sa={name:"system",resolver:e=>e in Mo?`data:image/svg+xml,${encodeURIComponent(Mo[e])}`:""},Ea=Sa,Aa=[Ta,Ea],to=[];function Da(e){to.push(e)}function Oa(e){to=to.filter(t=>t!==e)}function Po(e){return Aa.find(t=>t.name===e)}var za=S`
  :host {
    display: inline-block;
    width: 1em;
    height: 1em;
...
`;function E(e,t){const i=Ue({waitUntilFirstUpdate:!1},t);return(o,s)=>{const{update:a}=o,r=Array.isArray(e)?e:[e];o.update=function(l){r.forEach(d=>{const u=d;if(l.has(u)){const p=l.get(u),m=this[u];p!==m&&(!i.waitUntilFirstUpdate||this.hasUpdated)&&this[s](p,m)}}),a.call(this,l)}}}/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ma=(e,t)=>(e==null?void 0:e._$litType$)!==void 0,ws=e=>e.strings===void 0,Pa={},La=(e,t=Pa)=>e._$AH=t;var Mt=Symbol(),ti=Symbol(),Wi,Ui=new Map,G=class extends P{constructor(){super(...arguments),this.initialRender=!1,this.svg=null,this.label="",this.library="default"}async resolveIcon(e,t){var i;let o;if(t!=null&&t.spriteSheet)return this.svg=h`<svg part="svg">
        <use part="use" href="${e}"></use>
      </svg>`,this.svg;try{if(o=await fetch(e,{mode:"cors"}),!o.ok)return o.status===410?Mt:ti}catch{return ti}try{const s=document.createElement("div");s.innerHTML=await o.text();const a=s.firstElementChild;if(((i=a==null?void 0:a.tagName)==null?void 0:i.toLowerCase())!=="svg")return Mt;Wi||(Wi=new DOMParser);const l=Wi.parseFromString(a.outerHTML,"text/html").body.querySelector("svg");return l?(l.part.add("svg"),document.adoptNode(l)):Mt}catch{return Mt}}connectedCallback(){super.connectedCallback(),Da(this)}firstUpdated(){this.initialRender=!0,this.setIcon()}disconnectedCallback(){super.disconnectedCallback(),Oa(this)}getIconSource(){const e=Po(this.library);return this.name&&e?{url:e.resolver(this.name),fromLibrary:!0}:{url:this.src,fromLibrary:!1}}handleLabelChange(){typeof this.label=="string"&&this.label.length>0?(this.setAttribute("role","img"),this.setAttribute("aria-label",this.label),this.removeAttribute("aria-hidden")):(this.removeAttribute("role"),this.removeAttribute("aria-label"),this.setAttribute("aria-hidden","true"))}async setIcon(){var e;const{url:t,fromLibrary:i}=this.getIconSource(),o=i?Po(this.library):void 0;if(!t){this.svg=null;return}let s=Ui.get(t);if(s||(s=this.resolveIcon(t,o),Ui.set(t,s)),!this.initialRender)return;const a=await s;if(a===ti&&Ui.delete(t),t===this.getIconSource().url){if(Ma(a)){if(this.svg=a,o){await this.updateComplete;const r=this.shadowRoot.querySelector("[part='svg']");typeof o.mutator=="function"&&r&&o.mutator(r)}return}switch(a){case ti:case Mt:this.svg=null,this.emit("sl-error");break;default:this.svg=a.cloneNode(!0),(e=o==null?void 0:o.mutator)==null||e.call(o,this.svg),this.emit("sl-load")}}}render(){return this.svg}};G.styles=[F,za];n([y()],G.prototype,"svg",2);n([c({reflect:!0})],G.prototype,"name",2);n([c()],G.prototype,"src",2);n([c()],G.prototype,"label",2);n([c({reflect:!0})],G.prototype,"library",2);n([E("label")],G.prototype,"handleLabelChange",1);n([E(["name","src","library"])],G.prototype,"setIcon",1);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const M=Ti(class extends Si{constructor(e){var t;if(super(e),e.type!==He.ATTRIBUTE||e.name!=="class"||((t=e.strings)==null?void 0:t.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return" "+Object.keys(e).filter(t=>e[t]).join(" ")+" "}update(e,[t]){var o,s;if(this.st===void 0){this.st=new Set,e.strings!==void 0&&(this.nt=new Set(e.strings.join(" ").split(/\s/).filter(a=>a!=="")));for(const a in t)t[a]&&!((o=this.nt)!=null&&o.has(a))&&this.st.add(a);return this.render(t)}const i=e.element.classList;for(const a of this.st)a in t||(i.remove(a),this.st.delete(a));for(const a in t){const r=!!t[a];r===this.st.has(a)||(s=this.nt)!=null&&s.has(a)||(r?(i.add(a),this.st.add(a)):(i.remove(a),this.st.delete(a)))}return vt}});/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */const _=e=>e??w;var L=class extends P{constructor(){super(...arguments),this.formControlController=new qt(this,{assumeInteractionOn:["click"]}),this.hasSlotController=new qe(this,"[default]","prefix","suffix"),this.localize=new ie(this),this.hasFocus=!1,this.invalid=!1,this.title="",this.variant="default",this.size="medium",this.caret=!1,this.disabled=!1,this.loading=!1,this.outline=!1,this.pill=!1,this.circle=!1,this.type="button",this.name="",this.value="",this.href="",this.rel="noreferrer noopener"}get validity(){return this.isButton()?this.button.validity:mo}get validationMessage(){return this.isButton()?this.button.validationMessage:""}firstUpdated(){this.isButton()&&this.formControlController.updateValidity()}handleBlur(){this.hasFocus=!1,this.emit("sl-blur")}handleFocus(){this.hasFocus=!0,this.emit("sl-focus")}handleClick(){this.type==="submit"&&this.formControlController.submit(this),this.type==="reset"&&this.formControlController.reset(this)}handleInvalid(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)}isButton(){return!this.href}isLink(){return!!this.href}handleDisabledChange(){this.isButton()&&this.formControlController.setValidity(this.disabled)}click(){this.button.click()}focus(e){this.button.focus(e)}blur(){this.button.blur()}checkValidity(){return this.isButton()?this.button.checkValidity():!0}getForm(){return this.formControlController.getForm()}reportValidity(){return this.isButton()?this.button.reportValidity():!0}setCustomValidity(e){this.isButton()&&(this.button.setCustomValidity(e),this.formControlController.updateValidity())}render(){const e=this.isLink(),t=e?hi`a`:hi`button`;return li`
    ...
    `}};L.styles=[F,xa];L.dependencies={"sl-icon":G,"sl-spinner":$i};n([C(".button")],L.prototype,"button",2);n([y()],L.prototype,"hasFocus",2);n([y()],L.prototype,"invalid",2);n([c()],L.prototype,"title",2);n([c({reflect:!0})],L.prototype,"variant",2);n([c({reflect:!0})],L.prototype,"size",2);n([c({type:Boolean,reflect:!0})],L.prototype,"caret",2);n([c({type:Boolean,reflect:!0})],L.prototype,"disabled",2);n([c({type:Boolean,reflect:!0})],L.prototype,"loading",2);n([c({type:Boolean,reflect:!0})],L.prototype,"outline",2);n([c({type:Boolean,reflect:!0})],L.prototype,"pill",2);n([c({type:Boolean,reflect:!0})],L.prototype,"circle",2);n([c()],L.prototype,"type",2);n([c()],L.prototype,"name",2);n([c()],L.prototype,"value",2);n([c()],L.prototype,"href",2);n([c()],L.prototype,"target",2);n([c()],L.prototype,"rel",2);n([c()],L.prototype,"download",2);n([c()],L.prototype,"form",2);n([c({attribute:"formaction"})],L.prototype,"formAction",2);n([c({attribute:"formenctype"})],L.prototype,"formEnctype",2);n([c({attribute:"formmethod"})],L.prototype,"formMethod",2);n([c({attribute:"formnovalidate",type:Boolean})],L.prototype,"formNoValidate",2);n([c({attribute:"formtarget"})],L.prototype,"formTarget",2);n([E("disabled",{waitUntilFirstUpdate:!0})],L.prototype,"handleDisabledChange",1);L.define("sl-button");var Fa=S`
  :host {
    display: block;
  }
...
`,bo=(e="value")=>(t,i)=>{const o=t.constructor,s=o.prototype.attributeChangedCallback;o.prototype.attributeChangedCallback=function(a,r,l){var d;const u=o.getPropertyOptions(e),p=typeof u.attribute=="string"?u.attribute:e;if(a===p){const m=u.converter||Do,f=(typeof m=="function"?m:(d=m==null?void 0:m.fromAttribute)!=null?d:Do.fromAttribute)(l,u.type);this[e]!==f&&(this[i]=f)}s.call(this,a,r,l)}},Ei=S`
...
`,V=class extends P{constructor(){super(...arguments),this.hasFocus=!1,this.label="",this.disabled=!1}handleBlur(){this.hasFocus=!1,this.emit("sl-blur")}handleFocus(){this.hasFocus=!0,this.emit("sl-focus")}handleClick(e){this.disabled&&(e.preventDefault(),e.stopPropagation())}click(){this.button.click()}focus(e){this.button.focus(e)}blur(){this.button.blur()}render(){const e=!!this.href,t=e?hi`a`:hi`button`;return li`
    ...
    `}};V.styles=[F,Ba];V.dependencies={"sl-icon":G};n([C(".icon-button")],V.prototype,"button",2);n([y()],V.prototype,"hasFocus",2);n([c()],V.prototype,"name",2);n([c()],V.prototype,"library",2);n([c()],V.prototype,"src",2);n([c()],V.prototype,"href",2);n([c()],V.prototype,"target",2);n([c()],V.prototype,"download",2);n([c()],V.prototype,"label",2);n([c({type:Boolean,reflect:!0})],V.prototype,"disabled",2);var ft=class extends P{constructor(){super(...arguments),this.localize=new ie(this),this.variant="neutral",this.size="medium",this.pill=!1,this.removable=!1}handleRemoveClick(){this.emit("sl-remove")}render(){return h`
      <span
        part="base"
    ...
    `}};ft.styles=[F,Na];ft.dependencies={"sl-icon-button":V};n([c({reflect:!0})],ft.prototype,"variant",2);n([c({reflect:!0})],ft.prototype,"size",2);n([c({type:Boolean,reflect:!0})],ft.prototype,"pill",2);n([c({type:Boolean})],ft.prototype,"removable",2);var Ha=S`
  :host {
    display: block;
  }
...
`;const Je=Math.min,ce=Math.max,fi=Math.round,ii=Math.floor,Oe=e=>({x:e,y:e}),qa={left:"right",right:"left",bottom:"top",top:"bottom"},Ya={start:"end",end:"start"};function so(e,t,i){return ce(e,Je(t,i))}function Ct(e,t){return typeof e=="function"?e(t):e}function Ze(e){return e.split("-")[0]}function $t(e){return e.split("-")[1]}function xs(e){return e==="x"?"y":"x"}function go(e){return e==="y"?"height":"width"}const Ka=new Set(["top","bottom"]);function je(e){return Ka.has(Ze(e))?"y":"x"}function vo(e){return xs(je(e))}function Ga(e,t,i){i===void 0&&(i=!1);const o=$t(e),s=vo(e),a=go(s);let r=s==="x"?o===(i?"end":"start")?"right":"left":o==="start"?"bottom":"top";return t.reference[a]>t.floating[a]&&(r=mi(r)),[r,mi(r)]}function Xa(e){const t=mi(e);return[ao(e),t,ao(t)]}function ao(e){return e.replace(/start|end/g,t=>Ya[t])}const Io=["left","right"],Ro=["right","left"],Qa=["top","bottom"],Ja=["bottom","top"];function Za(e,t,i){switch(e){case"top":case"bottom":return i?t?Ro:Io:t?Io:Ro;case"left":case"right":return t?Qa:Ja;default:return[]}}function er(e,t,i,o){const s=$t(e);let a=Za(Ze(e),i==="start",o);return s&&(a=a.map(r=>r+"-"+s),t&&(a=a.concat(a.map(ao)))),a}function mi(e){return e.replace(/left|right|bottom|top/g,t=>qa[t])}function tr(e){return{top:0,right:0,bottom:0,left:0,...e}}function _s(e){return typeof e!="number"?tr(e):{top:e,right:e,bottom:e,left:e}}function bi(e){const{x:t,y:i,width:o,height:s}=e;return{width:o,height:s,top:i,left:t,right:t+o,bottom:i+s,x:t,y:i}}function Fo(e,t,i){let{reference:o,floating:s}=e;const a=je(t),r=vo(t),l=go(r),d=Ze(t),u=a==="y",p=o.x+o.width/2-s.width/2,m=o.y+o.height/2-s.height/2,v=o[l]/2-s[l]/2;let f;switch(d){case"top":f={x:p,y:o.y-s.height};break;case"bottom":f={x:p,y:o.y+o.height};break;case"right":f={x:o.x+o.width,y:m};break;case"left":f={x:o.x-s.width,y:m};break;default:f={x:o.x,y:o.y}}switch($t(t)){case"start":f[r]-=v*(i&&u?-1:1);break;case"end":f[r]+=v*(i&&u?-1:1);break}return f}const ir=async(e,t,i)=>{const{placement:o="bottom",strategy:s="absolute",middleware:a=[],platform:r}=i,l=a.filter(Boolean),d=await(r.isRTL==null?void 0:r.isRTL(t));let u=await r.getElementRects({reference:e,floating:t,strategy:s}),{x:p,y:m}=Fo(u,o,d),v=o,f={},b=0;for(let g=0;g<l.length;g++){const{name:k,fn:x}=l[g],{x:A,y:T,data:W,reset:N}=await x({x:p,y:m,initialPlacement:o,placement:v,strategy:s,middlewareData:f,rects:u,platform:r,elements:{reference:e,floating:t}});p=A??p,m=T??m,f={...f,[k]:{...f[k],...W}},N&&b<=50&&(b++,typeof N=="object"&&(N.placement&&(v=N.placement),N.rects&&(u=N.rects===!0?await r.getElementRects({reference:e,floating:t,strategy:s}):N.rects),{x:p,y:m}=Fo(u,v,d)),g=-1)}return{x:p,y:m,placement:v,strategy:s,middlewareData:f}};async function yo(e,t){var i;t===void 0&&(t={});const{x:o,y:s,platform:a,rects:r,elements:l,strategy:d}=e,{boundary:u="clippingAncestors",rootBoundary:p="viewport",elementContext:m="floating",altBoundary:v=!1,padding:f=0}=Ct(t,e),b=_s(f),k=l[v?m==="floating"?"reference":"floating":m],x=bi(await a.getClippingRect({element:(i=await(a.isElement==null?void 0:a.isElement(k)))==null||i?k:k.contextElement||await(a.getDocumentElement==null?void 0:a.getDocumentElement(l.floating)),boundary:u,rootBoundary:p,strategy:d})),A=m==="floating"?{x:o,y:s,width:r.floating.width,height:r.floating.height}:r.reference,T=await(a.getOffsetParent==null?void 0:a.getOffsetParent(l.floating)),W=await(a.isElement==null?void 0:a.isElement(T))?await(a.getScale==null?void 0:a.getScale(T))||{x:1,y:1}:{x:1,y:1},N=bi(a.convertOffsetParentRelativeRectToViewportRelativeRect?await a.convertOffsetParentRelativeRectToViewportRelativeRect({elements:l,rect:A,offsetParent:T,strategy:d}):A);return{top:(x.top-N.top+b.top)/W.y,bottom:(N.bottom-x.bottom+b.bottom)/W.y,left:(x.left-N.left+b.left)/W.x,right:(N.right-x.right+b.right)/W.x}}const or=e=>({name:"arrow",options:e,async fn(t){const{x:i,y:o,placement:s,rects:a,platform:r,elements:l,middlewareData:d}=t,{element:u,padding:p=0}=Ct(e,t)||{};if(u==null)return{};const m=_s(p),v={x:i,y:o},f=vo(s),b=go(f),g=await r.getDimensions(u),k=f==="y",x=k?"top":"left",A=k?"bottom":"right",T=k?"clientHeight":"clientWidth",W=a.reference[b]+a.reference[f]-v[f]-a.floating[b],N=v[f]-a.reference[f],ye=await(r.getOffsetParent==null?void 0:r.getOffsetParent(u));let Z=ye?ye[T]:0;(!Z||!await(r.isElement==null?void 0:r.isElement(ye)))&&(Z=l.floating[T]||a.floating[b]);const Ne=W/2-N/2,Ee=Z/2-g[b]/2-1,be=Je(m[x],Ee),Ye=Je(m[A],Ee),Ae=be,Ke=Z-g[b]-Ye,se=Z/2-g[b]/2+Ne,at=so(Ae,se,Ke),Be=!d.arrow&&$t(s)!=null&&se!==at&&a.reference[b]/2-(se<Ae?be:Ye)-g[b]/2<0,we=Be?se<Ae?se-Ae:se-Ke:0;return{[f]:v[f]+we,data:{[f]:at,centerOffset:se-at-we,...Be&&{alignmentOffset:we}},reset:Be}}}),sr=function(e){return e===void 0&&(e={}),{name:"flip",options:e,async fn(t){var i,o;const{placement:s,middlewareData:a,rects:r,initialPlacement:l,platform:d,elements:u}=t,{mainAxis:p=!0,crossAxis:m=!0,fallbackPlacements:v,fallbackStrategy:f="bestFit",fallbackAxisSideDirection:b="none",flipAlignment:g=!0,...k}=Ct(e,t);if((i=a.arrow)!=null&&i.alignmentOffset)return{};const x=Ze(s),A=je(l),T=Ze(l)===l,W=await(d.isRTL==null?void 0:d.isRTL(u.floating)),N=v||(T||!g?[mi(l)]:Xa(l)),ye=b!=="none";!v&&ye&&N.push(...er(l,g,b,W));const Z=[l,...N],Ne=await yo(t,k),Ee=[];let be=((o=a.flip)==null?void 0:o.overflows)||[];if(p&&Ee.push(Ne[x]),m){const se=Ga(s,r,W);Ee.push(Ne[se[0]],Ne[se[1]])}if(be=[...be,{placement:s,overflows:Ee}],!Ee.every(se=>se<=0)){var Ye,Ae;const se=(((Ye=a.flip)==null?void 0:Ye.index)||0)+1,at=Z[se];if(at&&(!(m==="alignment"?A!==je(at):!1)||be.every(ke=>je(ke.placement)===A?ke.overflows[0]>0:!0)))return{data:{index:se,overflows:be},reset:{placement:at}};let Be=(Ae=be.filter(we=>we.overflows[0]<=0).sort((we,ke)=>we.overflows[1]-ke.overflows[1])[0])==null?void 0:Ae.placement;if(!Be)switch(f){case"bestFit":{var Ke;const we=(Ke=be.filter(ke=>{if(ye){const Ge=je(ke.placement);return Ge===A||Ge==="y"}return!0}).map(ke=>[ke.placement,ke.overflows.filter(Ge=>Ge>0).reduce((Ge,na)=>Ge+na,0)]).sort((ke,Ge)=>ke[1]-Ge[1])[0])==null?void 0:Ke[0];we&&(Be=we);break}case"initialPlacement":Be=l;break}if(s!==Be)return{reset:{placement:Be}}}return{}}}},ar=new Set(["left","top"]);async function rr(e,t){const{placement:i,platform:o,elements:s}=e,a=await(o.isRTL==null?void 0:o.isRTL(s.floating)),r=Ze(i),l=$t(i),d=je(i)==="y",u=ar.has(r)?-1:1,p=a&&d?-1:1,m=Ct(t,e);let{mainAxis:v,crossAxis:f,alignmentAxis:b}=typeof m=="number"?{mainAxis:m,crossAxis:0,alignmentAxis:null}:{mainAxis:m.mainAxis||0,crossAxis:m.crossAxis||0,alignmentAxis:m.alignmentAxis};return l&&typeof b=="number"&&(f=l==="end"?b*-1:b),d?{x:f*p,y:v*u}:{x:v*u,y:f*p}}const nr=function(e){return e===void 0&&(e=0),{name:"offset",options:e,async fn(t){var i,o;const{x:s,y:a,placement:r,middlewareData:l}=t,d=await rr(t,e);return r===((i=l.offset)==null?void 0:i.placement)&&(o=l.arrow)!=null&&o.alignmentOffset?{}:{x:s+d.x,y:a+d.y,data:{...d,placement:r}}}}},lr=function(e){return e===void 0&&(e={}),{name:"shift",options:e,async fn(t){const{x:i,y:o,placement:s}=t,{mainAxis:a=!0,crossAxis:r=!1,limiter:l={fn:k=>{let{x,y:A}=k;return{x,y:A}}},...d}=Ct(e,t),u={x:i,y:o},p=await yo(t,d),m=je(Ze(s)),v=xs(m);let f=u[v],b=u[m];if(a){const k=v==="y"?"top":"left",x=v==="y"?"bottom":"right",A=f+p[k],T=f-p[x];f=so(A,f,T)}if(r){const k=m==="y"?"top":"left",x=m==="y"?"bottom":"right",A=b+p[k],T=b-p[x];b=so(A,b,T)}const g=l.fn({...t,[v]:f,[m]:b});return{...g,data:{x:g.x-i,y:g.y-o,enabled:{[v]:a,[m]:r}}}}}},cr=function(e){return e===void 0&&(e={}),{name:"size",options:e,async fn(t){var i,o;const{placement:s,rects:a,platform:r,elements:l}=t,{apply:d=()=>{},...u}=Ct(e,t),p=await yo(t,u),m=Ze(s),v=$t(s),f=je(s)==="y",{width:b,height:g}=a.floating;let k,x;m==="top"||m==="bottom"?(k=m,x=v===(await(r.isRTL==null?void 0:r.isRTL(l.floating))?"start":"end")?"left":"right"):(x=m,k=v==="end"?"top":"bottom");const A=g-p.top-p.bottom,T=b-p.left-p.right,W=Je(g-p[k],A),N=Je(b-p[x],T),ye=!t.middlewareData.shift;let Z=W,Ne=N;if((i=t.middlewareData.shift)!=null&&i.enabled.x&&(Ne=T),(o=t.middlewareData.shift)!=null&&o.enabled.y&&(Z=A),ye&&!v){const be=ce(p.left,0),Ye=ce(p.right,0),Ae=ce(p.top,0),Ke=ce(p.bottom,0);f?Ne=b-2*(be!==0||Ye!==0?be+Ye:ce(p.left,p.right)):Z=g-2*(Ae!==0||Ke!==0?Ae+Ke:ce(p.top,p.bottom))}await d({...t,availableWidth:Ne,availableHeight:Z});const Ee=await r.getDimensions(l.floating);return b!==Ee.width||g!==Ee.height?{reset:{rects:!0}}:{}}}};function Ai(){return typeof window<"u"}function Tt(e){return Cs(e)?(e.nodeName||"").toLowerCase():"#document"}function de(e){var t;return(e==null||(t=e.ownerDocument)==null?void 0:t.defaultView)||window}function Ie(e){var t;return(t=(Cs(e)?e.ownerDocument:e.document)||window.document)==null?void 0:t.documentElement}function Cs(e){return Ai()?e instanceof Node||e instanceof de(e).Node:!1}function _e(e){return Ai()?e instanceof Element||e instanceof de(e).Element:!1}function ze(e){return Ai()?e instanceof HTMLElement||e instanceof de(e).HTMLElement:!1}function No(e){return!Ai()||typeof ShadowRoot>"u"?!1:e instanceof ShadowRoot||e instanceof de(e).ShadowRoot}const dr=new Set(["inline","contents"]);function Yt(e){const{overflow:t,overflowX:i,overflowY:o,display:s}=Ce(e);return/auto|scroll|overlay|hidden|clip/.test(t+o+i)&&!dr.has(s)}const ur=new Set(["table","td","th"]);function hr(e){return ur.has(Tt(e))}const pr=[":popover-open",":modal"];function Di(e){return pr.some(t=>{try{return e.matches(t)}catch{return!1}})}const fr=["transform","translate","scale","rotate","perspective"],mr=["transform","translate","scale","rotate","perspective","filter"],br=["paint","layout","strict","content"];function Oi(e){const t=wo(),i=_e(e)?Ce(e):e;return fr.some(o=>i[o]?i[o]!=="none":!1)||(i.containerType?i.containerType!=="normal":!1)||!t&&(i.backdropFilter?i.backdropFilter!=="none":!1)||!t&&(i.filter?i.filter!=="none":!1)||mr.some(o=>(i.willChange||"").includes(o))||br.some(o=>(i.contain||"").includes(o))}function gr(e){let t=et(e);for(;ze(t)&&!kt(t);){if(Oi(t))return t;if(Di(t))return null;t=et(t)}return null}function wo(){return typeof CSS>"u"||!CSS.supports?!1:CSS.supports("-webkit-backdrop-filter","none")}const vr=new Set(["html","body","#document"]);function kt(e){return vr.has(Tt(e))}function Ce(e){return de(e).getComputedStyle(e)}function zi(e){return _e(e)?{scrollLeft:e.scrollLeft,scrollTop:e.scrollTop}:{scrollLeft:e.scrollX,scrollTop:e.scrollY}}function et(e){if(Tt(e)==="html")return e;const t=e.assignedSlot||e.parentNode||No(e)&&e.host||Ie(e);return No(t)?t.host:t}function $s(e){const t=et(e);return kt(t)?e.ownerDocument?e.ownerDocument.body:e.body:ze(t)&&Yt(t)?t:$s(t)}function Bt(e,t,i){var o;t===void 0&&(t=[]),i===void 0&&(i=!0);const s=$s(e),a=s===((o=e.ownerDocument)==null?void 0:o.body),r=de(s);if(a){const l=ro(r);return t.concat(r,r.visualViewport||[],Yt(s)?s:[],l&&i?Bt(l):[])}return t.concat(s,Bt(s,[],i))}function ro(e){return e.parent&&Object.getPrototypeOf(e.parent)?e.frameElement:null}function Ts(e){const t=Ce(e);let i=parseFloat(t.width)||0,o=parseFloat(t.height)||0;const s=ze(e),a=s?e.offsetWidth:i,r=s?e.offsetHeight:o,l=fi(i)!==a||fi(o)!==r;return l&&(i=a,o=r),{width:i,height:o,$:l}}function ko(e){return _e(e)?e:e.contextElement}function wt(e){const t=ko(e);if(!ze(t))return Oe(1);const i=t.getBoundingClientRect(),{width:o,height:s,$:a}=Ts(t);let r=(a?fi(i.width):i.width)/o,l=(a?fi(i.height):i.height)/s;return(!r||!Number.isFinite(r))&&(r=1),(!l||!Number.isFinite(l))&&(l=1),{x:r,y:l}}const yr=Oe(0);function Ss(e){const t=de(e);return!wo()||!t.visualViewport?yr:{x:t.visualViewport.offsetLeft,y:t.visualViewport.offsetTop}}function wr(e,t,i){return t===void 0&&(t=!1),!i||t&&i!==de(e)?!1:t}function ut(e,t,i,o){t===void 0&&(t=!1),i===void 0&&(i=!1);const s=e.getBoundingClientRect(),a=ko(e);let r=Oe(1);t&&(o?_e(o)&&(r=wt(o)):r=wt(e));const l=wr(a,i,o)?Ss(a):Oe(0);let d=(s.left+l.x)/r.x,u=(s.top+l.y)/r.y,p=s.width/r.x,m=s.height/r.y;if(a){const v=de(a),f=o&&_e(o)?de(o):o;let b=v,g=ro(b);for(;g&&o&&f!==b;){const k=wt(g),x=g.getBoundingClientRect(),A=Ce(g),T=x.left+(g.clientLeft+parseFloat(A.paddingLeft))*k.x,W=x.top+(g.clientTop+parseFloat(A.paddingTop))*k.y;d*=k.x,u*=k.y,p*=k.x,m*=k.y,d+=T,u+=W,b=de(g),g=ro(b)}}return bi({width:p,height:m,x:d,y:u})}function Mi(e,t){const i=zi(e).scrollLeft;return t?t.left+i:ut(Ie(e)).left+i}function Es(e,t){const i=e.getBoundingClientRect(),o=i.left+t.scrollLeft-Mi(e,i),s=i.top+t.scrollTop;return{x:o,y:s}}function kr(e){let{elements:t,rect:i,offsetParent:o,strategy:s}=e;const a=s==="fixed",r=Ie(o),l=t?Di(t.floating):!1;if(o===r||l&&a)return i;let d={scrollLeft:0,scrollTop:0},u=Oe(1);const p=Oe(0),m=ze(o);if((m||!m&&!a)&&((Tt(o)!=="body"||Yt(r))&&(d=zi(o)),ze(o))){const f=ut(o);u=wt(o),p.x=f.x+o.clientLeft,p.y=f.y+o.clientTop}const v=r&&!m&&!a?Es(r,d):Oe(0);return{width:i.width*u.x,height:i.height*u.y,x:i.x*u.x-d.scrollLeft*u.x+p.x+v.x,y:i.y*u.y-d.scrollTop*u.y+p.y+v.y}}function xr(e){return Array.from(e.getClientRects())}function _r(e){const t=Ie(e),i=zi(e),o=e.ownerDocument.body,s=ce(t.scrollWidth,t.clientWidth,o.scrollWidth,o.clientWidth),a=ce(t.scrollHeight,t.clientHeight,o.scrollHeight,o.clientHeight);let r=-i.scrollLeft+Mi(e);const l=-i.scrollTop;return Ce(o).direction==="rtl"&&(r+=ce(t.clientWidth,o.clientWidth)-s),{width:s,height:a,x:r,y:l}}const Bo=25;function Cr(e,t){const i=de(e),o=Ie(e),s=i.visualViewport;let a=o.clientWidth,r=o.clientHeight,l=0,d=0;if(s){a=s.width,r=s.height;const p=wo();(!p||p&&t==="fixed")&&(l=s.offsetLeft,d=s.offsetTop)}const u=Mi(o);if(u<=0){const p=o.ownerDocument,m=p.body,v=getComputedStyle(m),f=p.compatMode==="CSS1Compat"&&parseFloat(v.marginLeft)+parseFloat(v.marginRight)||0,b=Math.abs(o.clientWidth-m.clientWidth-f);b<=Bo&&(a-=b)}else u<=Bo&&(a+=u);return{width:a,height:r,x:l,y:d}}const $r=new Set(["absolute","fixed"]);function Tr(e,t){const i=ut(e,!0,t==="fixed"),o=i.top+e.clientTop,s=i.left+e.clientLeft,a=ze(e)?wt(e):Oe(1),r=e.clientWidth*a.x,l=e.clientHeight*a.y,d=s*a.x,u=o*a.y;return{width:r,height:l,x:d,y:u}}function Ho(e,t,i){let o;if(t==="viewport")o=Cr(e,i);else if(t==="document")o=_r(Ie(e));else if(_e(t))o=Tr(t,i);else{const s=Ss(e);o={x:t.x-s.x,y:t.y-s.y,width:t.width,height:t.height}}return bi(o)}function As(e,t){const i=et(e);return i===t||!_e(i)||kt(i)?!1:Ce(i).position==="fixed"||As(i,t)}function Sr(e,t){const i=t.get(e);if(i)return i;let o=Bt(e,[],!1).filter(l=>_e(l)&&Tt(l)!=="body"),s=null;const a=Ce(e).position==="fixed";let r=a?et(e):e;for(;_e(r)&&!kt(r);){const l=Ce(r),d=Oi(r);!d&&l.position==="fixed"&&(s=null),(a?!d&&!s:!d&&l.position==="static"&&!!s&&$r.has(s.position)||Yt(r)&&!d&&As(e,r))?o=o.filter(p=>p!==r):s=l,r=et(r)}return t.set(e,o),o}function Er(e){let{element:t,boundary:i,rootBoundary:o,strategy:s}=e;const r=[...i==="clippingAncestors"?Di(t)?[]:Sr(t,this._c):[].concat(i),o],l=r[0],d=r.reduce((u,p)=>{const m=Ho(t,p,s);return u.top=ce(m.top,u.top),u.right=Je(m.right,u.right),u.bottom=Je(m.bottom,u.bottom),u.left=ce(m.left,u.left),u},Ho(t,l,s));return{width:d.right-d.left,height:d.bottom-d.top,x:d.left,y:d.top}}function Ar(e){const{width:t,height:i}=Ts(e);return{width:t,height:i}}function Dr(e,t,i){const o=ze(t),s=Ie(t),a=i==="fixed",r=ut(e,!0,a,t);let l={scrollLeft:0,scrollTop:0};const d=Oe(0);function u(){d.x=Mi(s)}if(o||!o&&!a)if((Tt(t)!=="body"||Yt(s))&&(l=zi(t)),o){const f=ut(t,!0,a,t);d.x=f.x+t.clientLeft,d.y=f.y+t.clientTop}else s&&u();a&&!o&&s&&u();const p=s&&!o&&!a?Es(s,l):Oe(0),m=r.left+l.scrollLeft-d.x-p.x,v=r.top+l.scrollTop-d.y-p.y;return{x:m,y:v,width:r.width,height:r.height}}function qi(e){return Ce(e).position==="static"}function jo(e,t){if(!ze(e)||Ce(e).position==="fixed")return null;if(t)return t(e);let i=e.offsetParent;return Ie(e)===i&&(i=i.ownerDocument.body),i}function Ds(e,t){const i=de(e);if(Di(e))return i;if(!ze(e)){let s=et(e);for(;s&&!kt(s);){if(_e(s)&&!qi(s))return s;s=et(s)}return i}let o=jo(e,t);for(;o&&hr(o)&&qi(o);)o=jo(o,t);return o&&kt(o)&&qi(o)&&!Oi(o)?i:o||gr(e)||i}const Or=async function(e){const t=this.getOffsetParent||Ds,i=this.getDimensions,o=await i(e.floating);return{reference:Dr(e.reference,await t(e.floating),e.strategy),floating:{x:0,y:0,width:o.width,height:o.height}}};function zr(e){return Ce(e).direction==="rtl"}const ci={convertOffsetParentRelativeRectToViewportRelativeRect:kr,getDocumentElement:Ie,getClippingRect:Er,getOffsetParent:Ds,getElementRects:Or,getClientRects:xr,getDimensions:Ar,getScale:wt,isElement:_e,isRTL:zr};function Os(e,t){return e.x===t.x&&e.y===t.y&&e.width===t.width&&e.height===t.height}function Mr(e,t){let i=null,o;const s=Ie(e);function a(){var l;clearTimeout(o),(l=i)==null||l.disconnect(),i=null}function r(l,d){l===void 0&&(l=!1),d===void 0&&(d=1),a();const u=e.getBoundingClientRect(),{left:p,top:m,width:v,height:f}=u;if(l||t(),!v||!f)return;const b=ii(m),g=ii(s.clientWidth-(p+v)),k=ii(s.clientHeight-(m+f)),x=ii(p),T={rootMargin:-b+"px "+-g+"px "+-k+"px "+-x+"px",threshold:ce(0,Je(1,d))||1};let W=!0;function N(ye){const Z=ye[0].intersectionRatio;if(Z!==d){if(!W)return r();Z?r(!1,Z):o=setTimeout(()=>{r(!1,1e-7)},1e3)}Z===1&&!Os(u,e.getBoundingClientRect())&&r(),W=!1}try{i=new IntersectionObserver(N,{...T,root:s.ownerDocument})}catch{i=new IntersectionObserver(N,T)}i.observe(e)}return r(!0),a}function Pr(e,t,i,o){o===void 0&&(o={});const{ancestorScroll:s=!0,ancestorResize:a=!0,elementResize:r=typeof ResizeObserver=="function",layoutShift:l=typeof IntersectionObserver=="function",animationFrame:d=!1}=o,u=ko(e),p=s||a?[...u?Bt(u):[],...Bt(t)]:[];p.forEach(x=>{s&&x.addEventListener("scroll",i,{passive:!0}),a&&x.addEventListener("resize",i)});const m=u&&l?Mr(u,i):null;let v=-1,f=null;r&&(f=new ResizeObserver(x=>{let[A]=x;A&&A.target===u&&f&&(f.unobserve(t),cancelAnimationFrame(v),v=requestAnimationFrame(()=>{var T;(T=f)==null||T.observe(t)})),i()}),u&&!d&&f.observe(u),f.observe(t));let b,g=d?ut(e):null;d&&k();function k(){const x=ut(e);g&&!Os(g,x)&&i(),g=x,b=requestAnimationFrame(k)}return i(),()=>{var x;p.forEach(A=>{s&&A.removeEventListener("scroll",i),a&&A.removeEventListener("resize",i)}),m==null||m(),(x=f)==null||x.disconnect(),f=null,d&&cancelAnimationFrame(b)}}const Lr=nr,Ir=lr,Rr=sr,Vo=cr,Fr=or,Nr=(e,t,i)=>{const o=new Map,s={platform:ci,...i},a={...s.platform,_c:o};return ir(e,t,{...s,platform:a})};function Br(e){return Hr(e)}function Yi(e){return e.assignedSlot?e.assignedSlot:e.parentNode instanceof ShadowRoot?e.parentNode.host:e.parentNode}function Hr(e){for(let t=e;t;t=Yi(t))if(t instanceof Element&&getComputedStyle(t).display==="none")return null;for(let t=Yi(e);t;t=Yi(t)){if(!(t instanceof Element))continue;const i=getComputedStyle(t);if(i.display!=="contents"&&(i.position!=="static"||Oi(i)||t.tagName==="BODY"))return t}return null}function jr(e){return e!==null&&typeof e=="object"&&"getBoundingClientRect"in e&&("contextElement"in e?e.contextElement instanceof Element:!0)}var I=class extends P{constructor(){super(...arguments),this.localize=new ie(this),this.active=!1,this.placement="top",this.strategy="absolute",this.distance=0,this.skidding=0,this.arrow=!1,this.arrowPlacement="anchor",this.arrowPadding=10,this.flip=!1,this.flipFallbackPlacements="",this.flipFallbackStrategy="best-fit",this.flipPadding=0,this.shift=!1,this.shiftPadding=0,this.autoSizePadding=0,this.hoverBridge=!1,this.updateHoverBridge=()=>{if(this.hoverBridge&&this.anchorEl){const e=this.anchorEl.getBoundingClientRect(),t=this.popup.getBoundingClientRect(),i=this.placement.includes("top")||this.placement.includes("bottom");let o=0,s=0,a=0,r=0,l=0,d=0,u=0,p=0;i?e.top<t.top?(o=e.left,s=e.bottom,a=e.right,r=e.bottom,l=t.left,d=t.top,u=t.right,p=t.top):(o=t.left,s=t.bottom,a=t.right,r=t.bottom,l=e.left,d=e.top,u=e.right,p=e.top):e.left<t.left?(o=e.right,s=e.top,a=t.left,r=t.top,l=e.right,d=e.bottom,u=t.left,p=t.bottom):(o=t.right,s=t.top,a=e.left,r=e.top,l=t.right,d=t.bottom,u=e.left,p=e.bottom),this.style.setProperty("--hover-bridge-top-left-x",`${o}px`),this.style.setProperty("--hover-bridge-top-left-y",`${s}px`),this.style.setProperty("--hover-bridge-top-right-x",`${a}px`),this.style.setProperty("--hover-bridge-top-right-y",`${r}px`),this.style.setProperty("--hover-bridge-bottom-left-x",`${l}px`),this.style.setProperty("--hover-bridge-bottom-left-y",`${d}px`),this.style.setProperty("--hover-bridge-bottom-right-x",`${u}px`),this.style.setProperty("--hover-bridge-bottom-right-y",`${p}px`)}}}async connectedCallback(){super.connectedCallback(),await this.updateComplete,this.start()}disconnectedCallback(){super.disconnectedCallback(),this.stop()}async updated(e){super.updated(e),e.has("active")&&(this.active?this.start():this.stop()),e.has("anchor")&&this.handleAnchorChange(),this.active&&(await this.updateComplete,this.reposition())}async handleAnchorChange(){if(await this.stop(),this.anchor&&typeof this.anchor=="string"){const e=this.getRootNode();this.anchorEl=e.getElementById(this.anchor)}else this.anchor instanceof Element||jr(this.anchor)?this.anchorEl=this.anchor:this.anchorEl=this.querySelector('[slot="anchor"]');this.anchorEl instanceof HTMLSlotElement&&(this.anchorEl=this.anchorEl.assignedElements({flatten:!0})[0]),this.anchorEl&&this.active&&this.start()}start(){!this.anchorEl||!this.active||(this.cleanup=Pr(this.anchorEl,this.popup,()=>{this.reposition()}))}async stop(){return new Promise(e=>{this.cleanup?(this.cleanup(),this.cleanup=void 0,this.removeAttribute("data-current-placement"),this.style.removeProperty("--auto-size-available-width"),this.style.removeProperty("--auto-size-available-height"),requestAnimationFrame(()=>e())):e()})}reposition(){if(!this.active||!this.anchorEl)return;const e=[Lr({mainAxis:this.distance,crossAxis:this.skidding})];this.sync?e.push(Vo({apply:({rects:i})=>{const o=this.sync==="width"||this.sync==="both",s=this.sync==="height"||this.sync==="both";this.popup.style.width=o?`${i.reference.width}px`:"",this.popup.style.height=s?`${i.reference.height}px`:""}})):(this.popup.style.width="",this.popup.style.height=""),this.flip&&e.push(Rr({boundary:this.flipBoundary,fallbackPlacements:this.flipFallbackPlacements,fallbackStrategy:this.flipFallbackStrategy==="best-fit"?"bestFit":"initialPlacement",padding:this.flipPadding})),this.shift&&e.push(Ir({boundary:this.shiftBoundary,padding:this.shiftPadding})),this.autoSize?e.push(Vo({boundary:this.autoSizeBoundary,padding:this.autoSizePadding,apply:({availableWidth:i,availableHeight:o})=>{this.autoSize==="vertical"||this.autoSize==="both"?this.style.setProperty("--auto-size-available-height",`${o}px`):this.style.removeProperty("--auto-size-available-height"),this.autoSize==="horizontal"||this.autoSize==="both"?this.style.setProperty("--auto-size-available-width",`${i}px`):this.style.removeProperty("--auto-size-available-width")}})):(this.style.removeProperty("--auto-size-available-width"),this.style.removeProperty("--auto-size-available-height")),this.arrow&&e.push(Fr({element:this.arrowEl,padding:this.arrowPadding}));const t=this.strategy==="absolute"?i=>ci.getOffsetParent(i,Br):ci.getOffsetParent;Nr(this.anchorEl,this.popup,{placement:this.placement,middleware:e,strategy:this.strategy,platform:Ut(Ue({},ci),{getOffsetParent:t})}).then(({x:i,y:o,middlewareData:s,placement:a})=>{const r=this.localize.dir()==="rtl",l={top:"bottom",right:"left",bottom:"top",left:"right"}[a.split("-")[0]];if(this.setAttribute("data-current-placement",a),Object.assign(this.popup.style,{left:`${i}px`,top:`${o}px`}),this.arrow){const d=s.arrow.x,u=s.arrow.y;let p="",m="",v="",f="";if(this.arrowPlacement==="start"){const b=typeof d=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"";p=typeof u=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"",m=r?b:"",f=r?"":b}else if(this.arrowPlacement==="end"){const b=typeof d=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"";m=r?"":b,f=r?b:"",v=typeof u=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:""}else this.arrowPlacement==="center"?(f=typeof d=="number"?"calc(50% - var(--arrow-size-diagonal))":"",p=typeof u=="number"?"calc(50% - var(--arrow-size-diagonal))":""):(f=typeof d=="number"?`${d}px`:"",p=typeof u=="number"?`${u}px`:"");Object.assign(this.arrowEl.style,{top:p,right:m,bottom:v,left:f,[l]:"calc(var(--arrow-size-diagonal) * -1)"})}}),requestAnimationFrame(()=>this.updateHoverBridge()),this.emit("sl-reposition")}render(){return h`
...
`,ve=class extends P{constructor(){super(...arguments),this.localize=new ie(this),this.isInitialized=!1,this.current=!1,this.selected=!1,this.hasHover=!1,this.value="",this.disabled=!1}connectedCallback(){super.connectedCallback(),this.setAttribute("role","option"),this.setAttribute("aria-selected","false")}handleDefaultSlotChange(){this.isInitialized?customElements.whenDefined("sl-select").then(()=>{const e=this.closest("sl-select");e&&e.handleDefaultSlotChange()}):this.isInitialized=!0}handleMouseEnter(){this.hasHover=!0}handleMouseLeave(){this.hasHover=!1}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false")}handleSelectedChange(){this.setAttribute("aria-selected",this.selected?"true":"false")}handleValueChange(){typeof this.value!="string"&&(this.value=String(this.value)),this.value.includes(" ")&&(console.error("Option values cannot include a space. All spaces have been replaced with underscores.",this),this.value=this.value.replace(/ /g,"_"))}getTextLabel(){const e=this.childNodes;let t="";return[...e].forEach(i=>{i.nodeType===Node.ELEMENT_NODE&&(i.hasAttribute("slot")||(t+=i.textContent)),i.nodeType===Node.TEXT_NODE&&(t+=i.textContent)}),t.trim()}render(){return h`
      <div
        part="base"
    ...
    `}};ve.styles=[F,Yr];ve.dependencies={"sl-icon":G};n([C(".option__label")],ve.prototype,"defaultSlot",2);n([y()],ve.prototype,"current",2);n([y()],ve.prototype,"selected",2);n([y()],ve.prototype,"hasHover",2);n([c({reflect:!0})],ve.prototype,"value",2);n([c({type:Boolean,reflect:!0})],ve.prototype,"disabled",2);n([E("disabled")],ve.prototype,"handleDisabledChange",1);n([E("selected")],ve.prototype,"handleSelectedChange",1);n([E("value")],ve.prototype,"handleValueChange",1);ve.define("sl-option");var Kr=S`
  :host {
    --size: 25rem;
...
`,Re=class extends P{constructor(){super(...arguments),this.hasSlotController=new qe(this,"footer"),this.localize=new ie(this),this.modal=new Ls(this),this.open=!1,this.label="",this.noHeader=!1,this.handleDocumentKeyDown=e=>{e.key==="Escape"&&this.modal.isActive()&&this.open&&(e.stopPropagation(),this.requestClose("keyboard"))}}firstUpdated(){this.dialog.hidden=!this.open,this.open&&(this.addOpenListeners(),this.modal.activate(),Rt(this))}disconnectedCallback(){super.disconnectedCallback(),this.modal.deactivate(),Ft(this),this.removeOpenListeners()}requestClose(e){if(this.emit("sl-request-close",{cancelable:!0,detail:{source:e}}).defaultPrevented){const i=B(this,"dialog.denyClose",{dir:this.localize.dir()});H(this.panel,i.keyframes,i.options);return}this.hide()}addOpenListeners(){var e;"CloseWatcher"in window?((e=this.closeWatcher)==null||e.destroy(),this.closeWatcher=new CloseWatcher,this.closeWatcher.onclose=()=>this.requestClose("keyboard")):document.addEventListener("keydown",this.handleDocumentKeyDown)}removeOpenListeners(){var e;(e=this.closeWatcher)==null||e.destroy(),document.removeEventListener("keydown",this.handleDocumentKeyDown)}async handleOpenChange(){if(this.open){this.emit("sl-show"),this.addOpenListeners(),this.originalTrigger=document.activeElement,this.modal.activate(),Rt(this);const e=this.querySelector("[autofocus]");e&&e.removeAttribute("autofocus"),await Promise.all([U(this.dialog),U(this.overlay)]),this.dialog.hidden=!1,requestAnimationFrame(()=>{this.emit("sl-initial-focus",{cancelable:!0}).defaultPrevented||(e?e.focus({preventScroll:!0}):this.panel.focus({preventScroll:!0})),e&&e.setAttribute("autofocus","")});const t=B(this,"dialog.show",{dir:this.localize.dir()}),i=B(this,"dialog.overlay.show",{dir:this.localize.dir()});await Promise.all([H(this.panel,t.keyframes,t.options),H(this.overlay,i.keyframes,i.options)]),this.emit("sl-after-show")}else{_o(this),this.emit("sl-hide"),this.removeOpenListeners(),this.modal.deactivate(),await Promise.all([U(this.dialog),U(this.overlay)]);const e=B(this,"dialog.hide",{dir:this.localize.dir()}),t=B(this,"dialog.overlay.hide",{dir:this.localize.dir()});await Promise.all([H(this.overlay,t.keyframes,t.options).then(()=>{this.overlay.hidden=!0}),H(this.panel,e.keyframes,e.options).then(()=>{this.panel.hidden=!0})]),this.dialog.hidden=!0,this.overlay.hidden=!1,this.panel.hidden=!1,Ft(this);const i=this.originalTrigger;typeof(i==null?void 0:i.focus)=="function"&&setTimeout(()=>i.focus()),this.emit("sl-after-hide")}}async show(){if(!this.open)return this.open=!0,ne(this,"sl-after-show")}async hide(){if(this.open)return this.open=!1,ne(this,"sl-after-hide")}render(){return h`
    ...
    `}};Re.styles=[F,en];Re.dependencies={"sl-icon-button":V};n([C(".dialog")],Re.prototype,"dialog",2);n([C(".dialog__panel")],Re.prototype,"panel",2);n([C(".dialog__overlay")],Re.prototype,"overlay",2);n([c({type:Boolean,reflect:!0})],Re.prototype,"open",2);n([c({reflect:!0})],Re.prototype,"label",2);n([c({attribute:"no-header",type:Boolean,reflect:!0})],Re.prototype,"noHeader",2);n([E("open",{waitUntilFirstUpdate:!0})],Re.prototype,"handleOpenChange",1);R("dialog.show",{keyframes:[{opacity:0,scale:.8},{opacity:1,scale:1}],options:{duration:250,easing:"ease"}});R("dialog.hide",{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.8}],options:{duration:250,easing:"ease"}});R("dialog.denyClose",{keyframes:[{scale:1},{scale:1.02},{scale:1}],options:{duration:250}});R("dialog.overlay.show",{keyframes:[{opacity:0},{opacity:1}],options:{duration:250}});R("dialog.overlay.hide",{keyframes:[{opacity:1},{opacity:0}],options:{duration:250}});Re.define("sl-dialog");var tn=S`
  :host {
    display: inline-flex;
  }
...
`,Kt=class extends P{constructor(){super(...arguments),this.variant="primary",this.pill=!1,this.pulse=!1}render(){return h`
      <span
        part="base"
    ...
    `}};Kt.styles=[F,tn];n([c({reflect:!0})],Kt.prototype,"variant",2);n([c({type:Boolean,reflect:!0})],Kt.prototype,"pill",2);n([c({type:Boolean,reflect:!0})],Kt.prototype,"pulse",2);Kt.define("sl-badge");var on=S`
  :host {
    display: contents;
...
`,he=class rt extends P{constructor(){super(...arguments),this.hasSlotController=new qe(this,"icon","suffix"),this.localize=new ie(this),this.open=!1,this.closable=!1,this.variant="primary",this.duration=1/0,this.remainingTime=this.duration}static get toastStack(){return this.currentToastStack||(this.currentToastStack=Object.assign(document.createElement("div"),{className:"sl-toast-stack"})),this.currentToastStack}firstUpdated(){this.base.hidden=!this.open}restartAutoHide(){this.handleCountdownChange(),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval),this.open&&this.duration<1/0&&(this.autoHideTimeout=window.setTimeout(()=>this.hide(),this.duration),this.remainingTime=this.duration,this.remainingTimeInterval=window.setInterval(()=>{this.remainingTime-=100},100))}pauseAutoHide(){var t;(t=this.countdownAnimation)==null||t.pause(),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval)}resumeAutoHide(){var t;this.duration<1/0&&(this.autoHideTimeout=window.setTimeout(()=>this.hide(),this.remainingTime),this.remainingTimeInterval=window.setInterval(()=>{this.remainingTime-=100},100),(t=this.countdownAnimation)==null||t.play())}handleCountdownChange(){if(this.open&&this.duration<1/0&&this.countdown){const{countdownElement:t}=this,i="100%",o="0";this.countdownAnimation=t.animate([{width:i},{width:o}],{duration:this.duration,easing:"linear"})}}handleCloseClick(){this.hide()}async handleOpenChange(){if(this.open){this.emit("sl-show"),this.duration<1/0&&this.restartAutoHide(),await U(this.base),this.base.hidden=!1;const{keyframes:t,options:i}=B(this,"alert.show",{dir:this.localize.dir()});await H(this.base,t,i),this.emit("sl-after-show")}else{_o(this),this.emit("sl-hide"),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval),await U(this.base);const{keyframes:t,options:i}=B(this,"alert.hide",{dir:this.localize.dir()});await H(this.base,t,i),this.base.hidden=!0,this.emit("sl-after-hide")}}handleDurationChange(){this.restartAutoHide()}async show(){if(!this.open)return this.open=!0,ne(this,"sl-after-show")}async hide(){if(this.open)return this.open=!1,ne(this,"sl-after-hide")}async toast(){return new Promise(t=>{this.handleCountdownChange(),rt.toastStack.parentElement===null&&document.body.append(rt.toastStack),rt.toastStack.appendChild(this),requestAnimationFrame(()=>{this.clientWidth,this.show()}),this.addEventListener("sl-after-hide",()=>{rt.toastStack.removeChild(this),t(),rt.toastStack.querySelector("sl-alert")===null&&rt.toastStack.remove()},{once:!0})})}render(){return h`
    ...
    `}};he.styles=[F,on];he.dependencies={"sl-icon-button":V};n([C('[part~="base"]')],he.prototype,"base",2);n([C(".alert__countdown-elapsed")],he.prototype,"countdownElement",2);n([c({type:Boolean,reflect:!0})],he.prototype,"open",2);n([c({type:Boolean,reflect:!0})],he.prototype,"closable",2);n([c({reflect:!0})],he.prototype,"variant",2);n([c({type:Number})],he.prototype,"duration",2);n([c({type:String,reflect:!0})],he.prototype,"countdown",2);n([y()],he.prototype,"remainingTime",2);n([E("open",{waitUntilFirstUpdate:!0})],he.prototype,"handleOpenChange",1);n([E("duration")],he.prototype,"handleDurationChange",1);var sn=he;R("alert.show",{keyframes:[{opacity:0,scale:.8},{opacity:1,scale:1}],options:{duration:250,easing:"ease"}});R("alert.hide",{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.8}],options:{duration:250,easing:"ease"}});sn.define("sl-alert");var an=S`
  :host {
    display: block;
  }
...
`,oe=class extends P{constructor(){super(...arguments),this.localize=new ie(this),this.open=!1,this.placement="bottom-start",this.disabled=!1,this.stayOpenOnSelect=!1,this.distance=0,this.skidding=0,this.hoist=!1,this.sync=void 0,this.handleKeyDown=e=>{this.open&&e.key==="Escape"&&(e.stopPropagation(),this.hide(),this.focusOnTrigger())},this.handleDocumentKeyDown=e=>{var t;if(e.key==="Escape"&&this.open&&!this.closeWatcher){e.stopPropagation(),this.focusOnTrigger(),this.hide();return}if(e.key==="Tab"){if(this.open&&((t=document.activeElement)==null?void 0:t.tagName.toLowerCase())==="sl-menu-item"){e.preventDefault(),this.hide(),this.focusOnTrigger();return}const i=(o,s)=>{if(!o)return null;const a=o.closest(s);if(a)return a;const r=o.getRootNode();return r instanceof ShadowRoot?i(r.host,s):null};setTimeout(()=>{var o;const s=((o=this.containingElement)==null?void 0:o.getRootNode())instanceof ShadowRoot?Ms():document.activeElement;(!this.containingElement||i(s,this.containingElement.tagName.toLowerCase())!==this.containingElement)&&this.hide()})}},this.handleDocumentMouseDown=e=>{const t=e.composedPath();this.containingElement&&!t.includes(this.containingElement)&&this.hide()},this.handlePanelSelect=e=>{const t=e.target;!this.stayOpenOnSelect&&t.tagName.toLowerCase()==="sl-menu"&&(this.hide(),this.focusOnTrigger())}}connectedCallback(){super.connectedCallback(),this.containingElement||(this.containingElement=this)}firstUpdated(){this.panel.hidden=!this.open,this.open&&(this.addOpenListeners(),this.popup.active=!0)}disconnectedCallback(){super.disconnectedCallback(),this.removeOpenListeners(),this.hide()}focusOnTrigger(){const e=this.trigger.assignedElements({flatten:!0})[0];typeof(e==null?void 0:e.focus)=="function"&&e.focus()}getMenu(){return this.panel.assignedElements({flatten:!0}).find(e=>e.tagName.toLowerCase()==="sl-menu")}handleTriggerClick(){this.open?this.hide():(this.show(),this.focusOnTrigger())}async handleTriggerKeyDown(e){if([" ","Enter"].includes(e.key)){e.preventDefault(),this.handleTriggerClick();return}const t=this.getMenu();if(t){const i=t.getAllItems(),o=i[0],s=i[i.length-1];["ArrowDown","ArrowUp","Home","End"].includes(e.key)&&(e.preventDefault(),this.open||(this.show(),await this.updateComplete),i.length>0&&this.updateComplete.then(()=>{(e.key==="ArrowDown"||e.key==="Home")&&(t.setCurrentItem(o),o.focus()),(e.key==="ArrowUp"||e.key==="End")&&(t.setCurrentItem(s),s.focus())}))}}handleTriggerKeyUp(e){e.key===" "&&e.preventDefault()}handleTriggerSlotChange(){this.updateAccessibleTrigger()}updateAccessibleTrigger(){const t=this.trigger.assignedElements({flatten:!0}).find(o=>Jr(o).start);let i;if(t){switch(t.tagName.toLowerCase()){case"sl-button":case"sl-icon-button":i=t.button;break;default:i=t}i.setAttribute("aria-haspopup","true"),i.setAttribute("aria-expanded",this.open?"true":"false")}}async show(){if(!this.open)return this.open=!0,ne(this,"sl-after-show")}async hide(){if(this.open)return this.open=!1,ne(this,"sl-after-hide")}reposition(){this.popup.reposition()}addOpenListeners(){var e;this.panel.addEventListener("sl-select",this.handlePanelSelect),"CloseWatcher"in window?((e=this.closeWatcher)==null||e.destroy(),this.closeWatcher=new CloseWatcher,this.closeWatcher.onclose=()=>{this.hide(),this.focusOnTrigger()}):this.panel.addEventListener("keydown",this.handleKeyDown),document.addEventListener("keydown",this.handleDocumentKeyDown),document.addEventListener("mousedown",this.handleDocumentMouseDown)}removeOpenListeners(){var e;this.panel&&(this.panel.removeEventListener("sl-select",this.handlePanelSelect),this.panel.removeEventListener("keydown",this.handleKeyDown)),document.removeEventListener("keydown",this.handleDocumentKeyDown),document.removeEventListener("mousedown",this.handleDocumentMouseDown),(e=this.closeWatcher)==null||e.destroy()}async handleOpenChange(){if(this.disabled){this.open=!1;return}if(this.updateAccessibleTrigger(),this.open){this.emit("sl-show"),this.addOpenListeners(),await U(this),this.panel.hidden=!1,this.popup.active=!0;const{keyframes:e,options:t}=B(this,"dropdown.show",{dir:this.localize.dir()});await H(this.popup.popup,e,t),this.emit("sl-after-show")}else{this.emit("sl-hide"),this.removeOpenListeners(),await U(this);const{keyframes:e,options:t}=B(this,"dropdown.hide",{dir:this.localize.dir()});await H(this.popup.popup,e,t),this.panel.hidden=!0,this.popup.active=!1,this.emit("sl-after-hide")}}render(){return h`
      <sl-popup
        part="base"
    ...
    `}};oe.styles=[F,rn];oe.dependencies={"sl-popup":I};n([C(".dropdown")],oe.prototype,"popup",2);n([C(".dropdown__trigger")],oe.prototype,"trigger",2);n([C(".dropdown__panel")],oe.prototype,"panel",2);n([c({type:Boolean,reflect:!0})],oe.prototype,"open",2);n([c({reflect:!0})],oe.prototype,"placement",2);n([c({type:Boolean,reflect:!0})],oe.prototype,"disabled",2);n([c({attribute:"stay-open-on-select",type:Boolean,reflect:!0})],oe.prototype,"stayOpenOnSelect",2);n([c({attribute:!1})],oe.prototype,"containingElement",2);n([c({type:Number})],oe.prototype,"distance",2);n([c({type:Number})],oe.prototype,"skidding",2);n([c({type:Boolean})],oe.prototype,"hoist",2);n([c({reflect:!0})],oe.prototype,"sync",2);n([E("open",{waitUntilFirstUpdate:!0})],oe.prototype,"handleOpenChange",1);R("dropdown.show",{keyframes:[{opacity:0,scale:.9},{opacity:1,scale:1}],options:{duration:100,easing:"ease"}});R("dropdown.hide",{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.9}],options:{duration:100,easing:"ease"}});oe.define("sl-dropdown");var nn=S`
  :host {
    display: block;
    position: relative;
    background: var(--sl-panel-background-color);
...
`,Co=class extends P{connectedCallback(){super.connectedCallback(),this.setAttribute("role","menu")}handleClick(e){const t=["menuitem","menuitemcheckbox"],i=e.composedPath(),o=i.find(l=>{var d;return t.includes(((d=l==null?void 0:l.getAttribute)==null?void 0:d.call(l,"role"))||"")});if(!o||i.find(l=>{var d;return((d=l==null?void 0:l.getAttribute)==null?void 0:d.call(l,"role"))==="menu"})!==this)return;const r=o;r.type==="checkbox"&&(r.checked=!r.checked),this.emit("sl-select",{detail:{item:r}})}handleKeyDown(e){if(e.key==="Enter"||e.key===" "){const t=this.getCurrentItem();e.preventDefault(),e.stopPropagation(),t==null||t.click()}else if(["ArrowDown","ArrowUp","Home","End"].includes(e.key)){const t=this.getAllItems(),i=this.getCurrentItem();let o=i?t.indexOf(i):0;t.length>0&&(e.preventDefault(),e.stopPropagation(),e.key==="ArrowDown"?o++:e.key==="ArrowUp"?o--:e.key==="Home"?o=0:e.key==="End"&&(o=t.length-1),o<0&&(o=t.length-1),o>t.length-1&&(o=0),this.setCurrentItem(t[o]),t[o].focus())}}handleMouseDown(e){const t=e.target;this.isMenuItem(t)&&this.setCurrentItem(t)}handleSlotChange(){const e=this.getAllItems();e.length>0&&this.setCurrentItem(e[0])}isMenuItem(e){var t;return e.tagName.toLowerCase()==="sl-menu-item"||["menuitem","menuitemcheckbox","menuitemradio"].includes((t=e.getAttribute("role"))!=null?t:"")}getAllItems(){return[...this.defaultSlot.assignedElements({flatten:!0})].filter(e=>!(e.inert||!this.isMenuItem(e)))}getCurrentItem(){return this.getAllItems().find(e=>e.getAttribute("tabindex")==="0")}setCurrentItem(e){this.getAllItems().forEach(i=>{i.setAttribute("tabindex",i===e?"0":"-1")})}render(){return h`
      ...
      ></slot>
    `}};Co.styles=[F,nn];n([C("slot")],Co.prototype,"defaultSlot",2);Co.define("sl-menu");var ln=S`
  :host {
    --submenu-offset: -2px;
 ...
 */const pn=()=>new fn;class fn{}const Ki=new WeakMap,mn=Ti(class extends hn{render(e){return w}update(e,[t]){var o;const i=t!==this.G;return i&&this.G!==void 0&&this.rt(void 0),(i||this.lt!==this.ct)&&(this.G=t,this.ht=(o=e.options)==null?void 0:o.host,this.rt(this.ct=e.element)),w}rt(e){if(this.isConnected||(e=void 0),typeof this.G=="function"){const t=this.ht??globalThis;let i=Ki.get(t);i===void 0&&(i=new WeakMap,Ki.set(t,i)),i.get(this.G)!==void 0&&this.G.call(this.ht,void 0),i.set(this.G,e),e!==void 0&&this.G.call(this.ht,e)}else this.G.value=e}get lt(){var e,t;return typeof this.G=="function"?(e=Ki.get(this.ht??globalThis))==null?void 0:e.get(this.G):(t=this.G)==null?void 0:t.value}disconnected(){this.lt===this.ct&&this.rt(void 0)}reconnected(){this.rt(this.ct)}});var bn=class{constructor(e,t){this.popupRef=pn(),this.enableSubmenuTimer=-1,this.isConnected=!1,this.isPopupConnected=!1,this.skidding=0,this.submenuOpenDelay=100,this.handleMouseMove=i=>{this.host.style.setProperty("--safe-triangle-cursor-x",`${i.clientX}px`),this.host.style.setProperty("--safe-triangle-cursor-y",`${i.clientY}px`)},this.handleMouseOver=()=>{this.hasSlotController.test("submenu")&&this.enableSubmenu()},this.handleKeyDown=i=>{switch(i.key){case"Escape":case"Tab":this.disableSubmenu();break;case"ArrowLeft":i.target!==this.host&&(i.preventDefault(),i.stopPropagation(),this.host.focus(),this.disableSubmenu());break;case"ArrowRight":case"Enter":case" ":this.handleSubmenuEntry(i);break}},this.handleClick=i=>{var o;i.target===this.host?(i.preventDefault(),i.stopPropagation()):i.target instanceof Element&&(i.target.tagName==="sl-menu-item"||(o=i.target.role)!=null&&o.startsWith("menuitem"))&&this.disableSubmenu()},this.handleFocusOut=i=>{i.relatedTarget&&i.relatedTarget instanceof Element&&this.host.contains(i.relatedTarget)||this.disableSubmenu()},this.handlePopupMouseover=i=>{i.stopPropagation()},this.handlePopupReposition=()=>{const i=this.host.renderRoot.querySelector("slot[name='submenu']"),o=i==null?void 0:i.assignedElements({flatten:!0}).filter(u=>u.localName==="sl-menu")[0],s=getComputedStyle(this.host).direction==="rtl";if(!o)return;const{left:a,top:r,width:l,height:d}=o.getBoundingClientRect();this.host.style.setProperty("--safe-triangle-submenu-start-x",`${s?a+l:a}px`),this.host.style.setProperty("--safe-triangle-submenu-start-y",`${r}px`),this.host.style.setProperty("--safe-triangle-submenu-end-x",`${s?a+l:a}px`),this.host.style.setProperty("--safe-triangle-submenu-end-y",`${r+d}px`)},(this.host=e).addController(this),this.hasSlotController=t}hostConnected(){this.hasSlotController.test("submenu")&&!this.host.disabled&&this.addListeners()}hostDisconnected(){this.removeListeners()}hostUpdated(){this.hasSlotController.test("submenu")&&!this.host.disabled?(this.addListeners(),this.updateSkidding()):this.removeListeners()}addListeners(){this.isConnected||(this.host.addEventListener("mousemove",this.handleMouseMove),this.host.addEventListener("mouseover",this.handleMouseOver),this.host.addEventListener("keydown",this.handleKeyDown),this.host.addEventListener("click",this.handleClick),this.host.addEventListener("focusout",this.handleFocusOut),this.isConnected=!0),this.isPopupConnected||this.popupRef.value&&(this.popupRef.value.addEventListener("mouseover",this.handlePopupMouseover),this.popupRef.value.addEventListener("sl-reposition",this.handlePopupReposition),this.isPopupConnected=!0)}removeListeners(){this.isConnected&&(this.host.removeEventListener("mousemove",this.handleMouseMove),this.host.removeEventListener("mouseover",this.handleMouseOver),this.host.removeEventListener("keydown",this.handleKeyDown),this.host.removeEventListener("click",this.handleClick),this.host.removeEventListener("focusout",this.handleFocusOut),this.isConnected=!1),this.isPopupConnected&&this.popupRef.value&&(this.popupRef.value.removeEventListener("mouseover",this.handlePopupMouseover),this.popupRef.value.removeEventListener("sl-reposition",this.handlePopupReposition),this.isPopupConnected=!1)}handleSubmenuEntry(e){const t=this.host.renderRoot.querySelector("slot[name='submenu']");if(!t){console.error("Cannot activate a submenu if no corresponding menuitem can be found.",this);return}let i=null;for(const o of t.assignedElements())if(i=o.querySelectorAll("sl-menu-item, [role^='menuitem']"),i.length!==0)break;if(!(!i||i.length===0)){i[0].setAttribute("tabindex","0");for(let o=1;o!==i.length;++o)i[o].setAttribute("tabindex","-1");this.popupRef.value&&(e.preventDefault(),e.stopPropagation(),this.popupRef.value.active?i[0]instanceof HTMLElement&&i[0].focus():(this.enableSubmenu(!1),this.host.updateComplete.then(()=>{i[0]instanceof HTMLElement&&i[0].focus()}),this.host.requestUpdate()))}}setSubmenuState(e){this.popupRef.value&&this.popupRef.value.active!==e&&(this.popupRef.value.active=e,this.host.requestUpdate())}enableSubmenu(e=!0){e?(window.clearTimeout(this.enableSubmenuTimer),this.enableSubmenuTimer=window.setTimeout(()=>{this.setSubmenuState(!0)},this.submenuOpenDelay)):this.setSubmenuState(!0)}disableSubmenu(){window.clearTimeout(this.enableSubmenuTimer),this.setSubmenuState(!1)}updateSkidding(){var e;if(!((e=this.host.parentElement)!=null&&e.computedStyleMap))return;const t=this.host.parentElement.computedStyleMap(),o=["padding-top","border-top-width","margin-top"].reduce((s,a)=>{var r;const l=(r=t.get(a))!=null?r:new CSSUnitValue(0,"px"),u=(l instanceof CSSUnitValue?l:new CSSUnitValue(0,"px")).to("px");return s-u.value},0);this.skidding=o}isExpanded(){return this.popupRef.value?this.popupRef.value.active:!1}renderSubmenu(){const e=getComputedStyle(this.host).direction==="rtl";return this.isConnected?h`
    ...
    `}};pe.styles=[F,ln];pe.dependencies={"sl-icon":G,"sl-popup":I,"sl-spinner":$i};n([C("slot:not([name])")],pe.prototype,"defaultSlot",2);n([C(".menu-item")],pe.prototype,"menuItem",2);n([c()],pe.prototype,"type",2);n([c({type:Boolean,reflect:!0})],pe.prototype,"checked",2);n([c()],pe.prototype,"value",2);n([c({type:Boolean,reflect:!0})],pe.prototype,"loading",2);n([c({type:Boolean,reflect:!0})],pe.prototype,"disabled",2);n([E("checked")],pe.prototype,"handleCheckedChange",1);n([E("disabled")],pe.prototype,"handleDisabledChange",1);n([E("type")],pe.prototype,"handleTypeChange",1);pe.define("sl-menu-item");G.define("sl-icon");var gn=S`
  :host {
...
`,X=class extends P{constructor(){super(),this.localize=new ie(this),this.content="",this.placement="top",this.disabled=!1,this.distance=8,this.open=!1,this.skidding=0,this.trigger="hover focus",this.hoist=!1,this.handleBlur=()=>{this.hasTrigger("focus")&&this.hide()},this.handleClick=()=>{this.hasTrigger("click")&&(this.open?this.hide():this.show())},this.handleFocus=()=>{this.hasTrigger("focus")&&this.show()},this.handleDocumentKeyDown=e=>{e.key==="Escape"&&(e.stopPropagation(),this.hide())},this.handleMouseOver=()=>{if(this.hasTrigger("hover")){const e=Uo(getComputedStyle(this).getPropertyValue("--show-delay"));clearTimeout(this.hoverTimeout),this.hoverTimeout=window.setTimeout(()=>this.show(),e)}},this.handleMouseOut=()=>{if(this.hasTrigger("hover")){const e=Uo(getComputedStyle(this).getPropertyValue("--hide-delay"));clearTimeout(this.hoverTimeout),this.hoverTimeout=window.setTimeout(()=>this.hide(),e)}},this.addEventListener("blur",this.handleBlur,!0),this.addEventListener("focus",this.handleFocus,!0),this.addEventListener("click",this.handleClick),this.addEventListener("mouseover",this.handleMouseOver),this.addEventListener("mouseout",this.handleMouseOut)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this.closeWatcher)==null||e.destroy(),document.removeEventListener("keydown",this.handleDocumentKeyDown)}firstUpdated(){this.body.hidden=!this.open,this.open&&(this.popup.active=!0,this.popup.reposition())}hasTrigger(e){return this.trigger.split(" ").includes(e)}async handleOpenChange(){var e,t;if(this.open){if(this.disabled)return;this.emit("sl-show"),"CloseWatcher"in window?((e=this.closeWatcher)==null||e.destroy(),this.closeWatcher=new CloseWatcher,this.closeWatcher.onclose=()=>{this.hide()}):document.addEventListener("keydown",this.handleDocumentKeyDown),await U(this.body),this.body.hidden=!1,this.popup.active=!0;const{keyframes:i,options:o}=B(this,"tooltip.show",{dir:this.localize.dir()});await H(this.popup.popup,i,o),this.popup.reposition(),this.emit("sl-after-show")}else{this.emit("sl-hide"),(t=this.closeWatcher)==null||t.destroy(),document.removeEventListener("keydown",this.handleDocumentKeyDown),await U(this.body);const{keyframes:i,options:o}=B(this,"tooltip.hide",{dir:this.localize.dir()});await H(this.popup.popup,i,o),this.popup.active=!1,this.body.hidden=!0,this.emit("sl-after-hide")}}async handleOptionsChange(){this.hasUpdated&&(await this.updateComplete,this.popup.reposition())}handleDisabledChange(){this.disabled&&this.open&&this.hide()}async show(){if(!this.open)return this.open=!0,ne(this,"sl-after-show")}async hide(){if(this.open)return this.open=!1,ne(this,"sl-after-hide")}render(){return h`
    ...
    `}};X.styles=[F,vn];X.dependencies={"sl-popup":I};n([C("slot:not([name])")],X.prototype,"defaultSlot",2);n([C(".tooltip__body")],X.prototype,"body",2);n([C("sl-popup")],X.prototype,"popup",2);n([c()],X.prototype,"content",2);n([c()],X.prototype,"placement",2);n([c({type:Boolean,reflect:!0})],X.prototype,"disabled",2);n([c({type:Number})],X.prototype,"distance",2);n([c({type:Boolean,reflect:!0})],X.prototype,"open",2);n([c({type:Number})],X.prototype,"skidding",2);n([c()],X.prototype,"trigger",2);n([c({type:Boolean})],X.prototype,"hoist",2);n([E("open",{waitUntilFirstUpdate:!0})],X.prototype,"handleOpenChange",1);n([E(["content","distance","hoist","placement","skidding"])],X.prototype,"handleOptionsChange",1);n([E("disabled")],X.prototype,"handleDisabledChange",1);R("tooltip.show",{keyframes:[{opacity:0,scale:.8},{opacity:1,scale:1}],options:{duration:150,easing:"ease"}});R("tooltip.hide",{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.8}],options:{duration:150,easing:"ease"}});X.define("sl-tooltip");var yn=S`
  :host {
    display: inline-block;
  }
...
`,Y=class extends P{constructor(){super(...arguments),this.formControlController=new qt(this,{value:e=>e.checked?e.value||"on":void 0,defaultValue:e=>e.defaultChecked,setValue:(e,t)=>e.checked=t}),this.hasSlotController=new qe(this,"help-text"),this.hasFocus=!1,this.title="",this.name="",this.size="medium",this.disabled=!1,this.checked=!1,this.indeterminate=!1,this.defaultChecked=!1,this.form="",this.required=!1,this.helpText=""}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}firstUpdated(){this.formControlController.updateValidity()}handleClick(){this.checked=!this.checked,this.indeterminate=!1,this.emit("sl-change")}handleBlur(){this.hasFocus=!1,this.emit("sl-blur")}handleInput(){this.emit("sl-input")}handleInvalid(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)}handleFocus(){this.hasFocus=!0,this.emit("sl-focus")}handleDisabledChange(){this.formControlController.setValidity(this.disabled)}handleStateChange(){this.input.checked=this.checked,this.input.indeterminate=this.indeterminate,this.formControlController.updateValidity()}click(){this.input.click()}focus(e){this.input.focus(e)}blur(){this.input.blur()}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(e){this.input.setCustomValidity(e),this.formControlController.updateValidity()}render(){const e=this.hasSlotController.test("help-text"),t=this.helpText?!0:!!e;return h`
    ...
    `}};Y.styles=[F,Ei,yn];Y.dependencies={"sl-icon":G};n([C('input[type="checkbox"]')],Y.prototype,"input",2);n([y()],Y.prototype,"hasFocus",2);n([c()],Y.prototype,"title",2);n([c()],Y.prototype,"name",2);n([c()],Y.prototype,"value",2);n([c({reflect:!0})],Y.prototype,"size",2);n([c({type:Boolean,reflect:!0})],Y.prototype,"disabled",2);n([c({type:Boolean,reflect:!0})],Y.prototype,"checked",2);n([c({type:Boolean,reflect:!0})],Y.prototype,"indeterminate",2);n([bo("checked")],Y.prototype,"defaultChecked",2);n([c({reflect:!0})],Y.prototype,"form",2);n([c({type:Boolean,reflect:!0})],Y.prototype,"required",2);n([c({attribute:"help-text"})],Y.prototype,"helpText",2);n([E("disabled",{waitUntilFirstUpdate:!0})],Y.prototype,"handleDisabledChange",1);n([E(["checked","indeterminate"],{waitUntilFirstUpdate:!0})],Y.prototype,"handleStateChange",1);Y.define("sl-checkbox");var wn=S`
  :host {
    --indicator-color: var(--sl-color-primary-600);
...
`,Cn=0,Te=class extends P{constructor(){super(...arguments),this.localize=new ie(this),this.attrId=++Cn,this.componentId=`sl-tab-${this.attrId}`,this.panel="",this.active=!1,this.closable=!1,this.disabled=!1,this.tabIndex=0}connectedCallback(){super.connectedCallback(),this.setAttribute("role","tab")}handleCloseClick(e){e.stopPropagation(),this.emit("sl-close")}handleActiveChange(){this.setAttribute("aria-selected",this.active?"true":"false")}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false"),this.disabled&&!this.active?this.tabIndex=-1:this.tabIndex=0}render(){return this.id=this.id.length>0?this.id:this.componentId,h`
      <div
        part="base"
    ...
    `}};Te.styles=[F,_n];Te.dependencies={"sl-icon-button":V};n([C(".tab")],Te.prototype,"tab",2);n([c({reflect:!0})],Te.prototype,"panel",2);n([c({type:Boolean,reflect:!0})],Te.prototype,"active",2);n([c({type:Boolean,reflect:!0})],Te.prototype,"closable",2);n([c({type:Boolean,reflect:!0})],Te.prototype,"disabled",2);n([c({type:Number,reflect:!0})],Te.prototype,"tabIndex",2);n([E("active")],Te.prototype,"handleActiveChange",1);n([E("disabled")],Te.prototype,"handleDisabledChange",1);Te.define("sl-tab");var $n=S`
  :host {
    --padding: 0;
...
`,Tn=0,Gt=class extends P{constructor(){super(...arguments),this.attrId=++Tn,this.componentId=`sl-tab-panel-${this.attrId}`,this.name="",this.active=!1}connectedCallback(){super.connectedCallback(),this.id=this.id.length>0?this.id:this.componentId,this.setAttribute("role","tabpanel")}handleActiveChange(){this.setAttribute("aria-hidden",this.active?"false":"true")}render(){return h`
      <slot
        part="base"
        class=${M({"tab-panel":!0,"tab-panel--active":this.active})}
      ></slot>
    `}};Gt.styles=[F,$n];n([c({reflect:!0})],Gt.prototype,"name",2);n([c({type:Boolean,reflect:!0})],Gt.prototype,"active",2);n([E("active")],Gt.prototype,"handleActiveChange",1);Gt.define("sl-tab-panel");$i.define("sl-spinner");V.define("sl-icon-button");var Sn=S`
  :host {
    display: block;
  }
...
`,Se=class extends P{constructor(){super(...arguments),this.localize=new ie(this),this.open=!1,this.disabled=!1}firstUpdated(){this.body.style.height=this.open?"auto":"0",this.open&&(this.details.open=!0),this.detailsObserver=new MutationObserver(e=>{for(const t of e)t.type==="attributes"&&t.attributeName==="open"&&(this.details.open?this.show():this.hide())}),this.detailsObserver.observe(this.details,{attributes:!0})}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this.detailsObserver)==null||e.disconnect()}handleSummaryClick(e){e.preventDefault(),this.disabled||(this.open?this.hide():this.show(),this.header.focus())}handleSummaryKeyDown(e){(e.key==="Enter"||e.key===" ")&&(e.preventDefault(),this.open?this.hide():this.show()),(e.key==="ArrowUp"||e.key==="ArrowLeft")&&(e.preventDefault(),this.hide()),(e.key==="ArrowDown"||e.key==="ArrowRight")&&(e.preventDefault(),this.show())}async handleOpenChange(){if(this.open){if(this.details.open=!0,this.emit("sl-show",{cancelable:!0}).defaultPrevented){this.open=!1,this.details.open=!1;return}await U(this.body);const{keyframes:t,options:i}=B(this,"details.show",{dir:this.localize.dir()});await H(this.body,qo(t,this.body.scrollHeight),i),this.body.style.height="auto",this.emit("sl-after-show")}else{if(this.emit("sl-hide",{cancelable:!0}).defaultPrevented){this.details.open=!0,this.open=!0;return}await U(this.body);const{keyframes:t,options:i}=B(this,"details.hide",{dir:this.localize.dir()});await H(this.body,qo(t,this.body.scrollHeight),i),this.body.style.height="auto",this.details.open=!1,this.emit("sl-after-hide")}}async show(){if(!(this.open||this.disabled))return this.open=!0,ne(this,"sl-after-show")}async hide(){if(!(!this.open||this.disabled))return this.open=!1,ne(this,"sl-after-hide")}render(){const e=this.localize.dir()==="rtl";return h`
    ...
    `}};Se.styles=[F,Sn];Se.dependencies={"sl-icon":G};n([C(".details")],Se.prototype,"details",2);n([C(".details__header")],Se.prototype,"header",2);n([C(".details__body")],Se.prototype,"body",2);n([C(".details__expand-icon-slot")],Se.prototype,"expandIconSlot",2);n([c({type:Boolean,reflect:!0})],Se.prototype,"open",2);n([c()],Se.prototype,"summary",2);n([c({type:Boolean,reflect:!0})],Se.prototype,"disabled",2);n([E("open",{waitUntilFirstUpdate:!0})],Se.prototype,"handleOpenChange",1);R("details.show",{keyframes:[{height:"0",opacity:"0"},{height:"auto",opacity:"1"}],options:{duration:250,easing:"linear"}});R("details.hide",{keyframes:[{height:"auto",opacity:"1"},{height:"0",opacity:"0"}],options:{duration:250,easing:"linear"}});Se.define("sl-details");const En="modulepreload",An=function(e,t){return new URL(e,t).href},Xo={},Qo=function(t,i,o){let s=Promise.resolve();if(i&&i.length>0){const r=document.getElementsByTagName("link"),l=document.querySelector("meta[property=csp-nonce]"),d=(l==null?void 0:l.nonce)||(l==null?void 0:l.getAttribute("nonce"));s=Promise.allSettled(i.map(u=>{if(u=An(u,o),u in Xo)return;Xo[u]=!0;const p=u.endsWith(".css"),m=p?'[rel="stylesheet"]':"";if(!!o)for(let b=r.length-1;b>=0;b--){const g=r[b];if(g.href===u&&(!p||g.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${u}"]${m}`))return;const f=document.createElement("link");if(f.rel=p?"stylesheet":En,p||(f.as="script"),f.crossOrigin="",f.href=u,d&&f.setAttribute("nonce",d),document.head.appendChild(f),p)return new Promise((b,g)=>{f.addEventListener("load",b),f.addEventListener("error",()=>g(new Error(`Unable to preload CSS for ${u}`)))})}))}function a(r){const l=new Event("vite:preloadError",{cancelable:!0});if(l.payload=r,window.dispatchEvent(l),!l.defaultPrevented)throw r}return s.then(r=>{for(const l of r||[])l.status==="rejected"&&a(l.reason);return t().catch(a)})};/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let Dn=class extends Event{constructor(t,i,o,s){super("context-request",{bubbles:!0,composed:!0}),this.context=t,this.contextTarget=i,this.callback=o,this.subscribe=s??!1}};/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 *//**
      ...
      >
        ...
        <div class="epic-info">
          ...
          <div class="badges">
            ...
            ${e.after&&e.after.length>0?e.after.map(o=>h`
